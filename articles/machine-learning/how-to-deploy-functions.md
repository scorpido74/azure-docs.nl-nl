...
description: Meer informatie over het gebruik van Azure Machine Learning om een model als een webservice in een Azure Functions-app te verpakken en implementeren.
