...
Als uw trainings bestanden zich niet in een Git-opslag plaats in uw ontwikkelings omgeving bevinden, of als de `git`-opdracht niet beschikbaar is, worden er geen gegevens over git bijgehouden.
