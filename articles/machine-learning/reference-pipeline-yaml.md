...
| YAML-toets | Beschrijving |
| ----- | ----- |
| `steps` | Reeks van een of meer PipelineStep-definities. Merk op `destination` dat de `outputs` van een stap `inputs` is uitgegroeid tot de sleutels van de .| 
