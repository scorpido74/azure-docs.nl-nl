---
title: 'Zelfstudie: Een machine learning-model maken met R (preview)'
...
> [!IMPORTANT]
> De Azure Machine Learning R SDK is momenteel beschikbaar als openbare preview-versie.
...
De rekeninstantie heeft al de laatste versie van de R SDK van CRAN geïnstalleerd. Als u in plaats daarvan de ontwikkelversie van GitHub wilt installeren om de nieuwste oplossingen voor fouten op te halen, voer dan het volgende uit:
...
> [!WARNING]
> Als u tijdens het installatieproces de prompt `Would you like to install Miniconda? [Y/n]:` ziet, reageer dan met `n`, aangezien de rekeninstantie al Anaconda heeft geïnstalleerd en Miniconda niet hoeft te worden geïnstalleerd.
...
Met uw model kunt u het risico van overlijden als gevolg van een auto-ongeluk voorspellen. Gebruik Azure ML om uw model te implementeren als een voorspellingsservice. In deze zelfstudie gaat u de webservice implementeren in [Azure Container Instances](../container-instances/index.yml) (ACI).
