...
description: Meer informatie over hoe u de uitvoering van een Azure Machine Learning pijp lijn kunt activeren met behulp van Azure Logic Apps om te reageren op nieuwe gegevens.
