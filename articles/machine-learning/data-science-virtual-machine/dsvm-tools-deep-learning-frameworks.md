...
> [!NOTE]
> De volgende VM-installatie kopieën zijn afgeschaft:
>
> * Windows Server 2016 DSVM-installatie kopie
> * Ubuntu 16,04 DSVM-installatie kopie 
>
> Deze VM-installatie kopieën zijn alleen beschikbaar voor bestaande klanten die gebruikmaken van ARM-implementaties. Deze installatie kopieën blijven essentiële beveiligings patches ontvangen tot de datum van beëindiging, maar worden niet bijgewerkt met de meest recente data Science-hulpprogram ma's die worden verzonden.
> 
> Raadpleeg de pagina met [afschaffing](./reference-deprecation.md)van de DSVM-afbeelding.
...
| Ondersteunde DSVM-edities      | Ubuntu 16,04 (afgeschaft)    |
...
| Ondersteunde DSVM-edities      | Windows Server 2019<br>Ubuntu 18.04<br> Windows 2016 (afgeschaft)<br> Ubuntu 16,04 (afgeschaft)  |
...
| Ondersteunde DSVM-edities      | Ubuntu 18.04<br> Ubuntu 16,04 (afgeschaft)   |
...
| Ondersteunde DSVM-edities      | Windows 2016 (afgeschaft)<br> Ubuntu 16,04 (afgeschaft)   |
...
| Ondersteunde DSVM-edities      | Windows Server 2019<br>Ubuntu 18.04<br> Ubuntu 16,04 (afgeschaft) |
