...
Als u dit wilt doen, gebruikt u de klassieke versie van Studio om een experiment te maken met de naam *training* , waar u uw model traint, scoreeert en bewerkt. Zodra u tevreden bent, kunt u uw model implementeren door uw trainings experiment te converteren naar een *voorspellend experiment* dat is geconfigureerd voor de Score gebruikers gegevens.
