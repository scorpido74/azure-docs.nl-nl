...
> [!TIP]
> Raadpleeg [Algoritmen kiezen voor Microsoft Azure Machine Learning Studio (klassiek)](algorithm-choice.md) als u informatie nodig hebt om te bepalen welk Machine Learning-algoritme het beste tegemoetkomt aan het specifieke probleem dat u probeert om op te lossen.
> 
> 
