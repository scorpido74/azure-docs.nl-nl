...
Er zijn verschillende manieren om een model te selecteren. In machine learning is Kruis validatie een van de meest gebruikte methoden voor het selecteren van modellen en het is het standaard model selectie mechanisme in de klassieke versie van Azure Machine Learning Studio. Omdat de klassieke versie van Azure Machine Learning Studio zowel R als python ondersteunt, kunt u hun eigen model selectie mechanismen altijd implementeren met behulp van R of python.
...
In de volgende afbeelding ziet u hoe dit kan worden bereikt in de klassieke versie van Azure Machine Learning Studio.
