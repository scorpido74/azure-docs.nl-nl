...
Zie voor documentatie over webservices en de facturering van het toezeggings plan [Azure machine learning Studio (klassiek) rest API verwijzing](/rest/api/machinelearning/).