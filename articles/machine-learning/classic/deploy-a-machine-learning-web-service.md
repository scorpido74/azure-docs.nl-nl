...
* Zie voor meer informatie over het voorbereiden van uw model voor het implementeren van uw model [voor implementatie in azure machine learning Studio (klassiek)](deploy-a-machine-learning-web-service.md).
