---
title: 'ML Studio (klassiek): implementatie en verbruik-Azure'
...
* Naslag informatie voor [Azure machine learning Studio (klassieke)-cmdlets](/powershell/module/az.machinelearning) op MSDN
