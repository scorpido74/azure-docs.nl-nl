...
Als u uw model wilt delegeren `run` , gebruikt en geeft u de lijst met uitvoer resultaten op die u wilt retour neren (laat dit leeg als u wilt dat alle) en een kaart van de invoer waarden. Het resultaat is een lijst met de uitvoer.  
```python
