...
description: Azure Machine Learning is een geïntegreerde oplossing voor gegevens wetenschap voor het model leren en implementeren van ML-toepassingen op Cloud schaal. De functie Workbench is buiten gebruik gesteld.
...
+ Een [vereenvoudigd Azure-resource model](concept-azure-machine-learning-architecture.md).
...
+ Een nieuwe, uitgebreidere Python-<a href="/python/api/overview/azure/ml/intro?view=azure-ml-py" target="_blank">SDK</a>.
...
Alle nieuwste mogelijkheden zijn beschikbaar via deze nieuwe <a href="/python/api/overview/azure/ml/intro?view=azure-ml-py" target="_blank">SDK</a>, de [CLI](reference-azure-machine-learning-cli.md) en de [portal](how-to-manage-workspace.md).
