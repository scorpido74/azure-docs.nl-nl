...
U kunt gegevens sets in een Panda data frame laden met de methode [`to_pandas_dataframe()`](https://docs.microsoft.com/python/api/azureml-core/azureml.data.tabulardataset?view=azure-ml-py#to-pandas-dataframe-on-error--null---out-of-range-datetime--null--) van de klasse `azureml-contrib-dataset`. Installeer de klasse met de volgende shell-opdracht: 
...
U kunt gegevens sets in Torchvision-gegevensset laden met de methode [to_torchvision ()](https://docs.microsoft.com/python/api/azureml-contrib-dataset/azureml.contrib.dataset.tabulardataset?view=azure-ml-py#to-torchvision--) , ook van de `azureml-contrib-dataset`-klasse. Als u deze methode wilt gebruiken, moet [PyTorch](https://pytorch.org/) zijn geïnstalleerd. 
