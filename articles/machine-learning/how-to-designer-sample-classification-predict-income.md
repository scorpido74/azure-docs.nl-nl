...
**Voor beeld van Designer 3**

[!INCLUDE [applies-to-skus](../../includes/aml-applies-to-enterprise-sku.md)]

Meer informatie over het bouwen van een machine learning classificatie zonder een enkele regel code te schrijven met behulp van de ontwerp functie. In dit voor beeld wordt een **geboostte beslissings structuur met twee klassen** getraind om inkomsten te voors pellen (> = 50.000 of < = 50.000).
...
![Grafiek van de pijp lijn](./media/how-to-designer-sample-classification-predict-income/overall-graph.png)
...
De gegevensset bevat 14 functies en één label kolom. Er zijn meerdere typen functies, waaronder numerieke en categorische. In het volgende diagram ziet u een fragment uit de gegevensset: ![gegevens](media/how-to-designer-sample-classification-predict-income/sample3-dataset-1225.png)
...
![apply-trans formatie](./media/how-to-designer-sample-classification-predict-income/transformation.png)
...
![De resultaten evalueren](media/how-to-designer-sample-classification-predict-income/sample3-evaluate-1225.png)
