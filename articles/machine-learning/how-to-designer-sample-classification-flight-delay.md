...
[Grafiek van de pijp lijn ![](media/how-to-designer-sample-classification-flight-delay/pipeline-graph.png)](media/how-to-designer-sample-classification-flight-delay/pipeline-graph.png#lightbox)
...
![gegevens proces](./media/how-to-designer-sample-classification-flight-delay/data-process.png)
...
Vlucht records worden toegevoegd aan de gegevens van het begin van de vlucht (**OriginAirportID**) met behulp van de **join data** -module.
 ...
 ![Sluit vlucht en weer aan de oorsprong](./media/how-to-designer-sample-classification-flight-delay/join-origin.png)


Vlucht records worden gekoppeld aan weer gegevens die gebruikmaken van de bestemming van de vlucht (**DestAirportID**).

 ![Vlucht en weer aan de bestemming toevoegen](./media/how-to-designer-sample-classification-flight-delay/join-destination.png)
...
In de module **Split data** worden de gegevens gesplitst in april tot en met september records voor training en oktober records voor test doeleinden.
 ...
 ![Training en test gegevens splitsen](./media/how-to-designer-sample-classification-flight-delay/split.png)
...
Het logistiek regressie model heeft AUC van 0,631 in de testset.
 ...
 ![evalueren](media/how-to-designer-sample-classification-flight-delay/sample6-evaluate-1225.png)
