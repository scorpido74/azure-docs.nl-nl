...
description: Meer informatie over het gebruik van de module voor het uitvoeren van R-script in Azure Machine Learning Designer om aangepaste R-code uit te voeren.
