...
description: Meer informatie over het gebruik van de Two-Class Support Vector machine module in Azure Machine Learning om een binaire classificatie te maken.
