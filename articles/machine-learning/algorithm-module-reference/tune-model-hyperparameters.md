...
description: Gebruik de module model Hyper parameters afstemmen in de ontwerp functie voor het opruimen van een para meter om Hyper-para meters af te stemmen.
