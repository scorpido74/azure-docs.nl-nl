...
| Python en R | Schrijf code en sluit deze in een module in om python en R met uw pijp lijn te integreren. | [Python-model maken](create-python-model.md) <br/> [Python-script uitvoeren](execute-python-script.md)   <br/>  [R-script uitvoeren](execute-r-script.md)
...
| Trainen   | Voer gegevens uit via de algoritme. | [Model trainen](train-model.md)  <br/> [Cluster model trainen](train-clustering-model.md) <br/>  [Model Hyper parameters afstemmen](tune-model-hyperparameters.md) |
...
| Statistische functies | Bieden een groot aantal statistische methoden die zijn gerelateerd aan data Science. | [Wiskundige bewerking Toep assen](apply-math-operation.md) <br/> [Gegevens samenvatten](summarize-data.md)|
