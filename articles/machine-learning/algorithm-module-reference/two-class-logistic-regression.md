...
description: Meer informatie over het gebruik van de Two-Class logistiek-regressie module in Azure Machine Learning om een binaire classificatie te maken.
