...
ms.locfileid: "77925954"
---
# <a name="train-anomaly-detection-model"></a>Model voor afwijkings detectie trainen
...
+ [Anomalie detectie op basis van PCA](pca-based-anomaly-detection.md)  
