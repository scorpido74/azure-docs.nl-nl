...
|Uitzonderings berichten|
|------------------------|
|Er bestaan meerdere classificaties voor de waarde (n) in de gegevensset.|
...
|Uitzonderings berichten|
|------------------------|
|Model kan niet worden gedeserialiseerd, omdat het waarschijnlijk met een oudere serialisatie-indeling is geserialiseerd. Probeer het model opnieuw te trainen en opnieuw op te slaan.|
...
|Er is een niet-ondersteund parameter type {parameter_name} opgegeven.|
|Er is een niet-ondersteund parameter type {parameter_name} opgegeven. Reden: {reden}.|
...
## <a name="error-0154"></a>Fout 0154  
 Uitzonde ring treedt op wanneer de gebruiker probeert gegevens toe te voegen op sleutel kolommen met een niet-compatibel kolom Type.
...
|Uitzonderings berichten|
|------------------------|
|Kolom namen zijn geen teken reeks.|
|Kolom namen: {column_names} zijn geen teken reeks.|
