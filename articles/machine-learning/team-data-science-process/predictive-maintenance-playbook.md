...
| 6 | [Azure IoT-voor speld onderhoud](https://github.com/Azure/azure-iot-predictive-maintenance) | Azure IoT Suite PC'S-vooraf geconfigureerde oplossing. PdM-sjabloon voor vliegtuig onderhoud met IoT Suite. [Een ander document en een](../../iot-accelerators/quickstart-predictive-maintenance-deploy.md) [scenario](../../iot-accelerators/iot-accelerators-predictive-walkthrough.md) met betrekking tot hetzelfde project. |
