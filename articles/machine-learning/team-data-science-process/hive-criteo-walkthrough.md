...
ms.locfileid: "73492350"
---
# <a name="the-team-data-science-process-in-action---using-an-azure-hdinsight-hadoop-cluster-on-a-1-tb-dataset"></a>Het team data Science-proces in actie-een Azure HDInsight Hadoop cluster op een gegevensset van 1 TB gebruiken
...
## <a name="dataset"></a>Beschrijving van de Criteo-gegevensset
De Criteo-gegevens zijn een klik op Voorspellings-dataset die ongeveer 370GB aan gzip gecomprimeerde TSV-bestanden (~ 1.3 TB ongecomprimeerd) is, met meer dan 4.300.000.000 records. Het wordt opgehaald van 24 dagen aan geklikte gegevens die beschikbaar zijn gesteld door [Criteo](https://labs.criteo.com/downloads/download-terabyte-click-logs/). Voor het gemak van gegevens wetenschappers zijn de gegevens die voor ons zijn beschikbaar om te experimenteren, uitgepakt.
...
**Definitie:** aantal geklikt *(plaats):* dit is het percentage van klikken in de gegevens. In deze Criteo-gegevensset bevindt de afdeling zich ongeveer 3,3% of 0,033.
...
## <a name="setup"></a>Een HDInsight Hadoop-cluster voor data Science instellen
**Opmerking:** Dit is doorgaans een **beheer** taak.
...
1. [Een opslag account maken](../../storage/common/storage-quickstart-create-account.md): dit opslag account wordt gebruikt om gegevens op te slaan in Azure Blob Storage. De gegevens die in HDInsight-clusters worden gebruikt, worden hier opgeslagen.
2. [Azure HDInsight Hadoop clusters voor data Science aanpassen](customize-hadoop-cluster.md): met deze stap maakt u een Azure HDInsight Hadoop cluster met 64-bits Anaconda python 2,7 geïnstalleerd op alle knoop punten. Er zijn twee belang rijke stappen (beschreven in dit onderwerp) om te volt ooien bij het aanpassen van het HDInsight-cluster.
   ...
   * U moet het opslag account dat u in stap 1 hebt gemaakt, koppelen met uw HDInsight-cluster wanneer het wordt gemaakt. Dit opslag account wordt gebruikt voor toegang tot gegevens die in het cluster kunnen worden verwerkt.
   * U moet externe toegang tot het hoofd knooppunt van het cluster inschakelen nadat het is gemaakt. Onthoud de RAS-referenties die u hier opgeeft (anders dan die voor het maken van het cluster): u hebt ze nodig om de volgende procedures uit te voeren.
...
## <a name="getdata"></a>Gegevens uit een open bare bron ophalen en gebruiken
U kunt de [Criteo](https://labs.criteo.com/downloads/download-terabyte-click-logs/) -gegevensset openen door op de koppeling te klikken, de gebruiks voorwaarden te accepteren en een naam op te geven. Hier ziet u een moment opname van wat dit lijkt:
...
De gegevens bevinden zich in een open bare [Azure Blob-opslag](../../storage/blobs/storage-dotnet-how-to-use-blobs.md) locatie: wasb://criteo@azuremlsampleexperiments.blob.core.windows.net/raw/. De wasb verwijst naar de locatie van Azure Blob Storage.

1. De gegevens in deze open bare Blob-opslag bestaan uit drie submappen van ongecomprimeerde gegevens.

   1. De submap *RAW/Count/* bevat de eerste 21 dagen aan gegevens-van dag\_00 tot dag\_20
   2. De submap *RAW/Train/* bestaat uit één dag van de gegevens, dag\_21
   3. De submap *RAW/test/* bestaat uit twee dagen aan gegevens, dag\_22 en dag\_23
2. Voor degenen die met de onbewerkte gzip-gegevens willen beginnen, zijn deze ook beschikbaar in de hoofdmap *RAW/* als day_NN. gz, waarbij nn van 00 tot 23 loopt.
...
## <a name="hive-db-tables"></a>Hive-data base en-tabellen maken
...
* een *tabel voor het genereren van aantallen* die zijn gebouwd op dagen dag\_00 tot dag\_20,
* een *tabel voor gebruik als de Train-gegevensset die* is gebouwd op dag\_21, en
* twee *tabellen die worden gebruikt als de test gegevens sets die* zijn gebouwd op dag\_22 en dag\_23 respectievelijk.
...
De [component&#95;&#95;script voorbeeld Create&#95;Criteo&#95;data&#95;Base&#95;and tables. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_create_criteo_database_and_tables.hql) wordt hier weer gegeven voor het gemak:
...
Al deze tabellen zijn extern, zodat u gewoon kunt verwijzen naar hun Azure Blob Storage-locaties (wasb).

**Er zijn twee manieren om een Hive-query uit te voeren:**

1. **Met behulp van de Hive-opdracht regel**: de eerste is het uitgeven van een Hive-opdracht en het kopiëren en plakken van een query op de Hive-opdracht regel. Ga hiervoor als volgt te werk:

        cd %hive_home%\bin
        hive

     Nu kunt u op de opdracht regel van REPL de query knippen en plakken uitvoeren.
2. **Query's opslaan in een bestand en de opdracht uitvoeren**: de tweede is om de query's op te slaan in een. HQL-bestand ([&#95;&#95;bij&#95;het&#95;maken&#95;van&#95;een Criteo-data base en tabellen. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_create_criteo_database_and_tables.hql)) en vervolgens de volgende gegevens op te geven opdracht voor het uitvoeren van de query:
...
## <a name="exploration"></a>Component gegevens verkennen in
...
De inhoud van [het&#95;&#95;voor&#95;beeld&#95;van&#95;een Hive van het aantal voor beelden van een HQL.](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_count_train_table_examples.hql) deze worden hier weer gegeven:
...
Tel nu het aantal voor beelden in de twee test gegevens sets. De inhoud van [het&#95;aantal&#95;&#95;voorbeeld onderdelen&#95;Criteo&#95;test&#95;Day&#95;22&#95;Table-voor beelden. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_count_criteo_test_day_22_table_examples.hql) zijn:
...
Ten slotte bekijkt u het aantal test voorbeelden in de test-gegevensset op basis van de dag\_23.

De opdracht die u hiervoor moet volgen, is vergelijkbaar met het item dat wordt weer gegeven (Raadpleeg het [&#95;aantal&#95;&#95;&#95;&#95;voorbeeld onderdelen&#95;Criteo test&#95;Day 23 voor beelden. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_count_criteo_test_day_23_examples.hql)):
...
De label distributie in de Train-gegevensset is van belang. Als u dit wilt zien, geeft u inhoud van de [&#95;voorbeeld&#95;component&#95;&#95;Criteo&#95;&#95;Label Distribution Train Table. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_label_distribution_train_table.hql):
...
Houd er rekening mee dat het percentage positieve labels ongeveer 3,3% is (consistent met de oorspronkelijke gegevensset).
...
U kunt de functie ' histogram\_numeriek ' van de Hive gebruiken om erachter te komen hoe de numerieke variabelen eruitzien. Hier vindt u de inhoud [van&#95;de&#95;voorbeeld&#95;component&#95;Criteo histogram numeric. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_histogram_numeric.hql):
...
Met de ZIJDELINGSe weer gave-combi natie in Hive kunt u een SQL-achtige uitvoer maken in plaats van de gebruikelijke lijst. Houd er rekening mee dat in deze tabel de eerste kolom overeenkomt met het bin Center en de tweede met de frequentie van de opslag locatie.
...
Het is ook belang rijke percentielen voor het berekenen van de geschatte waarden. Het systeem eigen percentiel van de Hive-\_ong. De inhoud van [de&#95;voorbeeld&#95;component&#95;Criteo geschatte&#95;percentielen. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_approximate_percentiles.hql) zijn:
...
Het aantal combi Naties van Categorische variabelen is ook van belang. Dit kan worden bepaald met behulp van de code in de [&#95;voorbeeld&#95;component&#95;&#95;Criteo&#95;paared categorische counts. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_paired_categorical_counts.hql):
...
## <a name="downsample"></a>Voor beeld van de gegevens sets voor Azure Machine Learning
...
Als u de gegevens sets van de trein en test op 1% van de oorspronkelijke grootte wilt bemonsteren, gebruikt u de functie systeem eigen RAND () van de component. Het volgende script, [een&#95;voor&#95;beeld&#95;van een&#95;Criteo&#95;down sampling DataSet. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_downsample_train_dataset.hql) voert dit uit voor de Train-gegevensset:
...
De [voorbeeld&#95;code van&#95;het&#95;script Criteo&#95;down&#95;sampling&#95;test&#95;Day 22 DataSet. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_downsample_test_day_22_dataset.hql) voor test gegevens, dag\_22:
...
Ten slotte wordt de [Criteo&#95;&#95;&#95;Downsample&#95;test&#95;Day&#95;door de Hive&#95;](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_downsample_test_day_23_dataset.hql) van de voorbeeld toepassing voor test gegevens 23 DataSet. HQL gebruikt voor het testen van data, Day\_23:
...
## <a name="count"></a>Een korte discussie over de tabel aantal
Zoals u hebt gezien, hebben verschillende categorische-variabelen een zeer hoge dimensionaliteit. In de walkthrough wordt een krachtige techniek genoemd [met de naam learning met aantallen](https://blogs.technet.com/b/machinelearning/archive/2015/02/17/big-learning-made-easy-with-counts.aspx) om deze variabelen op een efficiënte en robuuste manier te coderen. Meer informatie over deze techniek vindt u in de koppeling.
...
## <a name="aml"></a>Een model bouwen met Azure Machine Learning
...
### <a name="step1"></a>Stap 1: gegevens uit Hive-tabellen ophalen in Azure Machine Learning met behulp van de module gegevens importeren en deze selecteren voor een machine learning experiment
Begin met het selecteren van een **+ nieuw** -> **experiment** -> **leeg experiment**. Zoek vervolgens **in het zoekvak** linksboven op ' gegevens importeren '. Sleep de module **gegevens importeren** naar het canvas op het experiment (het middelste gedeelte van het scherm) om de module voor gegevens toegang te gebruiken.
...
2. In het vak **Hive-database query** is een eenvoudige SELECT * van < uw\_-data base\_naam. uw\_tabel\_naam >-is voldoende.
3. **URI van Hcatalog-server**: als uw cluster ' ABC ' is, is dit gewoon: https://abc.azurehdinsight.net
...
8. **Sleutel van het Azure-opslag account**: de sleutel van het opslag account dat aan het cluster is gekoppeld.
...
### <a name="step2"></a>Stap 2: een eenvoudig experiment maken in Azure Machine Learning om klikken/geen klikken te voors pellen
...
Bekijk nu de belangrijkste onderdelen van dit experiment. Sleep onze opgeslagen trein-en test gegevens sets naar ons experiment doek eerst.
...
![de eigenschappen van de transformatie module voor het genereren van de trans formatie](./media/hive-criteo-walkthrough/e0eqKtZ.png)
![build-module voor het tellen](./media/hive-criteo-walkthrough/OdDN0vw.png)
...
Nu is de focus gericht op een belang rijk punt over het transformeren van onze Train-en test gegevens voordat het aantal functies daad werkelijk wordt gegenereerd. Houd er rekening mee dat er twee **R-script** modules worden gebruikt voordat de Count-trans formatie op onze gegevens wordt toegepast.
...
### <a name="step3"></a>Stap 3: het model bouwen, trainen en beoordelen
...
Kies voor het experiment de standaard waarden. Houd er rekening mee dat de standaard waarden vaak zinvol zijn en een goede manier zijn om snelle basis lijnen te krijgen voor de prestaties. U kunt de prestaties verbeteren door para meters te verruimen als u een basis lijn hebt gekozen.
...
Ten slotte moet u de model prestaties analyseren. Normaal gesp roken is een goede meting voor problemen met twee klasse (binaire)-classificatie de AUC. Als u dit wilt visualiseren, koppelt u de module **score model** aan de module **Evaluate model** . Als u op **visualiseren** in de module **Evaluate model** klikt, wordt er een afbeelding weer gegeven zoals in het volgende voor beeld:

![Het BDT-model van de module evalueren](./media/hive-criteo-walkthrough/0Tl0cdg.png)

In binaire classificatie problemen (of twee klassen) is een goede meting van de nauw keurigheid van voor spellingen de Opper vlakte onder curve (AUC). In de volgende sectie vindt u de resultaten met behulp van dit model in onze test-gegevensset. U kunt dit doen door met de rechter muisknop op de uitvoer poort van de module **Evaluate model** te klikken en vervolgens te **visualiseren**.
...
Als u dit wilt doen, slaat u het getrainde model eerst op als een opgeleid model object. Dit doet u door met de rechter muisknop te klikken op de module **Train model** en de optie **Opslaan als getraind model** te gebruiken.
...
Als een zeroth-stap, omdat de Count-tabel groot is, neemt u enkele regels test gegevens en genereert u uitvoer gegevens van deze met aantal functies. Dit kan fungeren als de invoer gegevens indeling voor onze webservice. Dit wordt hier weer gegeven:
...
Eerst wordt weer gegeven hoe dit eruitziet. De essentiële structuur is een **score model** module die ons getrainde model object accepteert en enkele regels invoer gegevens die in de vorige stappen zijn gegenereerd met behulp van de Featurizer-module **Count** . Gebruik ' select columns in Dataset ' om de gescoorde labels en de Score kansen te projecteren.
...
Als u op de koppelings **aanvraag/antwoord** klikt, gaat u naar een pagina met een vooraf ingecheckte code in C#, python en R. Deze code kan gemakkelijk worden gebruikt voor het maken van aanroepen naar de webservice. Houd er rekening mee dat de API-sleutel op deze pagina moet worden gebruikt voor verificatie.
...
Houd er rekening mee dat de standaard-API-sleutel is vervangen door de API-sleutel van onze webservices. Als u in deze cel in een IPython-notebook op **uitvoeren** klikt, wordt het volgende antwoord opgeleverd:

![IPython-antwoord](./media/hive-criteo-walkthrough/KSxmia2.png)

Voor de twee test voorbeelden die worden gevraagd over (in het JSON-Framework van het python-script), krijgt u terug-antwoorden in de vorm ' gescoorde labels, gescoorde kansen '. In dit geval zijn de standaard waarden gekozen. de vooraf ingecheckte code levert (0 voor alle numerieke kolommen en de teken reeks "waarde" voor alle kolommen van categorische).

Dit is de procedure die laat zien hoe u een grootschalige gegevensset kunt verwerken met Azure Machine Learning. U bent begonnen met een terabyte aan gegevens, een Voorspellings model gemaakt en deze als een webservice in de Cloud geïmplementeerd.
