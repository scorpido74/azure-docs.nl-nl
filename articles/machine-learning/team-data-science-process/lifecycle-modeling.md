...
De artefacten die in deze fase worden geproduceerd, zijn onder andere:
   ...
   * **Beslissing van het controle punt**: Bepaal of het model voldoende presteert om het te implementeren in een productie systeem. Er zijn een aantal belangrijke vragen stellen:
