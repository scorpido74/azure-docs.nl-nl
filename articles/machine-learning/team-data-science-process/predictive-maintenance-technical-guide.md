...
* Het vinden van de Stream Analytics-taken ![Stream Analytics pictogram](./media/predictive-maintenance-technical-guide/icon-stream-analytics.png) die zijn gegenereerd toen de oplossing werd*for example*geïmplementeerd (bijvoorbeeld **maintenancesa02asapbi** en **maintenancesa02asablob** voor de oplossing voor voor speld onderhoud)
* Selecteren
...
![Data Factory-gegevensset-fouten](./media/predictive-maintenance-technical-guide/data-factory-dataset-error.png)
...
1. Referenties van de database ophalen.
   ...
   * Klik in het nieuwe deel venster pop-out op het pictogram ![SQL-pictogram](./media/predictive-maintenance-technical-guide/icon-sql.png) om toegang te krijgen tot uw data base. De naam van uw Data Base bevindt zich naast dit pictogram (bijvoorbeeld **' pmaintenancedb '** ) en de naam van de **database server** wordt vermeld onder de eigenschap Server naam en moet er ongeveer uitzien als **YourSolutionName.database.Windows.net**.
...
2. De gegevensbron van het koude pad-rapportbestand bijwerken met Power BI Desktop.
   ...
   * U ziet twee tabellen, **RemainingUsefulLife** en **PMResult**. Selecteer de eerste tabel en klik op ![pictogram query instellingen](./media/predictive-maintenance-technical-guide/icon-query-settings.png) naast **' Bron '** onder **toegepaste stappen** in het rechter paneel **' query instellingen** '. Negeer eventuele waarschuwingsberichten die worden weergegeven.
   ...
   * Klik op de tweede tabel **PMResult** klik op ![navigatie pictogram](./media/predictive-maintenance-technical-guide/icon-navigation.png) naast **' Bron '** onder **toegepaste stappen** in het rechterdeel venster ' **query instellingen** ' en werk de namen van de server en de data base bij, zoals in de bovenstaande stappen. Klik vervolgens op OK.
...
3. Beschrijving Publiceer het dash board koud pad om [online te Power bi](https://www.powerbi.com/). Voor deze stap hebt u een Power BI account (of een Office 365-account) nodig.
   ...
   * Zodra u het rapport hebt geopend, klikt u op ![SPELd pictogram](./media/predictive-maintenance-technical-guide/icon-pin.png) om alle visualisaties aan uw dash board vast te maken. Zie [een tegel vastmaken aan een Power bi-dash board vanuit een rapport](https://support.powerbi.com/knowledgebase/articles/430323-pin-a-tile-to-a-power-bi-dashboard-from-a-report)om gedetailleerde instructies te vinden.
