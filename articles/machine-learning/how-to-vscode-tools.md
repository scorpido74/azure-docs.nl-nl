...
De [Azure machine learning](overview-what-is-azure-ml.md) stroomlijnt het bouwen, trainen en implementeren van machine learning modellen.
...
+ U kunt ook de Azure Machine Learning gebruiken om machine learning modellen eenvoudig te implementeren voor uw test-en productie behoeften.
...
1. Er wordt een welkomst tabblad voor de uitbrei ding geopend in Visual Studio code en het Azure-symbool (rood gemarkeerd in de volgende scherm afbeelding) wordt toegevoegd aan de activiteiten balk.
   ...
   ![Azure-pictogram op de activiteiten balk van Visual Studio](./media/how-to-vscode-tools/azure-activity-bar.png)
...
Er zijn meerdere manieren waarop u uw trainings scripts kunt uitvoeren met behulp van Azure Machine Learning. Als u net aan de slag gaat, laten we eerst zien hoe u snel een trainings script kunt indienen om uit te voeren in Azure.
...
1. Open **Train.py** en voer deze uit door het fout opsporingsprogramma te openen en op de knop uitvoeren te drukken (of druk op F5).
   ...
   [MNIST-training ![uitvoeren](./media/how-to-vscode-tools/run-mnist.gif)](./media/how-to-vscode-tools/run-mnist.gif#lightbox)
...
[Tensor flow-model ![weer geven](./media/how-to-vscode-tools/show-tensorflow-model.gif)](./media/how-to-vscode-tools/show-tensorflow-model.gif#lightbox)
...
Dat is alles. Gebruik nu alleen de extensie om uw script uit te voeren in de Cloud. De volgende scenario video neemt de vrijheid van het comprimeren van de hoeveelheid tijd die nodig is om een nieuwe Azure Machine Learning werk ruimte te maken en te berekenen, evenals de tijd die nodig is om het trainings script uit te voeren.

   [![een Azure ML-experiment starten](./media/how-to-vscode-tools/start-golden-path.gif)](./media/how-to-vscode-tools/start-golden-path.gif#lightbox)

Nadat u op de knop experiment uitvoeren hebt geklikt, beantwoordt u de prompts als volgt:

1. Kies uw Azure-abonnement.
1. Kies ervoor om een *nieuwe* Azure machine learning-werk ruimte te maken.
...
1. U kunt terug en even horen terwijl de uitbrei ding alles voor u instelt en uw script uitvoert.
    ...
    [![Train in de Cloud](./media/how-to-vscode-tools/run-golden-path.gif)](./media/how-to-vscode-tools/run-golden-path.gif#lightbox)

In een paar seconden wordt u gewaarschuwd dat het experiment is verzonden naar Azure, op welk moment u de voortgang kunt bekijken in de Azure Machine Learning Studio door te klikken op de koppeling **experiment-uitvoering weer geven** in de melding over de VS-code of in VS code door op de knop Vernieuwen op het tabblad van Azure.

Op het moment wordt het weer geven van metrische uitvoerings gegevens alleen ondersteund in de Studio. Met de koppeling voor het uitvoeren van het **experiment weer geven** hierboven gaat u naar de uitvoering waar u de metrische gegevens ziet die u hebt geregistreerd.
[![experiment in Portal uitvoeren](./media/how-to-vscode-tools/experiment-run-on-portal.PNG)](./media/how-to-vscode-tools/experiment-run-on-portal.PNG#lightbox)
...
1. Op de activiteiten balk van Visual Studio, selecteert u het pictogram van Azure. De Azure Machine Learning zijbalk wordt weer gegeven.
    ...
    [een werk ruimte ![maken](./media/how-to-vscode-tools/create-workspace.gif)](./media/how-to-vscode-tools/create-workspace.gif#lightbox)
...
1. In een werk ruimte kunt u met de rechter muisknop op een experiment klikken om dit als het **actieve** experiment in te stellen. Het **actieve** experiment bevat koppelingen waarmee in de Cloud wordt geexperimenteerd naar de map die u momenteel hebt geopend in Visual Studio code. Deze map moet uw lokale python-scripts bevatten. Door een actief experiment in te stellen, worden belang rijke metrische gegevens voor alle trainings runs opgeslagen in het experiment, ongeacht waar ze worden uitgevoerd.
    ...
    [![een experiment maken](./media/how-to-vscode-tools/create-experiment.gif)](./media/how-to-vscode-tools/create-experiment.gif#lightbox)
...
1. Breng de gewenste wijzigingen aan in het JSON-bestand dat wordt weer gegeven en klik vervolgens op ' opslaan en door gaan ' code lens (met behulp van het toetsen bord kunt u op **CTRL + SHIFT + p** drukken om het opdracht palet aan te roepen en de opdracht **Azure ml: opslaan en door gaan** uit te voeren)

Hier volgt een voor beeld van het maken en bewerken van een Azure Machine Learning Compute (AMLCompute):

[![AML-Compute maken in Visual Studio code](./media/how-to-vscode-tools/create-remote-compute.gif)](./media/how-to-vscode-tools/create-remote-compute.gif#lightbox)
...
[![een uitvoerings configuratie maken voor een compute](./media/how-to-vscode-tools/create-runconfig.gif)](./media/how-to-vscode-tools/create-runconfig.gif#lightbox)
...
1. Klik met de rechter muisknop op het trainings script en kies **Azure ml: uitvoeren als experiment in azure**
...
1. Het VS code-opdracht palet gebruiken om **Azure ml uit te voeren: experiment uitvoeren**
...
[![een experiment lokaal uitvoeren](./media/how-to-vscode-tools/run-experiment.gif)](./media/how-to-vscode-tools/run-experiment.gif#lightbox)
...
[![de registratie van een model op AML](./media/how-to-vscode-tools/register-model.gif)](./media/how-to-vscode-tools/register-model.gif#lightbox)
...
[een webservice ![implementeren](./media/how-to-vscode-tools/create-image.gif)](./media/how-to-vscode-tools/create-image.gif#lightbox)
...
[![toetsenbord snel toetsen voor Azure Machine Learning voor Visual Studio code](./media/how-to-vscode-tools/commands.gif)](./media/how-to-vscode-tools/commands.gif#lightbox)
