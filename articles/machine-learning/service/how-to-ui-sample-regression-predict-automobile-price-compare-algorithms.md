...
Meer informatie over het bouwen van een complexe machine learning pijp lijn zonder dat u een regel code hoeft te schrijven met behulp van de visuele interface. Dit voor beeld van treinen en vergelijkt meerdere regressie modellen om de prijs van een auto te voors pellen op basis van de technische functies. We bieden de reden voor de keuzes die u in deze pijp lijn hebt gemaakt zodat u uw eigen machine learning problemen kunt aanpakken.

Als u net aan de slag gaat met machine learning, bekijkt u de [basis versie](how-to-ui-sample-regression-predict-automobile-price-basic.md) van deze pijp lijn.

Hier is de voltooide grafiek voor deze pijp lijn:

[![Graph van de pijp lijn](media/how-to-ui-sample-regression-predict-automobile-price-compare-algorithms/graph.png)](media/how-to-ui-sample-classification-predict-credit-risk-cost-sensitive/graph.png#lightbox)

## <a name="prerequisites"></a>Vereisten

[!INCLUDE [aml-ui-prereq](../../../includes/aml-ui-prereq.md)]

4. Selecteer de knop **openen** voor de pijp lijn met voor beeld 2:

    ![De pijp lijn openen](media/how-to-ui-sample-regression-predict-automobile-price-compare-algorithms/open-sample2.png)
...
In deze pijp lijn gebruikt u twee exemplaren van het **Evaluate-model** om twee combi Naties van modellen te vergelijken.
