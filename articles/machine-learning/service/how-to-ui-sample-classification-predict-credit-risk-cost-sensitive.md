---
title: 'Voor beeld van een Visual-Interface #4: classificatie om het krediet risico te voors pellen (kosten gevoelig)'
titleSuffix: Azure Machine Learning
description: In dit artikel wordt beschreven hoe u een complexe machine learning pijp lijn bouwt met behulp van de visuele interface. U leert hoe u aangepaste python-scripts implementeert en hoe u meerdere modellen vergelijkt om de beste optie te kiezen.
...
ms.locfileid: "72693520"
---
# <a name="sample-4---classification-predict-credit-risk-cost-sensitive"></a>Voor beeld 4-classificatie: krediet risico voors pellen (kosten gevoelig)

In dit artikel wordt beschreven hoe u een complexe machine learning pijp lijn bouwt met behulp van de visuele interface. U leert hoe u aangepaste logica implementeert met behulp van python-scripts en meerdere modellen vergelijkt om de beste optie te kiezen.
...
[![Graph van de pijp lijn](media/how-to-ui-sample-classification-predict-credit-risk-cost-sensitive/graph.png)](media/how-to-ui-sample-classification-predict-credit-risk-cost-sensitive/graph.png#lightbox)

## <a name="prerequisites"></a>Vereisten

[!INCLUDE [aml-ui-prereq](../../../includes/aml-ui-prereq.md)]

4. Selecteer de knop **openen** voor de pijp lijn met voor beeld 4:

    ![De pijp lijn openen](media/how-to-ui-sample-classification-predict-credit-risk-cost-sensitive/open-sample4.png)
