...
1. Selecteer **ontwerp functie**.
    ...
    ![Scherm afbeelding van de Visual-werk ruimte met weer gave van toegang tot de ontwerp functie](./media/ui-tutorial-automobile-price-train-score/launch-visual-interface.png)
