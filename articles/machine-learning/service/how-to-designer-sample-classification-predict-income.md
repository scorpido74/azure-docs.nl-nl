...
De gegevensset bevat 14 functies en één label kolom. Er zijn meerdere typen functies, waaronder numerieke en categorische. In het volgende diagram ziet u een fragment uit de gegevensset: ![gegevens](media/how-to-designer-sample-classification-predict-income/data.png)
...
![De resultaten evalueren](media/how-to-designer-sample-classification-predict-income/evaluate-result.png)
