...
description: In dit artikel vindt u informatie over de voor delen van de machine learning pijp lijnen die u kunt bouwen met de Azure Machine Learning SDK voor python. Pijp lijnen voor machine learning (ML) worden gebruikt door gegevens wetenschappers om hun machine learning werk stromen te bouwen, te optimaliseren en te beheren.
...
+ Training en validatie op efficiënte en herhaal bare wijze, waaronder het opgeven van specifieke gegevens subsets, verschillende hardware Compute-bronnen, gedistribueerde verwerking en voortgangs bewaking
...
+ Wanneer elk knoop punt in de uitvoerings grafiek wordt uitgevoerd:
    ...
    + De stap wordt uitgevoerd, waarmee informatie over logboek registratie en controle wordt verstrekt aan het object met `Experiment`
...
![Pijplijn stappen](media/how-to-create-your-first-pipeline/run_an_experiment_as_a_pipeline.png)
