---
title: 'Voor beeld van een Visual-Interface #7: classificatie van boek overzichten'
...
Dit voor beeld laat zien hoe u met behulp van tekst analyse modules een pijp lijn met tekst classificatie kunt bouwen in Azure Machine Learning visuele interface.
...
[![Graph van het experiment](./media/how-to-ui-sample-text-classification/nlp-modules-overall.png)](./media/how-to-ui-sample-text-classification/nlp-modules-overall.png#lightbox)

## <a name="data"></a>Gegevens

In dit experiment gebruiken we de **Wikipedia SP 500** -gegevensset. De gegevensset is afgeleid van Wikipedia (https://www.wikipedia.org/) op basis van artikelen van elke S & P 500-bedrijf. Voordat u uploadt naar Azure Machine Learning visuele interface, is de gegevensset als volgt verwerkt:
...
Uw keuze van algoritme is vaak afhankelijk van de vereisten van de use-case. Omdat het doel van dit experiment het voors pellen van de categorie van het bedrijf is, is een classificatie model met meerdere klassen een goede keuze. Gezien het feit dat het aantal functies groot is en deze functies verspreid zijn, gebruiken we een **logistiek regressie** model met multi class voor dit experiment.
...
[![Graph van een n-gram-Score](./media/how-to-ui-sample-text-classification/n-gram.png)](./media/how-to-ui-sample-text-classification/n-gram.png)
