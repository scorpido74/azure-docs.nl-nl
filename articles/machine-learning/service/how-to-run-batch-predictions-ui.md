...
1. Als u nog geen Azure-abonnement hebt, maakt u een gratis account voordat u begint. Probeer de [gratis of betaalde versie van de Azure machine learning service](https://aka.ms/AMLFree).
...
![Introductie pagina ontwerpen](media/how-to-run-batch-predictions-ui/ui-batch-scoring-1.png)
...
![Eenvoudig experiment maken](media/how-to-run-batch-predictions-ui/ui-batch-scoring-2.png)
...
![Pijp lijn voor batch-deinterferentie maken](media/how-to-run-batch-predictions-ui/ui-batch-scoring-5.png)
...
![Pijp lijn voor de standaard batch-deinterferentie](media/how-to-run-batch-predictions-ui/ui-batch-scoring-6.png)
...
![Nieuw knoop punt](media/how-to-run-batch-predictions-ui/ui-batch-scoring-7.png)
...
![Voorbeeld instellingen](media/how-to-run-batch-predictions-ui/ui-batch-scoring-8.png)
...
![Pijplijnparameter](media/how-to-run-batch-predictions-ui/ui-batch-scoring-9.png)
...
![Pijp lijn implementeren](media/how-to-run-batch-predictions-ui/ui-batch-scoring-10.png)
...
![Installatie-eind punt](media/how-to-run-batch-predictions-ui/ui-batch-scoring-11.png)
...
![Eindpunt koppeling](media/how-to-run-batch-predictions-ui/ui-batch-scoring-12.png)
...
![Pijp lijn afleiding](media/how-to-run-batch-predictions-ui/ui-batch-scoring-13.png)
...
![Pijp lijn Details](media/how-to-run-batch-predictions-ui/ui-batch-scoring-14.png)
...
![Pijplijn uitvoering](media/how-to-run-batch-predictions-ui/ui-batch-scoring-15.png)
