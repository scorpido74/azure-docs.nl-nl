...
1. Voer de naam van de resourcegroup in. Then, select **Delete**.

U kunt de resourcegroep ook bewaren en slechts één werkruimte verwijderen. Display the workspace properties, and then select **Delete**.
