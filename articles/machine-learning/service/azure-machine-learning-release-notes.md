...
+ **Oplossingen en verbeteringen voor oplossingen**
  ...
  + **azureml-automl-core**
    ...
    + Toestaan dat tussenliggende gegevens in Azure Machine Learning pPipeline worden geconverteerd naar tabellaire gegevensset en worden gebruikt in `AutoMLStep`.
