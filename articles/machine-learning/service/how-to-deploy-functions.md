...
* Meer informatie over het configureren van uw functions-app in de [functions](https://docs.microsoft.com/azure/azure-functions/functions-create-function-linux-custom-imag) -documentatie.
