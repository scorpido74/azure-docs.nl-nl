...
4. Maak gegevensset-monitors voor de invoer-en uitvoer gegevens sets van uw model voor het detecteren van gegevens drift. 
5. Als gegevens drift wordt gedetecteerd, werkt u uw gegevensset bij en traint u uw model dienovereenkomstig.
