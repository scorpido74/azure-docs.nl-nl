---
title: 'Route filters configureren voor micro soft-peering-ExpressRoute: Power shell: Azure | Microsoft Docs'
...
### <a name="about"></a>Over route filters
...
## <a name="prefixes"></a>Stap 1: een lijst met voor voegsels en waarden voor de BGP-Community ophalen
...
### <a name="getproperties"></a>De eigenschappen van een route filter ophalen
...
### <a name="updateproperties"></a>De eigenschappen van een route filter bijwerken
...
### <a name="detach"></a>Een route filter loskoppelen van een ExpressRoute-circuit
...
### <a name="delete"></a>Een route filter verwijderen
