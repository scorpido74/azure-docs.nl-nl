...
| Bestands service           | `StorageAccountA-internetrouting.file.core.windows.net`  |
...
| Bestands service           | `StorageAccountA-internetrouting-secondary.file.core.windows.net`  |
