---
title: Nalevings aanbod Azure Storage | Microsoft Docs
description: Lees een samen vatting van compliance-aanbiedingen op Azure Storage voor nationale, regionale en branchespecifieke vereisten voor het verzamelen en gebruiken van gegevens.
services: storage
author: fhryo-msft
ms.service: storage
ms.topic: conceptual
...
* [CSA-STAR-zelf evaluatie](https://www.microsoft.com/trustcenter/compliance/csa-self-assessment)
...
* [Sectie 508 VPAT'S](https://www.microsoft.com/trustcenter/compliance/accessibility)
...
* [AVG (EU)](https://www.microsoft.com/trustcenter/privacy/gdpr)
...
Microsoft Azure & Azure Storage het voor komen van voor aanstaande nalevings aanbiedingen, kunt u de meest recente dekking en informatie vinden in [micro soft TrustCenter](https://www.microsoft.com/TrustCenter/Compliance/default.aspx).
