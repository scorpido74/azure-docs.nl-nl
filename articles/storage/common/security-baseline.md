...
De basis lijn voor deze service wordt opgehaald uit de [Azure Security Bench Mark-versie 1,0](/azure/security/benchmarks/overview), die aanbevelingen biedt over hoe u uw cloud oplossingen kunt beveiligen in azure met onze richt lijnen voor best practices.

Zie [overzicht van Azure Security-basis lijnen](/azure/security/benchmarks/security-baselines-overview)voor meer informatie.
...
- [De Azure Storage firewall configureren](/azure/storage/common/storage-network-security#change-the-default-network-access-rule)

- [Privé-eind punten voor Azure Storage configureren](/azure/storage/common/storage-private-endpoints)
...
- [Azure Storage-firewalls en virtuele netwerken configureren](/azure/storage/common/storage-network-security)

- [NSG-stroom logboeken inschakelen](/azure/network-watcher/network-watcher-nsg-flow-logging-portal)

- [Informatie over netwerk beveiliging die wordt verschaft door Azure Security Center](/azure/security-center/security-center-network-recommendations)

- [Meer informatie over privé-eind punten voor Azure Storage](/azure/storage/common/storage-private-endpoints#known-issues)
...
- [Geavanceerde beveiliging tegen bedreigingen inschakelen](/azure/storage/common/storage-advanced-threat-protection?tabs=azure-portal)
...
- [Pakket opnames beheren met Azure Network Watcher met behulp van de portal](/azure/network-watcher/network-watcher-packet-capture-manage-portal)
...
- [Geavanceerde bedreigings beveiliging voor Azure Storage configureren](/azure/storage/common/storage-advanced-threat-protection)
...
- [Voor meer informatie over het gebruik van service Tags](/azure/virtual-network/service-tags-overview)

- [Voor meer informatie over het beleid voor service-eind punten van virtuele netwerken voor Azure Storage](/azure/virtual-network/virtual-network-service-endpoint-policies-overview)
...
- [Voor beelden Azure Policy voor opslag](/azure/governance/policy/samples/built-in-policies#storage)

- [Azure Policy voor beelden voor netwerk](/azure/governance/policy/samples/built-in-policies#network)

- [Een Azure Blueprint maken](/azure/governance/blueprints/create-blueprint-portal)
...
- [Een Virtual Network maken](/azure/virtual-network/quick-create-portal)

- [Een NSG maken met een beveiligings configuratie](/azure/virtual-network/tutorial-filter-network-traffic)
...
- [Bewaking configureren voor uw Azure Storage-account](/azure/storage/common/storage-monitor-storage-account#configure-monitoring-for-a-storage-account)
...
- [Gegevens registreren en controleren](/azure/storage/common/storage-analytics-logging#how-logs-are-stored)
...
- [Azure-Sentinel onboarden](/azure/sentinel/quickstart-onboard)

- [Waarschuwingen beheren in Azure Security Center](/azure/security-center/security-center-managing-and-responding-alerts)

- [Een waarschuwing over logboek gegevens van log Analytics](/azure/azure-monitor/learn/tutorial-response)

- [Logboekregistratie van Azure Opslaganalyse](/azure/storage/common/storage-analytics-logging)
...
- [Geavanceerde bedreigings beveiliging voor Azure Storage configureren](/azure/storage/common/storage-advanced-threat-protection?tabs=azure-portal)
...
- [Inzichten over uw DNS-infra structuur verzamelen met de preview-oplossing van DNS-analyse](/azure/azure-monitor/insights/dns-analytics)
...
*Zie [beveiligings beheer: identiteit en Access Control](/azure/security/benchmarks/security-control-identity-access-control)voor meer informatie.*
...
- [Toegang tot gegevens in Azure Storage autoriseren](/azure/storage/common/storage-auth)

- [Informatie over beveiligings-principals en toegangs beheer voor Azure Storage account](/azure/storage/common/storage-introduction)
...
- [Inzicht in Azure Security Center identiteit en toegang](/azure/security-center/security-center-identity-access)
...
- [Toegang verlenen tot blobs en wacht rijen met behulp van Azure Active Directory](/azure/storage/common/storage-auth-aad)
...
- [Identiteit en toegang bewaken in Azure Security Center](/azure/security-center/security-center-identity-access)
...
- [Geavanceerde bedreigings beveiliging instellen voor Azure Storage-account](/azure/storage/common/storage-advanced-threat-protection)
...
- [Benoemde locaties configureren in azure](/azure/active-directory/reports-monitoring/quickstart-configure-named-locations)
...
- [Een Azure AD-exemplaar maken en configureren](/azure/active-directory/fundamentals/active-directory-access-create-new-tenant)

- [De resource provider van Azure Storage gebruiken om toegang te krijgen tot beheer resources](/azure/storage/common/authorization-resource-provider)

- [Toegang tot Azure-Blob en wachtrij gegevens configureren met Azure RBAC in Azure Portal](/azure/storage/common/storage-auth-aad-rbac-portal)

- [Toegang tot gegevens in Azure Storage autoriseren](/azure/storage/common/storage-auth)

- [Beperkte toegang verlenen tot Azure Storage-resources met behulp van Shared Access signatures (SAS)](/azure/storage/common/storage-sas-overview)
...
- [Toegang op het niveau van Azure Storage-account weer geven en wijzigen](/azure/storage/common/storage-auth-aad-rbac-portal)

- [Beperkte toegang verlenen tot Azure Storage-resources met behulp van Shared Access signatures (SAS)](/azure/storage/common/storage-sas-overview)

- [Anonieme leestoegang tot containers en blobs beheren](/azure/storage/blobs/storage-manage-access-to-resources)

- [Een Storage-account bewaken in de Azure-portal](/azure/storage/common/storage-monitor-storage-account)

- [Toegangs sleutels voor opslag accounts beheren](/azure/storage/common/storage-account-keys-manage)
...
- [Metrische waarschuwingen voor Azure Storage accounts configureren](/azure/storage/common/storage-monitor-storage-account)
...
- [Risico beleid voor identiteits beveiliging configureren en inschakelen](/azure/active-directory/identity-protection/howto-identity-protection-configure-risk-policies)
...
- [Klanten-lockbox begrijpen](/azure/security/fundamentals/customer-lockbox-overview)
...
- [Service-eind punten Virtual Network](/azure/virtual-network/virtual-network-service-endpoints-overview)
...
- [Azure Storage-firewalls en virtuele netwerken configureren](/azure/virtual-network/virtual-network-service-endpoint-policies-overview)

- [Service-eindpuntbeleid voor virtueel netwerk voor Azure Storage](/azure/private-link/create-private-endpoint-storage-portal)

- [Informatie over beveiliging van klanten in azure](/azure/security/fundamentals/protection-customer-data)
...
- [Veilige overdracht vereisen in Azure Storage](/azure/storage/common/storage-require-secure-transfer)

- [Azure-beveiligings beleid bewaakt door Security Center](/azure/security-center/security-center-policy-definitions)
...
- [Azure-rollen toewijzen voor Azure Storage account](/azure/storage/common/storage-auth-aad-rbac-portal#assign-azure-roles-using-the-azure-portal)

- [De resource provider van Azure Storage gebruiken om toegang te krijgen tot beheer resources](/azure/storage/common/authorization-resource-provider)

- [Toegang tot Azure-Blob en wachtrij gegevens configureren met Azure RBAC in Azure Portal](/azure/storage/common/storage-auth-aad-rbac-portal)

- [Een AAD-exemplaar maken en configureren](/azure/active-directory/fundamentals/active-directory-access-create-new-tenant)
...
- [Meer informatie over Azure Storage versleuteling in rust](/azure/storage/common/storage-service-encryption)
...
- [Aanbevelingen voor beveiliging: een naslaggids](/azure/security-center/recommendations-reference)
...
- [Query's maken met Azure Graph](/azure/governance/resource-graph/first-query-portal)

- [Uw Azure-abonnementen weer geven](/powershell/module/az.accounts/get-azsubscription)

- [Meer informatie over Azure RBAC](/azure/role-based-access-control/overview)
...
- [Voorwaardelijke toegang configureren om toegang tot ARM te blok keren](/azure/role-based-access-control/conditional-access-azure-management)
...
- [Wat zijn Azure Policy effecten?](/azure/governance/policy/concepts/effects)
...
- [Aanbevelingen herstellen in Azure Security Center](/azure/security-center/security-center-remediate-recommendations)
...
- [Azure Storage-versleuteling voor inactieve gegevens](/azure/storage/common/storage-service-encryption)
...
- [Toegang verlenen tot Azure Blob-en wachtrij gegevens met behulp van een beheerde identiteit](/azure/storage/common/storage-auth-aad-rbac-portal)
...
- [Informatie over Azure Storage redundantie en Service-Level-overeenkomsten](/azure/storage/common/storage-redundancy)

- [Een moment opname van een BLOB maken](/rest/api/storageservices/creating-a-snapshot-of-a-blob)

- [Overzicht van Azure Automation](/azure/automation/automation-intro)
...
- [Aan de slag met AzCopy](/azure/storage/common/storage-use-azcopy-v10)

- [Onveranderbaarheid-beleid instellen en beheren voor Blob Storage](/azure/storage/blobs/storage-blob-immutability-policies-manage?tabs=azure-portal)
...
- [AzCopy is een opdracht regel programma dat u kunt gebruiken voor het kopiëren van blobs, bestanden en tabel gegevens naar of van een opslag account](/azure/storage/common/storage-use-azcopy-v10)
...
- [Bedrijfs kritieke blobgegevens opslaan met onveranderlijke opslag](/azure/storage/blobs/storage-blob-immutable-storage)
...
- [Beveiligingswaarschuwingen in Azure Security Center](/azure/security-center/security-center-alerts-overview)
...
- [De Azure Security Center Security-contact persoon instellen](/azure/security-center/security-center-provide-security-contact-details)
...
- [Continue export configureren](/azure/security-center/continuous-export)

- [Waarschuwingen streamen naar Azure Sentinel](/azure/sentinel/connect-azure-security-center)
...
- [Werk stroom automatisering en Logic Apps configureren](/azure/security-center/workflow-automation)
