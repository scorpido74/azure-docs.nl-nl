...
1. Ga naar uw import/export-taak. Navigeer naar ondersteuning en de sectie **probleem oplossing** en klik vervolgens op **nieuwe ondersteunings aanvraag**.
...
Meer informatie over het oplossen van problemen met de [import/export-service](storage-import-export-tool-troubleshooting-v1.md).
