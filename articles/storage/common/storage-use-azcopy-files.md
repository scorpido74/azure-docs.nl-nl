...
|    |     |
|--------|-----------|
| **Syntaxis** | `azcopy copy 'https://<storage-account-name>.file.core.windows.net/<file-share-name>/<file-path>?<SAS-token>?<SAS-token>' '<local-file-path>'` |
...
|    |     |
|--------|-----------|
| **Syntaxis** | ' azcopy Copy ' https://< Storage-account-name >. file. core. Windows. net/< bestands share-name >/< directory-pad >? < SAS-token > ' 
"< lokale-map-pad >"--recursief " |
