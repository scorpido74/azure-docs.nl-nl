...
1. Maak verbinding met uw client en gebruik het meegeleverde koppelings script.
    ...
    :::image type="content" source="media/storage-files-how-to-create-mount-nfs-shares/mount-nfs-file-share-script.png" alt-text="Scherm afbeelding van de configuratie van het opslag account met beveiligde overdracht is uitgeschakeld.":::
