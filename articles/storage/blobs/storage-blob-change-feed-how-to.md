...
Parseer de connection string door de methode [Cloud Storage account. TryParse](/dotnet/api/microsoft.windowsazure.storage.cloudstorageaccount.tryparse) aan te roepen. 

Maak vervolgens een object dat Blob Storage in uw opslag account vertegenwoordigt door de methode [Cloud Storage account. CreateCloudBlobClient](https://docs.microsoft.com/dotnet/api/microsoft.windowsazure.storage.cloudstorageaccount.createcloudblobclient?view=azure-dotnet) aan te roepen.
