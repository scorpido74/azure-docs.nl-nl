...
description: Gegevens kopiëren van en naar Azure Data Lake Storage Gen2 met behulp van het Apache Hadoop Distributed copy tool (DistCp).
author: normesta
