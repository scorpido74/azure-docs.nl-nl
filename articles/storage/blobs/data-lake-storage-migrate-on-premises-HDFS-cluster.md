...
4. Voor elk JSON-object dat in het bestand wordt weer gegeven, werkt u het `target` kenmerk bij van een AAD User Principal Name (UPN) of ObjectId (OID) met de juiste toegewezen identiteit. Wanneer u klaar bent, slaat u het bestand op. U hebt dit bestand nodig in de volgende stap.
