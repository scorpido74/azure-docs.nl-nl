...
> [!NOTE]
> Toegang voor meerdere protocollen op Data Lake Storage is in open bare preview en is beschikbaar in [deze regio's](#region-availability). Zie het artikel [bekende problemen](data-lake-storage-known-issues.md) voor een overzicht van de beperkingen. Zie [Deze pagina](https://aka.ms/blobinteropsignup)als u zich wilt inschrijven voor de preview-versie.
...
Toegang voor meerdere protocollen op Azure Data Lake Storage (preview) is beschikbaar in de volgende regio's:

|||||
|-|-|-|-|
|US - centraal|US - west-centraal|Canada - midden|
|East US|Azië - oost|Europa - noord|
|US - oost 2|Azië - zuidoost|Europa -west|
|US - west|Australië - oost|Japan - oost|
|US - west 2|Brazilië - zuid||
