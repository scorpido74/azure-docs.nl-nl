---
title: Open-source platforms die ondersteuning bieden voor Azure Data Lake Storage Gen2 | Microsoft Docs
description: Meer informatie over de open-source platforms die ondersteuning bieden voor Azure Data Lake Storage Gen2
author: normesta
...
Dit artikel bevat een overzicht van de open-source platforms die Data Lake Storage Gen2 ondersteunen.  

## <a name="supported-open-source-platforms"></a>Open source-platforms ondersteund

Deze tabel geeft een lijst van de open-source platforms die Data Lake Storage Gen2 ondersteunen.
...
| --- | --- | --- |
| [HDInsight](https://azure.microsoft.com/services/hdinsight/) | 3.6 + | [Wat zijn de Apache Hadoop onderdelen en versies die beschikbaar zijn in HDInsight?](https://docs.microsoft.com/azure/hdinsight/hdinsight-component-versioning?toc=%2Fazure%2Fhdinsight%2Fstorm%2FTOC.json&bc=%2F2Fazure%2Fbread%2Ftoc.json)
