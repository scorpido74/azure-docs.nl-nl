...
In elke sectie zult u kunnen bepalen de 'musts' voor de upgrade. Nadat u zeker weet dat de mogelijkheden beschikbaar zijn, of als u zeker weet dat er redelijk tijdelijke oplossingen zijn, gaat u verder naar de sectie [een upgrade plannen](#planning-for-an-upgrade) van deze hand leiding.
...
| SDK's voor ontwikkelaars | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| BLOB SDK: *nu beschikbaar*. Azure Data Lake Storage Gen2 SDK- *nog niet beschikbaar*  |
...
| Node.js                |   [koppelen](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                               | *Nu beschikbaar*                                                     | *Nu beschikbaar*                                                                                           |
| Python SDK                   |   [koppelen](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)                                                                                                                                                                                                                | *Nu beschikbaar*                                                      | *Nu beschikbaar*                                        |
...
| Azure Resource Manager-sjablonen - management             | [Template1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/)  [Template2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/)  [Template3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *Nu beschikbaar*                                                      | *Nu beschikbaar*                                          |
...
Het URI-schema voor Data Lake Storage Gen1 wordt in [detail beschreven,](https://docs.microsoft.com/azure/hdinsight/hdinsight-hadoop-use-data-lake-store) maar breed gepaard, het is *adl://mydatalakestore.azuredatalakestore.net/\<file_path\>.*
...
Als uw toepassing gebruikmaakt van Data Lake Storage REST API's, moet u uw toepassing voor het gebruik van de Data Lake Storage Gen2 REST-API wijzigen. Koppelingen worden gegeven in de sectie *programmeer interfaces* .
...
U kunt management vlak commandlets vervangen met de juiste namen in Data Lake Storage Gen2. Koppelingen worden gegeven in de sectie *programmeer interfaces* .
...
U kunt management vlak opdrachten vervangen met de juiste namen in Data Lake Storage Gen2. Koppelingen worden gegeven in de sectie *programmeer interfaces* .
...
Controleer eerst of u hebt het Gen2-account hebt gemaakt en vervolgens gekopieerd gegevens en metagegevens van Gen1 naar Gen2 met behulp van een geschikt hulpprogramma. Deze hulpprogram ma's worden in de sectie [gegevens upgrades](#data-upgrade) van deze hand leiding genoemd.
...
De stappen zijn daarna gebaseerd op hoe de bestaande Databricks-werkruimte heeft toegang gegevens in het Data Lake Storage Gen1-account tot. U kunt dit doen door adl://-Uri's [rechtstreeks](https://docs.azuredatabricks.net/spark/latest/data-sources/azure/azure-datalake.html#access-azure-data-lake-store-directly) vanuit notebooks of via [mountpoints](https://docs.azuredatabricks.net/spark/latest/data-sources/azure/azure-datalake.html#mount-azure-data-lake-store-with-dbfs)aan te roepen.
