...
:heavy_check_mark: Een upgrade plannen
...
| Gegevensbewerkingen – Logboeken  | Ja | Speciale aanvragen voor logboeken voor een bepaalde duur ondersteuningsticket Azure Monitoring-integratie met | Eenmalige aanvragen voor logboeken voor specifieke duur met een ondersteunings ticket dat *nu beschikbaar is*<br><br> Integratie van Azure-bewaking – *nog niet beschikbaar* |
...
| SDK's voor ontwikkelaars | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| *Nog niet beschikbaar* |
...
Deze tabel wordt beschreven welke API ingesteld die beschikbaar voor uw aangepaste toepassingen zijn. Om iets duidelijker te maken, hebben we deze API-sets onderverdeeld in twee typen: beheer-Api's en File System-Api's.
...
| .NET SDK – bestands systeem                  | [Link](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/client?view=azure-dotnet)                                                                                                                                                                                                                     | *Nog niet beschikbaar*                                                | *Nog niet beschikbaar*                                                                                                                                             |
...
| Java SDK – bestands systeem                  | [Koppeling](https://docs.microsoft.com/java/api/overview/azure/datalake)                                                                                                                                                                                                                                         | *Nog niet beschikbaar*                                                | *Nog niet beschikbaar*                                                                                                                                             |
| Node.js - beheer                   | [Koppeling](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | Niet ondersteund                                                      | *Er zijn nu beschikbaar -* [koppeling](https://azure.github.io/azure-storage-node/)                                                                                            |
| Node. js-bestands systeem                   | [Koppeling](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | *Nog niet beschikbaar*                                                | *Nog niet beschikbaar*                                                                                                                                             |
...
| Python-bestands systeem                    | [Link](https://azure-datalake-store.readthedocs.io/en/latest/)                                                                                                                                                                                                                                                                 | *Nog niet beschikbaar*                                                | *Nog niet beschikbaar*                                                                                                                                             |
| REST-API - beheer                  | [Link](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Niet ondersteund*                                                      | *Nu - beschikbaar*                                                                                                                                               |
| REST API-bestands systeem                  | [Link](https://docs.microsoft.com/rest/api/datalakestore/webhdfs-filesystem-apis)                                                                                                                                                                                                                                       | *Nu beschikbaar*                                                    | *Er zijn nu beschikbaar -* [koppeling](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2)                                                      |
| Power shell-beheer en bestands systeem | [Link](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | Beheer-niet-ondersteund bestands systeem- *nog niet beschikbaar*        | Beheer – *nu beschikbaar-* [koppeling](https://docs.microsoft.com/powershell/module/az.storage) <br><br>Bestands systeem- *nog niet beschikbaar* |
...
| CLI-bestands systeem                       | [Link](https://docs.microsoft.com/cli/azure/dls/fs?view=azure-cli-latest)                                                                                                                                                                                                                                               | *Nog niet beschikbaar*                                                | *Nog niet beschikbaar*                                                                                                                                             |
...
De belangrijkste taak is hier om de URI te vertalen met een voor voegsel van `adl://` naar URI'S met een `abfss://`-voor voegsel.
...
Het URI-schema voor het openen van Data Lake Storage Gen2-bestanden [wordt in detail](../../hdinsight/hdinsight-hadoop-use-data-lake-storage-gen2.md) beschreven, maar breed gering is het `abfss://<FILE_SYSTEM_NAME>@<ACCOUNT_NAME>.dfs.core.windows.net/<PATH>`.
...
De elementen die hierboven worden genoemd (bijvoorbeeld: URI en referenties) moeten worden gewijzigd. Kunt u het bestaande exemplaar dat met Data Lake Storage Gen1 werkt wijzigen of u een nieuw exemplaar die met Data Lake Storage Gen2 werken kan maken.
