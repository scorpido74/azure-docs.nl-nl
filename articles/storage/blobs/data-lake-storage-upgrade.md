...
| Gegevens bewerkingen: Logboeken  | Ja | Ja | *Nu beschikbaar* (preview-versie). Zie [bekende problemen](data-lake-storage-known-issues.md).<br><br> Integratie van Azure-bewaking – *nog niet beschikbaar* |
...
| Sdk's van ontwikkel aars | .NET, Java, Python, node. js  | .NET, Java, Python, node. js, C++, Ruby, PHP, go, Android, Ios| BLOB SDK: *nu beschikbaar*. Azure Data Lake Storage Gen2 SDK- *nog niet beschikbaar*  |
...
| Gegevensbeheer                             | Verlopen bestanden                                                                                                                                        | Levenscyclus beleid                                                                                                                                                                                                                                                                                                                                                                                                          | Levenscyclus beleid *nu beschikbaar* (preview-versie). Zie [bekende problemen](data-lake-storage-known-issues.md).                                                                                                                     |

### <a name="programming-interfaces"></a>Programmeerinterfaces

In deze tabel wordt beschreven welke API-sets beschikbaar zijn voor uw aangepaste toepassingen. SDK-ondersteuning voor ACL en bewerkingen op Directory-niveau worden nog niet ondersteund.
...
| Azure Resource Manager sjablonen-beheer             | [Template1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/)  [Template2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/)  [Template3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *Nu beschikbaar*                                                      | *Nu beschikbaar*                                          |
...
| Onderwerp            | Partner  | Product/service  | Beschik baarheid voor Data Lake Storage Gen1                                                                                                                                               | Beschik baarheid voor Data Lake Storage Gen2-met gedeelde sleutel verificatie                                                   | De beschikbaarheid van Data Lake Storage Gen2 – met Oauth                                                             |
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
