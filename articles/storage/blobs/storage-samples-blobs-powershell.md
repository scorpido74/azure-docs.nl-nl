...
description: Zie koppelingen naar Azure PowerShell-voorbeeldscripts voor het werken met Azure Blob Storage, zoals het maken van een opslagaccount, het migreren van blobs tussen accounts, en meer.
...
De volgende tabel bevat koppelingen naar voorbeelden van PowerShell-scripts waarmee Azure Storage wordt gemaakt en beheerd.
...
| [Containers met een specifiek voorvoegsel verwijderen](../scripts/storage-blobs-container-delete-by-prefix-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json) | Hier worden containers verwijderd die een specifieke tekenreeks bevatten. |
