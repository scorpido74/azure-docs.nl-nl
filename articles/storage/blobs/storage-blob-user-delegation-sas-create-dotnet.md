...
description: Meer informatie over het maken van een SAS (preview) voor gebruikers overdracht met Azure Active Directory referenties met behulp van de .NET-client bibliotheek voor Azure Storage.
services: storage
author: tamram
ms.service: storage
ms.topic: how-to
