...
1. Vervang de `accountname` en `accountkey` waarden door de naam en sleutel van uw opslag account:
...
Met de volgende code maakt u een `generator` voor de methode `list_blobs`. De code loopt door in de lijst met blobs in de container en drukt hun namen af op de-console.
