...
| Uw accounttoegangssleutels beveiligen met Azure Key Vault | Microsoft raadt aan Azure AD te gebruiken om aanvragen voor Azure Storage te autoriseren. Als u echter de machtiging Gedeelde sleutel moet gebruiken, u uw accountsleutels beveiligen met Azure Key Vault. U de sleutels ophalen uit de sleutelkluis tijdens runtime, in plaats van ze op te slaan met uw toepassing. Zie overzicht van [Azure Key Vault](../../key-vault/key-vault-overview.md)voor meer informatie over Azure Key Vault. | - |
