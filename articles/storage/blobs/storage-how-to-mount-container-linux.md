...
description: Meer informatie over het koppelen van een Azure Blob Storage-container met blobfuse, een virtueel bestandssysteem stuur programma in Linux.
author: rishabpoh
ms.service: storage
ms.subservice: blobs
ms.topic: how-to
