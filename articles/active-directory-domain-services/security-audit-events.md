...
ms.locfileid: "73569818"
---
# <a name="enable-security-audits-for-azure-active-directory-domain-services-preview"></a>Beveiligings controles voor Azure Active Directory Domain Services inschakelen (preview)
...
|Azure Log Analytics-werk ruimte| Dit doel moet worden gebruikt wanneer uw primaire behoefte is om veilige controles van de Azure Portal rechtstreeks te analyseren en te controleren. Voordat u Azure AD DS beveiligings controle gebeurtenissen inschakelt, [maakt u een log Analytics-werk ruimte in de Azure Portal.](https://docs.microsoft.com/azure/azure-monitor/learn/quick-create-workspace)|
...
1. Zoek en selecteer **Azure AD Domain Services**aan de bovenkant van de Azure Portal. Kies uw beheerde domein, zoals *contoso.com*.
1. Selecteer in het venster Azure AD DS **Diagnostische instellingen (preview)** aan de linkerkant.
...
1. Maak de doel resource voor de beveiligings controle gebeurtenissen.
    ...
    * **Azure storage** - [een opslag account maken met behulp van Azure PowerShell](../storage/common/storage-quickstart-create-account.md?tabs=azure-powershell)
