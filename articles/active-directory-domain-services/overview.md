...
Voor het leveren van identiteits Services maakt Azure een AD DS-exemplaar in een virtueel netwerk van uw keuze. Achter de schermen wordt een paar Windows Server-domein controllers gemaakt die worden uitgevoerd op virtuele Azure-machines. U hoeft deze domein controllers niet te beheren, te configureren of bij te werken. Het Azure-platform beheert de domein controllers als onderdeel van de Azure AD DS-service.
