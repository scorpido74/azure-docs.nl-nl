...
Zie het [artikel over DNS-hulpprogram ma's op TechNet](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc753579(v=ws.11))voor meer informatie over het beheren van DNS.
