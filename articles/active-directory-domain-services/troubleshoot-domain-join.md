...
1. Probeer het domein te pingen met de domein naam van het beheerde Azure AD DS-domein, `ping aaddscontoso.com`zoals.
    * Als het ping-antwoord mislukt, probeert u de IP-adressen voor het domein te pingen dat wordt weer gegeven op de pagina overzicht in de portal voor uw `ping 10.0.0.4`Azure AD DS beheerd domein, zoals.
...
1. Probeer de cache van de DNS-resolver te leegmaken op de virtuele machine, `ipconfig /flushdns`zoals.
...
1. Gebruik de UPN-indeling om referenties op te geven, `dee@aaddscontoso.onmicrosoft.com`zoals. Zorg ervoor dat deze UPN juist is geconfigureerd in azure AD.
