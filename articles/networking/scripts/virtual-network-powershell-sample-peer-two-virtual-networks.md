...
description: Maak en verbind twee virtuele netwerken in dezelfde regio. Gebruik het Azure-script voor twee virtuele netwerken van de peer om de netwerken te verbinden via het Azure-netwerk.
