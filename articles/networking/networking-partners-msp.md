...
description: Meer informatie over het Azure Networking Managed Service Provider Partner Program en vindt u een lijst met partners die Cloud-en hybride netwerk services aanbieden.
services: networking
author: skishen525
...
## <a name="azure-marketplace-offers-by-azure-networking-msp-partners"></a><a name="msp"></a>Azure Marketplace biedt ondersteuning voor MSP-partners van Azure-netwerken

Gebruik de koppelingen in deze sectie voor meer informatie over beheerde Cloud netwerk services die worden aangeboden door Azure Networking MSP-partners. Als uw Cloud Network Services-partner niet wordt vermeld in de onderstaande sectie, laat u de provider contact met ons opnemen. Ze kunnen contact met ons opnemen door een e-mail te verzenden naar ManagedVirtualWAN@microsoft.com . 

| **MSP** | **Transformatie Services voor Cloud netwerken** | **Beheerde ExpressRoute** | **Beheerd virtueel WAN** | **Beheerde persoonlijke-rand zones**|
| ---| ---| ---| ---| ---|
...
|[Macquarie Telecom](https://macquariecloudservices.com/azure-managed-services/)|[Door Azure beheerde services per Macquarie-Cloud](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/macquariecloudservices.managed_services?tab=Overview)||[SD-WAN-installatie van virtuele rand door Macquarie Cloud](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/macquariecloudservices.nanaged_network_services?tab=Overview)|||
