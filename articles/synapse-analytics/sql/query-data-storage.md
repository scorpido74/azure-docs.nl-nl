...
Gebruik FORMAT = 'CSV' om een query uit te voeren op Parquet-brongegevens. U kunt het schema van het CSV-bestand opgeven als onderdeel van de `OPENROWSET`-functie bij het opvragen van CSV-bestanden:
