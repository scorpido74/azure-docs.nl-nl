---
title: Ondersteuning voor Synapse Spark-versie
...
ms.locfileid: "81429237"
---
# <a name="supported-language-and-runtime-versions-for-apache-spark-and-dependent-components"></a>Ondersteunde taal- en runtimeversies voor Apache Spark en afhankelijke componenten  

De Apache Spark in Azure Synapse Analytics-service ondersteunt verschillende looptijden en services waarin dit document de versies bevat.

## <a name="spark-version"></a>Spark-versie

Spark 2.4 is de momenteel ondersteunde versie.

## <a name="operating-system-version"></a>Versie besturingssysteem

Apache Spark in Azure Synapse draait op Ubuntu versie 16.04.

## <a name="java-version"></a>Java-versie

Apache Spark in Azure Synapse bevat Java-versie 1.8.0_222
...
Azure Synapse bevat .NET-ondersteuning voor Apache Spark 0,5.0

## <a name="delta-lake"></a>Delta Lake

Synapse Analytics biedt ondersteuning voor Delta Lake 0.5.0
...
accessoire-smart-1.2.jar

activering-1.1.1.jar

luchtcompressor-0.10.jar

annotaties-2.0.1.jar
...
aopalliance-herverpakt-2.4.0-b34.jar
...
arpack_combined_all-0.1.pot

pijl-formaat-0.10.0.jar

pijlgeheugen-0.10.0.pot

pijl-vector-0.10.0.jar

publiek-annotaties-0.5.0.jar
...
aws-java-sdk-bundel-1.11.199.jar
...
calciet-avatica-1.2.0-incubatie.pot

calciet-kern-1.2.0-incubatie.pot

calciet-linq4j-1.2.0-incubatie.pot
...
comprimeren-lzf-1.0.3.jar

kern-1.1.2.jar

curator-cliënt-2.7.1.jar

curator-kader-2.7.1.jar

curator-recepten-2.7.1.jar
...
hadoop-annotaties-2.9.1.2.6.99.201-1240.jar
...
hadoop-garen-gemeenschappelijk-2.9.1.2.6.99.201-1240.jar

hadoop-garen-register-2.9.1.2.6.99.201-1240.jar

hadoop-garen-server-gemeenschappelijk-2.9.1.2.6.99.201-1240.jar
...
htrace-core4-4.1.0-incubatie.jar

httpclient-4.5.6.jar

httpcore-4.4.10.jar httpcore-4.4.10.jar

klimop-2.4.0.jar

jackson-annotaties-2.6.7.jar
...
jackson-module-jaxb-annotaties-2.6.7.jar
...
steiger-sslengine-6.1.26.jar

steiger-util-6.1.26.jar
...
orc-mapreduce-1.5.5-nohive.jar orc-mapreduce-1.5.5-nohive.jar
...
parket-kolom-1.10.1.pot

parket-gemeenschappelijk-1.10.1.jar

parket-encoding-1.10.1.jar

parket-formaat-2.4.0.jar

parket-hadoop-1.10.1.jar

parket-hadoop-bundel-1.6.0.jar

parket-jackson-1.10.1.jar
...
vonk-mllib-local_2.11-2.4.0.2.6.99.201-1240.jar
...
sklearn-panda's==1.7.0

smart-open==1.8.4

snowballstemmer==1.2.1

gesorteerde collecties==0,5,3

gesorteerde containers==1,5,7

gesorteerde containers==2.1.0
