---
title: Problemen met exclusieve SQL-groep oplossen
description: Problemen met een toegewezen SQL-groep in azure Synapse Analytics oplossen.
...
| Aanbevolen procedures implementeren                              | De beste manier om te beginnen met het verbeteren van de prestaties van query's is een speciaal artikel over het [Best practices van SQL-Pools](sql-data-warehouse-best-practices.md) . |
| Prestaties verbeteren met schalen                      | Soms is de oplossing voor het verbeteren van de prestaties het eenvoudig om meer reken kracht aan uw query's toe te voegen door [uw toegewezen SQL-groep te schalen](sql-data-warehouse-manage-compute-overview.md). |
