...
ms.locfileid: "80351358"
---
# <a name="t-sql-statements-supported-in-sql-analytics"></a>T-SQL-instructies ondersteund in SQL Analytics
...
Zie [T-SQL-taalelementen in SQL Analytics](sql-data-warehouse-reference-tsql-language-elements.md)en [Systeemweergaven in SQL Analytics](sql-data-warehouse-reference-tsql-system-views.md)voor meer referentiegegevens.
