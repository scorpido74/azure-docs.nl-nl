...
description: Meer informatie over het verifiëren naar Azure Synapse Analytics met Azure Active Directory (AAD) of SQL Server-verificatie.
...
* Databasemachtigingen beheren met externe AAD-groepen (AAD).
