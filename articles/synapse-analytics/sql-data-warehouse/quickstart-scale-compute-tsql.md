...
Voer de volgende query uit op de [sys.dm_operation_status](/sql/relational-databases/system-dynamic-management-views/sys-dm-operation-status-azure-sql-database) DMV als u informatie wilt retourneren over verschillende beheerbewerkingen op uw Azure Synapse. Zo wordt bijvoorbeeld de bewerking en de status van de bewerking (IN_PROGRESS of COMPLETED) geretourneerd.
