...
Het beheerde privé-eindpunt dat gericht is op de SQL-pool, heet *synapse-ws-sql--\<werkruimtenaam\>* en het eindpunt dat gericht is op SQL op aanvraag heet *synapse-ws-sqlOnDemand--\<werkruimtenaam\>* .
