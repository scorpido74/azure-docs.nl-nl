...
De [Azure IoT Explorer](https://github.com/Azure/azure-iot-explorer) wordt gebruikt om de telemetrie weer te geven die het apparaat verzendt, werkt met apparaateigenschappen en aanroepopdrachten. U de explorer ook gebruiken om te communiceren met en uw apparaten te testen en om plug and play-apparaten te beheren.
...
De apparaatverkenner is vervangen door de [Azure IoT Explorer](https://github.com/Azure/azure-iot-explorer), die wordt gebruikt om de telemetrie weer te geven die het apparaat verzendt, werkt met apparaateigenschappen en oproepopdrachten. U de explorer ook gebruiken om te communiceren met en uw apparaten te testen en om plug and play-apparaten te beheren.
