...
* De *aanvraag-URI* die specifiek is voor het apparaat, samen met de [API-versie](https://docs.microsoft.com/rest/api/iothub/service/devices/invokemethod):
