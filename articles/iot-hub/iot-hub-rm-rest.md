...
description: Meer informatie over het gebruik van de C# resource provider REST API een IOT hub programmatisch te maken en te beheren.
author: robinsh
ms.author: robinsh
ms.service: iot-hub
services: iot-hub
...
1. Maak in Visual Studio een klassiek C# Windows-bureau blad-project met behulp van de project sjabloon **console-app (.NET Framework)** . Geef het project de naam **CreateIoTHubREST**.
