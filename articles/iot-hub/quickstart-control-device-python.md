...
1. Open het bestand **SimulatedDevice.py** in een teksteditor van uw keuze.
    ...
    Vervang de waarde van de `CONNECTION_STRING` variabele door het apparaat Connection String u eerder een notitie hebt gemaakt. Sla de wijzigingen vervolgens op in **SimulatedDevice.py**.
...
1. Open het bestand **BackEndApplication.py** in een teksteditor van uw keuze.
    ...
    Vervang de waarde van de `CONNECTION_STRING` variabele door de Service Connection String u eerder een notitie hebt gemaakt. Sla de wijzigingen vervolgens op in **BackEndApplication.py**.
