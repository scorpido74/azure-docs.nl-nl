...
Open een browser om te `http://localhost:3000`.
...
7. Voeg een extern aan uw kloon toe die verwijst naar de Git-opslag plaats voor de web-app in App Service. Voor \<Git kloon-URL\>gebruikt u de URL die u in de vorige stap hebt geretourneerd. Voer de volgende opdracht uit in het opdracht venster.
