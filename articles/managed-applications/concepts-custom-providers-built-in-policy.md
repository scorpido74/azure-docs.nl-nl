---
title: Koppelingen voor een aangepaste Azure-provider implementeren met behulp van beleid
...
![Ingebouwd beleid toewijzen](media/builtin-policy/assign-builtin-policy-customprovider.png)
