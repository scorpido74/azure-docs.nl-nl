---
title: Gebruikers interface-element van Azure TagsByResource
...
ms.locfileid: "73933140"
---
# <a name="microsoftcommontagsbyresource-ui-element"></a>Micro soft. common. TagsByResource UI-element

Een besturings element voor het koppelen van [Tags](../azure-resource-manager/resource-group-using-tags.md) aan de resources in een implementatie.

## <a name="ui-sample"></a>UI-voor beeld

![Micro soft. common. DropDown](./media/managed-application-elements/microsoft.common.tagsbyresource.png)
...
- Gebruik de [als](../azure-resource-manager/resource-group-template-functions-logical.md#if) -functie bij het openen van de para meter tagsByResource. U kunt hiermee een leeg object toewijzen wanneer er geen labels aan het opgegeven resource type zijn toegewezen.
