...
**Hulp**: data Lake Analytics heeft niet het concept standaard wachtwoord als verificatie wordt meegeleverd met Azure Active Directory en beveiligd door op rollen gebaseerd toegangs beheer (RBAC).
