...
* Imaging [OCR (Optische tekenherkenning)](https://github.com/Azure-Samples/usql-cognitive-imaging-ocr-hello-world)
* SMS [Sleuteltermextractie & Sentimentanalyse](https://github.com/Azure-Samples/usql-cognitive-text-hello-world)

## <a name="registering-cognitive-extensions-in-u-sql"></a>Cognitieve extensies in U-SQL registreren
Voordat u begint, volgt u de stappen in dit artikel om cognitieve uitbrei dingen in U-SQL te registreren: [Cognitieve uitbrei dingen registreren in U-SQL](/u-sql/objects-and-extensions/cognitive-capabilities-in#registeringExtensions).
