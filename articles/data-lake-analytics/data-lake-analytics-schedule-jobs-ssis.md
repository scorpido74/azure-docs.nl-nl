...
3. Set **AzureDataLakeDirectory**. Ga naar de map waarin U uw U-SQL-scripts opslaat. Gebruik relatief pad dat relatief is ten opzichte van de hoofdmap van het Azure Data Lake Store-account.
