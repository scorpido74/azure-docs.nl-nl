...
In dit artikel vindt u voor beelden van C#-code die laten zien hoe u de Azure WebJobs SDK versie 1. x kunt gebruiken met de Azure Queue Storage-service.
...
### <a name="poco-plain-old-clr-object-queue-messages"></a>POCO [(onbewerkt oud CLR-object](https://en.wikipedia.org/wiki/Plain_Old_CLR_Object)) berichten in wachtrij
