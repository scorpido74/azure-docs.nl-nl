...
* Ga naar de [pagina met Publisher-hand leiding voor commerciële Marketplace](https://docs.microsoft.com/azure/marketplace/).
* Meer informatie over [ondersteuning voor het programma voor commerciële Marketplace in het partner centrum](https://docs.microsoft.com/azure/marketplace/partner-center-portal/support).
