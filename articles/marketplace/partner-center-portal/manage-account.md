...
- Bevestig uw Symantec-ID, de verkoper-ID, de MPN-ID, de uitgevers-ID en de contact gegevens, inclusief de fiatteur van het bedrijf en de contact persoon van de verkoper
...
2. Selecteer in de sectie profiel de optie **uw micro soft-account koppelen**.
3. Meld u aan met uw micro soft-account (MSA) wanneer u hierom wordt gevraagd. Dit account kan niet al zijn gekoppeld aan een ander partner centrum-account.
4. Als u de installatie van uw account voor betaling wilt volt ooien, meldt u zich volledig af bij partner centrum en meldt u zich vervolgens opnieuw aan met uw micro soft-account (in plaats van uw werk account).
