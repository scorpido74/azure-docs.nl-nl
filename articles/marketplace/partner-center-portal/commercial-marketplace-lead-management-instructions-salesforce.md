...
5. Selecteer op de **pagina Web**-to-lead instellen de optie **Web-naar-lead-formulier maken**.
    ![Setup van Sales Force-webto-lead](./media/commercial-marketplace-lead-management-instructions-salesforce/salesforce-3.png)

6. Zorg ervoor dat `the Include reCAPTCHA in HTML` in het **formulier een web-naar-lead maken**de optie is uitgeschakeld en selecteer **genereren**. 
    ![Sales Force: een formulier voor webtoegang maken](./media/commercial-marketplace-lead-management-instructions-salesforce/salesforce-4.png)
...
7. Er wordt een aantal HTML-tekst weer gegeven. Zoek naar de tekst "OID" en kopieer de **OID-waarde** uit de HTML-tekst (alleen de tekst tussen aanhalings tekens) en sla deze op. Plak deze waarde in het veld **organisatie-id** op de portal voor publiceren.
    ![Sales Force: een formulier voor webtoegang maken](./media/commercial-marketplace-lead-management-instructions-salesforce/salesforce-5.png)
...
1. Selecteer in het pop-upvenster verbindings Details de optie **Sales Force** voor de **doel bestemming** en plak `oid` het formulier van web-naar-lead dat u hebt gemaakt door eerdere stappen in het veld **organisatie-id** te volgen.
