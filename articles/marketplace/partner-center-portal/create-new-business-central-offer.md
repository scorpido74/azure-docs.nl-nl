...
- **Duur van test drive** (vereist): Geef aan hoe lang het test station actief blijft, in aantal uren. Het test station wordt automatisch beëindigd nadat deze periode is verstreken. Bij deze duur mag alleen een treffer worden ingesteld met een geheel aantal uur (bijvoorbeeld ' 2 ' uur, ' 1,5 ' is niet geldig).
