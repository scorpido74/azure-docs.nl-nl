...
- Als u al bent Inge schreven in de Microsoft Partner Network, maakt u rechtstreeks vanuit Partner Center een account met behulp van [uw Microsoft Partner Network registratie](#create-an-account-using-your-microsoft-partner-network-enrollment).
...
## <a name="create-an-account-using-your-microsoft-partner-network-enrollment"></a>Een account maken met behulp van uw Microsoft Partner Network-inschrijving

Als u al bent Inge schreven in de Microsoft Partner Network, gebruikt u deze sectie om uw account rechtstreeks vanuit het partner centrum te maken met behulp van de volgende stappen:

- [Aanmelden bij Partner Center met uw werk account](#sign-into-partner-center-with-your-work-account)
- [Voer uw Publisher-profiel in](#enter-your-publisher-profile)

Zorg ervoor dat uw Microsoft Partner Network-account gegevens handig zijn.

>[!Important]
>Als u een account hebt in de [Cloud Partner-Portal (cpp)](https://cloudpartner.azure.com) dat is verplaatst naar het partner centrum, hoeft u geen nieuw account te maken. Zie [uitgevers verplaatsen vanuit cpp](#publishers-moving-from-cpp) voor meer informatie.

### <a name="sign-into-partner-center-with-your-work-account"></a>Aanmelden bij Partner Center met uw werk account
...
### <a name="enter-your-publisher-profile"></a>Voer uw Publisher-profiel in

Nadat u zich hebt aangemeld, gebruikt u de stappen in deze sectie om het instellen van uw account te volt ooien.
