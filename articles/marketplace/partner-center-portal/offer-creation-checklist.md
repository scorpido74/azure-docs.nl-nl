...
| [De pagina prijzen en beschik baarheid plannen](#plan-pricing-and-availability-page)  | Alleen beschikbaar als u selecteert om het aanbod via micro soft te verkopen.  Verzamelt de bedrijfs kenmerken (prijs model), de beschik baarheid van de doel groep en de markt voor elk abonnement (versie) van uw aanbieding.  |
...
| Veldnaam | Notities |
| ---------------- | -----------|  
| Wilt u door micro soft verkopen?  | Vereist. Standaard waarde: Ja. |
...
| Aanbiedings-URL  | Vereist als ' nu ophalen ' is geselecteerd, als de manier waarop klanten moeten communiceren met de aanbieding. |
...
| Winkel logo's (klein, normaal, groot)  | Het grote logo (van 216 x 216 tot 350 x 350 px) is vereist. In het partner centrum wordt dit gebruikt om een klein logo (48 x 48 px) en middel groot (90 x 90 px) te maken. U kunt deze desgewenst later vervangen door andere installatie kopieën. Logo's moeten de PNG-indeling hebben. |
...
## <a name="plan-pricing-and-availability-page"></a>De pagina prijzen en beschik baarheid plannen
