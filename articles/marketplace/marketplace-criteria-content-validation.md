...
| 6 | Afbeeldingen | <ul><li>Installatie kopie vereisten worden vermeld in Partner Center.</li><li>De tekst die in de scherm opname is opgenomen, is leesbaar en de afbeelding is duidelijk. | De oplossings aanbieding kan in één oogopslag worden begrepen. |
...
| 7 | Marketing artefacten | Logo's worden correct weer gegeven. | <ul><li>Logo's: kleine (48x48 pixels) en grote (216x216 pixels) zijn vereist.</li><li>Scherm afbeelding (max. 5): vereist een. PNG-afbeelding met een resolutie van 1280x720 pixels. |
...
| 3 | Marketplace-artefacten | Logo's worden correct weer gegeven. |<ul><li>Logo's: klein (48 x 48 pixels) en groot (216x216 pixels) zijn vereist.</li><li>Scherm afbeelding (max. 5): vereist een. PNG-afbeelding met een resolutie van 1280 x 720 pixels.|
...
| 9 | Competenties | Moet competentie hebben in ten minste één van de volgende:<ul><li>Ontwikkeling van toepassingen</li><li>Integratie van toepassingen</li><li>Beheer van toepassingslevenscyclus</li><li>Cloud platform<li>Gegevensanalyse</li><li>Datacentrum</li><li>Gegevens platform</li><li>DevOps |
