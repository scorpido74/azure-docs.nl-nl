...
Voer de volgende stappen uit op de pagina aanbiedings **vermelding** onder **Marketplace-Details**. Zie [Details](plan-saas-offer.md#offer-listing-details)van aanbieding voor meer informatie over deze vereiste informatie.
...
## <a name="add-links-to-supplemental-online-documentation-optional"></a>Koppelingen naar aanvullende online documentatie toevoegen (optioneel)
