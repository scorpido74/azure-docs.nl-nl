...
-   **Type service:** Gedefinieerd op het tabblad Details van de **winkel** van de editor. Typen `Assessment`Services zijn, `Briefing` `Implementation` `Proof of concept`,, en. `Workshop`
