...
|  **Veld**       |     **Beschrijving**                                                          |
|  ---------       |     ---------------                                                          |
| **Aanbiedings-id\***       | Een unieke id (binnen een Publisher-profiel) voor de aanbieding. Deze id is zichtbaar in product-Url's en inzichten rapporten. De naam mag Maxi maal 50 tekens lang zijn en kan kleine letters en streepjes (-) bevatten. (De id mag niet eindigen met een streepje.) **Opmerking:** Dit veld kan niet worden gewijzigd nadat een aanbieding Live is. <br> Als contoso bijvoorbeeld een aanbieding publiceert met de voor beeld- **container**van de aanbieding, wordt de Azure Marketplace-URL `https://azuremarketplace.microsoft.com/marketplace/apps/contoso.sample-container?tab=Overview`toegewezen. |
