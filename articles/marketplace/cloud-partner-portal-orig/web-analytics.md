---
title: Webanalyse
description: In dit artikel vindt u instructies voor het leren en gebruiken van Web Analytics om uw bedrijf het beste te laten groeien.
author: dsindona
...
1. Marketing medewerker koopt advertenties van Google om verkeer naar de landings\'pagina ```https://contoso.com```van het bedrijf te sturen. Deze landings pagina heeft \"de koppeling mijn\" product proberen ```https://appsource.com```.
...
3. De gebruiker klikt op \"de koppeling mijn\" product proberen en gaat naar AppSource.
    ...
    2. URL van de landings pagina (**Zorg ervoor dat\_deze URL UTM\_-campagne heeft en UTM-bron is toegevoegd aan deze URL**) =```https://appsource.microsoft.com/product/dynamics-365/contoso.offername?**utm\_campaign=MyCampaignAdName&utm\_source=MySourceAdName**```
