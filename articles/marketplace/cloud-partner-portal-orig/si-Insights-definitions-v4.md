...
| **Orderhoeveelheid**                       | Het aantal orders voor dezelfde SKU dat is gekoppeld aan een Azure-abonnement.  Voor SAAS-orders vertegenwoordigt het het aantal seats dat is gekoppeld aan dit exemplaar van een order.                                            |
...
| **Gebruiksdatum**                                       | De datum waarop klant gebruik heeft plaatsgevonden.                                                                                                             |
...
| **Gebruikstype**                                       | Een beschrijving van het gebruik dat wordt gemeten. (Genormaliseerd gebruik of onbewerkt gebruik)                                                              |
...
| **VM-grootte**                                       | Hiermee wordt de grootte van de hardware van de virtuele machine afgestemd op de Azure-aanbieding. Voor beelden `Basic_A0`zijn `Standard_A11`, `Standard_D12`, en `Standard_G4`.   |
|  |  |
