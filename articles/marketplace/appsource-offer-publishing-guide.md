...
Zie de volgende tabel voor koppelingen naar het publiceren van processen en richt lijnen voor elk aanbiedings type:
...
| Power Apps | Meer informatie over hoe [klanten uw app kunnen test drive op AppSource](https://powerapps.microsoft.com/blog/appsource-test-drive/). |
| Power BI | Bekijk het [publicatie proces en de richt lijnen](/power-bi/developer/office-store). |
...
Als u een nieuwe aanbieding wilt maken of een bestaand aanbod wilt volt ooien, gaat u naar [partner centrum](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/partnership).
