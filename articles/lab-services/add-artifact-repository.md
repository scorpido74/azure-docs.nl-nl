...
- URI naar de opslag plaats (voor `https://github.com/<myteam>/<nameofrepo>.git` beeld `"https://MyProject1.visualstudio.com/DefaultCollection/_git/TeamArtifacts"`: of.
...
| ArtifactRepositoryDisplayName | Weergave naam voor de artefact opslagplaats. Dit is de naam die wordt weer gegeven in de Azure Portalhttps://portal.azure.com) (bij het weer geven van alle artefact opslagplaatsen voor een lab. |
| RepositoryUri | De URI naar de opslag plaats. Voor beelden `https://github.com/<myteam>/<nameofrepo>.git` : `"https://MyProject1.visualstudio.com/DefaultCollection/_git/TeamArtifacts"`of.|
