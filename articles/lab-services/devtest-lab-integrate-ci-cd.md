...
1. Configureer de taak als volgt:
   ...
   |**Source Lab VM** > **VM-id** van bron Lab VM-bron Lab|Als u de standaard naam van de variabele LabVMId hebt gewijzigd, voert u deze hier in. De standaard waarde is **$ (labVMId)**.|
   |**Output Variables** > **Aangepaste installatie kopie-id** van uitvoer variabelen|U kunt de standaard naam van de variabele indien nodig bewerken.|
