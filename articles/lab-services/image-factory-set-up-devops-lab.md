...
Als u aan de slag wilt gaan, maakt u een gratis account in azure DevOps. Ga naar https://www.visualstudio.com/ en selecteer **gratis aan de slag** met **Azure DEVOPS** (voorheen VSTS). U moet een unieke account naam kiezen en ervoor zorgen dat u code beheert met behulp van Git. Zodra dit is gemaakt, slaat u de URL op in uw team project. Hier volgt een voor beeld-URL: `https://<accountname>.visualstudio.com/MyFirstProject`.
