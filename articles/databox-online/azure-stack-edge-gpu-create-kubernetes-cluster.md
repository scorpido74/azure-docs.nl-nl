...
5. U hebt het Kubernetes API-eind punt van de pagina **apparaat** van uw lokale webgebruikersinterface. Zie de instructies in [KUBERNETES API-eind punt ophalen](azure-stack-edge-gpu-deploy-configure-compute.md#get-kubernetes-api-endpoint) voor meer informatie
