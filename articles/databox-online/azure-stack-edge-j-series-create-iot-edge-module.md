...
![De werking van Azure IoT Edge-module op Azure Stack rand](./media/azure-stack-edge-j-series-create-iot-edge-module/how-module-works-1.png)
...
- Een Azure Stack edge-apparaat met.
    ...
    Ga voor meer informatie naar [Configure Compute](azure-stack-edge-j-series-deploy-configure-compute.md#configure-compute) voor uw Azure stack Edge.
...
2. Meld u aan bij docker door de volgende opdracht in de geïntegreerde terminal in te voeren.
    ...
    ![IoT Edge oplossing bouwen en pushen](./media/azure-stack-edge-j-series-create-iot-edge-module/build-iot-edge-solution-1.png)
...
3. Zodra de referenties zijn opgegeven, kunt u de module-installatie kopie pushen naar uw Azure container Registry. Klik in de VS code Explorer met de rechter muisknop op het **module.js** bestand en selecteer **Build and push IOT Edge Solution**.
    ...
    ![IoT Edge oplossing bouwen en pushen](./media/azure-stack-edge-j-series-create-iot-edge-module/build-iot-edge-solution-2.png)
...
Als u deze module wilt implementeren en uitvoeren op Azure Stack Edge, raadpleegt u de stappen in [een module toevoegen](azure-stack-edge-j-series-deploy-configure-compute.md#add-a-module).
