...
2. Selecteer in het linkerdeel venster **+ een resource maken**. Zoeken naar **Azure stack EDGE/Data Box gateway**. Selecteer Azure Stack rand/Data Box Gateway. Selecteer **Maken**.
