...
3. Open het `QSTodoService.cs` bestand in deze map - xamarin.iOS/ZUMOAPPNAME. De toepassingsnaam `ZUMOAPPNAME`is .

4. Vervang `QSTodoService` in `ZUMOAPPURL` de klasse variabele door het bovenstaande openbare eindpunt.
...
5. Druk op de F5-toets om de app te implementeren en uit te voeren in een iPhone-emulator.

6. Typ in de app betekenisvolle tekst, zoals *De zelfstudie voltooien* en klik op de + knop.
