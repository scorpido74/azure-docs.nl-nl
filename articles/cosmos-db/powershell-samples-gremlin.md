...
De volgende tabel bevat koppelingen naar Azure PowerShell-voorbeeldscripts voor Azure Cosmos DB-API voor Gremlin.
...
|Taak | Beschrijving |
|---|---|
|[Een account, database en grafiek maken](scripts/powershell/gremlin/ps-gremlin-create.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Hiermee maakt u een Azure Cosmos-account, -database en -grafiek. |
|[Databases of grafieken in een lijst weergeven of ophalen](scripts/powershell/gremlin/ps-gremlin-list-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Geef de databases of grafiek in een lijst weer of haal deze op. |
|[RU/s ophalen](scripts/powershell/gremlin/ps-gremlin-ru-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| RU/s ophalen voor een database of grafiek. |
|[RU/s bijwerken](scripts/powershell/gremlin/ps-gremlin-ru-update.md?toc=%2fpowershell%2fmodule%2ftoc.json)| RU/s bijwerken voor een database of grafiek. |
...
|[Resources vergrendelen tegen verwijdering](scripts/powershell/gremlin/powershell-gremlin-lock.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Voorkomen dat resources worden verwijderd met een resourcevergrendeling. |
|||
