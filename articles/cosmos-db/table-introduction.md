...
* Kant-en- [klare wereld wijde distributie](distribute-data-globally.md).
...
| Consistentie | Sterke in primaire regio. Mogelijk in secundaire regio. | [Vijf goed gedefinieerde consistentie niveaus](consistency-levels.md) voor het afhandelen van Beschik baarheid, latentie, door Voer en consistentie op basis van de behoeften van uw toepassing. |
...
* [Azure Cosmos DB tabel .NET Standard SDK](table-sdk-dotnet-standard.md)
* [Azure Cosmos DB-tabel .NET SDK](table-sdk-dotnet.md)
