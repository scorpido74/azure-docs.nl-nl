---
title: Azure PowerShell script-Azure Cosmos DB Update RU/s voor MongoDB-API
description: Azure PowerShell script-Azure Cosmos DB Update RU/s voor MongoDB-API
author: markjbrown
