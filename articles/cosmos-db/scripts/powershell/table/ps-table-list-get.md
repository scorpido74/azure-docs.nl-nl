...
| [Get-AzCosmosDBTable](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbtable) | Geeft een lijst van Cosmos DB Table-API tabellen in een account, of haalt een opgegeven Cosmos DB Table-API-tabel op in een account. |
