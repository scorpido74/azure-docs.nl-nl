---
title: PowerShell-script voor het ophalen van doorvoer (RU/s) voor Azure Cosmos DB Cassandra API-resources
description: 'Azure PowerShell-script: doorvoer (RU/s) ophalen met Cassandra-API van Azure Cosmos DB'
author: markjbrown
...
ms.locfileid: "87505496"
---
# <a name="get-throughput-rus-for-a-keyspace-or-table-for-azure-cosmos-db---cassandra-api"></a>Doorvoer (RU/s) ophalen voor een keyspace of tabel voor Azure Cosmos DB - Cassandra-API
