---
title: Azure PowerShell script-Azure Cosmos DB RU/s voor Cassandra-API bijwerken
description: Azure PowerShell script-Azure Cosmos DB RU/s voor Cassandra-API bijwerken
author: markjbrown
