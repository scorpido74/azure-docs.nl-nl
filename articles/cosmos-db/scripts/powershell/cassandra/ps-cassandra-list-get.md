...
| [Get-AzCosmosDBCassandraKeyspace](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbcassandrakeyspace) | Een lijst met Cosmos DB Cassandra-API Keys in een account, of een opgegeven Cosmos DB Cassandra-API-spatie in een account. |
| [Get-AzCosmosDBCassandraTable](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbcassandratable) | Geeft een lijst van Cosmos DB Cassandra-API tabellen in een spatie of haalt een opgegeven Cosmos DB Cassandra-API tabel op in een spatie. |
