---
title: Een Gremlin-database en -grafiek met automatische schaalaanpassing maken voor Azure Cosmos DB
description: Een Gremlin-database en -grafiek met automatische schaalaanpassing maken voor Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "87433440"
---
# <a name="create-an-azure-cosmos-gremlin-api-account-database-and-graph-with-autoscale-using-azure-cli"></a>Een Azure Cosmos Gremlin-API-account, -database en -grafiek met automatische schaalaanpassing maken met behulp van Azure CLI
