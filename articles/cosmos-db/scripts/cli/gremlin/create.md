...
---
# <a name="create-an-azure-cosmos-gremlin-api-account-database-and-graph-using-azure-cli"></a>Een Azure Cosmos Gremlin API-account, database en grafiek maken met Azure CLI
