...
| Maximum number of distinct (logical) partition keys | Onbeperkt |
| Maximum storage per container | Onbeperkt |
| Maximum storage per database | Onbeperkt |
...
| Bron | Standaardlimiet |
| --- | --- |
| Maximum number of databases | Onbeperkt |
| Maximum number of containers per database (or account) | Onbeperkt |
