...
### <a name="delete-all-the-rows-in-the-table"></a>Alle rijen in de tabel verwijderen
...
### <a name="delete-specific-columns"></a>Specifieke kolommen verwijderen
