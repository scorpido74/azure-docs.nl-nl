...
1. Schakel over naar het venster Power BI query-editor, waarbij de kolom **document** in het middelste deel venster wordt.
   ![Query-Editor Power BI Desktop](./media/powerbi-visualize/power_bi_connector_pbiqueryeditor.png)
...
## <a name="create-a-dashboard-in-powerbicom"></a>Een dash board maken in PowerBI.com
