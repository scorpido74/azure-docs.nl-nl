...
---
# <a name="quickstart-build-a-cassandra-app-with-python-sdk-and-azure-cosmos-db"></a>Snelstart: een Cassandra-app bouwen met Python SDK en Azure Cosmos DB
...
- [Python Driver voor Apache Cassandra](https://github.com/datastax/python-driver).
...
2. Open *pyquickstart.py* en `path\to\cert` wijzig de to-point naar uw nieuwe certificaat.

3. Bespaar *pyquickstart.py*.
...
In deze quickstart hebt u geleerd hoe u een Azure Cosmos DB-account met Cassandra API maken en een Cassandra Python-app uitvoeren waarmee een Cassandra-database en -container worden gemaakt. U nu extra gegevens importeren in uw Azure Cosmos DB-account. 
