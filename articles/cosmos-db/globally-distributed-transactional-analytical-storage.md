...
|Bewaren (time-to-Live of TTL)   |  Beleid dat is geconfigureerd in de Azure Cosmos-container met behulp van de `DefaultTimeToLive` -eigenschap.       |   Beleid dat is geconfigureerd in de Azure Cosmos-container met behulp van de `ColumnStoreTimeToLive` -eigenschap.      |
