...
- Referenties ophalen voor het gebruik van bijlagen via [de .NET SDK v2 van Azure Cosmos DB](https://docs.microsoft.com/dotnet/api/microsoft.azure.documents.attachment?view=azure-dotnet&preserve-view=true)
- Referenties ophalen voor het gebruik van bijlagen via [de Java SDK v2 van Azure Cosmos DB](https://docs.microsoft.com/java/api/com.microsoft.azure.documentdb.attachment?view=azure-java-stable&preserve-view=true)
