...
> [!NOTE] 
> De `ssl=true` optie is belangrijk vanwege cosmos DB-vereisten. Zie [Verbindingstekenreeksvereisten](connect-mongodb-account.md#connection-string-requirements)voor meer informatie .
>
>
