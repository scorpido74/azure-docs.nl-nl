...
description: In dit artikel wordt beschreven hoe Azure Cosmos DB hoge Beschik baarheid biedt door de gegevens transparant te repliceren in alle regio's die zijn gekoppeld aan het Azure Cosmos-account
author: markjbrown
