...
3. Plak de USERNAME-waarde uit de portal over `<PROVIDE>` op regel 13 heen.
...
3. Ga terug naar de portal en kopieer de PASSWORD-waarde. Plak de PASSWORD-waarde uit de portal over `<PROVIDE>` op regel 14 heen.
...
4. Sla het bestand Program.cs op.
