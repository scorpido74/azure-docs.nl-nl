...
2. Open het bestand *src/Remote. yaml* en plak de unieke id-waarde `$name$` in `hosts: [$name$.graphs.azure.com]`.
...
13. Voer in **Target** het vak doel *Rakesh*in en voer in het vak **rand label** de tekst *kent*in en schakel het selectie vakje in.
