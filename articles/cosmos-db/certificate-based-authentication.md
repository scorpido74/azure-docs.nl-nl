...
1. Vul **een toepassings formulier registreren** in met de volgende details:  
   ...
   * **Omleidings-URL** : Kies toepassing van het type **Web** en geef een URL op waar uw toepassing wordt gehost. Dit kan een wille keurige URL zijn. Voor dit voor beeld kunt u een test-URL opgeven, zoals `https://sampleApp.com` het is, zelfs als de app niet bestaat.
...
* [Beveiligings controles voor Azure Cosmos DB](cosmos-db-security-controls.md)
