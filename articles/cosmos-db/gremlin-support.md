...
## <a name="gremlin-wire-format"></a>Gremlin Wire-indeling

Azure Cosmos DB gebruikt de JSON-indeling bij het retour neren van resultaten van Gremlin-bewerkingen. Azure Cosmos DB ondersteunt momenteel de JSON-indeling. Het volgende code fragment toont bijvoorbeeld een JSON-weer gave van een hoek punt *dat wordt geretourneerd naar de client* van Azure Cosmos DB:
...
De eigenschappen die worden gebruikt door de JSON-indeling voor hoek punten, worden hieronder beschreven:
