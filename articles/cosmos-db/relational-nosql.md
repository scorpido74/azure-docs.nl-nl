...
## <a name="high-throughput"></a>Hoge doorvoer
...
![Grafiek](./media/relational-or-nosql/graph.png)
...
Als u gegevens beheert waarvan de structuren voortdurend worden gewijzigd op basis van een hoog tempo, met name als trans acties kunnen afkomstig zijn van externe bronnen waar het lastig is om conformiteit in de data base af te dwingen, kunt u overwegen een meer schema-neutraal benadering een beheerde NoSQL-database service gebruiken zoals Azure Cosmos DB.
