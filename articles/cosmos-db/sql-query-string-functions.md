---
title: Teken reeks functies in Azure Cosmos DB query taal
description: Meer informatie over teken reeks-SQL-functies in Azure Cosmos DB.
author: ginamr
...
* [REPLICEREN](sql-query-replicate.md)
* [OMGEKEERDE](sql-query-reverse.md)
...
* [SUBTEKENREEKS](sql-query-substring.md)
