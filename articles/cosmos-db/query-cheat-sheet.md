...
* Voor SQL-API-query's raadpleegt [u query met behulp van de SQL-API](tutorial-query-sql-api.md), [SQL-query's voor Azure Cosmos DB](./sql-query-getting-started.md)en [Naslag informatie over SQL-syntaxis](./sql-query-getting-started.md)
