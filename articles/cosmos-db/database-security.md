...
De volgende scherm afbeelding laat zien hoe u controle logboeken en activiteiten Logboeken kunt gebruiken om uw account te bewaken: :::image type="content" source="./media/database-security/nosql-database-security-application-logging.png" alt-text="Verantwoordelijkheden van klanten en database providers":::
