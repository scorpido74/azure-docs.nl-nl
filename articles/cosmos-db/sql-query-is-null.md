...
## <a name="examples"></a>Voorbeelden
  ...
  In het volgende voor beeld worden objecten van JSON-Boole, getal, teken reeks, null, object, matrix en niet-gedefinieerde `IS_NULL` typen gecontroleerd met behulp van de functie.  
