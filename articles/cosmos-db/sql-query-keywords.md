...
> [!TIP]
> Voor snellere query-uitvoerings tijden maakt u een indexerings beleid dat gebruikmaakt van een bereik index type voor alle numerieke eigenschappen of paden die de `BETWEEN` component filtert.
