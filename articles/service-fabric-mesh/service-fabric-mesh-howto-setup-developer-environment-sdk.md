...
Visual Studio 2017 of hoger is vereist voor de implementatie van Service Fabric-mesh-toepassingen. [Installeer versie 15.6.0][download-visual-studio] of hoger en schakel de volgende werk belastingen in:
...
Down load en installeer de nieuwste versie van [docker Community Edition voor Windows][download-docker] ter ondersteuning van de container service Fabric-apps die worden gebruikt door service Fabric net.
...
Als Hyper-V niet is ingeschakeld, opent u PowerShell als een beheerder en voert u de volgende opdracht uit om Hyper-V in te schakelen. Start vervolgens uw computer opnieuw op. Zie [docker Enter prise Edition voor Windows Server][download-docker-server]voor meer informatie.
...
1. Installeer de [service Fabric mesh SDK][download-sdkmesh] met het installatie programma voor het webplatform. Hierdoor worden ook de Microsoft Azure Service Fabric SDK en -runtime geïnstalleerd.
2. Installeer de [extensie Visual studio service Fabric net-Hulpprogram ma's (preview)][download-tools] van Visual Studio Marketplace.
