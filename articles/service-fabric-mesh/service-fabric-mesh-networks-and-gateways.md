...
Wanneer de netwerk bron wordt gemaakt met `ingressConfig`, wordt er een openbaar IP-adres toegewezen aan de netwerk bron. Het open bare IP-adres wordt gekoppeld aan de levens duur van de netwerk bron.
