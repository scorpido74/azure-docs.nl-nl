...
>
> Momenteel worden verbindingen van particuliere koppelingen op Sender-clients ondersteund. 
...
8. Voer de volgende stappen uit op de pagina **resource** :
    ...
    2. Als u **verbinding maken met een Azure-resource selecteert op resource-id of alias** , omdat de naam ruimte zich niet in dezelfde map bevindt als die van het persoonlijke eind punt, volgt u deze stappen:
        1. Voer de **resource-id** of **alias**in. Dit kan de resource-ID of alias zijn die iemand met u heeft gedeeld. De eenvoudigste manier om de resource-ID op te halen, is door te navigeren naar de Azure Relay naam ruimte in de Azure Portal en het `/subscriptions/`gedeelte van de URI te kopiëren vanaf. Hier volgt een voor beeld:`/subscriptions/000000000-0000-0000-0000-000000000000000/resourceGroups/myresourcegroup/providers/Microsoft.Relay/namespaces/myrelaynamespace.` 
