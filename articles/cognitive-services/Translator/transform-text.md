...
|:---|:---|
| Autorisatie-header | **Vereist** HTTP-header die wordt gebruikt om de toepassing te identificeren. Gebruik sleutel: ' autorisatie ' en waarde: ' Bearer ' + ' ' en het toegangs token. Meer informatie vindt u hier.|
