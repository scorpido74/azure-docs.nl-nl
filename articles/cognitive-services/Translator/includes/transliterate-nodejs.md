...
Maak een nieuw project met uw favoriete IDE of editor `translate-text.js` of een nieuwe map met een bestand met de naam op uw bureaublad. Kopieer dit codefragment vervolgens naar uw project/bestand:
