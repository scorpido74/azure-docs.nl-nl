...
Maak een nieuw project met behulp van uw favoriete IDE of editor of maak een nieuwe map op uw bureaublad. Kopieer dit codefragment naar uw project/bestand in een bestand met de naam `alt-translations.js`.
...
>[!NOTE]
> Meer informatie over eindpunten, routes en aanvraagparameters vindt u in [Translator 3.0: opzoeken in woordenlijst](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-dictionary-lookup).
