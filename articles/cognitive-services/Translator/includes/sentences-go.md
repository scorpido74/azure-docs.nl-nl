...
U gaat nu een functie maken om de zinlengte te bepalen. Deze functie moet één argument, uw abonnements sleutel van uw abonnement.
...
>[!NOTE]
> Zie [Translator 3,0: BreakSentence](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-break-sentence)voor meer informatie over eind punten, routes en aanvraag parameters.
