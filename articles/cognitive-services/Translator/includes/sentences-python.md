...
Het globale eind punt van het conversie programma is ingesteld als `endpoint` . Met `path` wordt de `breaksentence`-route ingesteld en wordt bepaald dat we versie 3 van de API willen gebruiken.
...
>[!NOTE]
> Zie [Translator 3,0: languages](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-break-sentence)(Engelstalig) voor meer informatie over eind punten, routes en aanvraag parameters.
