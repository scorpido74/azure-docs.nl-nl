...
>[!NOTE]
> Meer informatie over eindpunten, routes en aanvraagparameters vindt u in [Translator 3.0: vertalen](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-translate).
