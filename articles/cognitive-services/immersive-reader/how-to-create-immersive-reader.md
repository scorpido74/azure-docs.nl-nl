...
1. Begin met het openen van de [Azure Cloud shell](https://docs.microsoft.com/azure/cloud-shell/overview). Zorg ervoor dat de Cloud shell is ingesteld op Power shell in de vervolg keuzelijst linksboven of door `pwsh`te typen.
