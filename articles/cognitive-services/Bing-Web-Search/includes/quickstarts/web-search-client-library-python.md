...
1. Kopieer deze voorbeeld code naar uw project. `endpoint` kunnen het globale eind punt hieronder zijn of het [aangepaste subdomein](~/articles/cognitive-services/cognitive-services-custom-subdomains.md) -eind punt dat wordt weer gegeven in de Azure portal voor uw resource.:  
