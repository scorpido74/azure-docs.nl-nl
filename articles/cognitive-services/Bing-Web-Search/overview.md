...
description: De Bing Webzoekopdrachten-API is een betrouw bare service die direct antwoord geeft op zoek query's op internet. Configureer resultaten voor het toevoegen van webpagina's, afbeeldingen, Video's, nieuws en meer. Resultaten worden gegeven als JSON en zijn gebaseerd op zoekrelevantie en uw Bing Webzoekopdrachten-abonnementen.
...
* [Een web-app met één pagina bouwen](tutorial-bing-web-search-single-page-app.md).
