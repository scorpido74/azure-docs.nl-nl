...
- Importeer deze bibliotheken vanuit de Maven-opslagplaats
...
1. Maak een methode met de naam `detectAnomaliesBatch()` om anomalieën in de gegevens op te sporen als een batch. Roep de hierboven gemaakte `sendRequest()`-methode aan met uw eindpunt, URL, abonnementssleutel en JSON-gegevens. Haal het resultaat op en druk het af naar de console.
