...
> ![Voorbeeld factuur](media/tutorial-form-recognizer-with-logic-apps/sample-receipt.png)
...
1. Selecteer **nieuwe stap**en zoek onder **Kies een actie**naar **formulier herkenner**. Selecteer in de resultaten die worden weer gegeven, de optie **formulier Recognizer**en selecteer vervolgens onder de acties die beschikbaar zijn voor de formulier herkenner, **Train model**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Model van een formulier herkenning trainen](media/tutorial-form-recognizer-with-logic-apps/logic-app-form-reco-train-model.png)
...
1. Voer in het dialoog venster **formulier analyseren** de volgende stappen uit:
    ...
    2. Klik op het tekstvak **document** en selecteer in het dialoog venster dat wordt geopend op het tabblad **dynamische inhoud** de optie **bijlagen inhoud**. Hiermee configureert u de stroom om het voorbeeld factuur bestand te gebruiken dat is gekoppeld aan het e-mail bericht dat de werk stroom activeert.
        ...
        > [!div class="mx-imgBorder"]
        > ![E-mail bijlage gebruiken voor het analyseren van facturen](media/tutorial-form-recognizer-with-logic-apps/analyze-form-input-data.png)
...
1. Zodra het e-mail bericht in de map wordt bezorgd, wordt in de Logic Apps Designer een scherm weer gegeven met de voortgang van elke fase. In de onderstaande scherm afbeelding ziet u dat er een e-mail bericht met een bijlage wordt ontvangen en dat de werk stroom wordt uitgevoerd.
    ...
    > [!div class="mx-imgBorder"]
    > ![De werk stroom starten door een e-mail te verzenden](media/tutorial-form-recognizer-with-logic-apps/logic-apps-email-arrived-progress.png)
