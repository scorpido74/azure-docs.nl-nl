---
title: 'Quick Start: Language Understanding (LUIS) het ontwerpen van client bibliotheek 3. x voor .NET'
titleSuffix: Azure Cognitive Services
description: Aan de slag met de LUIS-client bibliotheek 3. x voor .NET. Volg deze stappen om het pakket te installeren en de voorbeeld code voor basis taken uit te proberen.
...
ms.locfileid: "74807504"
---
# <a name="quickstart-language-understanding-luis-client-library-3x-for-net"></a>Quick Start: Language Understanding (LUIS) client bibliotheek 3. x voor .NET

Ga aan de slag met de Language Understanding-client bibliotheek (LUIS) 3. x voor .NET. Volg deze stappen om het pakket te installeren en de voorbeeld code voor basis taken uit te proberen.  Met Language Understanding (LUIS) kunt u aangepaste informatie over machine learning Toep assen op de conversatie van een gebruiker, tekst in natuurlijke taal om de algemene betekenis te voors pellen en relevante, gedetailleerde gegevens uit te voeren.

Gebruik de Language Understanding-client bibliotheek (LUIS) 3. x voor .NET voor het volgende:

* Een gepubliceerd eind punt opvragen
