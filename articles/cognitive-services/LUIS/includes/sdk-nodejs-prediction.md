...
[Naslag informatie](https://docs.microsoft.com/javascript/api/@azure/cognitiveservices-luis-runtime/?view=azure-node-latest) | over de[NPM-](https://www.npmjs.com/package/@azure/cognitiveservices-luis-runtime) | voor[beelden](https://github.com/Azure-Samples/cognitive-services-quickstart-code/blob/master/javascript/LUIS/luis_prediction.js) in de documentatie[bibliotheek met bron code](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/cognitiveservices/cognitiveservices-luis-runtime) | 
...
Maak een nieuw Java script-bestand in uw voorkeurs editor of IDE `luis_prediction.js`, met de naam.
...
* Voor [Spelling](https://docs.microsoft.com/javascript/api/@azure/cognitiveservices-luis-runtime/predictionoperations?view=azure-node-latest#getslotprediction-string--string--predictionrequest--models-predictiongetslotpredictionoptionalparams-) per `staging` of sleuf `production`
...
Open het `luis_prediction.js` bestand in de map van het project in uw voorkeurs editor of IDE. Voeg de volgende afhankelijkheden toe:
...
Voer de toepassing uit met `node luis_prediction.js` de opdracht uit de toepassingsmap.
