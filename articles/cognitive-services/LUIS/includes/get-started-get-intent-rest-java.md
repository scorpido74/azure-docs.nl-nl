...
ms.locfileid: "91545517"
---
[Referentiedocumentatie](https://westeurope.dev.cognitive.microsoft.com/docs/services/luis-programmatic-apis-v3-0-preview/operations/5890b47c39e2bb052c5b9c08) | [Voorbeeld](https://github.com/Azure-Samples/cognitive-services-quickstart-code/blob/master/java/LUIS/java-predict-with-rest/Predict.java)
...
Gebruik Java om een query uit te voeren op het [voorspellingseindpunt](https://aka.ms/luis-apim-v3-prediction) en een voorspellingsresultaat op te halen.
...
> [Voeg uitingen toe en train met Java](../get-started-get-model-rest-apis.md)