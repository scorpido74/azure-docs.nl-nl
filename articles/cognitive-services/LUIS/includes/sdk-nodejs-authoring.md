...
* `LUIS_AUTHORING_ENDPOINT`-Het eind punt dat aan uw sleutel is gekoppeld.
...
Maak een nieuw tekst bestand in uw voorkeurs editor of IDE met `luis_authoring_quickstart.js`de naam. Voeg vervolgens de volgende afhankelijkheden toe.
...
Voer de toepassing uit met `node luis_authoring_quickstart.js` de opdracht in uw Quick Start-bestand.
