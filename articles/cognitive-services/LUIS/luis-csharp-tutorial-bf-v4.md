...
1. Voer `Book a flight from Seattle to Berlin tomorrow` in de bot-emulator hetzelfde antwoord in voor de Basic-bot zoals u deze hebt ontvangen in de **test in Web Chat** in een vorige sectie.
