...
| | **Gebruikers account** | **App** | **Voor beeld van Utterance (s)** | **Query's voor eind gebruikers** |
| --- | --- | --- | --- | --- |
...
| | **Gebruikers account** | **App** | **Utterance (s)** | **Query's voor eind gebruikers** |
| --- | --- | --- | --- | --- |
