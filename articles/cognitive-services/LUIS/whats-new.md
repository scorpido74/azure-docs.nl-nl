...
* DevOps-procedures Toep assen met LUIS
    * Concepten
        * [DevOps-procedures voor LUIS](luis-concept-devops-sourcecontrol.md)
        * [Continue integratie en doorlopende leverings werk stromen voor LUIS DevOps](luis-concept-devops-automation.md)
        * [Testen op LUIS DevOps](luis-concept-devops-testing.md)
    * Uitleg
        * [DevOps Toep assen op het ontwikkelen van LUIS-apps met behulp van GitHub-acties](luis-how-to-devops-with-github.md)
    * [Volledige code GitHub opslag plaats](https://github.com/Azure-Samples/LUIS-DevOps-Template)
