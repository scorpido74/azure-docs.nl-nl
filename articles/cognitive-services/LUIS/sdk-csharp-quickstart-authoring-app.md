...
description: Ga met deze Snelstartgids aan de slag met de LUIS-client bibliotheek voor .NET. Volg deze stappen om het pakket te installeren en de voorbeeld code voor basis taken uit te proberen.
...
ms.locfileid: "75447751"
---
# <a name="quickstart-language-understanding-luis-authoring-2x-client-library-for-net"></a>Quick Start: Language Understanding (LUIS) voor het ontwerpen van 2. x-client bibliotheek voor .NET

Ga aan de slag met de Language Understanding (LUIS) ontwerp 2. x-client bibliotheek voor .NET. Volg deze stappen om het pakket te installeren en de voorbeeld code voor basis taken uit te proberen.  Met Language Understanding (LUIS) kunt u aangepaste informatie over machine learning Toep assen op de conversatie van een gebruiker, tekst in natuurlijke taal om de algemene betekenis te voors pellen en relevante, gedetailleerde gegevens uit te voeren.
