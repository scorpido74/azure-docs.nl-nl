...
|--|--|
|Intentie|**Classificeer** gebruikers uitingen in één intentie of actie. Voor beelden `BookFlight` zijn `GetWeather`en.|
...
Een versie kan worden geïmporteerd op app-niveau. Deze versie wordt de actieve versie en gebruikt de versie-ID in `versionId` de eigenschap van het app-bestand. U kunt ook op versie niveau importeren in een bestaande app. De nieuwe versie wordt de actieve versie. 
