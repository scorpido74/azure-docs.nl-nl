---
title: Bing Autosuggest API v5 naar v7 upgraden
...
---
# <a name="autosuggest-api-upgrade-guide"></a>Api-upgradehandleiding automatisch voorstellen

Deze upgradehandleiding identificeert de wijzigingen tussen versie 5 en versie 7 van de Bing Autosuggest API. Gebruik deze handleiding om uw toepassing bij te werken om versie 7 te gebruiken.

## <a name="breaking-changes"></a>Wijzigingen die fouten veroorzaken

### <a name="endpoints"></a>Eindpunten

- Het versienummer van het eindpunt is gewijzigd van v5 naar v7. Bijvoorbeeld https:\//api.cognitive.microsoft.com/bing/\*\*v7.0**/Suggesties.
