...
Maak een HTML-formulier met een tekstveld. De `oninput` gebeurtenis wordt verwerkt en de `bingAutosuggest()` functie wordt aangeroepen door de inhoud van het tekst veld en de automatische suggestie-API voor Bing sleutel door te geven.
