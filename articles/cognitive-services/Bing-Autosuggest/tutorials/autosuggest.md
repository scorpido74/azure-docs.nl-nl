---
title: 'Zelf studie: resultaten van automatische suggesties ophalen met behulp van Automatische suggestie-API voor Bing'
titleSuffix: Azure Cognitive Services
description: In deze zelf studie maakt u een webpagina waarmee gebruikers een query kunnen uitvoeren op de Automatische suggestie-API voor Bing en de query resultaten worden weer gegeven.
...
Als u deze zelfstudie wilt volgen, hebt u een abonnementssleutel nodig voor de Automatische suggestie-API voor Bing. Als u geen sleutel hebt, kunt u zich [registreren voor een gratis proefversie](https://azure.microsoft.com/try/cognitive-services/?api=autosuggest-api).
...
Maak een HTML-formulier met een tekstveld. De gebeurtenis `oninput` afhandelen en de `bingAutosuggest()` functie aanroepen, waarbij de inhoud van het tekst veld en de Automatische suggestie-API voor Bing sleutel worden door gegeven.
