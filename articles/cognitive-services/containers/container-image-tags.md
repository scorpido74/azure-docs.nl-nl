---
title: Container installatie kopie-Tags Cognitive Services
...
| Afbeeldings Tags | Opmerkingen |
|------------|:------|
| `latest` | Container installatie kopie met de `en-US` land instelling en `JessaRUS`e stem. |
