...
**V: Zullen containers beschikbaar zijn voor alle Cognitive Services en wat is de volgende set containers die we moeten verwachten?**
...
**V: Hoe worden updates in versie beschreven?**
...
**V: Kunt u de aanbevelingen van product feedback en functies Hoe kan ik bieden?**
...
* [Anomalie detectie][ad-containers-billing]
* [Computer Vision][cv-containers-billing]
* [Face][fa-containers-billing]
* [Formulier herkenning][fr-containers-billing]
...
**V: Wat gebeurt er met Cognitive Services containers wanneer de verbinding met internet is verbroken?**
...
* [Anomalie detectie][ad-containers-recommendations]
* [Computer Vision][cv-containers-recommendations]
* [Face][fa-containers-recommendations]
* [Formulier herkenning][fr-containers-recommendations]
