...
Om de positie aanvraag te volt ooien, worden de voor keuren van de gebruiker gevraagd om inhouds keuzes te maken. Het proces kan inhoud maken om de acties uit te sluiten die als `excludeActions`worden weer gegeven. De rang aanvraag heeft de [acties](../concepts-features.md#actions-represent-a-list-of-options) en hun functies, eigenschap currentcontext-functies, excludeActions en een unieke positie gebeurtenis-id nodig om de geclassificeerde reactie te ontvangen.
