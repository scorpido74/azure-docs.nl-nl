...
Personaler gebruikt machine learning om te selecteren welke actie (inhoud) u wilt weer geven van de gebruiker. De selectie kan aanzienlijk variëren, afhankelijk van de hoeveelheid, de kwaliteit en de distributie van de gegevens die naar de service worden verzonden.
...
**Gebruik persoonlijke instellingen niet** als het persoonlijke gedrag niet iets is dat kan worden gedetecteerd voor alle gebruikers. Als u bijvoorbeeld met Personaler een pizza-volg orde van een lijst met 20 mogelijke menu-items wilt gebruiken, is het nuttig, maar welke contact persoon moet worden aangeroepen vanuit de lijst met contact personen van de gebruiker wanneer u hulp nodig hebt bij Childcare (zoals ' Grandma ') is niet iets dat persoonlijk is in uw gebruikers basis.
