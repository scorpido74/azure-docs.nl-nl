---
title: Externe & Community-inhoud voor Text Analytics-API
titleSuffix: Azure Cognitive Services
description: Partner Blogs, YouTube-Video's, training voor Azure Cognitive Services Text Analytics-API.
...
# <a name="external--community-content-for-the-text-analytics-cognitive-service"></a>Externe & Community-inhoud voor de Text Analytics cognitieve service
 ...
 Via de koppelingen in dit artikel krijgt u nuttige webinhoud die is ontwikkeld en gemaakt door partners en professionals met ervaring in het gebruik van de Text Analytics-API.
...
+ [Logische app voor het detecteren van sentiment en het uitpakken van sleutel zinnen uit uw tekst](https://www.youtube.com/watch?v=jVN9NObAzgk)

+ [Sentimentanalyse Power BI en Microsoft Cognitive Services gebruiken](https://www.youtube.com/watch?v=gJ1j3N7Y75k)

+ [Tekst analyse haalt sleutel zinnen op met behulp van Power BI en Microsoft Cognitive Services](https://www.youtube.com/watch?v=R_-1TB2BF14)
