...
* [Model versie](how-tos/text-analytics-how-to-entity-linking.md#named-entity-recognition-versions-and-features) `2019-10-01`, waaronder:
...
* [Model versie](how-tos/text-analytics-how-to-sentiment-analysis.md#sentiment-analysis-versions-and-features) `2019-10-01`, waaronder:
...
Het biedt ondersteuning voor`en`Engels (),`ja`Japans (), vereenvoudigd`zh-Hans`Chinees (), traditioneel`zh-Hant`Chinees (),`fr`Frans (),`it`Italiaans (),`es`Spaans (),`nl`Nederlands (),`pt`Portugees () en Duits`de`(), en is beschikbaar in de volgende regio's `Australia East`: `Central Canada`, `Central US`, `East Asia`, `East US` `East US 2`,, `North Europe`, `Southeast Asia`, `South Central US`, `UK South` `West Europe`,, en `West US 2`. 
