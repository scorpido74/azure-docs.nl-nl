...
| Naam subtype | Beschrijving                                                                                | Beschikbaar vanaf model versie |
|--------------|--------------------------------------------------------------------------------------------|----------------------------------------|
| N.v.t.          | Taak `civil engineer`typen zoals `salesperson` `chef`,,, `librarian`,`nursing aide` | `2020-02-01`                           |
...
| Geopolitieke entiteit (GPE)-alleen Engelstalig| Steden, landen, Staten `Seattle` `Pennsylvania` `South Africa`, bijvoorbeeld,,`Tokyo` | `2020-02-01`                           |
...
| Naam subtype | Beschrijving                                                                        | Beschikbaar vanaf model versie |
|--------------|------------------------------------------------------------------------------------|----------------------------------------|
| N.v.t.          | Bijvoorbeeld `Microsoft Surface laptop` `sunglasses`,,, `bag` `motorcycle``Xbox` | `2020-02-01`                           |
