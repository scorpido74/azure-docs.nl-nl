---
title: Taaldetectie Kubernetes config en implementeren stappen
titleSuffix: Azure Cognitive Services
description: Taaldetectie Kubernetes config en implementeren stappen
...
ms.locfileid: "80877809"
---
### <a name="deploy-the-language-detection-container-to-an-aks-cluster"></a>De taaldetectiecontainer implementeren in een AKS-cluster
...
1. Maak in de teksteditor een nieuw bestand met de naam *language.yaml*en plak de volgende YAML erin. Zorg ervoor `billing/value` dat `apikey/value` u en met uw eigen informatie te vervangen.
...
1. Voer de `apply` opdracht Kubernetes uit met het *bestand language.yaml* als doel:
...
1. Controleer of de service beschikbaar is en haal het IP-adres op.
    ...
    De uitvoer voor de uitvoerstatus van de *taalservice* in de pod:
