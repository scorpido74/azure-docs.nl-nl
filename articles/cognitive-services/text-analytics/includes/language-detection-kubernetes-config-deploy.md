---
title: Taaldetectie Kubernetes-configuratie en implementatie stappen
titleSuffix: Azure Cognitive Services
description: Taaldetectie Kubernetes-configuratie en implementatie stappen
...
1. Maak in de tekst editor een nieuw bestand met de naam *Language. yaml*en plak de volgende YAML hierin. Vervang `billing/value` en `apikey/value` door uw eigen gegevens.
...
1. Voer de opdracht `apply` Kubernetes uit met het bestand *Language. yaml* als doel:
