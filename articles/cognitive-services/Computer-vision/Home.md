...
De Computer Vision-service van Azure biedt ontwikkelaars toegang tot geavanceerde algoritmen die afbeeldingen verwerken en informatie retourneren, afhankelijk van de visuele functies waarin u geïnteresseerd bent. Computer Vision kan bijvoorbeeld bepalen of een afbeelding inhoud voor volwassenen bevat of dat het alle menselijke gezichten in een afbeelding kan vinden.

U Computer Vision in uw toepassing gebruiken via een native SDK of door rechtstreeks een beroep te doen op de REST API. Deze pagina laat grosso modo zien wat u kunt doen met Computer Vision.

## <a name="computer-vision-for-digital-asset-management"></a>Computer Vision voor digitaal asset management

Computer Vision kan veel scenario's voor digital asset management (DAM) van stroom voorzien. DAM is het bedrijfsproces van het organiseren, opslaan en ophalen van rich media assets en het beheren van digitale rechten en machtigingen. Een bedrijf kan bijvoorbeeld afbeeldingen groeperen en identificeren op basis van zichtbare logo's, gezichten, objecten, kleuren, enzovoort. U ook automatisch [bijschriften voor afbeeldingen genereren](./Tutorials/storage-lab-tutorial.md) en zoekwoorden toevoegen zodat ze doorzoekbaar zijn. Zie de [Knowledge Mining Solution Accelerator Guide](https://github.com/Azure-Samples/azure-search-knowledge-mining) op GitHub voor een alles-in-één DAM-oplossing met behulp van Cognitive Services, Azure Cognitive Search en intelligente rapportage. Zie voor andere DAM-voorbeelden de repository [Computer Vision Solution Templates.](https://github.com/Azure-Samples/Cognitive-Services-Vision-Solution-Templates)
...
| Actie | Beschrijving |
| ------ | ----------- |
|**[Visuele kenmerken taggen](concept-tagging-images.md)**|Identificeer en tag visuele kenmerken in een afbeelding op basis van een set met duizenden herkenbare objecten, levende wezens, landschappen en acties. Wanneer de tags dubbelzinnig zijn of niet algemeen bekend zijn, biedt de API-respons tips om de context van de tag te verduidelijken. U kunt tagging niet alleen gebruiken voor het hoofdonderwerp, zoals een persoon op de voorgrond, maar ook voor de omgeving (binnen of buiten), meubels, gereedschap, planten, dieren, accessoires, gadgets en enzovoort.|
...
|**[Gezichten detecteren](concept-detecting-faces.md)** |Detecteer gezichten in een afbeelding en geef informatie op over elk gedetecteerd gezicht. Met Computer Vision worden de coördinaten, de rechthoek, het geslacht en de leeftijd van elk gedetecteerd gezicht geretourneerd.<br/>Computer Vision biedt een [Face](/azure/cognitive-services/face/) subset van de Face-servicefunctionaliteit. U de Face-service gebruiken voor meer gedetailleerde analyse, zoals gezichtsidentificatie en posedetectie.|
...
|**[Interessegebied ophalen](concept-generating-thumbnails.md#area-of-interest)**|Analyseer de inhoud van een afbeelding om de coördinaten van het *interessegebied* te retourneren. In plaats van de afbeelding bij te snijden en een miniatuur te genereren, retourneert Computer Vision de grenzende coördinaten van de regio, zodat de aanroepende toepassing de oorspronkelijke afbeelding naar wens kan wijzigen.|

## <a name="extract-text-from-images"></a>Extraheren van tekst uit afbeeldingen

U De API van Computer Vision [read](concept-recognizing-text.md#read-api) gebruiken om gedrukte en handgeschreven tekst uit afbeeldingen te extraheren in een machineleesbare tekenstroom. De Read API maakt gebruik van onze nieuwste modellen en werkt met tekst op verschillende oppervlakken en achtergronden, zoals ontvangstbewijzen, posters, visitekaartjes, brieven en whiteboards. Momenteel zijn Engels en Spaans de enige ondersteunde talen.

U de [OCR-API (Optical Character Recognition)](concept-recognizing-text.md#ocr-optical-character-recognition-api) ook gebruiken om afgedrukte tekst in verschillende talen te extraheren. Via OCR wordt zo nodig de draaiing van de herkende tekst gecorrigeerd en worden de framecoördinaten van elk woord weergegeven. OCR ondersteunt 25 talen en detecteert automatisch de taal van de herkende tekst.

## <a name="moderate-content-in-images"></a>Beheren van inhoud in afbeeldingen

U Computer Vision gebruiken om [inhoud voor volwassenen](concept-detecting-adult-content.md) in een afbeelding te detecteren en vertrouwensscores voor verschillende classificaties terug te geven. De drempel voor het markeren van inhoud kan worden ingesteld op een glijdende schaal om aan uw voorkeuren te voldoen.

## <a name="use-containers"></a>Containers gebruiken

[Gebruik Computer Vision-containers](computer-vision-how-to-install-containers.md) om afgedrukte en handgeschreven tekst lokaal te herkennen door een gestandaardiseerde Docker-container dichter bij uw gegevens te installeren.
...
- De afmetingen van de afbeelding moet groter zijn dan 50 x 50 pixels
  - Voor de Read API moeten de afmetingen van de afbeelding tussen 50 x 50 en 10000 x 10000 pixels liggen.
...
- [Snelstart: Computer Vision Python-clientbibliotheek](./quickstarts-sdk/client-library.md?pivots=programming-language-python)
- [Snelstart: Computer Vision Java-clientbibliotheek](./quickstarts-sdk/client-library.md?pivots=programming-language-java)
