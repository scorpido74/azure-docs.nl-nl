...
ms.locfileid: "81404469"
---
# <a name="quickstart-analyze-a-remote-image-using-the-computer-vision-rest-api-and-python"></a>Snelstart: een externe afbeelding analyseren met de Computer Vision REST API en Python

In deze quickstart analyseert u een op afstand opgeslagen afbeelding om visuele functies te extraheren met behulp van de Computer Vision REST API. Met de methode [Afbeelding analyseren](https://westcentralus.dev.cognitive.microsoft.com/docs/services/5adf991815e1060e6355ad44/operations/56f91f2e778daf14a499e1fa) u visuele functies extraheren op basis van afbeeldingsinhoud.
...
- U moet de volgende Python-pakketten hebben geïnstalleerd. U [pip](https://packaging.python.org/tutorials/installing-packages/) gebruiken om Python-pakketten te installeren.
    - Verzoeken
    - [matplotlib](https://matplotlib.org/)
    - [Kussen](https://python-pillow.org/)
...
Verken vervolgens een Python-toepassing die Computer Vision gebruikt om optische tekenherkenning (OCR) uit te voeren; slim bijgesneden miniaturen maken; plus visuele functies in afbeeldingen detecteren, categoriseren, taggen en beschrijven.
