...
---
# <a name="quickstart-generate-a-thumbnail-using-the-computer-vision-rest-api-and-nodejs"></a>Quick Start: een miniatuur genereren met behulp van de Computer Vision REST API en node. js
