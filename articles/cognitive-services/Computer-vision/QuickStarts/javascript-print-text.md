...
ms.locfileid: "70137792"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-computer-vision-rest-api-and-javascript"></a>Quickstart: Gedrukte tekst (OCR) extra heren met behulp van de Computer Vision REST API en Java script
