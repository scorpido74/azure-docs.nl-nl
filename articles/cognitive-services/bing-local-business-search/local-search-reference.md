...
|<a name="query" />Nils|De zoek term van de gebruiker.|Tekenreeks|Nee|  
...
|<a name="error-parameter" />bepaalde|De query parameter in de aanvraag die de fout heeft veroorzaakt.|Tekenreeks|  
