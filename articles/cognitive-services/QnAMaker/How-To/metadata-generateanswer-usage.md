...
Vergeet niet om de eigenschap HTTP-header van `Authorization` in te stellen met een waarde van de teken reeks `EndpointKey` met een spatie en vervolgens de eindpunt sleutel op de pagina **instellingen** .
