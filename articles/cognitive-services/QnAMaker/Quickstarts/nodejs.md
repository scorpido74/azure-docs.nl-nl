...
description: Node.js REST gebaseerde informatie en voorbeelden van code om u te helpen snel aan de slag met behulp van de Microsoft Translator Text-API in Microsoft Cognitive Services op Azure.
...
ms.locfileid: "69650566"
---
# <a name="how-to-use-the-qna-maker-rest-api-with-nodejs"></a>Over het gebruik van de QnA Maker REST-API met Node.js 
<a name="HOLTop"></a>

In dit artikel leest u hoe u de [QnA Maker-API van Microsoft](../Overview/overview.md) met behulp van Node.js om het volgende te doen.
