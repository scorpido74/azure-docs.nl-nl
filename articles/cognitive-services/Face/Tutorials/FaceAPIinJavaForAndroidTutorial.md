...
In deze zelf studie maakt u een Android-toepassing die gebruikmaakt van Azure Face-API, via de Java-SDK, om menselijke gezichten in een installatie kopie te detecteren. Er wordt een geselecteerde afbeelding weergegeven en een kader rond elk gedetecteerd gezicht getekend.
