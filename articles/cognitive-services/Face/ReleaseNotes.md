...
* Verhoogde [gezicht-geef](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395239) `maxNumOfCandidatesReturned` para meter van [1, 5] tot [1, 100] en standaard ingesteld op 10.

### <a name="release-changes-in-may-2017"></a>Release wijzigingen in mei 2017

* Er zijn `hair`, `makeup`, `accessory`, `occlusion`, `blur`, `exposure`en `noise` kenmerken toegevoegd in de `returnFaceAttributes` para meter [Face-detect](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395236) .
...
* `emotion` kenmerk toegevoegd aan de para meter [Face-Detect](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395236) `returnFaceAttributes`.

* Het vlak kan niet opnieuw worden gedetecteerd met een rechthoek die is geretourneerd door een [gezichts detectie](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395236) als `targetFace` in [FaceList: add face](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395250) en [PersonGroup persoon](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f3039523b)toevoegen.
...
* Optionele `mode`-para meter voor het inschakelen van de selectie van twee werk modi: `matchPerson` en `matchFace` in [gezichts-Find vergelijkbaar](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395237) en standaard is `matchPerson`.

* Er is een optionele `confidenceThreshold` para meter toegevoegd voor de gebruiker om de drempel waarde in te stellen van het feit of een gezicht deel uitmaakt van een persoons object in [Face-identify](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395239).
