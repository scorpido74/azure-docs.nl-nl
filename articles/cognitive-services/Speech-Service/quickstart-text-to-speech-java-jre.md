...
ms.locfileid: "72299220"
---
# <a name="quickstart-synthesize-speech-with-the-speech-sdk-for-java"></a>Quick Start: spraak op de spraak-SDK voor Java
...
* Besturings systeem: 64-bits Windows, 64-bits Linux (Ubuntu 16,04, Ubuntu 18,04, Debian 9) of macOS 10,13 of hoger
...
- [Snelstartgids: spraak, java (Windows, Linux, macOS) herkennen](quickstart-java-jre.md)
- [Snelstartgids: spraak, java (Windows, Linux, macOS) vertalen](quickstart-translate-speech-java-jre.md)
