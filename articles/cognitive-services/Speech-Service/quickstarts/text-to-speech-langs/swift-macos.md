...
description: Meer informatie over het synthetiseren van spraak in Swift op macOS met de SpraakSDK
...
---
# <a name="quickstart-synthesize-speech-in-swift-on-macos-using-the-speech-sdk"></a>Snelstart: spraak synthetiseren in Swift op macOS met de SpraakSDK

In dit artikel leert u hoe u een macOS-app in Swift maakt met behulp van de Cognitive Services Speech SDK om spraak uit tekst te synthetiseren en af te spelen met de standaardaudio-uitvoer.
...
> [!NOTE] 
> Deze zelfstudie werkt niet eerder met versies van de SDK dan 1.7.0.
