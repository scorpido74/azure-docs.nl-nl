...
Laten we eens kijken [`SpeechConfig`](https://docs.microsoft.com/dotnet/api/microsoft.cognitiveservices.speech.speechconfig?view=azure-dotnet) hoe een wordt gemaakt met behulp van een sleutel en regio.
