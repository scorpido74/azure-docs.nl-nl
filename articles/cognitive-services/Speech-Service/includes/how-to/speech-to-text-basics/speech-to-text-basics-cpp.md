...
Laten we eens kijken [`SpeechConfig`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig) hoe een wordt gemaakt met behulp van een sleutel en regio.
