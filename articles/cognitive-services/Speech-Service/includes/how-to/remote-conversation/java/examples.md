...
U kunt **extern gesprek** verkrijgen door uw pom.xml-bestand als volgt te bewerken.

1. Maak aan het einde van het bestand `</project>` een `repositories` element met een verwijzing naar de Maven-opslag plaats voor de spraak-SDK, vóór de afsluit code.
