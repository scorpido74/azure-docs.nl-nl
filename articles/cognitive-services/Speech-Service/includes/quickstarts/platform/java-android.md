...
De Speech SDK is compatibel met Android-apparaten met een 32/64-bits ARM en Intel x86/x64 compatibele processors.

## <a name="install-the-speech-sdk-using-android-studio"></a>De Speech SDK installeren met behulp van Android Studio
