...
description: Gebruik deze hand leiding voor het instellen van uw platform voor C# onder .NET Framework voor Windows met de Speech Service SDK.
...
---
In deze hand leiding wordt beschreven hoe u de [Speech SDK](~/articles/cognitive-services/speech-service/speech-sdk.md) voor .NET Framework (Windows) installeert. Als u alleen de naam van het pakket wilt gebruiken om aan de slag te `Install-Package Microsoft.CognitiveServices.Speech` gaan, voert u uit in de NuGet-console.
