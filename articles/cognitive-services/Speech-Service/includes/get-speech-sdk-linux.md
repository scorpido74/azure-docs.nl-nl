...
ms.locfileid: "80656659"
---
:::row:::
    :::column span="3":::
        De Speech SDK ondersteunt alleen **Ubuntu 16.04/18.04**, **Debian 9,** **Red Hat Enterprise Linux (RHEL) 8**en **CentOS 7/8** op de volgende doelarchitecturen bij gebruik met Linux:
        - x86
        - x64
        - ARM32
        - ARM64
...
# <a name="rhel-8-and-centos-78"></a>[RHEL 8 en CentOS 7/8](#tab/rhel-centos)
