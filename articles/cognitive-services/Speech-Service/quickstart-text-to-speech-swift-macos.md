...
ms.locfileid: "71803990"
---
# <a name="quickstart-synthesize-speech-in-swift-on-macos-using-the-speech-sdk"></a>Quickstart: Spraak in Swift op macOS maken met de Speech SDK

Quick starts zijn ook beschikbaar voor [spraak herkenning](quickstart-swift-macos.md).
