...
<div id="main" class="v2">
    <div class="container">
        ...
        <ul class="pivots">
            <li>
                <a href="#start">Aan de slag</a>
                <ul id="start">
                    <li>
                        <a href="#speechtotext">Spraak naar tekst</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Spraak herkennen met een microfoon</h3>
                                                    <p>Gebruik de Speech SDK om spraak van een microfoon te herkennen en de uitvoer te transcriberen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Spraak herkennen vanuit een audiobestand</h3>
                                                    <p>Gebruik de Speech SDK om spraak uit één bestand te herkennen en de uitvoer te transcriberen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Asynchrone herkenning vanuit blob</h3>
                                                    <p>Gebruik onze REST-service voor het asynchroon herkennen van spraak uit bestanden die zijn opgeslagen in Azure Blob Storage.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Meer informatie over programmering en de ondersteuning voor gesproken taal voor spraak naar tekst.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prijzen</h3>
                                                    <p>Meer informatie over de kosten voor spraak naar tekst.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <li>
                            <a href="#texttospeech">Tekst naar spraak</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Spraaksynthese naar een luidspreker</h3>
                                                    <p>Gebruik de Speech SDK voor spraaksynthese naar audio-uitvoer, zoals een luidspreker.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Spraaksynthese naar een audiobestand</h3>
                                                    <p>Gebruik de Speech SDK voor spraaksynthese naar een audiobestand.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gebruik Speech Synthesis Markup Language om toonhoogte, prosodie en spreeksnelheid van uw audio-uitvoer nauwkeurig af te stemmen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Taalondersteuning</h3>
                                                    <p>Meer informatie over welke talen worden ondersteund voor spraaksynthese.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prijzen</h3>
                                                    <p>Meer informatie over de kosten voor tekst naar spraak.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#intentrecognition">Intentieherkenning</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Taalondersteuning</h3>
                                                    <p>Meer informatie over welke talen worden ondersteund voor intentieherkenning.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prijzen</h3>
                                                    <p>Meer informatie over de kosten voor intentieherkenning.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>De docs lezen</h3>
                                                    <p>Informatie over hoe u intentieherkenning toevoegt aan uw apps, hulpprogramma's en producten. Bevat concepten, zelfstudies, API-verwijzing en opmerkingen bij de release.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#speechtranslation">Spraakomzetting</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Spraak naar tekst omzetten vanuit een microfoon</h3>
                                                    <p>Gebruik de Speech SDK om spraak-naar-tekst om te zetten vanuit een microfoon.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Spraak omzetten naar meerdere doeltalen</h3>
                                                    <p>Gebruik de Speech SDK om spraak om te zetten naar uitvoer in meerdere doeltalen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Spraak naar spraak omzetten</h3>
                                                    <p>Gebruik de Speech SDK om spraak om te zetten naar spraak.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Taalondersteuning</h3>
                                                    <p>Meer informatie over programmering en de ondersteuning voor gesproken taal voor spraakomzetting.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prijzen</h3>
                                                    <p>Meer informatie over de kosten voor spraakomzetting.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#conversationtranscription">Gesprektranscriptie</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Een realtime gesprek transcriberen</h3>
                                                    <p>Meer informatie over hoe u een gesprek in realtime kunt transcriberen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gesprekken asynchroon transcriberen</h3>
                                                    <p>Meer informatie over het asynchroon transcriberen van gesprekken, het controleren van de status en het downloaden van de uitvoer.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Meer informatie over hoe u grote hoeveelheden telefoongegevens kunt transcriberen die afkomstig zijn van verschillende systemen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Taalondersteuning</h3>
                                                    <p>Meer informatie over programmering en de ondersteuning voor gesproken taal voor gesprektranscriptie.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prijzen</h3>
                                                    <p>Meer informatie over de kosten van gesprektranscriptie.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>De docs lezen</h3>
                                                    <p>Meer informatie over gesprektranscriptie en hoe u dit integreert in uw producten.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#voice-assistants">Spraakassistenten</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integreren met Bot Framework</h3>
                                                    <p>Meer informatie over het Bot Framework, Direct Line Speech-kanaal en nog veel meer.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Aangepaste opdrachten gebruiken</h3>
                                                    <p>Leer hoe u eenvoudig krachtige spraaktoepassingen voor opdrachten en beheer kunt bouwen, zodat gebruikers taken kunnen uitvoeren met hun stem.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>De docs lezen</h3>
                                                    <p>Meer informatie over wat u nodig hebt om een spraakassistent te bouwen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Een resource voor Azure-spraakservice maken</h3>
                                                    <p>Ontdek hoe u een Azure-abonnementssleutel kunt ophalen, een spraakresource kunt maken en hiermee aan de slag kunt gaan.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Spraakservicecontainers implementeren</h3>
                                                    <p>Meer informatie over het gebruik van Spraak-containers op locatie, met Kubernetes en Helm of Azure-containerinstanties.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Beschikbaarheid van Spraakservice-resources in een onafhankelijke Azure-cloud.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Meer informatie over de vele Spraak SDK-functiescenario's voor een groot aantal programmeertalen en omgevingen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Ondersteunde regio’s</h3>
                                                    <p>Meer informatie over de beschikbare regio's en eindpunten voor de Spraakservice.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#customization">Aanpassing</a>
                <ul id="customization">
                    <li>
                        <a href="#speech-to-text-customization">Spraak naar tekst</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Nauwkeurigheid verbeteren met Frasenlijsten</h3>
                                                    <p>Gebruik frasenlijsten in de Speech SDK om de nauwkeurigheid van de herkenning te verbeteren.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Nauwkeurigheid verbeteren met tenantmodellen</h3>
                                                    <p>Genereer aangepaste modellen met Office 365-gegevens om spraakherkenningsnauwkeurigheid te optimaliseren voor termen die specifiek zijn voor uw organisatie.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Nauwkeurigheid verbeteren met Custom Speech</h3>
                                                    <p>Een reeks online hulpprogramma's waarmee u de nauwkeurigheid van spraak naar tekst van Microsoft kunt evalueren en verbeteren voor uw apps, hulpprogramma's en producten.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Taalondersteuning</h3>
                                                    <p>Meer informatie over programmering en de ondersteuning voor gesproken taal voor Custom Speech.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prijzen</h3>
                                                    <p>Meer informatie over de kosten voor Custom Speech.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <li>
                        <a href="#text-to-speech-customization">Tekst naar spraak</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Synthese verbeteren met SSML</h3>
                                                    <p>Gebruik Speech Synthesis Markup Language om toonhoogte, prosodie en spreeksnelheid van uw audio-uitvoer nauwkeurig af te stemmen.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Synthese verbeteren met Custom Voice</h3>
                                                    <p>Bouw een herkenbare, eenduidige stem voor uw tekst-naar-spraak-apps met uw beschikbare gesproken gegevens.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Synthese verbeteren met Audio-inhoud maken</h3>
                                                    <p>Gebruik het hulpprogramma Audio-inhoud maken om de uitvoer van spraaksynthese nauwkeurig af te stemmen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Krijg toegang tot Aangepaste neurale stem</h3>
                                                    <p>Dit is een beperkte functie waarmee u een aangepaste neurale stem kunt maken. Meer informatie over toegang en beperkingen.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Taalondersteuning</h3>
                                                    <p>Meer informatie over programmering en de ondersteuning voor gesproken taal voor Custom Voice.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prijzen</h3>
                                                    <p>Meer informatie over de kosten voor Custom Voice.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
