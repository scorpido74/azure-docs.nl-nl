...
1. Een nieuwe opdracht maken door het `+` pictogram naast de opdrachten te selecteren en de naam op te geven`TurnOn`
1. Selecteer **Opslaan**
...
1. Een actie toevoegen
   1. Maak een nieuwe actie voor spraak antwoorden door het `+` pictogram naast acties te selecteren en selecteer`SpeechResponse`
