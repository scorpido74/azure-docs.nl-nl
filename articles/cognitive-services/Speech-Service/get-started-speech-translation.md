---
title: Snelstartgids voor spraak omzetting-spraak service
titleSuffix: Azure Cognitive Services
description: Meer informatie over het gebruik van de Speech SDK voor het vertalen van spraak. In deze Quick Start leert u meer over object constructie, ondersteunde audio-invoer indelingen en configuratie opties voor spraak omzetting.
...
* Bekijk de [Quick](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart) start-voor beelden op github.
