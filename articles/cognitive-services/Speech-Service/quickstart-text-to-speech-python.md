---
title: 'Quickstart: Bewaak spraak, python-Speech-Service'
...
ms.locfileid: "71803962"
---
# <a name="quickstart-synthesize-speech-with-the-speech-sdk-for-python"></a>Quickstart: Spraak op de spraak-SDK voor python

Quick starts zijn ook beschikbaar voor [spraak herkenning](quickstart-python.md).

In dit artikel wordt beschreven hoe u de spraak Services gebruikt via de Speech SDK voor python. In dit voor beeld ziet u hoe u met de standaard audio-uitvoer de spraak van tekst kunt opwaarderen en afspelen.
...
1. Als u de voorbeeldcode wilt uitvoeren, klikt u met de rechtermuisknop ergens in de editor. Selecteer **Python-bestand uitvoeren in de Terminal**.
   ...
   ![Een voorbeeld uitvoeren](media/sdk/qs-python-vscode-python-run-tts.png)
