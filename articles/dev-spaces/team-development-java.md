---
title: Teamontwikkeling met Java- en Visual Studio Code
services: azure-dev-spaces
author: stepro
ms.author: stephpr
ms.date: 08/01/2018
ms.topic: tutorial
description: In deze zelfstudie ziet u hoe u Azure Dev Spaces en Visual Studio Code gebruiken om teamontwikkeling te doen op een Java-toepassing in Azure Kubernetes Service
...
---
# <a name="team-development-using-java-and-visual-studio-code-with-azure-dev-spaces"></a>Teamontwikkeling met Java- en Visual Studio-code met Azure Dev Spaces
...
Ga naar het venster `mywebapi` VS-code voor en `String index()` maak `src/main/java/com/ms/sample/mywebapi/Application.java`een codebewerking naar de methode in bijvoorbeeld:
