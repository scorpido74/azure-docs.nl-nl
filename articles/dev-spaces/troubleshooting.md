...
U kunt dit probleem oplossen door de [VS code-extensie C#voor ](https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.csharp)te installeren.
