...
---
# <a name="quickstart-debug-and-iterate-on-kubernetes-visual-studio-code-and-net-core---azure-dev-spaces"></a>Quickstart: Debug and iterate on Kubernetes: Visual Studio Code and .NET Core - Azure Dev Spaces
...
To deploy an updated version of your service, you can update any file in your project and rerun *.NET Core Launch (AZDS)* . Bijvoorbeeld:
...
While the service is running in debugging mode, update line 22 in `Controllers/HomeController.cs`. Bijvoorbeeld:

```csharp
ViewData["Message"] = "Your application description page in Azure while debugging!";
```

Sla het bestand op. Click *Debug* then *Restart Debugging* or in the *Debug toolbar*, click the *Restart Debugging* button.
