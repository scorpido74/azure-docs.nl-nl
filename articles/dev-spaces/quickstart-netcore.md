...
- De [Azure dev Spaces](https://marketplace.visualstudio.com/items?itemName=azuredevspaces.azds) en [C#](https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.csharp) Extensions voor Visual Studio code geïnstalleerd.
...
Als u het opdracht palet wilt openen in Visual Studio code, klikt u op *weer gave* en vervolgens op *opdracht palet*. Begin met `Azure Dev Spaces` typen en klik `Azure Dev Spaces: Prepare configuration files for Azure Dev Spaces`op.
...
> [!Note]
> In eerste instantie kan de open bare URL een *onjuiste gateway* fout tonen. Wacht een paar seconden voordat u de webpagina vernieuwt. u ziet nu dat uw service wordt uitgevoerd.
