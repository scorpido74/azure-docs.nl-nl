---
title: Uw Azure dev Spaces-cluster configureren voor gebruik van helm 3 (preview-versie)
...
ms.locfileid: "78202258"
---
# <a name="configure-your-azure-dev-spaces-cluster-to-use-helm-3-preview"></a>Uw Azure dev Spaces-cluster configureren voor gebruik van helm 3 (preview-versie)
...
Maak een nieuw AKS-cluster in een regio met deze preview-functie. Met de onderstaande opdrachten maakt u een resource groep met de naam *MyResourceGroup* en een nieuw AKS-cluster met de naam *MyAKS* in de regio *Zuid-Centraal VS* :
