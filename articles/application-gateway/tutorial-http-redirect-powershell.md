...
Voor deze zelf studie is de Azure PowerShell module versie 1.0.0 of hoger vereist. Voer `Get-Module -ListAvailable Az` uit om de versie te bekijken. Als u PowerShell wilt upgraden, raadpleegt u [De Azure PowerShell-module installeren](/powershell/azure/install-az-ps). De opdrachten in deze zelfstudie, hebt u ook nodig om uit te voeren `Connect-AzAccount` voor het maken van een verbinding met Azure.
...
![Beveiligingswaarschuwing](./media/tutorial-http-redirect-powershell/application-gateway-secure.png)
...
![Basis-URL testen in de toepassingsgateway](./media/tutorial-http-redirect-powershell/application-gateway-iistest.png)
