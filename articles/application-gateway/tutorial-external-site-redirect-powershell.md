...
U kunt Azure Power shell gebruiken voor het configureren van het [omleiden van webverkeer](application-gateway-multi-site-overview.md) wanneer u een [toepassings gateway](application-gateway-introduction.md)maakt. In deze zelf studie configureert u een listener en regel voor het omleiden van webverkeer dat bij de toepassings gateway op een externe site arriveert.
...
Een listener is vereist om de toepassings gateway in staat te stellen het verkeer op de juiste wijze te routeren. Maak de listener met [New-AzApplicationGatewayHttpListener](/powershell/module/az.network/new-azapplicationgatewayhttplistener) met de front-end-configuratie en de frontend-poort die u eerder hebt gemaakt. U omleidt verkeer door een omleidings configuratie te maken die kan worden toegevoegd aan de door u gemaakte routerings regel.

Een routerings regel is vereist voor de listener om te weten waar binnenkomend verkeer moet worden verzonden. Maak een basis regel met de naam *redirectRule* met behulp van [New-AzApplicationGatewayRequestRoutingRule](/powershell/module/az.network/new-azapplicationgatewayrequestroutingrule) met de omleidings configuratie.
