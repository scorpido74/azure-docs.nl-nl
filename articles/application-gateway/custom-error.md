...
1. Navigeer naar Application Gateway in de portal en kies een toepassings gateway.
    ...
    ![Scherm afbeelding toont de overzichts pagina voor een toepassings gateway.](media/custom-error/ag-overview.png)
...
Zie [add-AzApplicationGatewayCustomError](/powershell/module/az.network/add-azapplicationgatewaycustomerror?view=azps-1.2.0) en [add-AzApplicationGatewayHttpListenerCustomError](/powershell/module/az.network/add-azapplicationgatewayhttplistenercustomerror?view=azps-1.3.0)voor meer informatie.
