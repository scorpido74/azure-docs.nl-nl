...
Een Application Gateway standard_v2 is ingericht voor een maand, met een minimum van nul instanties en gedurende deze periode worden er 25 nieuwe SSL-verbindingen per seconde ontvangen, gemiddeld 8,88-Mbps gegevens overdracht. Als er verbinding is met de korte levens duur, is uw prijs:
