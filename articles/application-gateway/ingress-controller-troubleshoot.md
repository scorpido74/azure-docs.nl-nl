...
- Back-end-groep:
  - Er bevindt zich één IP-adres in de back-endadresgroep en komt overeen met het IP-adres van de pod die eerder zijn waargenomen met `kubectl get pods -o wide`
