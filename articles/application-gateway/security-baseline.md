...
* [Veelgestelde vragen over diagnostische gegevens en logboek registratie voor Azure-toepassing gateway](./application-gateway-faq.md#diagnostics-and-logging)
