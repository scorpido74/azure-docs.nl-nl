---
title: 'Zelf studie: SSL-beëindiging configureren in portal-Azure-toepassing gateway'
...
---
# <a name="tutorial-configure-an-application-gateway-with-ssl-termination-using-the-azure-portal"></a>Zelf studie: een toepassings gateway met SSL-beëindiging configureren met behulp van de Azure Portal
...
> [!NOTE]
> Gebruik geen speciale tekens in het wacht woord voor het pfx-bestand. Alleen alfanumerieke tekens worden ondersteund.
...
3. Een routerings regel vereist een listener. Voer op het tabblad **listener** in het venster **een regel voor de route ring toevoegen** de volgende waarden in voor de listener:
   ...
   - **Wacht woord** -Typ *Azure123456* voor het wacht woord.
...
1. Voer deze waarden in op het tabblad **Basisinformatie** voor de volgende instellingen voor de virtuele machine:
    ...
    - **Wacht woord**: Voer *Azure123456* in voor het beheerders wachtwoord.
...
6. Zorg ervoor dat, op het tabblad **Netwerken**, **myVNet** is geselecteerd bij **Virtueel netwerk** en dat **Subnet** is ingesteld op **myBackendSubnet**. Accepteer de andere standaard instellingen en selecteer vervolgens **volgende: beheer**.
