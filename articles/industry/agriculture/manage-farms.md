...
ms.locfileid: "73797970"
---
# <a name="manage-farms"></a>Farms beheren
...
1. Meld u aan bij de farm Accelerator. de pagina **Farms** wordt weer gegeven.
    ...
    ![Maten van project-Farm](./media/create-farms/create-farm-main-page-1.png)
...
1. **Op kaart markeren**: gebruik het kaart beheer programma om de grens van de farm te tekenen en te markeren. Als u de grenzen wilt markeren, ![u de project Farm maten](./media/create-farms/pencil-icon-1.png) en markeert u de exacte grenzen.

    ![Maten van project-Farm](./media/create-farms/create-farm-mark-on-map-1.png)
...
Gebruik de knop Info om de informatie te vullen.
    ...
    ![Maten van project-Farm](./media/create-farms/create-new-farm-1.png)

4.  Selecteer **verzenden** om een farm te maken. Er wordt een nieuwe farm gemaakt en weer gegeven op de pagina **Farms** .
...
2.  Selecteer **Farm bewerken** om de farm gegevens te bewerken. In het venster **Farm Details** kunt u de grens **velden naam**, **gewas**, **adres**en **Farm** bewerken.

    ![Maten van project-Farm](./media/create-farms/edit-farm-1.png)
...
2.  Selecteer **farm verwijderen** om de farm te verwijderen.
    ...
    ![Maten van project-Farm](./media/create-farms/delete-farm-1.png)
