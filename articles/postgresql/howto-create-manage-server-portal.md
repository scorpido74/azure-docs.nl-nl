---
title: Azure-database beheren voor PostgreSQL - Azure-portal
description: Meer informatie over het beheren van een Azure Database voor PostgreSQL-server vanuit de Azure-portal.
author: rachel-msft
ms.author: raagyema
...
---
# <a name="manage-an-azure-database-for-postgresql-server-using-the-azure-portal"></a>Een Azure-database voor PostgreSQL-server beheren met behulp van de Azure-portal
In dit artikel ziet u hoe u uw Azure Database voor PostgreSQL-servers beheert. Beheertaken omvatten compute- en opslagschaling, het opnieuw instellen van beheerderswachtwoorden en het weergeven van servergegevens.

## <a name="sign-in"></a>Aanmelden
Meld u aan bij [Azure Portal](https://portal.azure.com).

## <a name="create-a-server"></a>Een server maken
Ga naar de [quickstart](quickstart-create-server-database-portal.md) voor meer informatie over het maken en aan de slag gaan met een Azure Database voor PostgreSQL-server.
...
- Meer informatie over [tuning- en bewakingsopties in Azure Database voor PostgreSQL](concepts-monitoring.md)
