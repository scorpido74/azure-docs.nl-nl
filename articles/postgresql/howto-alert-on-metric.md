---
title: Waarschuwingen configureren - Azure portal - Azure Database for PostgreSQL - Single Server
description: In dit artikel wordt beschreven hoe u metrische waarschuwingen voor Azure Database voor PostgreSQL - Single Server configureert en opent vanuit de Azure-portal.
author: rachel-msft
ms.author: raagyema
...
ms.locfileid: "74766834"
---
# <a name="use-the-azure-portal-to-set-up-alerts-on-metrics-for-azure-database-for-postgresql---single-server"></a>De Azure-portal gebruiken om waarschuwingen in te stellen voor metrische gegevens voor Azure Database voor PostgreSQL - Enkele server

In dit artikel ziet u hoe u Azure Database instelt voor PostgreSQL-waarschuwingen met behulp van de Azure-portal. U een waarschuwing ontvangen op basis van monitoringstatistieken voor uw Azure-services.
