...
ms.locfileid: "91819134"
---
# <a name="azure-policy-built-in-definitions-for-azure-event-hubs"></a>Ingebouwde Azure Policy-definities voor Azure Event Hubs

Deze pagina is een index van ingebouwde [Azure Policy](../governance/policy/overview.md)-beleidsdefinities voor Azure Event Hubs. Zie [Ingebouwde Azure Policy-definities](../governance/policy/samples/built-in-policies.md) voor aanvullende ingebouwde modules voor Azure Policy voor andere services.
