...
Standaard worden alle Event Hubs-resources beveiligd en zijn ze alleen beschikbaar voor de eigenaar van het account. Hoewel u een van de hierboven beschreven verificatie strategieën kunt gebruiken om clients toegang te verlenen tot Event hub-resources. Alleen Event Hubs resources die zijn gemaakt met Azure Resource Manager implementatie model ondersteunen Azure AD-autorisatie. Micro soft raadt u aan Azure AD zo mogelijk te gebruiken voor maximale beveiliging en gebruiks gemak.
