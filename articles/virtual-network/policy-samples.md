---
title: Ingebouwde beleidsdefinities voor Azure Virtual Network
description: Toont ingebouwde Azure Policy-beleidsdefinities voor Azure Virtual Network. Deze ingebouwde beleidsdefinities bieden algemene benaderingen voor het beheren van uw Azure-resources.
ms.date: 05/29/2020
ms.topic: sample
author: KumudD
ms.author: kumud
...
ms.locfileid: "84232516"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-virtual-network"></a>Ingebouwde Azure Policy-beleidsdefinities voor Azure Virtual Network

Deze pagina is een index van ingebouwde [Azure Policy](../governance/policy/overview.md)-beleidsdefinities voor Azure Virtual Network. Zie [Ingebouwde Azure Policy-definities](../governance/policy/samples/built-in-policies.md) voor aanvullende ingebouwde modules voor Azure Policy voor andere services.
