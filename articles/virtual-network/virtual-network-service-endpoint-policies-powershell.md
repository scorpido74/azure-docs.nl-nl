...
De toegang tot de share is geweigerd en er wordt een `New-PSDrive : Access is denied` fout weer gegeven. De toegang is geweigerd omdat het *notallowedaccount* van het opslag account zich niet in de lijst met toegestane resources in het service-eindpunt beleid bevindt. 
