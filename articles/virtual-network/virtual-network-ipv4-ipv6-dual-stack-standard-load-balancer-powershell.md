...
ms.locfileid: "84702981"
---
# <a name="deploy-an-ipv6-dual-stack-application-in-azure---powershell"></a>Een IPv6-toepassing met dubbele stack implementeren in azure-Power shell

In dit artikel wordt beschreven hoe u een dual stack (IPv4 + IPv6)-toepassing kunt implementeren met behulp van Standard Load Balancer in azure, met een virtueel netwerk en subnet met dubbele stack, een Standard Load Balancer met dubbele (IPv4 + IPv6) front-end configuraties, Vm's met Nic's met een dubbele IP-configuratie, netwerk beveiligings groep en open bare Ip's.
