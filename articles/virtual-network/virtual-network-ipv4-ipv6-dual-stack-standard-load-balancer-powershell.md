...
ms.locfileid: "80420935"
---
# <a name="deploy-an-ipv6-dual-stack-application-in-azure---powershell"></a>Een IPv6 dual stack-toepassing implementeren in Azure - PowerShell

In dit artikel ziet u hoe u een dual stack -toepassing (IPv4 + IPv6) implementeert met behulp van Standard Load Balancer in Azure met een virtueel dual stack-netwerk en subnet, een Standaard Load Balancer met dubbele (IPv4 + IPv6) front-endconfiguraties, VM's met NIC's met een dubbele IP-configuratie, netwerkbeveiligingsgroep en openbare IP-adressen.
