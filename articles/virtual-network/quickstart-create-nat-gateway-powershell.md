...
```
Combi neer de configuratie definities voor het maken van een virtuele machine met de naam **myVM** met [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) in **myResourceGroupNAT**.
