---
title: Exemplaren van virtuele GCP-machines beoordelen voor migratie naar Azure met Azure Migrate-serverevaluatie
description: Beschrijft hoe u exemplaren van virtuele GCP-machines kunt beoordelen voor migratie naar Azure met Azure Migrate-serverevaluatie.
ms.topic: tutorial
ms.date: 09/14/2020
ms.custom: MVC
...
In dit artikel wordt beschreven hoe u exemplaren van de virtuele GCP-machine (Google Cloud Platform) kunt beoordelen voor migratie naar Azure met behulp van het Azure Migrate: Serverevaluatieprogramma.
...
Beslis of u een evaluatie wilt uitvoeren met behulp van de groottecriteria op basis van de configuratiegegevens/metagegevens van de machine die zonder aanpassingen on-premises worden verzameld of op basis van prestatiegegevens.
