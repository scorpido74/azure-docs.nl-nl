...
- Als u een Log Analytics-werk ruimte hebt gekoppeld aan het hulp programma voor Server evaluatie voor afhankelijkheids analyse, moet u beslissen of u de werk ruimte wilt verwijderen. 
    ...
    - Voordat u het project verwijdert, kunt u een koppeling naar de werk ruimte vinden in **Azure migrate-Servers** > - **evaluatie van Azure migrate-server**, onder **OMS-werk ruimte**.
...
### <a name="hyper-v-vm"></a>Virtuele Hyper-V-machine 
