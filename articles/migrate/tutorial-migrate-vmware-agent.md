...
Voordat u met deze zelfstudie begint, moet u de architectuur voor migratie op basis van een agent voor VMware [controleren](migrate-architecture.md).
