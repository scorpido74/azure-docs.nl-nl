...
---
# <a name="assess-physical-servers-with-azure-migrateserver-assessment"></a>Fysieke servers beoordelen met Azure Migrate: Server evaluatie
...
- In de eerste zelf studie hebt u het volgende gedaan:
    - [Azure-machtigingen instellen](tutorial-prepare-physical.md) voor Azure Migrate.
...
6. Geef in **Project Details**de project naam en de geografie op waarin u het project wilt maken. Bekijk ondersteunde geografies voor [open bare](migrate-support-matrix.md#supported-geographies-public-cloud) en [overheids Clouds](migrate-support-matrix.md#supported-geographies-azure-government).
...
Zorg ervoor dat het apparaat verbinding kan maken met Azure-Url's voor [open bare](migrate-appliance.md#public-cloud-urls) en [overheids](migrate-appliance.md#government-cloud-urls) Clouds.
