...
Raadpleeg de volgende artikelen voor informatie over de vereisten voor netwerk connectiviteit voor het Azure Migrate apparaat:

- **VMware-evaluatie**: [URL-toegang](migrate-appliance.md#url-access) en [poort toegang](migrate-support-matrix-vmware.md#port-access)
- **VMware-agentloze migratie**: [URL-toegang](migrate-appliance.md#url-access) en [poort toegang](migrate-support-matrix-vmware-migration.md#agentless-ports)
- **Hyper-V-evaluatie**: [URL-toegang](migrate-appliance.md#url-access) en [poort toegang](migrate-support-matrix-hyper-v.md#port-access)
...
- **VMware-VM**: [prestatie gegevens](migrate-appliance.md#collected-performance-data-vmware) en [meta gegevens](migrate-appliance.md#collected-metadata-vmware)
- **Hyper-V VM**: [prestatie gegevens](migrate-appliance.md#collected-performance-data-hyper-v) en [meta gegevens](migrate-appliance.md#collected-metadata-hyper-v)
...
## <a name="can-i-connect-the-appliance-to-multiple-instances-of-vcenter-server"></a>Kan ik het apparaat aansluiten op meerdere exemplaren van vCenter Server?

Nee. Er is een een-op-een-toewijzing tussen een apparaat en vCenter Server. Als u Vm's op meerdere exemplaren van vCenter Server wilt detecteren, moet u meerdere toestellen implementeren.
