...
> [!NOTE]
> Deze code verwijdert de Log Analytics-agent voor Linux niet van de computer. Hiermee worden alleen de functionaliteit en configuratie van de rol Hybride Runbook Worker verwijderd.
