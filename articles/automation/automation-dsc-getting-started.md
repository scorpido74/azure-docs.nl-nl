...
2. Selecteer op de pagina registratie de naam van de knooppunt configuratie die in het veld **knooppunt configuratie naam** moet worden toegepast op de virtuele machine. Het opgeven van een naam op dit punt is optioneel. U kunt de toegewezen knooppunt configuratie wijzigen na onboarding van het knoop punt.
