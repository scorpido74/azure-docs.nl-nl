...
![Wijzigingen bijhouden Details](./media/change-tracking/change-tracking-details.png)
...
Met Wijzigingen bijhouden en inventaris kunt u de inhoud van een Windows-of Linux-bestand weer geven vóór en na een wijziging in een bestand. Voor elke wijziging in een bestand bevat Wijzigingen bijhouden en inventaris de inhoud van het bestand in een [Azure Storage-account](../storage/common/storage-create-storage-account.md). Wanneer u het bestand volgt, kunt u de inhoud ervan weer geven vóór of na een wijziging. U kunt de inhoud inline of naast elkaar weer geven. 
...
## <a name="support-for-file-integrity-monitoring-in-azure-security-center"></a>Ondersteuning voor de bewaking van bestands integriteit in Azure Security Center
