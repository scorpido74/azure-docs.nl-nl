...
U kunt ook een [InlineScript](automation-powershell-workflow.md#inlinescript) -activiteit gebruiken. `InlineScript`Hiermee kunt u code blokken op een andere computer met referenties uitvoeren.
