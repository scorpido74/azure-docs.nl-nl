...
Plan een update-implementatie met behulp van de instructies in [updates en patches voor uw virtuele machines beheren](update-mgmt-manage-updates-for-vm.md).
