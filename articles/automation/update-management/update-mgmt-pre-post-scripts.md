...
![Scripts selecteren](./media/update-mgmt-pre-post-scripts/select-scripts.png)
...
![Geselecteerde items](./media/update-mgmt-pre-post-scripts/selected-items.png)
...
![Resultaten bijwerken](./media/update-mgmt-pre-post-scripts/update-results.png)
...
![Resultaten van implementatie-uitvoering](./media/update-mgmt-pre-post-scripts/deployment-run.png)
...
![Galerie lijst](./media/update-mgmt-pre-post-scripts/runbook-gallery.png)
...
* Zie [updates en patches voor uw virtuele machines beheren](update-mgmt-manage-updates-for-vm.md)voor meer informatie over update beheer.
