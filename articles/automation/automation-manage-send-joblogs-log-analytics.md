...
2. Voer de volgende Power shell-opdrachten uit en bewerk de waarden voor `[your resource ID]` en `[resource ID of the log analytics workspace]` met de waarden uit de voor gaande sectie.
