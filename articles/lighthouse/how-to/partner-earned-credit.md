...
1. Wanneer u [een klant onboardt met arm-sjablonen](onboard-customer.md), moet u een autorisatie opnemen die het PEC Automation-account omvat als een gebruiker met een [ingebouwde Azure-rol die in aanmerking komt voor PEC](/partner-center/azure-roles-perms-pec).
...
Als u een klant al hebt voor bereid, wilt u mogelijk geen andere implementatie uitvoeren om uw PEC Automation-account Service-Principal toe te voegen. In plaats daarvan kunt u de **gekoppelde MPN-id** koppelen aan een gebruikers account dat al toegang heeft tot het werk in de Tenant van die klant. Zorg ervoor dat aan het account een [ingebouwde Azure-rol is toegewezen die in aanmerking komt voor PEC](/partner-center/azure-roles-perms-pec).
