...
- **Beheer op schaal**: klant betrokkenheid en levenscyclus bewerkingen om klanten resources te beheren zijn eenvoudiger en schaalbaar. Bestaande Api's, beheer hulpprogramma's en werk stromen kunnen worden gebruikt met gedelegeerde klant resources.
...
- **Aanbiedingen voor beheerde services in azure Marketplace**: bied uw services aan klanten aan via privé-of open bare aanbiedingen en laat deze automatisch door sturen naar Azure delegated resource management, als alternatief voor onboarding met behulp van Azure Resource Manager sjablonen. Zie [managed service aanbiedingen in azure Marketplace](concepts/managed-services-offers.md)voor meer informatie.
