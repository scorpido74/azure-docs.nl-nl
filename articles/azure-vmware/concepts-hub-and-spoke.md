...
Bekijk het specifieke artikel over de Azure VMware-oplossing op [Application Gateway](./protect-azure-vmware-solution-with-application-gateway.md) voor de details en vereisten.
