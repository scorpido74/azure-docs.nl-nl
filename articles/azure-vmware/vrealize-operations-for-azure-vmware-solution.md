...
- De **cloudadmin@vsphere.local** gebruiker in de Azure VMware-oplossing heeft [beperkte bevoegdheden](concepts-role-based-access-control.md). In-gast geheugen verzameling met behulp van VMware-hulpprogram ma's wordt niet ondersteund voor virtuele machines (Vm's) op de Azure VMware-oplossing. Actieve en verbruikte geheugen gebruik blijft in dit geval werken.
