...
description: Koppelingen naar de documentatie voor systeem weergaven die worden ondersteund in SQL Analytics.
...
ms.locfileid: "78198300"
---
# <a name="system-views-supported-in-sql-analytics"></a>Systeem weergaven die worden ondersteund in SQL Analytics
Koppelingen naar de documentatie voor T-SQL-instructies die worden ondersteund in SQL Analytics.

## <a name="sql-analytics-catalog-views"></a>Catalogus weergaven van SQL Analytics
...
* [sys. pdw_materialized_view_column_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-column-distribution-properties-transact-sql?view=azure-sqldw-latest) (preview-versie)
* [sys. pdw_materialized_view_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-distribution-properties-transact-sql?view=azure-sqldw-latest) (preview-versie)
* [sys. pdw_materialized_view_mappings](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-mappings-transact-sql?view=azure-sqldw-latest) (preview-versie)
...
* [sys. dm_workload_management_workload_groups_stats](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-workload-management-workload-group-stats-transact-sql) (preview-versie)

## <a name="sql-server-dmvs-applicable-to-sql-analytics"></a>SQL Server Dmv's die van toepassing zijn op SQL Analytics
De volgende Dmv's zijn van toepassing op SQL Analytics, maar moeten worden uitgevoerd door verbinding te maken met de **hoofd** database.
...
## <a name="sql-server-dmvs-available-in-sql-analytics"></a>SQL Server Dmv's beschikbaar in SQL Analytics
SQL Analytics maakt veel van de SQL Server dynamische beheer weergaven (Dmv's) beschikbaar. Deze weer gaven, wanneer u een query uitvoert in SQL Analytics, rapporteren de status van SQL-data bases die worden uitgevoerd op de distributies.

SQL Analytics en parallel data warehouse (PDW) gebruiken dezelfde systeem weergaven. Elke DMV heeft een kolom met de naam pdw_node_id, de id voor het reken knooppunt. 
...
| DMV-naam in SQL Analytics | Artikel SQL Server Transact-SQL|
|:--- |:--- |
...
| sys.dm_pdw_nodes_os_dispatchers |Er is geen Transact-SQL-documentatie beschikbaar. |
...
| sys. dm_pdw_nodes_os_memory_node_access_stats |Er is geen Transact-SQL-documentatie beschikbaar. |
...
| sys.dm_pdw_nodes_os_spinlock_stats |Er is geen Transact-SQL-documentatie beschikbaar. |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-analytics"></a>SQL Server 2016 poly base Dmv's beschikbaar in SQL Analytics
De volgende Dmv's zijn van toepassing op SQL Analytics, maar moeten worden uitgevoerd door verbinding te maken met de **hoofd** database.
...
## <a name="sql-server-information_schema-views"></a>INFORMATION_SCHEMA weergaven SQL Server
...
Zie [t-SQL-instructies in SQL Analytics](sql-data-warehouse-reference-tsql-statements.md)en [t-SQL-taal elementen in SQL Analytics](sql-data-warehouse-reference-tsql-language-elements.md)voor meer informatie.
