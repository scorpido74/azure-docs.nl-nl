---
title: Geheugen-en gelijktijdigheids limieten in Azure SQL Data Warehouse | Microsoft Docs
...
Bekijk de geheugen-en gelijktijdigheids limieten die zijn toegewezen aan de verschillende prestatie niveaus en resource klassen in Azure SQL Data Warehouse. Zie [resource klassen voor workload Management](resource-classes-for-workload-management.md)voor meer informatie en om deze mogelijkheden toe te passen op uw workload Management-abonnement. 
...
## <a name="concurrency-maximums"></a>Gelijktijdige maximum waarden
