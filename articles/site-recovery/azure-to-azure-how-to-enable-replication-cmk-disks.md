...
![Scherm afbeelding die laat zien waar de status van de virtuele machines moet worden gecontroleerd.](./media/azure-to-azure-how-to-enable-replication-cmk-disks/cmk-customize-target-disk-properties.png)
