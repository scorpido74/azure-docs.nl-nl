...
- Site Recovery IP-adressen van service-eind punten: beschikbaar in een [XML-bestand](https://aka.ms/site-recovery-public-ips) en zijn afhankelijk van de doel locatie. Het is raadzaam om toegang tot de tag **' AzureSiteRecovery '** toe te staan voor toegang tot site Recovery-service.
...
> [!NOTE]
> Het is raadzaam om de **AzureSiteRecovery-tag** te gebruiken in plaats van IP-adressen om toegang tot **site Recovery-service**toe te staan.
