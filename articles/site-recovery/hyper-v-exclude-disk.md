...
1. Als u schijven wilt uitsluiten wanneer u [replicatie inschakelt](site-recovery-hyper-v-site-to-azure.md) voor een Hyper-V-VM, moet u na het selecteren van de virtuele machines die u wilt repliceren, op de **pagina eigenschappen van** > **replicatie inschakelen** > **eigenschappen configureren** de kolom **te repliceren schijven** controleren. Standaard zijn alle schijven geselecteerd voor replicatie.
