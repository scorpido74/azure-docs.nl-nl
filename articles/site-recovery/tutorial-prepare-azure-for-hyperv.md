...
1. Selecteer in het menu [Azure Portal](https://portal.azure.com) **een resource** > **Storage** > **-opslag account maken-blob, bestand, tabel, wachtrij**.
...
4. Om snel toegang te krijgen tot de kluis vanuit het dash board, selecteert u**vastmaken** **aan dash board** > aanmaken.
