...
3. Selecteer **computer afsluiten voordat de failover wordt gestart** om te proberen de bron-vm's af te sluiten voordat de failover wordt geactiveerd. Failover wordt voortgezet, zelfs als het afsluiten mislukt. U kunt de voortgang van de failover op de pagina **taken** volgen.
