...
Een goede oplossing voor herstel na nood gevallen, moet het mogelijk maken dat herstel plannen worden gemodelleerd rond de bovenstaande complexe toepassings architecturen en ook de mogelijkheid heeft om aangepaste stappen toe te voegen voor het afhandelen van toepassings toewijzingen tussen verschillende lagen, zodat u een enkele klik kunt opgeven Zorg ervoor dat de oplossing in het geval van een nood situatie tot een lagere RTO.
...
Wijzig de naam zodat deze voldoet aan de vereisten van Azure als dat nodig is. U kunt ook informatie weer geven en toevoegen over het doelnet werken, het subnet en het IP-adres dat wordt toegewezen aan de Azure VM.
...
![Herstel plan](./media/site-recovery-citrix-xenapp-and-xendesktop/citrix-tfo.png)
