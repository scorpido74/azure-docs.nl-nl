...
manager: gwallace
keywords: Azure functions, functies, gebeurtenis verwerking, webhooks, dynamische compute, serverloze architectuur, testen
...
![Azure Functions testen met C# Visual Studio](./media/functions-test-a-function/azure-functions-test-visual-studio-xunit.png)
...
- **Timer_should_log_message**: met deze test wordt een exemplaar van `ListLogger` gemaakt en door gegeven aan een timer-functie. Zodra de functie is uitgevoerd, wordt het logboek gecontroleerd om te controleren of het verwachte bericht aanwezig is.
