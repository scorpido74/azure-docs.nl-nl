...
> [!NOTE]
> Als Gradle is niet uw voorkeur ontwikkeling tool, check out onze soortgelijke tutorials voor Java-ontwikkelaars met behulp van [Maven,](/azure/azure-functions/functions-create-first-azure-function-azure-cli?pivots=programming-language-java) [IntelliJ IDEA](/azure/developer/java/toolkit-for-intellij/quickstart-functions) en [VS Code](/azure/azure-functions/functions-create-first-function-vs-code?pivots=programming-language-java).
