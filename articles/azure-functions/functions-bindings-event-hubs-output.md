---
title: Azure Event Hubs-uitvoer binding voor Azure Functions
description: Meer informatie over het schrijven van berichten naar Azure Event Hubs streams met behulp van Azure Functions.
...
- [Reageren op gebeurtenissen die worden verzonden naar een Event Hub gebeurtenis stroom (trigger)](./functions-bindings-storage-blob-trigger.md)
