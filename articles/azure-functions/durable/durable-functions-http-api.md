...
---
# <a name="http-api-reference"></a>HTTP API reference
...
| **`{content}`**    | Request content | Optioneel. The JSON-formatted orchestrator function input. |
...
## <a name="get-instance-status"></a>Get instance status
...
## <a name="get-all-instances-status"></a>Get all instances status
...
| Veld                  | Gegevenstype | Beschrijving |
|------------------------|-----------|-------------|
| **`instancesDeleted`** | geheel getal   | The number of instances deleted. For the single instance case, this value should always be `1`. |
...
| Veld                   | Gegevenstype | Beschrijving |
|-------------------------|-----------|-------------|
| **`instancesDeleted`**  | geheel getal   | The number of instances deleted. |
...
## <a name="terminate-instance"></a>Terminate instance
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Optioneel. The reason for terminating the orchestration instance. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Optioneel. The reason for rewinding the orchestration instance. |
...
| **`op`**          | Query string    | Optioneel. The name of the user-defined operation to invoke. |
| **`{content}`**   | Request content | The JSON-formatted event payload. |
