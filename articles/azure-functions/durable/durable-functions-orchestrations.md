...
ms.date: 09/08/2019
ms.author: azfuncdf
ms.openlocfilehash: fbe8763f4dc45da16e0e6d4d0b857a72b498d8f3
ms.sourcegitcommit: d6b68b907e5158b451239e4c09bb55eccb5fef89
ms.translationtype: MT
ms.contentlocale: nl-NL
ms.lasthandoff: 11/20/2019
ms.locfileid: "74231353"
---
# <a name="durable-orchestrations"></a>Durable Orchestrations
...
* Orchestrator functions are durable and reliable. Execution progress is automatically checkpointed when the function "awaits" or "yields". Er gaat nooit lokale status verloren wanneer het proces recyclet of de VM opnieuw wordt opgestart.
...
## <a name="orchestration-identity"></a>Orchestration identity
...
## <a name="features-and-patterns"></a>Features and patterns
...
### <a name="durable-timers"></a>Durable timers
...
### <a name="critical-sections-durable-functions-2x"></a>Critical sections (Durable Functions 2.x)
...
### <a name="calling-http-endpoints-durable-functions-2x"></a>Calling HTTP endpoints (Durable Functions 2.x)
...
### <a name="passing-multiple-parameters"></a>Passing multiple parameters
