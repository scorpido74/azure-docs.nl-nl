...
1. At the left, select **Metrics** > **Select a resource**, then use the settings below the image to choose your function app.
    ...
    |---------|---------|---------|
    | Abonnement    |  Uw abonnement  | The subscription with your function app.  |
    | Resourcegroep     | Your resource group  | The resource group that contains your function app.   |
    | Resourcetype     |  App-services | Function apps are shown as App Services instances in Monitor. |
    | Bron     |  Your function app  | The function app to monitor.        |
