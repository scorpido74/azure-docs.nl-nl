...
|---------|---------|----------------------|
|**type** |n.v.t.| Must be set to `notificationHub`. |
|**direction** |n.v.t.| Must be set to `out`. | 
|**name** |n.v.t.| Variable name used in function code for the notification hub message. |
