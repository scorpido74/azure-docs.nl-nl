...
> [!NOTE]
> In dit artikel is bedoeld voor Azure Functions 1.x.  Zie [host. json Reference voor Azure functions 2. x](functions-host-json.md)voor een verwijzing naar de host. json in functions 2. x en hoger.
