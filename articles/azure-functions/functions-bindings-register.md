...
| Ontwikkelomgeving |Registratie<br/> in Functions 1.x  |Registratie<br/> in Functions 2.x  |
|-------------------------|------------------------------------|------------------------------------|
|Azure Portal|Automatisch|Automatisch|
|Non-.NET languages or local Azure Core Tools development|Automatisch|[Use Azure Functions Core Tools and extension bundles](#extension-bundles)|
