...
> [!NOTE] 
> Standard Functions billing applies to proxy executions. Zie [Prijzen voor Azure Functions](https://azure.microsoft.com/pricing/details/functions/) voor meer informatie.
...
|Character|Escaped Character|Voorbeeld|
|-|-|-|
