...
Volg de stappen in [aan de slag met Azure cli](/cli/azure/get-started-with-az-cli2) en maak verbinding met uw abonnement met behulp van de `az login` opdracht.
