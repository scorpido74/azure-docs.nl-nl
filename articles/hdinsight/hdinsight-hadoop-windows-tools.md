...
Gebruik Data Lake-Hulpprogram Ma's voor Visual Studio om Storm-topologieën te implementeren en te beheren. Met Data Lake-Hulpprogram Ma's wordt ook de SCP.NET-SDK geïnstalleerd, C# waarmee u Storm-topologieën kunt ontwikkelen met Visual Studio.
...
* [Clusters maken en werken in HDInsight vanuit een .NET Framework-toepassing](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md).
* [Voer Apache Hive Query's uit met behulp van de .NET SDK](hadoop/apache-hadoop-use-hive-dotnet-sdk.md).
* [Door C# de gebruiker gedefinieerde functies gebruiken met Apache Hive en Apache Pig-streaming op Apache Hadoop](hadoop/apache-hadoop-hive-pig-udf-dotnet-csharp.md).
...
Als u een situatie tegen komt waarbij u een hulp programma of technologie gebruikt die alleen beschikbaar is in Linux, moet u rekening houden met de volgende opties:
