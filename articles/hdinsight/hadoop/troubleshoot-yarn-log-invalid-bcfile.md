...
Het Apache-garen logboek wordt geaggregeerd naar `IndexFile`-indeling. dit wordt niet ondersteund door de bestands-parser.

## <a name="resolution"></a>Resolutie

1. Ga in een webbrowser naar `https://CLUSTERNAME.azurehdinsight.net`, waarbij `CLUSTERNAME` de naam van uw cluster is.

1. Ga vanuit de Ambari-gebruikers interface naar **garens** van > - **configuratie** > **Geavanceerde** > **Geavanceerde garens-site**.
