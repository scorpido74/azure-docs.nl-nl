...
1. Gebruik het volgende om een tabel met de naam **log4jLogs**te maken:
   ...
   * `SELECT`: Hiermee selecteert u een telling van alle rijen waarin de kolom **T4** de waarde **[error]** bevat. Deze instructie retourneert de waarde **3** als er drie rijen met deze waarde zijn.
