...
Azure Analysis Services (AAS) is een engine voor analytische gegevens die wordt gebruikt in de beslissings ondersteuning en Business Analytics, waarbij de analytische gegevens voor zakelijke rapporten en client toepassingen, zoals Power BI, Excel, Reporting Services-rapporten en andere hulpprogram ma's voor gegevens visualisatie, worden geleverd.
