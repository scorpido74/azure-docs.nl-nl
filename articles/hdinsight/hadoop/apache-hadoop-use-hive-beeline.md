...
Wanneer u verbinding maakt met een cluster met de openbare of privéeindpunten, moet u de naam van het clusteraccount (standaard) `admin`en het wachtwoord opgeven. Bijvoorbeeld met Beeline van een clientsysteem `clustername.azurehdinsight.net` om verbinding te maken met het adres. Deze verbinding wordt `443`gemaakt via de poort en wordt versleuteld met SSL.
