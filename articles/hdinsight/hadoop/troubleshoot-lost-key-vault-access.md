...
Bekijk [Azure Key Vault Beschik baarheid en redundantie](../../key-vault/key-vault-disaster-recovery-guidance.md) en de pagina status van Azure voor meer informatie https://status.azure.com/
