...
Als beveiligde overdracht is ingeschakeld voor Azure Storage of Data Lake Storage Gen2, wordt de URI respectievelijk `wasbs://` of `abfss://`.  Zie ook [beveiligde overdracht](../../storage/common/storage-require-secure-transfer.md).
