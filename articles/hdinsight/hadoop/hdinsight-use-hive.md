...
* __Intern__: gegevens worden opgeslagen in het Hive-Data Warehouse. Het Data Warehouse bevindt zich op `/hive/warehouse/` in de standaard opslag voor het cluster.
...
* [Een door C# de gebruiker gedefinieerde functie gebruiken met Apache Hive](../hadoop/apache-hadoop-hive-pig-udf-dotnet-csharp.md)
