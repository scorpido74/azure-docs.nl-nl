...
Zorg ervoor dat de para meter `-EnableHttpsTrafficOnly` is ingesteld op `1`voor de Power shell-cmdlet [New-AzStorageAccount](https://docs.microsoft.com/powershell/module/az.storage/new-azstorageaccount).
...
Voor de Azure CLI-opdracht [AZ Storage account create](https://docs.microsoft.com/cli/azure/storage/account?view=azure-cli-latest#az-storage-account-create), controleert u of para meter `--https-only` is ingesteld op `true`.
