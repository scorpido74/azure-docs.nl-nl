...
Noteer de waarde voor `host_name` later gebruik.
...
3. Start [sqlline gebruiken](http://sqlline.sourceforge.net/). Bewerk de onderstaande opdracht door te `ZOOKEEPER` vervangen door het knoop punt ZooKeeper dat eerder is geïdentificeerd en voer vervolgens de volgende opdracht in:
...
5. Gebruik de opdracht `!tables` sqlline gebruiken om alle tabellen in HBase weer te geven. Voer de volgende opdracht in:
...
10. Gebruik de opdracht `!quit` sqlline gebruiken om sqlline gebruiken af te sluiten. Voer de volgende opdracht in:
