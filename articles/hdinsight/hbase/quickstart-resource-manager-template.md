---
title: 'Snelstart: Apache HBase-cluster maken met sjabloon - Azure HDInsight'
description: Met deze snelstart ziet u hoe u resourcebeheersjabloon gebruikt om een Apache HBase-cluster in Azure HDInsight te maken.
...
ms.locfileid: "79485774"
---
# <a name="quickstart-create-apache-hbase-cluster-in-azure-hdinsight-using-resource-manager-template"></a>Snelstart: Apache HBase-cluster maken in Azure HDInsight met behulp van resourcebeheersjabloon

In deze snelstart gebruikt u een Azure Resource Manager-sjabloon om een [Apache HBase-cluster](./apache-hbase-overview.md) in Azure HDInsight te maken. HBase is een open-source, NoSQL-database die is gebouwd op Apache Hadoop en gemodelleerd naar [Google BigTable.](https://cloud.google.com/bigtable/)
...
De sjabloon die in deze quickstart wordt gebruikt, is afkomstig van [Azure Quickstart-sjablonen.](https://github.com/Azure/azure-quickstart-templates/tree/master/101-hdinsight-hbase-linux)
...
1. Selecteer de knop **Implementeren naar Azure** hieronder om u aan te melden bij Azure en open de sjabloon Resourcebeheer.
    ...
    [![Implementeren naar Azure](./media/quickstart-resource-manager-template/deploy-to-azure.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-hdinsight-hbase-linux%2Fazuredeploy.json)
...
In deze quickstart hebt u geleerd hoe u een Apache HBase-cluster in HDInsight maken met behulp van een Resource Manager-sjabloon. In het volgende artikel leert u hoe u HBase in HDInsight bevragen met HBase Shell.
