...
| Schaalbaarheid | Met HDInsight kunt u het aantal cluster knooppunten dynamisch wijzigen met de functie voor automatisch schalen. Zie [automatisch Azure HDInsight-clusters schalen](../hdinsight-autoscale-clusters.md). Bovendien kunnen Spark-clusters zonder gegevensverlies worden verwijderd, omdat alle gegevens zijn opgeslagen in Azure Storage of Data Lake Storage. |
