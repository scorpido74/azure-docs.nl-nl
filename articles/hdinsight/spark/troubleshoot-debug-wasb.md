...
1. Ga in een webbrowser naar `https://CLUSTERNAME.azurehdinsight.net`, waarbij `CLUSTERNAME` de naam van uw Spark-cluster is.

1. Navigeer naar **Spark2** > **configs** > **Advanced Spark2-log4j-Properties**.
...
1. Voeg de volgende eigenschap toe:
