...
3. Klik op het tabblad **fasen** om de fasen te zien die zijn gekoppeld aan de toepassing.
    ...
    ![Details van Spark-fasen weer geven](./media/apache-spark-job-debugging/view-spark-stages-details.png "Details van Spark-fasen weer geven") 
...
6. Andere tabbladen in de Spark-gebruikers interface geven ook nuttige informatie over de Spark-instantie.
   ...
   * Tabblad omgeving: dit tabblad biedt veel nuttige informatie over uw Spark-exemplaar, zoals de 
     * Scala-versie
...
1. Als u de Spark-geschiedenis server wilt starten, klikt u op de Blade overzicht op **Spark-geschiedenis server** onder **cluster dashboards**.
    ...
    ![Spark geschiedenis server1 starten](./media/apache-spark-job-debugging/launch-spark-history-server.png "Spark geschiedenis server1 starten")
...
2. U ziet alle voltooide toepassingen die worden weer gegeven. Klik op een toepassings-ID om in te zoomen op een toepassing voor meer informatie.
    ...
    ![Spark-geschiedenis server2 starten](./media/apache-spark-job-debugging/view-completed-applications.png "Spark-geschiedenis server2 starten")
