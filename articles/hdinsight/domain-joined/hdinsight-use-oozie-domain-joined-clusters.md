...
1. Gebruik de opdracht `klist` om de geslaagde Kerberos-verificatie te controleren. Als dat niet het geval is, gebruikt u `kinit` om Kerberos-verificatie te starten.
