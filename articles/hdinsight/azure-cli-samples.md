...
description: Azure CLI-voorbeelden voor veelvoorkomende taken in Azure HDInsight.
...
In dit artikel vindt u voorbeeldscripts voor veelvoorkomende taken. Werk voor elk voorbeeld de variabelen bij met de juiste waarden en voer de opdracht uit.

## <a name="prerequisites"></a>Vereisten

* Azure CLI. Zie [De Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli) installeren voor stappen.

* Optioneel: Bash. De voorbeelden in dit artikel gebruiken de Bash-shell op Windows 10. Zie [Windows Subsystem for Linux Installation Guide voor Windows 10](https://docs.microsoft.com/windows/wsl/install-win10) voor installatiestappen.  De voorbeelden werken vanuit een Windows Command-prompt met enkele kleine wijzigingen.

## <a name="az-login"></a>az login

[Log in bij Azure](https://docs.microsoft.com/cli/azure/reference-index?view=azure-cli-latest#az-login).
...
## <a name="az-hdinsight-create"></a>az hdinsight creëren
...
### <a name="create-a-cluster-with-the-enterprise-security-package-esp"></a>Een cluster maken met het Enterprise Security Package (ESP)
...
### <a name="create-a-cluster-with-configuration-from-json-string"></a>Een cluster maken met configuratie op JSON-tekenreeks
...
### <a name="create-a-cluster-with-configuration-from-a-local-file"></a>Een cluster maken met configuratie op basis van een lokaal bestand
...
## <a name="az-hdinsight-application-create"></a>az hdinsight applicatie te creëren
...
### <a name="create-an-application-with-a-script-uri-and-specified-edge-node-size"></a>Een toepassing maken met een script-URI en opgegeven randknooppuntgrootte
...
### <a name="create-an-application-with-https-endpoint"></a>Een toepassing maken met HTTPS-eindpunt
...
## <a name="az-hdinsight-script-action-execute"></a>az hdinsight script-actie uit te voeren
...
### <a name="execute-a-script-action-and-persist-on-success"></a>Een scriptactie uitvoeren en doorgaan met succes
