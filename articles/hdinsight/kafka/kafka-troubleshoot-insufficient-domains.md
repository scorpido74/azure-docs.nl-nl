...
---
# <a name="scenario-cluster-creation-failed-due-to-not-sufficient-fault-domains-in-region-in-azure-hdinsight"></a>Scenario: het `not sufficient fault domains in region` maken van het cluster is mislukt vanwege in azure HDInsight
