...
3. Geef het nieuwe bestand een naam met behulp van de `.hql` (Hive- `.py` query's) of de bestands extensie (Spark-script). In dit voor beeld wordt **HelloWorld. HQL**gebruikt.
