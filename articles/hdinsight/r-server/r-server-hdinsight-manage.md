...
3. Geef voor de **actie script verzenden**de volgende informatie op:
   ...
   * Geef bij **naam**een naam op voor de script actie.
     ...
     * Voer **Bash script URI** `https://mrsactionscripts.blob.core.windows.net/rpackages-v01/InstallRPackages.sh`voor bash-script-URI in. Dit is het script waarmee extra R-pakketten worden geïnstalleerd op het worker-knoop punt
