...
Alle map-en bestands verwijzingen verwijzen nu naar het opslag account `wasbs://container2@storage2.blob.core.windows.net`. Dit is het **naam knooppunt** dat u hebt opgegeven.
