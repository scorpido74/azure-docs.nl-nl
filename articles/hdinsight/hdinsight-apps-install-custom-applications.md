...
Vervang `CLUSTERNAME`en `RESOURCEGROUP` met de relevante waarden en voer de volgende opdrachten in:
...
Vervang `NAME`, `CLUSTERNAME`en `RESOURCEGROUP` met de relevante waarden en voer de volgende opdracht in:
