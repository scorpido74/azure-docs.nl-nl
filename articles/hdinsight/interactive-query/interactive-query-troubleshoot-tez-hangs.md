...
Standaard `yarn.scheduler.capacity.maximum-applications` bepaalt het maximum aantal toepassingen dat actief of in behandeling is en de standaard instelling is `10000`.
