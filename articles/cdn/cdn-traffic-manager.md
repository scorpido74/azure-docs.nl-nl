...
description: Meer informatie over het instellen van failover in meerdere Azure Content Delivery Network-eind punten met behulp van Azure Traffic Manager.
services: cdn
documentationcenter: ''
author: asudbring
manager: danielgi
