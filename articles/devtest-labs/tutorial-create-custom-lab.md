...
description: In deze zelfstudie maakt u een lab in Azure DevTest Labs met behulp van Azure Portal. Een labbeheerder stelt een lab in, maakt virtuele machines in het lab en configureert beleidsregels.
