...
### <a name="enable-system-assigned-managed-identity-during-creation-of-a-vm"></a>Door het systeem toegewezen beheerde identiteit inschakelen tijdens het maken van een virtuele machine
...
### <a name="enable-system-assigned-managed-identity-on-an-existing-vm"></a>Door het systeem toegewezen beheerde identiteit inschakelen op een bestaande virtuele machine
