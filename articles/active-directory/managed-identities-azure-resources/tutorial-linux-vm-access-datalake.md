...
This tutorial shows you how to use a system-assigned managed identity for a Linux virtual machine (VM) to access Azure Data Lake Store. In deze zelfstudie leert u procedures om het volgende te doen: 
