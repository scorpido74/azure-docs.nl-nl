...
- Als u de CLI-script voorbeelden wilt uitvoeren, hebt u drie opties:
    ...
    - [Installeer de nieuwste versie van de Azure cli](/cli/azure/install-azure-cli) als u liever een lokale cli-console gebruikt en zich aanmeldt bij Azure met `az login`
