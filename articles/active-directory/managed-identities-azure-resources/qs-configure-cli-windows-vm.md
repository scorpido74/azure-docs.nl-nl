...
- Als u de CLI-scriptvoorbeelden wilt uitvoeren, hebt u drie opties:
    ...
    - [Installeer de nieuwste versie van de Azure CLI](/cli/azure/install-azure-cli) als u liever een lokale CLI-console gebruikt. 
