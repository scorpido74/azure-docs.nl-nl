...
1. Blader naar **Microsoft intune** > **Device enrollment** > **registratie van Windows** > **Hello voor bedrijven** > **Properties**-inschrijving voor het apparaat.
...
Voor deze groepsbeleid instelling is een bijgewerkte versie van `credentialprovider.admx` de Groepsbeleid sjabloon vereist. Deze nieuwe sjabloon is beschikbaar in de volgende versie van Windows Server en met Windows 10 20H1. Deze instelling kan worden beheerd met een apparaat waarop een van deze nieuwere versies van Windows of een andere versie wordt uitgevoerd door de richt lijnen in het ondersteunings onderwerp te volgen, [het centrale archief voor Groepsbeleid-Beheersjablonen in Windows te maken en te beheren](https://support.microsoft.com/help/3087759/how-to-create-and-manage-the-central-store-for-group-policy-administra).
