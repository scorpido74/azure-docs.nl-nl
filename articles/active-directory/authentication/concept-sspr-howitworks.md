...
| Number of methods required to reset | One | Twee |
| :---: | :---: | :---: |
| Mobile app features available | Coderen | Code or Notification |
...
| Number of methods registered | Number of methods required | Resultaat |
| :---: | :---: | :---: |
