...
---
# <a name="troubleshoot-self-service-password-reset"></a>Troubleshoot self-service password reset
...
## <a name="troubleshoot-self-service-password-reset-errors-that-a-user-might-see"></a>Troubleshoot self-service password reset errors that a user might see
...
## <a name="troubleshoot-the-password-reset-configuration-in-the-azure-portal"></a>Troubleshoot the password reset configuration in the Azure portal
...
## <a name="troubleshoot-password-reset-reporting"></a>Troubleshoot password reset reporting
...
### <a name="if-the-source-of-the-event-is-adsync"></a>If the source of the event is ADSync

| Coderen | Name or message | Beschrijving |
| --- | --- | --- |
...
### <a name="if-the-source-of-the-event-is-passwordresetservice"></a>If the source of the event is PasswordResetService
...
### <a name="confirm-network-connectivity"></a>Confirm network connectivity
...
## <a name="verify-that-azure-ad-connect-has-the-required-permission-for-password-writeback"></a>Verify that Azure AD Connect has the required permission for password writeback
