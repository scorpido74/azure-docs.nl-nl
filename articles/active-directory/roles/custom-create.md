...
- Zie voor standaard gebruikers machtigingen een [vergelijking van de standaard machtigingen voor gast-en gebruikers rechten](/azure/active-directory/fundamentals/users-default-permissions).
