...
Zie aan de [slag](admin-units-manage.md#get-started)voor de stappen voor het voorbereiden van het gebruik van Power shell en Microsoft Graph voor beheer van beheer eenheden.
...
1. Op de pagina **Azure AD >-groepen**
    ...
    ![een groep afzonderlijk toewijzen aan een beheer eenheid](./media/admin-units-add-manage-groups/assign-to-group-1.png)
...
1. Van de pagina **Azure AD >-beheer eenheden > alle groepen**
    ...
    ![Selecteer een administratieve eenheid en selecteer lid toevoegen](./media/admin-units-add-manage-groups/assign-to-admin-unit.png)
...
![Lijst groepen in een beheer eenheid](./media/admin-units-add-manage-groups/list-groups-in-admin-units.png)
...
![Beheer eenheden voor een groep weer geven](./media/admin-units-add-manage-groups/list-group-au.png)
...
- Verwijderen uit een groeps overzicht
  ...
  1. Open **Azure AD**-  >  **groepen** en open het profiel voor de groep die u wilt verwijderen uit een beheer eenheid.
  1. Selecteer **beheer eenheden** in het linkerdeel venster om een lijst weer te geven met alle administratieve eenheden waarvan de groep lid is. Selecteer de beheer eenheid waarvan u de groep wilt verwijderen en selecteer vervolgens **verwijderen uit beheer eenheid**.

    ![Een groep verwijderen uit een beheer eenheid](./media/admin-units-add-manage-groups/group-au-remove.png)

- Verwijderen uit een beheer eenheid

  1. Open **Azure AD**-  >  **beheer eenheden** en selecteer de beheer eenheid waarvan de groep lid is.
  1. Selecteer **groepen** in het linkerdeel venster om de leden groepen weer te geven.
  1. Selecteer de groep die u wilt verwijderen uit de beheer eenheid en selecteer vervolgens **groepen verwijderen**.
