...
Voor het verkrijgen van tokens voor specifieke bereiken van een v 1.0-toepassing (bijvoorbeeld de Microsoft Graph-API, https://graph.microsoft.com)het maken van scopes door een gewenste resource-id te koppelen aan een gewenste OAuth2-machtiging voor die bron.
