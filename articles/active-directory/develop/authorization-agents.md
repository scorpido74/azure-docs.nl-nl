...
Als de toepassing gebruikmaakt `WebView` van een strategie zonder Microsoft Authenticator of bedrijfsportal ondersteuning in de app te integreren, hebben gebruikers geen SSO-ervaring (eenmalige aanmelding) op het apparaat of tussen systeem eigen apps en web-apps.
