...
1. Nadat de gebruiker is geverifieerd, worden ze omgeleid naar *http://localhost:8080/msal4jsamples/secure/aad* . Ze zijn nu aangemeld en op de pagina wordt informatie over het aangemelde account weer gegeven. De voor beeld-UI heeft de volgende knoppen:
...
MSAL4J is de Java-bibliotheek die wordt gebruikt voor het aanmelden van gebruikers en het aanvragen van tokens die worden gebruikt voor toegang tot een API die wordt beveiligd door het micro soft Identity-platform.
...
Voeg een verwijzing naar MSAL4J toe door de volgende code toe te voegen aan de bovenkant van het bestand waarin u MSAL4J wilt gebruiken:
...
> [!div class="nextstepaction"]
> [Micro soft Identity platform-enquête](https://forms.office.com/Pages/ResponsePage.aspxid=v4j5cvGGr0GRqy180BHbRyKrNDMV_xBIiPGgSvnbQZdUQjFIUUFGUE1SMEVFTkdaVU5YT0EyOEtJVi4u)
