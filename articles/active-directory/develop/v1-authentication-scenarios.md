...
In de onderstaande tabel staat een korte beschrijving van elk type claim dat door Azure AD wordt uitgegeven. Zie het [toegangs tokens](access-tokens.md) en de [id-tokens](id-tokens.md) die zijn uitgegeven door Azure AD voor meer gedetailleerde informatie.
