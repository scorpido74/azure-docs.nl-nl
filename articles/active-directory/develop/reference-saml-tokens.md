...
* Zie de [beleids resource](/graph/api/resources/policy?view=graph-rest-beta)voor meer informatie over het beheren van het token levensduur beleid met behulp van de Microsoft Graph-API.
