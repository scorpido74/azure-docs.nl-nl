---
title: Naslag informatie voor het SAML 2,0-token claims | Azure
titleSuffix: Microsoft identity platform
description: Verwijzing naar claims met details over de claims die zijn opgenomen in SAML 2,0-tokens die zijn uitgegeven door het micro soft Identity platform, met inbegrip van de bijbehorende JWT-equivalenten.
author: kenwith
...
Het micro soft-identiteits platform verzendt verschillende typen beveiligings tokens in de verwerking van elke verificatie stroom. In dit document worden de indeling, de beveiligings kenmerken en de inhoud van SAML 2,0-tokens beschreven.
...
* Zie het [overzicht van Azure AD-beleids bronnen](/graph/api/resources/policy)voor meer informatie over het beheren van het token levensduur beleid met behulp van de Microsoft Graph-API.
