...
> [!TIP]
> Probeer het nu! Klik [https://login.microsoftonline.com/common/v2.0/.well-known/openid-configuration](https://login.microsoftonline.com/common/v2.0/.well-known/openid-configuration) om de configuratie van de tenants weer te geven `common` .
...
> [!TIP]
> Klik op de volgende koppeling om deze aanvraag uit te voeren. Nadat u zich hebt aangemeld, wordt uw browser omgeleid naar `https://localhost/myapp/` met een ID-token en een code in de adres balk. Houd er rekening mee dat deze aanvraag `response_mode=fragment` alleen voor demonstratie doeleinden wordt gebruikt. We raden u aan om te gebruiken `response_mode=form_post` .
> <a href="https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=6731de76-14a6-49ae-97bc-6eba6914391e&response_type=id_token%20code&redirect_uri=http%3A%2F%2Flocalhost%2Fmyapp%2F&response_mode=fragment&scope=openid%20offline_access%20https%3A%2F%2Fgraph.microsoft.com%2Fuser.read&state=12345&nonce=678910" target="_blank">https://login.microsoftonline.com/common/oauth2/v2.0/authorize...</a>

Door de machtigings bereiken in de aanvraag in te nemen en met behulp van `response_type=id_token code` het micro soft Identity platform-eind punt, zorgt u ervoor dat de gebruiker heeft ingestemd met de machtigingen die zijn aangegeven in de `scope` query parameter. Er wordt een autorisatie code voor de app naar Exchange geretourneerd voor een toegangs token.
