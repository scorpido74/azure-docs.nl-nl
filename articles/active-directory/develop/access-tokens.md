...
> [!NOTE]
> Het eind punt v 1.0 retourneert zowel de als `x5t` `kid` -claims, terwijl het v 2.0-eind punt alleen reageert met de `kid` claim. We raden u aan `kid` om de claim te gebruiken om uw token te valideren.
