...
1. Schakel **https://login.microsoftonline.com/common/oauth2/nativeclient**in de sectie **omleidings-uri's** | **voorgestelde omleidings-uri's voor open bare clients (Mobile, Desktop)** in.
1. Selecteer **Opslaan**.
