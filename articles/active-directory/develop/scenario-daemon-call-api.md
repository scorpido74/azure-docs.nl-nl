...
> [Daemon-app-verplaatsen naar productie](./scenario-daemon-production.md?tabs=dotnet)

# <a name="python"></a>[Python](#tab/python)

> [!div class="nextstepaction"]
> [Daemon-app-verplaatsen naar productie](./scenario-daemon-production.md?tabs=python)

# <a name="java"></a>[Java](#tab/java)

> [!div class="nextstepaction"]
> [Daemon-app-verplaatsen naar productie](./scenario-daemon-production.md?tabs=java)
