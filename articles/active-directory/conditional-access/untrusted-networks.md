---
title: Multi-factor Authentication (MFA) vereisen voor toegang vanaf niet-vertrouwde netwerken met Azure Active Directory (Azure AD) voorwaardelijke toegang | Microsoft Docs
