...
**Gebruikers risico negeren** in identiteits beveiliging wordt de actor in de risico geschiedenis van de gebruiker in identiteits beveiliging ingesteld op **\<naam van de beheerder met een Hyper link die verwijst naar de Blade van de gebruiker\>** .
...
- Wanneer deze feedback wordt ontvangen, verplaatsen we de risico status van de aanmelding (niet de gebruiker) om de **veiligheid te bevestigen** en het risico niveau te **-** .
