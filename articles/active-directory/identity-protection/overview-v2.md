...
Azure AD Identity Protection detecteert de volgende risico detecties: 

| Type risico detectie | Description | Detectietype |
| --- | --- | --- |
...
| Gelekte referenties | Met deze risico detectie wordt aangegeven dat de geldige referenties van de gebruiker zijn gelekt | Offline |
...
- Alle risico detecties die niet zijn gekoppeld aan een aanmelding
...
Om inzicht te krijgen in hoe identiteits beveiliging het risico detecteert, zijn er twee belang rijke concepten: gebruikers risico en aanmeldings risico. Aanmeldings risico weerspiegelt de waarschijnlijkheid dat een bepaalde verificatie aanvraag niet is geautoriseerd door de eigenaar van de identiteit. Er zijn twee soorten aanmeldings Risico's: realtime en totaal. Realtime aanmeldings risico wordt gedetecteerd op het moment van de aanmeldings poging (zoals aanmeldingen vanuit anonieme IP-adressen). Het totale aanmeldings risico is het samen voegen van gedetecteerde real-time Risico's voor aanmelding en eventuele daaropvolgende niet-real-time risico detecties die zijn gekoppeld aan de aanmeldingen van de gebruiker (zoals niet mogelijk reis). Gebruikers risico weerspiegelt de algehele kans dat een ongeldige actor een bepaalde identiteit heeft aangetast. Gebruikers risico bevat alle risico activiteiten voor een bepaalde gebruiker, waaronder:
...
1. Een werk nemer probeert zich vanaf de Tor-browser aan te melden bij Exchange Online. Op het moment van aanmelden detecteert Azure AD real-time risico detecties. 
...
5. De mislukte MFA-prompt heeft een gegenereerde risico detectie geactiveerd, waardoor de gebruikers Risico's voor toekomstige aanmeldingen worden verhoogd. 
...
1. De werk nemer probeert zich vanuit Outlook aan te melden bij Exchange Online. Op het moment van aanmelden detecteert Azure AD realtime-risico detecties en eventuele voor gaande gebruikers Risico's. 
