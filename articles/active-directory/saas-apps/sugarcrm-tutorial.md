...
1. Klik in de sectie **beheer** op **wachtwoord beheer**.
    ...
    ![Dienen](./media/sugarcrm-tutorial/ic795889.png "Beheer")

1. Selecteer **SAML-verificatie inschakelen**.

    ![Dienen](./media/sugarcrm-tutorial/ic795890.png "Beheer")
...
1. Klik in de sectie **beheer** op **gebruikers beheer**.
    ...
    ![Dienen](./media/sugarcrm-tutorial/ic795893.png "Beheer")

1. Ga naar **gebruikers \> nieuwe gebruiker te maken**.
