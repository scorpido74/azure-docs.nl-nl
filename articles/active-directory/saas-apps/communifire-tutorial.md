---
title: 'Zelf studie: integratie Azure Active Directory met Communifire | Microsoft Docs'
...
ms.locfileid: "73159405"
---
# <a name="tutorial-azure-active-directory-integration-with-communifire"></a>Zelf studie: integratie Azure Active Directory met Communifire
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit als u de toepassing in de door **IDP** geïnitieerde modus wilt configureren:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met het volgende patroon: `https://<subdomain>.communifire.com/SAML/AssertionConsumerService.aspx`
