---
title: 'Zelf studie: Azure Active Directory de integratie van eenmalige aanmelding (SSO) met Vocoli | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-vocoli"></a>Zelf studie: Azure Active Directory de integratie van eenmalige aanmelding (SSO) met Vocoli
...
Als u eenmalige aanmelding wilt configureren op **Vocoli** , moet u het gedownloade **certificaat (base64)** en de juiste gekopieerde url's verzenden van Azure Portal naar [Vocoli ondersteunings team](mailto:inbox@vocoli.com). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.

### <a name="create-vocoli-test-user"></a>Vocoli-test gebruiker maken

In deze sectie maakt u een gebruiker met de naam B. Simon in Vocoli. Werk samen met [Vocoli-ondersteunings team](mailto:inbox@vocoli.com) om de gebruikers toe te voegen in het Vocoli-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
