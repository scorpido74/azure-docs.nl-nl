---
title: 'Zelf studie: integratie Azure Active Directory met Skyward Qmlativ | Microsoft Docs'
...
ms.locfileid: "73161099"
---
# <a name="tutorial-azure-active-directory-integration-with-skyward-qmlativ"></a>Zelf studie: integratie Azure Active Directory met Skyward Qmlativ
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    b. In het tekstvak **Id (Entiteits-id)** typt u een URL met het volgende patroon: `https://<BASEURL>/customeridentifierSTS`
