...
Wanneer u op de tegel SpectrumU in het toegangsvenster klikt, zou u automatisch moeten worden aangemeld bij de instantie van SpectrumU waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [SpectrumU beveiligen met geavanceerde zichtbaarheid en besturingselementen](/cloud-app-security/proxy-intro-aad)