---
title: 'Zelf studie: integratie Azure Active Directory met Bridge | Microsoft Docs'
...
ms.locfileid: "73158715"
---
# <a name="tutorial-azure-active-directory-integration-with-bridge"></a>Zelf studie: integratie met Bridge Azure Active Directory
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    b. In het tekstvak **Id (Entiteits-id)** typt u een URL met het volgende patroon: `https://<company name>.bridgeapp.com`
