---
title: 'Zelf studie: integratie Azure Active Directory met GTNexus SSO-systeem | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-integration-with-gtnexus-sso-system"></a>Zelf studie: integratie Azure Active Directory met GTNexus SSO-systeem
...
In deze sectie gaat u een gebruiker maken met de naam Britta Simon in GTNexus SSO System. Werk met het [ondersteunings team](mailto:support@gtnexus.com) van het GTNexus SSO-systeem om de gebruikers toe te voegen in het GTNexus SSO-systeem platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
