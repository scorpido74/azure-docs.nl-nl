...
1. Als u de toepassing in de gestarte modus **IDP** wilt configureren, voert u de volgende stap uit in de sectie **basis configuratie van SAML** :
    ...
    d. Typ in het tekstvak **URL voor aanmelding** een URL met het volgende patroon:`https://<your company instance of SAP NetWeaver>`
...
11. Ga naar het tabblad**identiteits Federatie** van de **vertrouwde provider** > (aan de onderkant van het scherm). Klik op **Bewerken**.
...
3. tcod: SU01/Create User CLIENT1 as `System type` en Assign password, sla het op als de referentie moet worden opgegeven voor de API-programmeur, die de gebruiker moet branden met de gebruikers naam voor de aanroepende code. Er mag geen profiel of rol worden toegewezen.
