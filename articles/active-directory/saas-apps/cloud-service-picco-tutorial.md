...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    a. Typ in het tekstvak **URL voor aanmelding** een URL met het volgende patroon:`https://<SUB DOMAIN>.cloudservicepicco.com/app`

    b. In het tekstvak **Id** typt u een URL met het volgende patroon: `<SUB DOMAIN>.cloudservicepicco.com`

    c. In het tekstvak **Antwoord-URL** typt u een URL met de volgende notatie: `https://<SUB DOMAIN>.cloudservicepicco.com/app`
