---
title: 'Zelf studie: integratie Azure Active Directory met Cloud service PICCO | Microsoft Docs'
...
ms.locfileid: "73157374"
---
# <a name="tutorial-azure-active-directory-integration-with-cloud-service-picco"></a>Zelf studie: integratie Azure Active Directory met Cloud service PICCO
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    > [!NOTE]
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke aanmeldings-URL, id en antwoord-URL. Neem contact op met het [ondersteuningsteam van Cloud Service PICCO](mailto:picco.support@est.fujitsu.com) om deze waarden te verkrijgen. U kunt ook verwijzen naar het patroon dat wordt weergegeven in de sectie **Standaard SAML-configuratie** in de Azure-portal.
