...
4. In het gedeelte **Standaard SAML-configuratie** voert u de volgende stappen uit als u de toepassing in de door **IDP** geïnitieerde modus wilt configureren:
    ...
    ![Informatie over eenmalige aanmelding bij Zoho One-domeinen en -URL's](common/idp-relay.png)
...
5. Als u de toepassing wilt configureren in door **SP** geïnitieerde modus, voert u de volgende stap uit:
    ...
    ![Informatie over eenmalige aanmelding bij Zoho One-domeinen en -URL's](common/both-signonurl.png)
