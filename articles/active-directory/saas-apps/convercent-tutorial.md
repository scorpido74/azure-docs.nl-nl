---
title: 'Zelf studie: integratie Azure Active Directory met Convercent | Microsoft Docs'
...
ms.locfileid: "73159326"
---
# <a name="tutorial-azure-active-directory-integration-with-convercent"></a>Zelf studie: integratie Azure Active Directory met Convercent
...
5. Klik op **Extra URL's instellen** en voer de volgende stappen uit als u de toepassing in de met **SP** geïnitieerde modus wilt configureren:
    ...
    a. Typ in het tekstvak **URL voor aanmelding** een URL met het volgende patroon:`https://<instancename>.convercent.com/`
