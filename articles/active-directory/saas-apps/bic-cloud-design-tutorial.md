...
Wanneer u in het toegangsvenster op de tegel BIC Cloud Design klikt, wordt u automatisch aangemeld bij de instantie van BIC Cloud Design waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
