...
**Als u SumTotalCentral wilt toevoegen vanuit de galerie, voert u de volgende stappen uit:**
...
4. Typ in het zoekvak **SumTotalCentral**, selecteer **SumTotalCentral** in het resultaatvenster en klik vervolgens op de knop **Toevoegen** om de toepassing toe te voegen.

     ![SumTotalCentral in de resultatenlijst](common/search-new-app.png)
...
2. **[Eenmalige aanmelding voor SumTotalCentral configureren](#configure-sumtotalcentral-single-sign-on)** : als u de instellingen voor eenmalige aanmelding aan de toepassingszijde wilt configureren.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)** : als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)** : als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[SumTotalCentral-testgebruiker maken](#create-sumtotalcentral-test-user)** : als u een equivalent van Britta Simon in SumTotalCentral wilt hebben dat gekoppeld is aan de Azure AD-weergave van de gebruiker.
...
Voor het configureren van eenmalige aanmelding via Azure AD bij SumTotalCentral moet u de volgende stappen uitvoeren:

1. Ga in de [Azure Portal](https://portal.azure.com/) naar de pagina voor integratie van de toepassing **SumTotalCentral** en selecteer **Eenmalige aanmelding**.
...
### <a name="configure-sumtotalcentral-single-sign-on"></a>Eenmalige aanmelding bij SumTotalCentral configureren
...
In dit gedeelte gaat u Britta Simon toestemming geven voor gebruik van eenmalige aanmelding via Azure door haar toegang te geven tot SumTotalCentral.

1. Selecteer **Bedrijfstoepassingen** in de Azure Portal, selecteer **Alle toepassingen** en selecteer vervolgens **SumTotalCentral**.

    ![De blade Bedrijfstoepassingen](common/enterprise-applications.png)

2. Selecteer **SumTotalCentral** in de lijst met toepassingen.

    ![De link naar SumTotalCentral in de lijst met toepassingen](common/all-applications.png)
