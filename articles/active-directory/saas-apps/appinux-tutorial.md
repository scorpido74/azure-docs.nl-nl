---
title: 'Zelf studie: integratie Azure Active Directory met Appinux | Microsoft Docs'
...
ms.locfileid: "73152837"
---
# <a name="tutorial-azure-active-directory-integration-with-appinux"></a>Zelf studie: integratie Azure Active Directory met Appinux

In deze zelfstudie leert u hoe u Appinux integreert met Azure Active Directory (Azure AD).
Het integreren van Appinux met Azure AD biedt de volgende voordelen:
...
Voor het configureren van Azure AD-integratie met Appinux hebt u de volgende items nodig:

* Een Azure AD-abonnement Als u geen Azure AD-omgeving hebt, kunt u [hier](https://azure.microsoft.com/pricing/free-trial/) de proefversie van één maand krijgen.
* Een abonnement op Appinux waarvoor eenmalige aanmelding is ingeschakeld
...
**Als u Appinux vanuit de galerie wilt toevoegen, voert u de volgende stappen uit:**
...
Voer de volgende stappen uit om eenmalige aanmelding in Azure AD te configureren voor Appinux:
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    ![Informatie over het Appinux-domein en de URL voor eenmalige aanmelding](common/sp-identifier.png)
...
In dit gedeelte gaat u Britta Simon toestemming geven voor gebruik van eenmalige aanmelding met Azure door haar toegang te geven tot Appinux.

1. Selecteer in de Azure-portal achtereenvolgens **Bedrijfstoepassingen**, **Alle toepassingen** en **Appinux**.

    ![De blade Bedrijfstoepassingen](common/enterprise-applications.png)

2. Selecteer in de lijst met toepassingen de optie **Appinux**.

    ![De koppeling voor Appinux in de lijst met toepassingen](common/all-applications.png)
...
> [!Note]
> Als u handmatig een gebruiker moet maken, neemt u contact op met het  [Appinux-ondersteuningsteam](https://support.appinux.com).
