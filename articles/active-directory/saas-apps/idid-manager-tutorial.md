---
title: 'Zelfstudie: Azure Active Directory-integratie met iDiD-beheer | Microsoft Documenten'
...
ms.locfileid: "73155214"
---
# <a name="tutorial-azure-active-directory-integration-with-idid-manager"></a>Zelfstudie: Azure Active Directory-integratie met iDiD-beheer
...
5. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:
    ...
    In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://idid2.fi/saml/login/<domain>`
