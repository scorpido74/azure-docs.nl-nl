---
title: 'Zelfstudie: Azure Active Directory-integratie met &frankly | Microsoft Docs'
...
Ga als volgt te werk om eenmalige aanmelding in &frankly in te schakelen:

1. Meld u aan bij &frankly. Ga naar **Account** > **Gebruikersbeheer**.
1. Wijzig het verificatiemechanisme van de standaardinstelling naar **Aanmelden voor bedrijven (SAML)** .
1. Upload het **XML-bestand met federatieve metagegevens** dat u in stap 6 in het vorige gedeelte hebt gedownload.
1. Selecteer **Opslaan**.
...
Wanneer u op de tegel &frankly in het toegangsvenster klikt, zou u automatisch moeten worden aangemeld bij de instantie van &frankly waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
