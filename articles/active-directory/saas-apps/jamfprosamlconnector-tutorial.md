...
Zie [Single sign-on with Azure Active Directory](../manage-apps/what-is-single-sign-on.md) (Eenmalige aanmelding met Azure Active Directory) voor meer informatie over de integratie van SaaS-apps met Azure AD.
...
Wanneer u de tegel Jamf Pro in het toegangsvenster selecteert, wordt u automatisch aangemeld bij het Jamf Pro-account waarvoor u eenmalige aanmelding hebt geconfigureerd. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
