...
1. Als u de toepassing in de gestarte modus **IDP** wilt configureren, voert u op de pagina **basis configuratie van SAML** de waarden voor het volgende veld in:
    ...
    Typ in het tekstvak **antwoord-URL** een URL met het volgende patroon:`https://<SERVER.DOMAIN.COM>/SAML/AssertionConsumerService.aspx`
...
1. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:
    ...
    > 
    > Neem contact op met het [ondersteunings team van MyWorkDrive](mailto:support@myworkdrive.com) als u niet zeker weet hoe u uw eigen HOSTNAAM en TLS/SSL-certificaat voor deze waarden kunt instellen.
