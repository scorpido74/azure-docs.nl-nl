---
title: 'Zelfstudie: Azure Active Directory-integratie met Compliance ELF | Microsoft Documenten'
...
ms.locfileid: "73159366"
---
# <a name="tutorial-azure-active-directory-integration-with-compliance-elf"></a>Zelfstudie: Azure Active Directory-integratie met Compliance ELF
...
5. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:
    ...
    In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://<subdomain>.complianceelf.com`
