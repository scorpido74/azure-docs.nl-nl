---
title: 'Zelf studie: Azure Active Directory-integratie met eenmalige aanmelding (SSO) met iServer Portal | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-iserver-portal"></a>Zelf studie: Azure Active Directory-integratie met eenmalige aanmelding (SSO) met de iServer-Portal
...
1. Als u de toepassing in de gestarte modus **IDP** wilt configureren, voert u in de sectie **basis configuratie van SAML** de waarden voor de volgende velden in:
    ...
    a. Typ in het tekstvak **id** een URL met het volgende patroon:`iserver-portal-<myiserverportal>`
...
1. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:
    ...
    In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://<myiserverportal.com>/SAML/login`
...
Als u eenmalige aanmelding wilt configureren op de **iServer-Portal** , moet u de **vingerafdruk waarde** en de juiste gekopieerde url's verzenden van Azure Portal naar [iServer Portal-ondersteunings team](mailto:support@orbussoftware.com). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.

### <a name="create-iserver-portal-test-user"></a>Test gebruiker voor iServer-portal maken

In deze sectie maakt u een gebruiker met de naam B. Simon in de iServer-Portal. Werk met [IServer Portal-ondersteunings team](mailto:support@orbussoftware.com) om de gebruikers toe te voegen in het IServer-portal platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
