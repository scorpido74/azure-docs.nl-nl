---
title: 'Zelfstudie: Azure Active Directory-integratie met UNIFI | Microsoft Documenten'
...
5. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:
    ...
    Typ een URL in het tekstvak **AANmeldings-URL:**`https://app.discoverunifi.com/login`
