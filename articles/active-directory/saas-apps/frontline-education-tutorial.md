---
title: 'Zelf studie: integratie Azure Active Directory met Frontline education | Microsoft Docs'
...
---
# <a name="tutorial-integrate-frontline-education-with-azure-active-directory"></a>Zelf studie: Frontline-onderwijs integreren met Azure Active Directory
...
1. Voer in de sectie **basis configuratie van SAML** de waarden in voor de volgende velden:
    ...
    Typ in het tekstvak **URL voor aanmelden** een URL met behulp van het volgende patroon:`https://login.frontlineeducation.com/sso/<CLIENTID>`
