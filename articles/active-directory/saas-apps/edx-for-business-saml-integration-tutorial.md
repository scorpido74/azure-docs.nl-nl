...
Wanneer u in het toegangsvenster op de tegel edX for Business SAML Integration klikt, zou u automatisch moeten worden aangemeld bij de instantie van edX for Business SAML Integration waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [edX for Business SAML Integration beveiligen met geavanceerde zichtbaarheid en controles](/cloud-app-security/proxy-intro-aad)