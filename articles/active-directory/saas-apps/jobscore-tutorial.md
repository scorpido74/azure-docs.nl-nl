---
title: 'Zelf studie: integratie Azure Active Directory met JobScore | Microsoft Docs'
...
ms.locfileid: "73157995"
---
# <a name="tutorial-azure-active-directory-integration-with-jobscore"></a>Zelf studie: integratie Azure Active Directory met JobScore
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://hire.jobscore.com/auth/adfs/<company name>`
