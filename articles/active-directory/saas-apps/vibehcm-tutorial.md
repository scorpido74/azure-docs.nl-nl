---
title: 'Zelf studie: integratie Azure Active Directory met Vibe HCM | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-integration-with-vibe-hcm"></a>Zelf studie: integratie Azure Active Directory met Vibe HCM
...
Als u eenmalige aanmelding wilt configureren op **Vibe HCM** , moet u de URL voor de **app-federatieve meta gegevens** verzenden naar [Vibe HCM-ondersteunings team](mailto:support@vibehcm.com). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
...
In deze sectie maakt u een gebruiker met de naam Julia Simon in Vibe HCM. Werk samen met het [ondersteunings team van Vibe HCM](mailto:support@vibehcm.com) om de gebruikers toe te voegen in het Vibe HCM-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
