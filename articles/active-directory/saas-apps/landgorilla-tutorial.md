---
title: 'Zelf studie: integratie Azure Active Directory met land gorilla | Microsoft Docs'
...
---
# <a name="tutorial-integrate-land-gorilla-with-azure-active-directory"></a>Zelf studie: land-gorilla integreren met Azure Active Directory
...
1. Voer op de pagina **eenmalige aanmelding met SAML instellen** de waarden in voor de volgende velden:
    ...
    > [!NOTE]
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke id en antwoord-URL. Wij raden u aan hiervoor de unieke waarde van de tekenreeks in de id te gebruiken. Neem contact op met het [ondersteunings team](https://www.landgorilla.com/support/) van de land-gorilla om deze waarden te verkrijgen. U kunt ook verwijzen naar het patroon dat wordt weergegeven in de sectie **Standaard SAML-configuratie** in de Azure-portal.
...
Als u eenmalige aanmelding wilt configureren voor de **gorilla** , moet u het gedownloade **XML-bestand met federatieve meta gegevens** en de juiste gekopieerde url's verzenden van Azure Portal naar [gorilla ondersteunings team](https://www.landgorilla.com/support/). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
...
In deze sectie maakt u een gebruiker met de naam Julia Simon in land gorilla. Werk samen met het [ondersteunings team voor Gorilla](https://www.landgorilla.com/support/) om de gebruikers toe te voegen aan het land gorilla-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
