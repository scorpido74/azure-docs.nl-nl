---
title: 'Zelfstudie: Azure Active Directory-integratie met Flatter-bestanden | Microsoft Documenten'
...
---
# <a name="tutorial-azure-active-directory-integration-with-flatter-files"></a>Zelfstudie: Azure Active Directory-integratie met Flatter-bestanden
...
4. Voer in het dialoogvenster **SAML-configuratie** de volgende stappen uit: 
   ...
   > [!NOTE]
   > Als u nog geen geregistreerd domein hebt, neemt u [support@flatterfiles.com](mailto:support@flatterfiles.com)contact op met uw ondersteuningsteam van Flatter Files via . 
    ...
    c.  Open uw basis-64 gecodeerd certificaat in kladblok, kopieer de inhoud ervan in uw klembord en plak het vervolgens in het textbox van het **identiteitsprovidercertificaat.**
