...
4. Voer in het dialoogvenster **SAML-configuratie** de volgende stappen uit: 
   ...
   > [!NOTE]
   > Als u nog geen geregistreerd domein hebt, neemt u contact op met het ondersteunings team voor flatter-bestanden via [support@flatterfiles.com](mailto:support@flatterfiles.com). 
    ...
    c.  Open uw met base 64 versleutelde certificaat in Klad blok, kopieer de inhoud ervan naar het klem bord en plak het in het tekstvak **ID-provider certificaat** .
