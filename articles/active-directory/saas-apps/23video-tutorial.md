...
Wanneer u in het toegangsvenster op de tegel 23 Video klikt, wordt u automatisch aangemeld bij de instantie van 23 Video waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
