...
1. Meld u aan bij [koppel](https://web.flock.com/?). Klik op het **pictogram instellingen** > **uw team te beheren**.
...
5. Geef in de sectie beheerders referenties de `https://api.flock-staging.com/v2/scim`-en **API-token** waarden op die respectievelijk eerder zijn opgehaald in de **Tenant-URL** en het **geheime token** . Klik op **verbinding testen** om te controleren of Azure AD verbinding kan maken met het koppel. Als de verbinding mislukt, zorg er dan voor dat het koppel account beheerders machtigingen heeft en probeer het opnieuw.
