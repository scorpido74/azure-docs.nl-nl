...
**Voer de volgende stappen uit om LINE WORKS vanuit de galerie toe te voegen:**
...
4. Typ in het zoekvak **LINE WORKS**, selecteer **LINE WORKS** in het deelvenster met resultaten en klik vervolgens op **Toevoegen** om de toepassing toe te voegen.

    ![LINE WORKS in de resultatenlijst](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD-eenmalige aanmelding configureren en testen

In deze sectie configureert en test u Azure AD-eenmalige aanmelding met LINE WORKS op basis van een testgebruiker met de naam **Britta Simon**.
Eenmalige aanmelding werkt alleen als er een koppelingsrelatie tussen een Azure AD-gebruiker en de daaraan gerelateerde gebruiker in LINE WORKS tot stand is gebracht.

U hebt de volgende bouwstenen nodig om eenmalige aanmelding van Azure AD met LINE WORKS te configureren en testen:

1. **[Azure AD-eenmalige aanmelding configureren](#configure-azure-ad-single-sign-on)** : als u wilt dat uw gebruikers deze functie kunnen gebruiken.
2. **[Eenmalige aanmelding voor LINE WORKS configureren](#configure-line-works-single-sign-on)** : als u de instellingen voor eenmalige aanmelding aan de toepassingszijde wil configureren.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)** : als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)** : als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[Testgebruiker voor LINE WORKS maken](#create-line-works-test-user)** : als u een tegenhanger van Britta Simon in LINE WORKS wilt hebben die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
Voer de volgende stappen uit om eenmalige aanmelding in Azure AD te configureren voor LINE WORKS:

1. Selecteer in de [Azure-portal](https://portal.azure.com/) op de integratiepagina van de toepassing **LINE WORKS** de optie **Eenmalige aanmelding**.
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    ![Informatie over eenmalige aanmelding voor LINE WORKS-domein en -URL's](common/sp-identifier.png)

    a. In het tekstvak **Aanmeldings-URL** typt u een URL met de volgende notatie: `https://auth.worksmobile.com/d/login/<domain>/`

    b. Typ een URL in het vak **Id (Entiteits-id)** : `worksmobile.com`
...
### <a name="configure-line-works-single-sign-on"></a>Eenmalige aanmelding voor LINE WORKS configureren
...
In deze sectie stelt u Britta Simon in staat gebruik te maken van eenmalige aanmelding via Azure door haar toegang te geven tot LINE WORKS.

1. Selecteer in de Azure-portal achtereenvolgens **Bedrijfstoepassingen**, **Alle toepassingen** en **LINE WORKS**.

    ![De blade Bedrijfstoepassingen](common/enterprise-applications.png)

2. Selecteer **LINE WORKS** in de lijst met toepassingen.

    ![De koppeling naar LINE WORKS in de lijst met toepassingen](common/all-applications.png)
...
Wanneer u op de tegel LINE WORKS in het toegangsvenster klikt, wordt u automatisch aangemeld bij de instantie van LINE WORKS waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
