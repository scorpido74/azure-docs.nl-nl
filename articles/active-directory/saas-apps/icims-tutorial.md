...
## <a name="configure-and-test-azure-ad-single-sign-on-for-icims"></a>Eenmalige aanmelding van Azure AD configureren en testen voor ICIMS
...
Voltooi de volgende stappen om eenmalige aanmelding van Azure AD met ICIMS te configureren en te testen:
...
1. Ga in [Azure Portal](https://portal.azure.com/) op de integratiepagina van de toepassing **ICIMS** naar de sectie **Beheren** en selecteer **Eenmalige aanmelding** .
...
1. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    b. In het tekstvak **Id** typt u een URL: `icims.com`

    c. In het tekstvak **Antwoord-URL** typt u een URL: `https://.icims.com/`
...
Wanneer u in het toegangsvenster op de tegel ICIMS klikt, wordt u automatisch aangemeld bij de instantie van ICIMS waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
