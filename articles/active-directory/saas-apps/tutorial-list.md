---
title: Zelf studies voor SaaS-app-integratie voor gebruik met Azure AD | Microsoft Docs
description: Configureer Azure Active Directory eenmalige aanmelding met diverse software van derden als een service toepassing.
...
We hebben een verzameling zelf studies ontwikkeld waarmee u de configuratie kunt door lopen om uw SaaS-toepassingen [(software als een service)](https://azure.microsoft.com/overview/what-is-saas/) in de cloud te integreren met Azure Active Directory.
...
| Logo | Zelf studie voor toepassingen voor eenmalige aanmelding | Zelf studie over toepassingen voor het inrichten van gebruikers |
| :--- | :--- | :--- |
...
## <a name="cloud-integrations"></a>Cloud integraties

| Logo | Zelf studie voor toepassingen voor eenmalige aanmelding | Zelf studie over toepassingen voor het inrichten van gebruikers |
| :--- | :--- | :--- |
| ![AWS-console (logo-Amazon Web Services)](./media/tutorial-list/active-directory-saas-amazon-web-service-tutorial.png)| [Amazon Web Services-console (AWS)](amazon-web-service-tutorial.md)| [Amazon Web Services-console (AWS)-rollen inrichten](amazon-web-service-tutorial.md#configure-azure-ad-sso) |
...
| Logo | Zelf studie voor toepassingen voor eenmalige aanmelding |
| :--- | :--- |
...
| ![logo-beoordeeld](./media/tutorial-list/active-directory-saas-appraisd-tutorial.png)| [Appraisd](appraisd-tutorial.md)|
| ![logo-ArcGIS Enter prise](./media/tutorial-list/active-directory-saas-arcgisenterprise-tutorial.png)| [ArcGIS Enterprise](arcgisenterprise-tutorial.md)|
...
| ![logo-Carbonite-eind punt back-up](./media/tutorial-list/active-directory-saas-carbonite-endpoint-backup-tutorial.png)| [Carbonite Endpoint Backup](carbonite-endpoint-backup-tutorial.md)|
...
| ![logo-deplayr](./media/tutorial-list/active-directory-saas-displayr-tutorial.png)| [Displayr](displayr-tutorial.md)|
...
| ![logo-Dome9 boog](./media/tutorial-list/active-directory-saas-dome9arc-tutorial.png)| [Dome9 Arc](dome9arc-tutorial.md)|
| ![logo-drift](./media/tutorial-list/active-directory-saas-drift-tutorial.png)| [Drift](drift-tutorial.md)|
| ![logo-Dropbox voor bedrijven](./media/tutorial-list/active-directory-saas-dropboxforbusiness-tutorial.png)| [Dropbox voor bedrijven](dropboxforbusiness-tutorial.md)|
...
| ![logo-levens gevoeder](./media/tutorial-list/active-directory-saas-foodee-tutorial.png)| [Foodee](foodee-tutorial.md)|
...
| ![logo-harnas](./media/tutorial-list/active-directory-saas-harness-tutorial.png)| [Harness](harness-tutorial.md)|
...
| ![logo-HRworks eenmalige aanmelding](./media/tutorial-list/active-directory-saas-hrworks-single-sign-on-tutorial.png)| [HRworks Single Sign-On](hrworks-single-sign-on-tutorial.md)|
...
| ![logo-kennis Anywhere-LMS](./media/tutorial-list/active-directory-saas-knowlwdge-anywhere-lms-tutorial.png)| [Knowledge Anywhere LMS](knowledge-anywhere-lms-tutorial.md)|
...
| ![logo-personen](./media/tutorial-list/active-directory-saas-people-tutorial.png)| [People](people-tutorial.md)|
...
| ![logo-Sales Force](./media/tutorial-list/active-directory-saas-salesforce-tutorial.png)| [Salesforce](salesforce-tutorial.md)|
| ![logo-scaleX Enter prise](./media/tutorial-list/active-directory-saas-scalex-enterprise-tutorial.png)| [ScaleX Enterprise](scalex-enterprise-tutorial.md)|
| ![logo-screen cast-O-Matic](./media/tutorial-list/active-directory-saas-screencast-tutorial.png)| [Screencast-O-Matic](screencast-tutorial.md)|
...
| ![logo-bekijken op kleuren](./media/tutorial-list/active-directory-saas-watch-by-colors-tutorial.png)| [Watch by Colors](watch-by-colors-tutorial.md)|
| ![logo-werk wijze](./media/tutorial-list/active-directory-saas-waywedo-tutorial.png)| [Way We Do](waywedo-tutorial.md)|
| ![logo-werk plek op Facebook](./media/tutorial-list/active-directory-saas-workplacebyfacebook-tutorial.png)| [Workplace van Facebook](workplacebyfacebook-tutorial.md)|
...
| ![logo-Zscaler drie](./media/tutorial-list/active-directory-saas-zscaler-three-tutorial.png)| [Zscaler Three](zscaler-three-tutorial.md)|
| ![logo-Zscaler twee](./media/tutorial-list/active-directory-saas-zscaler-two-tutorial.png)| [Zscaler Two](zscaler-two-tutorial.md)|  
...
Zie [Wat is toepassings beheer](../manage-apps/what-is-application-management.md)? voor meer informatie over toepassings beheer.