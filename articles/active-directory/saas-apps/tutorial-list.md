---
title: SaaS App-integratiezelfstudies voor gebruik met Azure AD | Microsoft Docs
description: Configureer eenmalige aanmelding van Azure Active Directory met externe software en servicetoepassingen.
...
Om u te helpen uw [cloudsoftwaretoepassingen als een service (SaaS)](https://azure.microsoft.com/overview/what-is-saas/) met Azure Active Directory, hebben we een collectie zelfstudies ontwikkeld die u helpen bij de configuratie.

Raadpleeg de [Active Directory-marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/category/azure-active-directory-apps) voor een lijst met alle SaaS-apps die vooraf zijn geïntegreerd in Azure Active Directory.

Gebruik de [netwerkportal van de toepassing](../azuread-dev/howto-app-gallery-listing.md) om een [SCIM](../app-provisioning/use-scim-to-provision-users-and-groups.md)-toepassing aan te vragen voor de galerie voor automatische inrichting, of een SAML-/ODIC-toepassing die aan de galerie kan worden toegevoegd voor SSO.

## <a name="quick-links"></a>Snelkoppelingen

| Logo | Toepassingszelfstudie voor eenmalige aanmelding | Toepassingszelfstudie voor gebruikersinrichting |
| :--- | :--- | :--- |
...
| ![logo-Slack](./media/tutorial-list/active-directory-saas-slack-tutorial.png)| [Slack](slack-tutorial.md)|[Slack - Gebruikers inrichten](slack-provisioning-tutorial.md)|
...
| ![logo-Workday](./media/tutorial-list/active-directory-saas-workday-tutorial.png)| [Workday](workday-tutorial.md)| [Workday - Gebruikers inrichten](workday-inbound-tutorial.md)|

Gebruik de inhoudsopgave aan de linkerzijde om meer zelfstudies te zoeken.

## <a name="cloud-integrations"></a>Cloudintegraties

| Logo | Toepassingszelfstudie voor eenmalige aanmelding | Toepassingszelfstudie voor gebruikersinrichting |
| :--- | :--- | :--- |
| ![logo-Amazon Web Services (AWS) Console](./media/tutorial-list/active-directory-saas-amazon-web-service-tutorial.png)| [Amazon Web Services (AWS) Console](amazon-web-service-tutorial.md)| [Amazon Web Services (AWS) Console - Rollen inrichten](amazon-web-service-tutorial.md#configure-azure-ad-sso) |
| ![logo-Alibaba Cloud Service (eenmalige aanmelding op basis van rollen)](./media/tutorial-list/active-directory-saas-alibaba-tutorial.png)| [Alibaba Cloud Service (eenmalige aanmelding op basis van rollen)](alibaba-cloud-service-role-based-sso-tutorial.md)| |
| ![logo-Google Cloud Platform](./media/tutorial-list/active-directory-saas-google-apps-tutorial.png)| [Google Cloud Platform](google-apps-tutorial.md)| [Google Cloud Platform - Gebruikers inrichten](google-apps-provisioning-tutorial.md) |
| ![logo-Salesforce](./media/tutorial-list/active-directory-saas-salesforce-tutorial.png)| [Salesforce](salesforce-tutorial.md)| [Salesforce - Gebruikers inrichten](salesforce-provisioning-tutorial.md) |
| ![logo-SAP Cloud Identity Platform](./media/tutorial-list/active-directory-saas-sapboc-tutorial.png)| [SAP Cloud Identity Platform](saphana-tutorial.md)|[SAP Cloud Identity Platform - Inrichting](./sap-cloud-platform-identity-authentication-provisioning-tutorial.md) |

## <a name="oneclick-sso"></a>OneClick SSO

| Logo | Toepassingszelfstudie voor eenmalige aanmelding |
| :--- | :--- |
...
| ![logo-Dropbox for Business](./media/tutorial-list/active-directory-saas-dropboxforbusiness-tutorial.png)| [Dropbox voor bedrijven](dropboxforbusiness-tutorial.md)|
...
| ![logo-Workplace by Facebook](./media/tutorial-list/active-directory-saas-workplacebyfacebook-tutorial.png)| [Workplace van Facebook](workplacebyfacebook-tutorial.md)|
...
Raadpleeg [Wat is toepassingsbeheer](../manage-apps/what-is-application-management.md) voor meer informatie over toepassingsbeheer.
