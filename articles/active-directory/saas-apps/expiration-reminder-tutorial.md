---
title: 'Zelf studie: integratie Azure Active Directory met verloop herinnering | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-integration-with-expiration-reminder"></a>Zelf studie: integratie Azure Active Directory met verval herinnering
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    Typ een URL in het tekstvak **URL voor aanmelding** :`https://app.expirationreminder.net/account/sso`
