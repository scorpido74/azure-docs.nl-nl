...
1. Klik in de linkermenu op **eenmalige aanmelding (SSO)** en voer op de pagina op **SAML gebaseerde eenmalige aanmelding (SSO)** de volgende stappen uit:
    ...
    e. Kopieer het certificaat dat u hebt gedownload van Azure Portal zonder `--BEGIN CERTIFICATE and END CERTIFICATE--` opmerkingen en plak het in het tekstvak **certificaat (verschaft door de ID-provider)** .
