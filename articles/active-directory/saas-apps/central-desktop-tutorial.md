...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    a. Typ in het tekstvak **URL voor aanmelding** een URL met het volgende patroon:`https://<companyname>.centraldesktop.com`
...
1. Meld u aan bij uw **centraal bureau blad** -Tenant.
