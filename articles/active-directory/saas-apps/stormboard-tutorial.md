---
title: 'Zelf studie: integratie Azure Active Directory met Stormboard | Microsoft Docs'
...
ms.locfileid: "73159955"
---
# <a name="tutorial-azure-active-directory-integration-with-stormboard"></a>Zelf studie: integratie Azure Active Directory met Stormboard
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit als u de toepassing in de door **IDP** geïnitieerde modus wilt configureren:
    ...
    ![Domein- en URL-gegevens voor eenmalige aanmelding met Stormboard](common/both-replyurl.png)

    Typ in het tekstvak **antwoord-URL** een URL met het volgende patroon:`https://<SUBDOMAIN>.stormboard.com/saml2/ad/acs/<TEAMID>`

5. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:

    ![Domein- en URL-gegevens voor eenmalige aanmelding met Stormboard](common/both-signonurl.png)

    In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://<SUBDOMAIN>.stormboard.com/saml2/ad/login/<TEAMID>`
...
Wanneer u op de tegel Stormboard in het toegangsvenster klikt, zou u automatisch moeten worden aangemeld bij de instantie van Stormboard waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
