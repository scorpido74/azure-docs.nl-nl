...
1. Voer op de pagina **eenmalige aanmelding met SAML instellen** de waarden in voor de volgende velden:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met het volgende patroon: `https://pantheon.auth0.com/login/callback?connection=<orgname>-SSO`
...
5. Geef het e-mailadres van de gebruiker op.
