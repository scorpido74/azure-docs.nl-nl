---
title: 'Zelf studie: integratie Azure Active Directory met M-bestanden | Microsoft Docs'
...
ms.locfileid: "73159447"
---
# <a name="tutorial-azure-active-directory-integration-with-m-files"></a>Zelf studie: integratie Azure Active Directory met M-bestanden
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    b. In het tekstvak **Id (Entiteits-id)** typt u een URL met het volgende patroon: `https://<tenantname>.cloudvault.m-files.com`
