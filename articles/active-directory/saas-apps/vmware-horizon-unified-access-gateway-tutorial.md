...
In deze sectie maakt u een gebruiker met de naam B.Simon in VMware Horizon - Unified Access Gateway. Werk samen met het  [ondersteuningsteam van VMware Horizon - Unified Access Gateway](mailto:support@vmware.com) om de gebruikers toe te voegen op het VMware Horizon - Unified Access Gateway-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
