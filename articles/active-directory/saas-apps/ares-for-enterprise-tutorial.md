---
title: 'Zelfstudie: Azure Active Directory-integratie met ARES voor Bedrijven | Microsoft Documenten'
...
ms.locfileid: "73157886"
---
# <a name="tutorial-azure-active-directory-integration-with-ares-for-enterprise"></a>Zelfstudie: Azure Active Directory-integratie met ARES voor Bedrijven
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stap uit:
    ...
    Typ een URL in het tekstvak **Aantekenen op URL:**`https://login.graebert.com`
