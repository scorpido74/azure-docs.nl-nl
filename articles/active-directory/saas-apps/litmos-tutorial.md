---
title: 'Zelf studie: Azure Active Directory de integratie van eenmalige aanmelding (SSO) met Litmos | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-litmos"></a>Zelf studie: Azure Active Directory de integratie van eenmalige aanmelding (SSO) met Litmos
