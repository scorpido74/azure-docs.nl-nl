---
title: 'Zelfstudie: Azure Active Directory-integratie met BambooHR | Microsoft Documenten'
...
2. Doe het volgende op de startpagina:
    ...
    ![De BambooHR Single Sign-On pagina](./media/bamboo-hr-tutorial/ic796691.png "Eenmalige aanmelding")   
...
3. Doe het volgende in het deelvenster **Eenmalige aanmelding op basis van SAML**:
    ...
    ![Het deelvenster Eenmalig aanmelding saml](./media/bamboo-hr-tutorial/IC796692.png "SAML-aanmelding")
...
4. Selecteer > **beveiligingsgebruikers**in **Security**het linkerdeelvenster .
