...
## <a name="configure-and-test-azure-ad-single-sign-on-for-box"></a>Eenmalige aanmelding van Azure AD configureren en testen voor Box
...
Voltooi de volgende stappen om eenmalige aanmelding van Azure AD met Box te configureren en te testen:
...
1. Zoek in [Azure Portal](https://portal.azure.com/) op de integratiepagina van de toepassing **Box** de sectie **Beheren** en selecteer **Eenmalige aanmelding** .
...
1. In de sectie **Standaard-SAML-configuratie** voert u de waarden in voor de volgende velden:
    ...
    c. In het tekstvak **Antwoord-URL** typt u een URL: `https://sso.services.box.net/sp/ACS.saml2`
...
Wanneer u op de tegel Box in het toegangsvenster klikt, wordt u automatisch aangemeld bij de instantie van Box waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [Box met Azure AD uitproberen](https://aad.portal.azure.com/)

- [Wat is sessiebeheer in Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Box beveiligen met geavanceerde zichtbaarheid en besturingselementen](/cloud-app-security/protect-box)