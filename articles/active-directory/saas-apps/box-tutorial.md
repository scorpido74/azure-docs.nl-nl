...
* Box biedt ondersteuning voor het [**automatisch** inrichten van gebruikers](https://docs.microsoft.com/azure/active-directory/saas-apps/box-userprovisioning-tutorial) (aanbevolen)
