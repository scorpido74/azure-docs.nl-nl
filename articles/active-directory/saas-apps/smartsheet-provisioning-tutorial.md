...
Het doel van deze zelf studie is het demonstreren van de stappen die moeten worden uitgevoerd in Smart Sheet en Azure Active Directory (Azure AD) om Azure AD te configureren voor het automatisch inrichten en ongedaan maken van de inrichting van gebruikers en/of groepen in [Smart Sheet](https://www.smartsheet.com/pricing). Zie voor belangrijke details over wat deze service doet, hoe het werkt en veelgestelde vragen [Inrichting en ongedaan maken van inrichting van gebruikers automatiseren naar SaaS-toepassingen met Azure Active Directory](../app-provisioning/user-provisioning.md). 
...
3. Bepaal welke gegevens moeten worden [toegewezen tussen Azure AD en Smart Sheet](../app-provisioning/customize-application-attributes.md). 
