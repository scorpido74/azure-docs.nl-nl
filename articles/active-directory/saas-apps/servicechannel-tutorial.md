...
1. De rolclaim is vooraf geconfigureerd, zodat u deze niet hoeft te configureren, maar u moet deze wel in Azure AD maken. Lees daarvoor dit [artikel](../develop/active-directory-enterprise-app-role-management.md). U kunt [hier](https://servicechannel.zendesk.com/hc/articles/217514326-Azure-AD-Configuration-Example) de handleiding voor ServiceChannel raadplegen voor meer hulp bij claims.
...
Wanneer u in het toegangsvenster op de ServiceChannel-tegel klikt, wordt u automatisch aangemeld bij het ServiceChannel-exemplaar waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
