---
title: 'Zelfstudie: Azure Active Directory-integratie met Canvas | Microsoft Documenten'
...
5. Voer de volgende stappen uit in het dialoogvenster Een nieuwe gebruiker toevoegen:
   ...
   c. Voer **in het** tekstvak Inloggen het Azure AD-e-mailadres van de gebruiker in, zoals **\@brittasimon contoso.com**.
...
> [!NOTE]
> U alle andere canvas hulpprogramma's voor het maken van canvas-accounts of API's die door Canvas worden verstrekt, gebruiken om Azure AD-gebruikersaccounts in te richten.
