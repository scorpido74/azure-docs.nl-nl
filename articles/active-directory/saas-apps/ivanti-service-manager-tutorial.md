...
Wanneer u in het toegangsvenster op de tegel Ivanti Service Manager klikt, wordt u als het goed is automatisch aangemeld bij het exemplaar van Ivanti Service Manager waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
