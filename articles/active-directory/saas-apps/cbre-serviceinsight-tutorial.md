---
title: 'Zelf studie: Azure Active Directory de integratie van eenmalige aanmelding (SSO) met CBRE ServiceInsight | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-cbre-serviceinsight"></a>Zelf studie: Azure Active Directory-integratie met eenmalige aanmelding (SSO) met CBRE ServiceInsight
...
1. Voer in de sectie **basis configuratie van SAML** de waarden in voor de volgende velden:
    ...
    Typ een URL in het tekstvak **URL voor aanmelding** :`https://adfs4.mainstreamsasp.com/adfs/ls/`
