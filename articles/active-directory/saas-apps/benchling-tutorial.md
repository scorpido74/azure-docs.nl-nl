...
## <a name="configure-and-test-azure-ad-single-sign-on-for-benchling"></a>Eenmalige aanmelding van Azure AD configureren en testen voor Benchling
...
Voltooi de volgende stappen om eenmalige aanmelding van Azure AD met Benchling te configureren en testen:
...
1. Zoek in [Azure Portal](https://portal.azure.com/), op de integratiepagina van de toepassing **Benchling** , de sectie **Beheren** en selecteer **Eenmalige aanmelding** .
...
Wanneer u op de Benchling-tegel in het toegangsvenster klikt, wordt u automatisch aangemeld bij de instantie van Benchling waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [Benchling met Azure AD uitproberen](https://aad.portal.azure.com/)