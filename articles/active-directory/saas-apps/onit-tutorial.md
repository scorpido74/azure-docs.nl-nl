...
* Controle in azure AD die toegang heeft tot Onit.
* Zorg ervoor dat uw gebruikers automatisch worden aangemeld bij Onit met hun Azure AD-accounts.
...
* Onit-abonnement dat is ingeschakeld voor eenmalige aanmelding (SSO).
...
1. Typ in de sectie **toevoegen vanuit de galerie** **Onit** in het zoekvak.
1. Selecteer **Onit** uit het paneel resultaten en voeg vervolgens de app toe. Wacht een paar seconden wanneer de app aan uw Tenant is toegevoegd.

## <a name="configure-and-test-azure-ad-single-sign-on-for-onit"></a>Eenmalige aanmelding voor Azure AD configureren en testen voor Onit

Azure AD SSO met Onit configureren en testen met behulp van een test gebruiker met de naam **B. Simon**. Voor het werken met SSO moet u een koppelings relatie tot stand brengen tussen een Azure AD-gebruiker en de bijbehorende gebruiker in Onit.

Als u Azure AD SSO wilt configureren en testen met Onit, voltooit u de volgende bouw stenen:

1. **[Configureer Azure AD SSO](#configure-azure-ad-sso)** -om uw gebruikers in staat te stellen deze functie te gebruiken.
    1. **[Een Azure AD-test gebruiker maken](#create-an-azure-ad-test-user)** : u kunt eenmalige aanmelding voor Azure AD testen met B. Simon.
    1. **[Wijs de Azure AD-test gebruiker](#assign-the-azure-ad-test-user)** toe, zodat B. Simon de eenmalige aanmelding van Azure AD kan gebruiken.
1. **[ONIT SSO configureren](#configure-onit-sso)** : voor het configureren van de instellingen voor eenmalige aanmelding aan de kant van de toepassing.
    1. **[Maak een Onit-test gebruiker](#create-onit-test-user)** -om een equivalent van B. Simon in Onit te hebben dat is gekoppeld aan de Azure AD-representatie van de gebruiker.
...
1. Zoek in het [Azure Portal](https://portal.azure.com/)op de pagina Toepassings integratie van **Onit** de sectie **beheren** en selecteer **eenmalige aanmelding**.
...
1. Op de sectie **Onit instellen** kopieert u de gewenste URL ('s) op basis van uw vereiste.
...
In deze sectie schakelt u B. Simon in om eenmalige aanmelding van Azure te gebruiken door toegang te verlenen aan Onit.
