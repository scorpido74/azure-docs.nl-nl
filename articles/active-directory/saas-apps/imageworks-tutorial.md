---
title: 'Zelf studie: integratie met installatie kopie Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "73158957"
---
# <a name="tutorial-azure-active-directory-integration-with-image-works"></a>Zelf studie: integratie met afbeelding Azure Active Directory
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    b. In het tekstvak **Id (Entiteits-id)** typt u een URL met het volgende patroon: `https://sp.i-imageworks.jp/iw/<tenantName>/postResponse`
