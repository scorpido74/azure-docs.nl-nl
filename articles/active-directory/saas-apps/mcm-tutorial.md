...
In deze sectie gaat u in MCM een gebruiker maken met de naam Britta Simon. Neem contact op met het [ondersteuningsteam van MCM](https://mcmtechnology.com/support) om de gebruikers toe te voegen in het MCM-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.

>[!NOTE]
>U kunt alle andere tools of API’s voor het maken van een MCM gebruikersaccount gebruiken die door MCM worden aangeboden voor het inrichten van Azure AD-gebruikersaccounts.
