---
title: 'Zelfstudie: Integratie van Azure Active Directory met eenmalige aanmelding (SSO) met Perforce Helix Core- Helix Authentication Service | Microsoft Docs'
description: Informatie over het configureren van eenmalige aanmelding tussen Azure Active Directory en Perforce Helix Core- Helix Authentication Service.
...
* In Azure AD bepalen wie toegang heeft tot de Perforce Helix Core- Helix Authentication Service.
* Ervoor zorgen dat uw gebruikers automatisch worden aangemeld bij Perforce Helix Core- Helix Authentication Service met hun Azure AD-accounts.
...
* Abonnement Perforce Helix Core- Helix Authentication Service met eenmalige aanmelding (SSO) ingeschakeld.
...
Voltooi de volgende bouwstenen om Azure AD SSO met Perforce Helix Core- Helix Authentication Service te configureren en testen:
...
1. Ga in [Azure Portal](https://portal.azure.com/) op de toepassingsintegratiepagina van **Perforce Helix Core- Helix Authentication Service**  naar de sectie **Beheren** en selecteer **Eenmalige aanmelding** .
...
1. In de sectie **Standaard-SAML-configuratie** voert u de waarden in voor de volgende velden:
    ...
    c. In het tekstvak **Antwoord-URL** typt u een URL met de volgende notatie: `https://<HELIX-AUTH-SERVICE>.<CUSTOMER-HOSTNAME>.com/saml/sso`

    > [!NOTE]
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke aanmeldings-URL, id en antwoord-URL. Neem contact op met de [technische ondersteuning van Perforce Helix Core- Helix Authentication Service Client](mailto:support@perforce.com) om deze waarden te krijgen. U kunt ook verwijzen naar het patroon dat wordt weergegeven in de sectie **Standaard SAML-configuratie** in de Azure-portal.
...
In deze sectie geeft u B.Simon toestemming om eenmalige aanmelding van Azure te gebruiken door toegang te verlenen tot Perforce Helix Core- Helix Authentication Service.

1. Selecteer in Azure Portal de optie **Bedrijfstoepassingen** en selecteer vervolgens **Alle toepassingen** .
1. Selecteer **Perforce Helix Core- Helix Authentication Service** in de lijst met toepassingen.
...
Wanneer u op de tegel Perforce Helix Core- Helix Authentication Service in het toegangsvenster klikt, wordt u als het goed is automatisch aangemeld bij de Perforce Helix Core- Helix Authentication Service waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [Perforce Helix Core- Helix Authentication Service met Azure AD uitproberen](https://aad.portal.azure.com/)

- [Wat is sessiebeheer in Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Perforce Helix Core- Helix Authentication Service beveiligen met geavanceerde zichtbaarheid en besturingselementen](/cloud-app-security/proxy-intro-aad)