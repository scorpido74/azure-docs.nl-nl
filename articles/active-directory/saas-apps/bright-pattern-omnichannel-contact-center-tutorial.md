...
Wanneer u in het toegangsvenster op de tegel Bright Pattern Omnichannel Contact Center klikt, wordt u automatisch aangemeld bij het exemplaar van Bright Pattern Omnichannel Contact Center waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
