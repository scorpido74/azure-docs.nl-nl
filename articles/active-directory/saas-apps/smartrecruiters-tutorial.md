...
description: Ontdek hoe u eenmalige aanmelding configureert tussen Azure Active Directory en SmartRecruiters.
...
In deze zelfstudie leert u hoe u SmartRecruiters kunt integreren met Azure Active Directory (Azure AD).
De integratie van SmartRecruiters met Azure AD biedt de volgende voordelen:

* U kunt in Azure AD beheren wie toegang heeft tot SmartRecruiters.
* U kunt instellen dat gebruikers automatisch met hun Azure AD-account worden aangemeld bij SmartRecruiters (eenmalige aanmelding).
...
U hebt het volgende nodig om Azure Active Directory-integratie met SmartRecruiters te configureren:

* Een Azure AD-abonnement Als u geen Azure AD-omgeving hebt, kunt u [hier](https://azure.microsoft.com/pricing/free-trial/) de proefversie van één maand krijgen.
* Een abonnement op SmartRecruiters waarvoor eenmalige aanmelding is ingeschakeld

## <a name="scenario-description"></a>Scenariobeschrijving

In deze zelfstudie gaat u in een testomgeving eenmalige aanmelding van Azure AD configureren en testen.

* SmartRecruiters ondersteunt door **SP en IDP** geïnitieerde eenmalige aanmelding

## <a name="adding-smartrecruiters-from-the-gallery"></a>SmartRecruiters toevoegen uit de galerie

Om de integratie van SmartRecruiters te configureren in Azure AD, moet u SmartRecruiters uit de galerie toevoegen aan uw lijst met beheerde SaaS-apps.
...
2. **[Eenmalige aanmelding voor SmartRecruiters configureren](#configure-smartrecruiters-single-sign-on)** : als u de instellingen voor eenmalige aanmelding aan de toepassingszijde wilt configureren.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)** : als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)** : als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[Testgebruiker voor SmartRecruiters maken](#create-smartrecruiters-test-user)** : als u een tegenhanger van Britta Simon in smartvid.io wilt hebben die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
5. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:
    ...
    > [!NOTE]
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke-id, de antwoord-URL en de aanmeldings-URL. Neem contact op met het [ondersteuningsteam van SmartRecruiters](https://www.smartrecruiters.com/about-us/contact-us/) om deze waarden te verkrijgen. U kunt ook verwijzen naar het patroon dat wordt weergegeven in de sectie **Standaard SAML-configuratie** in de Azure-portal.

6. Op de pagina **Eenmalige aanmelding met SAML instellen** in de sectie **SAML-handtekeningcertificaat** klikt u op **Downloaden** om het **Certificaat (Base64)** te downloaden uit de opgegeven opties overeenkomstig uw behoeften, en slaat u dit op uw computer op.

    ![De link om het certificaat te downloaden](common/certificatebase64.png)

7. In de sectie **SmartRecruiters instellen** kopieert u de juiste URL('s) op basis van uw behoeften.
...
In deze sectie maakt u een gebruiker met de naam Britta Simon in SmartRecruiters. Neem contact op met het [ondersteuningsteam van SmartRecruiters](https://www.smartrecruiters.com/about-us/contact-us/) om de gebruikers toe te voegen in het SmartRecruiters-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.

### <a name="test-single-sign-on"></a>Eenmalige aanmelding testen 

In deze sectie gaat u uw configuratie van Azure AD-eenmalige aanmelding testen via het toegangsvenster.

Wanneer u in het toegangsvenster op de tegel SmartRecruiters klikt, wordt u automatisch aangemeld bij het exemplaar van SmartRecruiters waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
