...
* U beheert in Azure Active Directory wie toegang heeft tot Netop Portal.
* U kunt ervoor zorgen dat gebruikers zich automatisch met hun Azure Active Directory-account aanmelden bij Netop Portal (eenmalige aanmelding).
...
Als u Azure Active Directory-integratie met Netop Portal wilt configureren, hebt u de volgende items nodig:

* Een Azure AD-abonnement Als u geen Azure AD-omgeving hebt, kunt u [hier](https://azure.microsoft.com/pricing/free-trial/) de proefversie van één maand krijgen.
* Een abonnement op Netop Portal waarvoor eenmalige aanmelding is ingeschakeld
...
4. Typ in het zoekvak **Netop Portal**, selecteer **Netop Portal** in het resultaatvenster en klik vervolgens op de knop **Toevoegen** om de toepassing toe te voegen.

     ![Netop Portal in de resultatenlijst](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD-eenmalige aanmelding configureren en testen

In dit gedeelte configureert en test u eenmalige aanmelding met Azure Active Directory bij Netop Portal op basis van een testgebruiker met de naam **Britta Simon**.
Eenmalige aanmelding werkt alleen als er een koppelingsrelatie tussen een Azure Active Directory-gebruiker en de daaraan gerelateerde gebruiker in Netop Portal tot stand is gebracht.

Als u eenmalige aanmelding met Azure Active Directory bij Apex Portal wilt configureren en testen, moet u de volgende bouwstenen voltooien:

1. **[Azure AD-eenmalige aanmelding configureren](#configure-azure-ad-single-sign-on)** : als u wilt dat uw gebruikers deze functie kunnen gebruiken.
2. **[Eenmalige aanmelding bij Netop Portal configureren](#configure-netop-portal-single-sign-on)** : als u de instellingen voor eenmalige aanmelding aan de toepassingszijde wilt configureren.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)** : als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)** : als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[Testgebruiker voor Netop Portal maken](#create-netop-portal-test-user)** : als u een tegenhanger van Britta Simon in Netop Portal wilt hebben die is gekoppeld aan de Azure Active Directory-weergave van de gebruiker.
...
Voer de volgende stappen uit om eenmalige aanmelding met Azure Active Directory bij Netop Portal te configureren:

1. In de [Azure Portal](https://portal.azure.com/) selecteert u **Eenmalige aanmelding** op de integratiepagina van de toepassing **Netop Portal**.
...
4. In de sectie **SAML-basisconfiguratie** hoeft de gebruiker geen enkele stap uit te voeren omdat de app al vooraf is geïntegreerd met Azure.
    ...
    ![Domein- en URL-gegevens voor eenmalige aanmelding bij Netop Portal](common/preintegrated.png)

5. In de Netop Portal-toepassing worden de SAML-asserties in een specifieke indeling verwacht. Hiervoor moet u aangepaste kenmerktoewijzingen toevoegen aan de configuratie van uw SAML-tokenkenmerken. In de volgende schermafbeelding wordt de lijst met standaardkenmerken weergegeven. Klik op het pictogram **Bewerken** om het dialoogvenster gebruikerskenmerken te openen.
...
8. Kopieer in het gedeelte **Netop Portal instellen** de juiste URL('s) op basis van uw behoeften.
...
In dit gedeelte geeft u Britta Simon toestemming voor het gebruik van eenmalige aanmelding met Azure door haar toegang te geven tot Netop Portal.

1. Selecteer **Bedrijfstoepassingen** in de Azure Portal, selecteer **Alle toepassingen** en selecteer vervolgens **Netop Portal**.

    ![De blade Bedrijfstoepassingen](common/enterprise-applications.png)

2. Selecteer **Netop Portal** in de lijst met toepassingen.
...
In deze sectie maakt u een gebruiker met de naam Britta Simon in Netop Portal. Werk met het  [ondersteuningsteam van Netop Portal](mailto:casemanager@netop.com) om de gebruikers in het Netop Portal-platform toe te voegen. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
