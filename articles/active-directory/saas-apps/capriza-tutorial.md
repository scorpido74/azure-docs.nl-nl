---
title: 'Zelfstudie: Azure Active Directory-integratie met Capriza-platform | Microsoft Documenten'
...
Het doel van deze sectie is het maken van een gebruiker met de naam Britta Simon in Capriza. Capriza Platform biedt ondersteuning voor Just-In-Time-inrichting; dit is standaard ingeschakeld. **Zorg ervoor dat uw domeinnaam is geconfigureerd met Capriza voor gebruikersinrichting. Daarna werkt alleen de just-in-time gebruikersinrichting.**
