...
1. Voer in de sectie **basis configuratie van SAML** de waarden in voor de volgende velden:
    ...
    c. In het tekstvak **Antwoord-URL** typt u een URL met het volgende patroon: `https://<HOSTNAME>.bomgar.com/saml/sso`
...
1. Ga naar de/login-interface van BeyondTrust Remote Support op `https://support.example.com/login` waarbij **support.example.com** de primaire hostnaam van uw apparaat is en verifieer met uw beheerders referenties.
