...
1. Bovendien verwacht de toepassing Meraki Dashboard nog enkele kenmerken die als SAML-antwoord moeten worden doorgestuurd. Deze worden hieronder weergegeven. Deze kenmerken worden ook vooraf ingevuld, maar u kunt ze herzien volgens uw vereisten.
    ...
    > [!NOTE]
    > Zie [hier](../develop/active-directory-enterprise-app-role-management.md)voor meer informatie over het configureren van rollen in Azure AD.
...
Wanneer u in het toegangsvenster op de tegel Meraki Dashboard klikt, zou u automatisch moeten worden aangemeld bij het exemplaar van Meraki Dashboard waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
