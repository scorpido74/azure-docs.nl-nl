---
title: 'Zelf studie: integratie Azure Active Directory met GaggleAMP | Microsoft Docs'
...
ms.locfileid: "73155390"
---
# <a name="tutorial-azure-active-directory-integration-with-gaggleamp"></a>Zelf studie: integratie Azure Active Directory met GaggleAMP
...
5. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:
    ...
    In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://gaggleamp.com/i/<customerid>`
...
1. Navigeer in een andere browser instantie naar de SAML SSO-pagina die u hebt gemaakt door het Gaggle-ondersteunings *https://accounts.gaggleamp.com/saml_configurations/oXH8sQcP79dOzgFPqrMTyw/edit*team (bijvoorbeeld:).
