---
title: 'Zelf studie: integratie met ClickUp-productiviteits platform Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "80048759"
---
# <a name="tutorial-azure-active-directory-integration-with-clickup-productivity-platform"></a>Zelf studie: integratie met ClickUp-productiviteits platform Azure Active Directory
...
2. Klik op het **gebruikers profiel**en selecteer vervolgens **instellingen**.
...
2. Klik op het **gebruikers profiel**en selecteer vervolgens **personen**.
...
3. Voer het e-mailadres van de gebruiker in het tekstvak in en klik op **Uitnodigen**.
    ...
    > [!NOTE]
    > De gebruiker ontvangt de melding en moet de uitnodiging accepteren om het account te activeren.
