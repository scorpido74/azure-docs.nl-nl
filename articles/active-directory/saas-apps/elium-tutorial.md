---
title: 'Zelfstudie: Azure Active Directory single sign-on (SSO) integratie met Elium | Microsoft Documenten'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-elium"></a>Zelfstudie: Azure Active Directory single sign-on (SSO) integratie met Elium

In deze zelfstudie leert u hoe u Elium integreren met Azure Active Directory (Azure AD). Wanneer u Elium integreert met Azure AD, u het:

* Beheer in Azure AD die toegang heeft tot Elium.
* Stel uw gebruikers in staat om automatisch te worden aangemeld bij Elium met hun Azure AD-accounts.
...
* Elium single sign-on (SSO) ingeschakeld abonnement.
...
1. Typ **Elium** in het zoekvak in de sectie **Toevoegen van de galerie.**
1. Selecteer **Elium** in het deelvenster Resultaten en voeg de app toe. Wacht een paar seconden terwijl de app wordt toegevoegd aan uw tenant.

## <a name="configure-and-test-azure-ad-single-sign-on-for-elium"></a>Azure AD-aanmelding voor Elium configureren en testen

Azure AD SSO configureren en testen met Elium met behulp van een testgebruiker genaamd **B.Simon**. Als SSO kan werken, moet u een koppelingsrelatie tot stand brengen tussen een Azure AD-gebruiker en de gerelateerde gebruiker in Elium.

Als u Azure AD SSO met Elium wilt configureren en testen, voert u de volgende bouwstenen in:

1. **[Configureer Azure AD SSO](#configure-azure-ad-sso)** - zodat uw gebruikers deze functie kunnen gebruiken.
    * **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)** - om Azure AD-enkele aanmelding te testen met B.Simon.
    * **[De Azure AD-testgebruiker toewijzen](#assign-the-azure-ad-test-user)** - om B.Simon in staat te stellen azure AD-aanmelding te gebruiken.
1. **[Configureer Elium SSO](#configure-elium-sso)** - om de instellingen voor één aanmelding aan de toepassingszijde te configureren.
    * **[Maak Elium-testgebruiker](#create-elium-test-user)** - om een tegenhanger van B.Simon in Elium te hebben die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
1. Zoek in de [Azure-portal](https://portal.azure.com/)op de pagina **Elium-toepassingsintegratie** de sectie **Beheren** en selecteer **eenmalige aanmelding**.
...
1. Elium-toepassing verwacht de SAML-beweringen in een specifieke indeling, waarvoor u aangepaste kenmerktoewijzingen moet toevoegen aan uw SAML-tokenkenmerkenconfiguratie. In de volgende schermafbeelding wordt de lijst met standaardkenmerken weergegeven.

    ![installatiekopie](common/default-attributes.png)

1. Naast bovenstaande, Elium applicatie verwacht weinig meer attributen worden teruggegeven in SAML reactie die hieronder worden weergegeven. Deze kenmerken zijn ook vooraf ingevuld, maar u ze bekijken volgens uw vereisten.
...
1. Kopieer in de sectie **Elium instellen** de juiste URL(s) op basis van uw vereiste.
...
In deze sectie u B.Simon inschakelen om Azure single sign-on te gebruiken door toegang te verlenen tot Elium.
...
1. Als u de configuratie binnen Elium wilt automatiseren, moet u **de beveiligingsextensie Mijn apps secure aanmelden** installeren door op De extensie **installeren**te klikken.

    ![Extensie Mijn apps](common/install-myappssecure-extension.png)

1. Na het toevoegen van extensie aan de browser, klik op **Set-up Elium** zal u doorverwijzen naar de Elium applicatie. Geef van daaruit de beheerdersreferenties op om u aan te melden bij Elium. De browserextensie configureert automatisch de toepassing voor u en automatiseert stappen 3-6.

    ![Configuratie instellen](common/setup-sso.png)

1. Als u Elium handmatig wilt instellen, opent u een nieuw browservenster en meldt u zich als beheerder aan op uw Elium-bedrijfssite en voert u de volgende stappen uit:
...
In deze sectie wordt een gebruiker genaamd B.Simon gemaakt in Elium. Elium ondersteunt **Just-In-Time-inrichting**; deze optie is standaard ingeschakeld. Er is geen actie-item voor u in deze sectie. Als er nog geen gebruiker in Elium bestaat, wordt er een nieuwe gemaakt wanneer u Elium probeert te openen.
