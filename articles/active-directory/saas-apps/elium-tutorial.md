...
* Elium ondersteunt SSO die door **SP en IDP** is geïnitieerd
...
1. Als u de toepassing in de gestarte modus **IDP** wilt configureren, voert u in de sectie **basis configuratie van SAML** de waarden voor de volgende velden in:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met het volgende patroon: `https://<platform-domain>.elium.com/login/saml2/acs`
