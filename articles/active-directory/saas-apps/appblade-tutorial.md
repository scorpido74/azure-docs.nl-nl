---
title: 'Zelfstudie: Azure Active Directory-integratie met AppBlade | Microsoft Documenten'
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://<companyname>.appblade.com/saml/<tenantid>`
