...
1. Onder **SAML-gebruikers-id-instellingen**controleert u de **gebruikers-id van SAML Wdesk gebruikers naam**.
...
2. Navigeer naar **beheerders** > **account beheerder**.
...
5. Voer in het tekstvak **gebruiker** de gebruikers naam van de gebruiker b.simon@contoso.com in en klik op de knop **door gaan** .
...
6.  Voer de details in zoals hieronder wordt weer gegeven:
    ...
    a. Voer in het tekstvak **e-mail** het e-mail adres van b.simon@contoso.comde gebruiker in.
