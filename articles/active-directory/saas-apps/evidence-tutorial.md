...
ms.locfileid: "73158222"
---
# <a name="tutorial-azure-active-directory-integration-with-evidencecom"></a>Zelf studie: integratie Azure Active Directory met Evidence.com

In deze zelfstudie leert u hoe u Evidence.com kunt integreren met Azure Active Directory (Azure AD).
Het integreren van Evidence.com met Azure AD biedt u de volgende voordelen:

* U kunt in Azure AD beheren wie toegang heeft tot Evidence.com.
* U kunt uw gebruikers zich automatisch met hun Azure AD-account laten aanmelden bij Evidence.com (eenmalige aanmelding).
...
Voor het configureren van Azure AD-integratie met Evidence.com hebt u het volgende nodig:

* Een Azure AD-abonnement Als u geen Azure AD-omgeving hebt, kunt u [hier](https://azure.microsoft.com/pricing/free-trial/) de proefversie van één maand krijgen.
* Een abonnement op Evidence.com waarvoor eenmalige aanmelding is ingeschakeld
...
**Voer de volgende stappen uit om Evidence.com uit de galerie toe te voegen:**
...
4. Typ in het zoekvak **Evidence.com**, selecteer **Evidence.com** in het resultaatvenster en klik vervolgens op de knop **Toevoegen** om de toepassing toe te voegen.

     ![Evidence.com in de resultatenlijst](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD-eenmalige aanmelding configureren en testen

In dit gedeelte configureert en test u eenmalige aanmelding van Azure AD met Evidence.com op basis van een testgebruiker met de naam **Britta Simon**.
Eenmalige aanmelding werkt alleen als er een koppelingsrelatie tussen een Azure AD-gebruiker en de daaraan gerelateerde gebruiker in Evidence.com tot stand is gebracht.

Om Azure AD eenmalige aanmelding met Evidence.com te configureren en testen, moet u de volgende bouwstenen voltooien:

1. **[Azure AD-eenmalige aanmelding configureren](#configure-azure-ad-single-sign-on)**: als u wilt dat uw gebruikers deze functie kunnen gebruiken.
2. **[Evidence.com voor eenmalige aanmelding configureren](#configure-evidencecom-single-sign-on)**: als u de instellingen voor eenmalige aanmelding aan de toepassingszijde wilt configureren.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)**: als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)**: als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[Testgebruiker maken in Evidence.com](#create-evidencecom-test-user)**: als u een tegenhanger van Britta Simon in Evidence.com wilt hebben die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
1. In de [Azure-portal](https://portal.azure.com/) selecteert u **Eenmalige aanmelding** op de integratiepagina van de toepassing **Evidence.com**.
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    ![Domein- en URL-gegevens voor eenmalige aanmelding bij Evidence.com](common/sp-identifier.png)
...
### <a name="configure-evidencecom-single-sign-on"></a>Evidence.com voor eenmalige aanmelding configureren
...
In dit gedeelte gaat u Britta Simon toestemming geven voor gebruik van eenmalige aanmelding met Azure door haar toegang te geven tot Evidence.com.

1. Selecteer **Bedrijfstoepassingen** in de Azure-portal, selecteer **Alle toepassingen** en selecteer vervolgens **Evidence.com**.

    ![De blade Bedrijfstoepassingen](common/enterprise-applications.png)

2. Selecteer **Evidence.com** in de lijst met toepassingen.

    ![De koppeling Evidence.com in de lijst met toepassingen](common/all-applications.png)
