...
In deze sectie gaat u een gebruiker maken met de naam Britta Simon in ice Contact Center. Neem contact op met het [ondersteuningsteam van ice Contact Center](mailto:support@computer-talk.com) om de gebruikers toe te voegen in het ice Contact Center-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.

## <a name="test-sso"></a>Eenmalige aanmelding testen 

In deze sectie gaat u uw configuratie van Azure AD-eenmalige aanmelding testen via het toegangsvenster.

Wanneer u in het toegangsvenster op de tegel ice Contact Center klikt, zou u automatisch moeten worden aangemeld bij het exemplaar van ice Contact Center waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [ice Contact Center beveiligen met geavanceerde zichtbaarheid en controles](/cloud-app-security/proxy-intro-aad)