...
Wanneer u in het toegangsvenster op de tegel Form.com klikt, wordt u als het goed is automatisch aangemeld bij de instantie van Form.com waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
