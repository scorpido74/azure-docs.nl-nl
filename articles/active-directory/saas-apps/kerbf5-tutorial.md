...
1. Zodra de toepassing is ingeschakeld, klikt u op **volt ooien**.
...
2.  Klik op **Create**. Het scherm nieuwe server eigenschappen wordt geopend.
...
*  **Stap 1:** Een delegerings account maken
    ...
    * New-ADUser-name "APM-delegerings account"-UserPrincipalName host/big-ipuser.superdemo.live@superdemo.live-SamAccountName "Big-ipuser"-PasswordNeverExpires $true-ingeschakeld $true-AccountPassword (Read-host-AsSecureString "wacht woord! 1234")
