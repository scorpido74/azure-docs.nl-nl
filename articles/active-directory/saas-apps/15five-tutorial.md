---
title: 'Zelfstudie: Azure Active Directory-integratie met 15Five | Microsoft Documenten'
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    b. In het tekstvak **Id (Entiteits-id)** typt u een URL met het volgende patroon: `https://<companyname>.15five.com/saml2/metadata/`
