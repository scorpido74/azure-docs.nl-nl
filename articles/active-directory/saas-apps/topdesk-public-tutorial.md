---
title: 'Zelf studie: integratie Azure Active Directory met TOPdesk-Public | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-integration-with-topdesk---public"></a>Zelf studie: integratie Azure Active Directory met TOPdesk-openbaar
...
4.  Voer in de sectie **Standaard SAML-configuratie** de volgende stappen uit als u beschikt over een **bestand met metagegevens van de serviceprovider**:
    ...
    d. Typ in het tekstvak **URL voor aanmelding** een URL met het volgende patroon:`https://<companyname>.topdesk.net`
...
3. Klik op **Login Settings**.
    ...
    ![Aanmeldings instellingen](./media/topdesk-public-tutorial/ic790599.png "Aanmeldings instellingen")
