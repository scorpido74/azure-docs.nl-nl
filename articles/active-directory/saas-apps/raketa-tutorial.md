...
1. Typ **Raketa** in het zoekvak in het gedeelte **Toevoegen vanuit de galerie**.
1. Selecteer **Raketa** in het deelvenster met resultaten en voeg vervolgens de app toe. Wacht enkele seconden tot de app is toegevoegd aan de tenant.
...
1. Zoek in [Azure Portal](https://portal.azure.com/) op de integratiepagina van de toepassing **Raketa** de sectie **Beheren** en selecteer **Eenmalige aanmelding**.
...
1. In de sectie **Standaard-SAML-configuratie** voert u de waarden in voor de volgende velden:
    ...
    a. In het tekstvak **Aanmeldings-URL** typt u de URL: `https://raketa.travel/`

    b. In het tekstvak **Antwoord-URL** typt u een URL met de volgende notatie: `https://raketa.travel/sso/acs?clientId=<CLIENT_ID>`
...
1. Selecteer **Raketa** in de lijst met toepassingen.
...
In dit gedeelte maakt u in Raketa een gebruiker met de naam B.Simon. Neem contact op met het  [ondersteuningsteam van Raketa](mailto:help@raketa.travel) om de gebruikers toe te voegen in het Raketa-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
