...
Wanneer u in het toegangsvenster op de tegel SSOGEN Azure AD SSO-gateway voor Oracle E Business Suite EBS, People Soft en JDE klikt, wordt u als het goed is automatisch aangemeld bij het exemplaar van SSOGEN Azure AD SSO-gateway voor Oracle E Business Suite EBS, People Soft en JDE waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [SSOGEN Azure AD SSO-gateway voor Oracle E Business Suite EBS, People Soft en JDE beveiligen met geavanceerde zichtbaarheid en besturingselementen](/cloud-app-security/proxy-intro-aad)