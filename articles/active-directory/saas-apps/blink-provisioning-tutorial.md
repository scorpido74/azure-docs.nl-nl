---
title: 'Zelfstudie: Blink configureren voor automatische gebruikers inrichting met Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "71156122"
---
# <a name="tutorial-configure-blink-for-automatic-user-provisioning"></a>Zelfstudie: Blink configureren voor automatische gebruikers inrichting

Het doel van deze zelf studie is het demonstreren van de stappen die moeten worden uitgevoerd in Blink en Azure Active Directory (Azure AD) om Azure AD te configureren voor het automatisch inrichten en ongedaan maken van de inrichting van gebruikers en/of groepen om te blinken.
...
Voordat u automatische gebruikers inrichting configureert en inschakelt, moet u beslissen welke gebruikers en/of groepen in azure AD toegang nodig hebben om te blinken. Nadat u hebt besloten, kunt u deze gebruikers en/of groepen toewijzen aan het Knip peren door de instructies hier te volgen:
...
1. Een [ondersteunings Case](https://help.joinblink.com/hc/requests/new) of **ondersteuning** voor e support@joinblink.com -mail berichten in het logboek vastleggen om een scim-token aan te vragen. .
...
In deze sectie wordt u begeleid bij de stappen voor het configureren van de Azure AD-inrichtings service om gebruikers en/of groepen in Blink te maken, bij te werken en uit te scha kelen op basis van gebruikers-en/of groeps toewijzingen in azure AD.
...
5. Selecteer in de sectie **beheerders referenties** de `https://api.joinblink.com/scim` invoer in de **Tenant-URL**. Voer de waarde voor het **scim-verificatie token** in die eerder is opgehaald in het **geheime token**. Klik op **verbinding testen** om te controleren of Azure AD verbinding kan maken met Blink. Als de verbinding mislukt, zorg er dan voor dat uw Blink-account beheerders machtigingen heeft en probeer het opnieuw.
...
9. Controleer de gebruikers kenmerken die zijn gesynchroniseerd vanuit Azure AD om te blinken in de sectie **kenmerk toewijzing** . De kenmerken die zijn geselecteerd als **overeenkomende** eigenschappen worden gebruikt om te voldoen aan de gebruikers accounts in Blink voor bijwerk bewerkingen. Selecteer de knop **Opslaan** om eventuele wijzigingen door te voeren.
    ...
    ![Gebruikers kenmerken blinken](media/blink-provisioning-tutorial/User_attributes.png)
