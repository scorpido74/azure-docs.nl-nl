...
1. Selecteer **extra Url's instellen** en voer de volgende stap uit als u de toepassing in de door SP geïnitieerde modus wilt configureren:
    ...
    Voer in het vak **aanmeld-URL** **\/https:/patents.iamip.com/login-User**in.
...
1. Voer de volgende stappen uit in de eigenschappen van de **gebruiker** :
   ...
   1. Voer \<in het vak **gebruikers naam** de gebruikers naam>\<@ companydomain> in. \<extensie>. Bijvoorbeeld `B.Simon@contoso.com`.
