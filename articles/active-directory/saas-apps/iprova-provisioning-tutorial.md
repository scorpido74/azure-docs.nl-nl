...
5. Selecteer in de sectie **beheerders referenties** de invoer `https://identitymanagement.services.iProva.nl/scim` in de **Tenant-URL**. Voer de **permanente token** waarde in die eerder is opgehaald in het **geheime token**. Klik op **verbinding testen** om te controleren of Azure AD verbinding kan maken met iProva. Als de verbinding mislukt, zorg er dan voor dat uw iProva-account beheerders machtigingen heeft en probeer het opnieuw.
