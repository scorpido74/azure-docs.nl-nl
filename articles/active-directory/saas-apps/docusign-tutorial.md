...
1. Voer de volgende stappen uit in de sectie **basis configuratie van SAML** :
    ...
    a. Voer in het tekstvak **URL voor aanmelden** een URL in met het volgende patroon:
    ...
    > [!NOTE]
    > Deze waarden tussen haakjes zijn tijdelijke aanduidingen. Vervang deze door de waarden in de URL voor de werkelijke aanmelding, de id en de antwoord-URL. Deze details worden beschreven in de sectie ' SAML 2,0-eind punten weer geven ' verderop in deze zelf studie.
...
1. Voer de volgende stappen uit in de eigenschappen van de **gebruiker** :
   ...
   1. Typ `<username>@<companydomain>.<extension>`in het veld **gebruikers naam** . Bijvoorbeeld: `B.Simon@contoso.com`.
