---
title: 'Zelfstudie: Azure Active Directory-integratie met Lifesize Cloud | Microsoft Documenten'
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    a. Typ in het tekstvak **AANmeldings-URL** een URL met het volgende patroon:`https://login.lifesizecloud.com/ls/?acs`
