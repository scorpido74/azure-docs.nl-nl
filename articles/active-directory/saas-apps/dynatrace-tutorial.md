...
1. Klik op **aanvullende Url's instellen** en voer de volgende stap uit om de toepassing te configureren in de modus door **SP** gestart:
    ...
    Typ een URL in het tekstvak **URL voor aanmelding** :`https://sso.dynatrace.com/`
...
Als u eenmalige aanmelding wilt configureren aan de **Dynatrace** zijde, moet u het gedownloade **XML-bestand met federatieve meta gegevens** en de juiste gekopieerde url's van de Azure Portal naar [Dynatrace](https://www.dynatrace.com/support/help/shortlink/users-sso-hub)verzenden. U kunt de instructies op de Dynatrace-website volgen voor het configureren van de SAML SSO-verbinding aan beide zijden.
