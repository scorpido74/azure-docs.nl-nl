---
title: 'Zelf studie: integratie Azure Active Directory met Benefitsolver | Microsoft Docs'
...
ms.locfileid: "73158924"
---
# <a name="tutorial-azure-active-directory-integration-with-benefitsolver"></a>Zelf studie: integratie Azure Active Directory met Benefitsolver
...
5. **[Testgebruiker voor Benefitsolver maken](#create-benefitsolver-test-user)** : als u een tegenhanger van Britta Simon in Benefitsolver{b> <b}wilt hebben die is gekoppeld aan de Azure Active Directory-weergave van de gebruiker.
