---
title: 'Zelfstudie: Azure Active Directory-integratie met Expensify | Microsoft Documenten'
...
In deze zelfstudie leert u hoe U Expensify integreren met Azure Active Directory (Azure AD). Wanneer u Expensify integreert met Azure AD, u het als:

* Beheer in Azure AD die toegang heeft tot Expensify.
* Stel uw gebruikers in om automatisch te worden aangemeld bij Expensify met hun Azure AD-accounts.
...
* Expensify single sign-on (SSO) ingeschakeld abonnement.
...
1. Typ **Expensify in** het zoekvak in de sectie Toevoegen in de sectie Toevoegen in de **galerie.**
1. Selecteer **Expensify in het** deelvenster Resultaten en voeg de app toe. Wacht een paar seconden terwijl de app wordt toegevoegd aan uw tenant.

## <a name="configure-and-test-azure-ad-single-sign-on-for-expensify"></a>Azure AD-aanmelding configureren en testen voor Expensify

Azure AD SSO configureren en testen met Expensify met behulp van een testgebruiker genaamd **B.Simon**. Als SSO kan werken, moet u een koppelingsrelatie tot stand brengen tussen een Azure AD-gebruiker en de gerelateerde gebruiker in Expensify.

Als u Azure AD SSO wilt configureren en testen met Expensify, voert u de volgende bouwstenen uit:

1. **[Configureer Azure AD SSO](#configure-azure-ad-sso)** - zodat uw gebruikers deze functie kunnen gebruiken.
    1. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)** - om Azure AD-enkele aanmelding te testen met B.Simon.
    1. **[De Azure AD-testgebruiker toewijzen](#assign-the-azure-ad-test-user)** - om B.Simon in staat te stellen azure AD-aanmelding te gebruiken.
2. **[Configureer Expensify SSO](#configure-expensify-sso)** - om de instellingen voor één aanmelding aan de toepassingszijde te configureren.
    1. **[Maak Expensify-testgebruiker](#create-expensify-test-user)** - om een tegenhanger van B.Simon in Expensify te hebben die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
1. Zoek in de [Azure-portal](https://portal.azure.com/)op de pagina Integratie van toepassingen **expensify** de sectie **Beheren** en selecteer **Enkele aanmelding**.
...
1. Kopieer in de sectie **Expensify instellen** de juiste URL(s) op basis van uw vereiste.
...
In deze sectie u B.Simon inschakelen om Azure single sign-on te gebruiken door toegang te verlenen tot Expensify.
...
In deze sectie maakt u een gebruiker genaamd B.Simon in Expensify. Werk met het [Expensify-klantenondersteuningsteam](mailto:help@expensify.com) om de gebruikers toe te voegen in het Expensify-platform.
