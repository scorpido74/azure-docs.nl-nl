...
4. Klik op **Beheerder**.
    ...
    ![Schermopname met de XaitPorter-site, waarop Admin is geselecteerd.](./media/xaitporter-tutorial/user1.png)

5. Selecteer **Eenmalige aanmelding beheren** uit de vervolgkeuzelijst **Systeeminstallatie**.

    ![Schermopname met Manage Single Sign-On geselecteerd in System Setup.](./media/xaitporter-tutorial/user2.png)

6. Voer in het gedeelte **EENMALIGE AANMELDING BEHEREN** de volgende stappen uit:

    ![Schermopname van de sectie MANAGE SINGLE SIGN-ON, waar u deze stappen kunt uitvoeren.](./media/xaitporter-tutorial/user3.png)
