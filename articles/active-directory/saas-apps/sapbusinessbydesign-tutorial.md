...
5. Voor de SAP Business ByDesign-toepassing worden de SAML-asserties in een bepaalde indeling verwacht. Configureer de volgende claims voor deze toepassing. U kunt de waarden van deze kenmerken vanuit de sectie **Gebruikerskenmerken** op de integratiepagina van de toepassing-beheren. Op de pagina **Eenmalige aanmelding met SAML instellen** klikt u op de knop **Bewerken** om het dialoogvenster **Gebruikerskenmerken** te openen.
    ...
    ![Schermopname met het dialoogvenster 'Gebruikerskenmerken' met de knop 'Bewerken' geselecteerd.](common/edit-attribute.png)

6. Klik op het pictogram **Bewerken** om de **waarde van Naam-ID** te bewerken.

    ![Schermopname van de pagina Gebruikerskenmerken en claims, waarop het pictogram Bewerken is geselecteerd.](media/sapbusinessbydesign-tutorial/mail-prefix1.png)
...
3. Klik op **Nieuwe ID-provider** en selecteer het XML-bestand voor metagegevens dat u hebt gedownload vanuit Azure Portal. Door het importeren van de metagegevens worden automatisch het vereiste handtekeningcertificaat en versleutelingscertificaat geüpload.
    ...
    ![Schermopname van de pagina Configure Single Sign-On, waarop het tabblad Identity Provider en de actie New Identity Provider zijn geselecteerd.](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_54.png)
...
7. Klik op het tabblad **Mijn systeem**.
    ...
    ![Schermopname van de pagina Configure Single Sign-On, waarop het tabblad My System is geselecteerd.](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_52.png)
...
Wanneer u op de tegel SAP Business ByDesign klikt in het toegangsvenster, wordt u automatisch aangemeld bij het exemplaar van SAP Business ByDesign waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
