---
title: 'Zelfstudie: Azure Active Directory single sign-on (SSO) integratie met RedBrick Health | Microsoft Documenten'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-redbrick-health"></a>Zelfstudie: Azure Active Directory single sign-on (SSO) integratie met RedBrick Health

In deze zelfstudie leert u hoe u RedBrick Health integreren met Azure Active Directory (Azure AD). Wanneer u RedBrick Health integreert met Azure AD, u het als:

* Beheer in Azure AD die toegang heeft tot RedBrick Health.
* Stel uw gebruikers in staat om automatisch te worden aangemeld bij RedBrick Health met hun Azure AD-accounts.
...
* RedBrick Health single sign-on (SSO) ingeschakeld abonnement.
...
1. Typ In de sectie **Toevoegen in de galerie** de tekst **Roodsteenstatus** in het zoekvak.
1. Selecteer **RedBrick Health** in het deelvenster Resultaten en voeg de app toe. Wacht een paar seconden terwijl de app wordt toegevoegd aan uw tenant.

## <a name="configure-and-test-azure-ad-single-sign-on-for-redbrick-health"></a>Azure AD-aanmelding voor RedBrick-status configureren en testen

Azure AD SSO configureren en testen met RedBrick Health met behulp van een testgebruiker genaamd **B.Simon**. Als SSO kan werken, moet u een koppelingsrelatie tot stand brengen tussen een Azure AD-gebruiker en de gerelateerde gebruiker in RedBrick Health.

Als u Azure AD SSO wilt configureren en testen met RedBrick Health, voert u de volgende bouwstenen uit:

1. **[Configureer Azure AD SSO](#configure-azure-ad-sso)** - zodat uw gebruikers deze functie kunnen gebruiken.
    1. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)** - om Azure AD-enkele aanmelding te testen met B.Simon.
    1. **[De Azure AD-testgebruiker toewijzen](#assign-the-azure-ad-test-user)** - om B.Simon in staat te stellen azure AD-aanmelding te gebruiken.
1. **[Configureer RedBrick Health SSO](#configure-redbrick-health-sso)** - om de instellingen voor één aanmelding aan de toepassingszijde te configureren.
    1. **[RedBrick Health-testgebruiker maken](#create-redbrick-health-test-user)** - om een tegenhanger van B.Simon in RedBrick-status te hebben die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
1. Zoek in de [Azure-portal](https://portal.azure.com/)op de pagina **RedBrick** Health-toepassingsintegratie de sectie **Beheren** en selecteer **eenmalige aanmelding**.
...
1. Voer in de sectie **BasisSAML-configuratie** de waarden in voor de volgende velden:
    ...
    b. Typ een URL in het tekstvak **URL beantwoorden:**`https://sso-intg.redbrickhealth.com/sp/ACS.saml2`
...
1. Kopieer in de sectie **RedBrick Health** instellen de juiste URL(s) op basis van uw vereiste.
...
In deze sectie u B.Simon inschakelen om Azure single sign-on te gebruiken door toegang te verlenen tot RedBrick Health.
...
In deze sectie maakt u een gebruiker genaamd B.Simon in RedBrick Health. Neem contact op met het  [ondersteuningsteam van RedBrick Health](https://home.redbrickhealth.com/contact/) om de gebruikers toe te voegen aan het RedBrick Health-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
...
- [RedBrick-status proberen met Azure AD](https://aad.portal.azure.com/)