---
title: 'Zelfstudie: Azure Active Directory-integratie met eenmalige aanmelding (SSO) met RedBrick-status | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-redbrick-health"></a>Zelfstudie: Azure Active Directory-integratie met eenmalige aanmelding (SSO) met RedBrick-status
...
Om eenmalige aanmelding te configureren in **RedBrick Health**, moet u het gedownloade **Certificaat (Base64)** en de juiste uit de Azure-portal gekopieerde URL's verzenden naar het [ondersteuningsteam van RedBrick Health](https://home.redbrickhealth.com/contact/). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.

### <a name="create-redbrick-health-test-user"></a>Een testgebruiker maken voor RedBrick Health

In deze sectie maakt u een gebruiker met de naam B. Simon in RedBrick Health. Neem contact op met het  [ondersteuningsteam van RedBrick Health](https://home.redbrickhealth.com/contact/) om de gebruikers toe te voegen aan het RedBrick Health-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken.
