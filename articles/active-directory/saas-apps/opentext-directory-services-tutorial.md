...
Wanneer u in het toegangsvenster op de tegel OpenText Directory Services klikt, zou u automatisch moeten worden aangemeld bij het exemplaar van OpenText Directory Services waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [OpenText Directory Services beveiligen met geavanceerde zichtbaarheid en besturingselementen](/cloud-app-security/proxy-intro-aad)