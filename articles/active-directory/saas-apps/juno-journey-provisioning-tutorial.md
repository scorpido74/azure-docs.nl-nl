---
title: 'Zelfstudie: Juno Journey configureren voor automatische gebruikersvoorziening met Azure Active Directory | Microsoft Documenten'
description: Meer informatie over het automatisch inrichten en de-inrichten van gebruikersaccounts van Azure AD naar Juno Journey.
...
In deze zelfstudie worden de stappen beschreven die u moet uitvoeren in zowel Juno Journey als Azure Active Directory (Azure AD) om automatische gebruikersinrichting te configureren. Wanneer azure AD is geconfigureerd, worden gebruikers en groepen automatisch in- en uitvoorzieningen van [Azure](https://www.junojourney.com/) AD voorzien met behulp van de Azure AD Provisioning-service. Zie Gebruikersinrichting en deprovisioning voor SaaS-toepassingen automatiseren voor belangrijke details over wat deze service doet, hoe deze werkt en veelgestelde vragen, zie [Gebruikersinrichting automatiseren en deprovisioning voor SaaS-toepassingen met Azure Active Directory](../manage-apps/user-provisioning.md). 


## <a name="capabilities-supported"></a>Ondersteunde mogelijkheden
> [!div class="checklist"]
> * Gebruikers maken in Juno Journey
> * Verwijder gebruikers in Juno Journey wanneer ze geen toegang meer nodig hebben
> * Gebruikerskenmerken gesynchroniseerd houden tussen Azure AD en Juno Journey
> * [Single sign-on to](https://docs.microsoft.com/azure/active-directory/saas-apps/juno-journey-tutorial) Juno Journey (aanbevolen)
...
*  Een [Juno Journey huurder](https://www.junojourney.com/getstartedwithjuno).
...
3. Bepaal welke gegevens u wilt [toewijzen tussen Azure AD en Juno Journey](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

## <a name="step-2-configure-juno-journey-to-support-provisioning-with-azure-ad"></a>Stap 2. Juno Journey configureren om de inrichting met Azure AD te ondersteunen

1. Neem voor **secret token** en tenant support@the-juno.com **URL** contact op met juno journey support team op . Deze waarde wordt respectievelijk ingevoerd in de **URL-velden Secret Token** en **Tenant** op het tabblad Provisioning van uw Juno Journey-toepassing in de Azure-portal. 

## <a name="step-3-add-juno-journey-from-the-azure-ad-application-gallery"></a>Stap 3. Juno Journey toevoegen vanuit de Azure AD-toepassingsgalerie

Voeg Juno Journey toe vanuit de Azure AD-toepassingsgalerie om de inrichting aan Juno Journey te beheren. Als u Juno Journey eerder hebt ingesteld voor SSO, u dezelfde toepassing gebruiken. Het wordt echter aanbevolen om een aparte app te maken bij het testen van de integratie in eerste instantie. Meer informatie over het toevoegen van een toepassing uit de galerie [hier](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
## <a name="step-5-configure-automatic-user-provisioning-to-juno-journey"></a>Stap 5. Automatische gebruikersvoorziening configureren voor Juno Journey 
...
### <a name="to-configure-automatic-user-provisioning-for-juno-journey-in-azure-ad"></a>Ga als een te meer met de automatische gebruikersvoorziening voor Juno Journey in Azure AD:
...
2. Selecteer **Juno Journey**in de lijst met toepassingen .
    ...
    ![De juno journey-koppeling in de lijst Toepassingen](common/all-applications.png)
...
5. Voer onder de sectie **Beheerdersreferenties** de URL-waarde van de tenant in die eerder in **tenant-URL**is opgehaald . Voer de geheime tokenwaarde in die eerder in **Secret Token**is opgehaald. Klik **op Verbinding testen** om ervoor te zorgen dat Azure AD verbinding kan maken met Juno Journey. Als de verbinding mislukt, moet u ervoor zorgen dat uw Juno Journey-account beheerdersmachtigingen heeft en het opnieuw proberen.
...
8. Selecteer Azure **Active Directory-gebruikers synchroniseren met Juno Journey**onder de sectie **Toewijzingen** .

9. Controleer de gebruikerskenmerken die zijn gesynchroniseerd van Azure AD naar Juno Journey in de sectie **Kenmerktoewijzing.** De kenmerken die zijn geselecteerd als **eigenschappen matching** worden gebruikt om de gebruikersaccounts in Juno Journey te matchen voor updatebewerkingen. Als u ervoor kiest het [overeenkomende doelkenmerk](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)te wijzigen, moet u ervoor zorgen dat de Juno Journey API filteringgebruikers ondersteunt op basis van dat kenmerk. Selecteer de knop **Opslaan** om wijzigingen door te voeren.
...
11. Als u de Azure AD-inrichtingsservice voor Juno Journey wilt inschakelen, wijzigt u de **instelstatus** in **Aan** in de sectie **Instellingen.**

    ![Status inrichten ingeschakeld](common/provisioning-toggle-on.png)

12. Definieer de gebruikers en/of groepen die u aan Juno Journey wilt inrichten door de gewenste waarden in **Bereik** te kiezen in de sectie **Instellingen.**
