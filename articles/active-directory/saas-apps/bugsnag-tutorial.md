---
title: 'Zelfstudie: Azure Active Directory-integratie met Bugsnag | Microsoft Documenten'
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit als u de toepassing in de door **IDP** geïnitieerde modus wilt configureren:
    ...
    Typ in het tekstvak **URL beantwoorden** een URL met het volgende patroon:`https://app.bugsnag.com/user/sign_in/saml/<org_slug>/acs`
