---
title: 'Zelfstudie: Azure Active Directory-integratie met IdeaScale | Microsoft Documenten'
...
4. Selecteer **SAML 2.0** als **Type eenmalige aanmelding**.
    ...
    ![Type met één teken](./media/ideascale-tutorial/ic790849.png "Type met één teken")
...
4. Klik op **Lid toevoegen**.
    ...
    ![Beheer van leden](./media/ideascale-tutorial/ic790852.png "Beheer van leden")
...
> [!NOTE]
> U alle andere tools voor het maken van ideascale-gebruikersaccounts of API's van IdeaScale gebruiken om Azure AD-gebruikersaccounts in te richten.
