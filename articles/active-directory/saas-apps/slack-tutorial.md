...
4. Voer in het dialoogvenster **SAML-verificatie-instellingen** de volgende stappen uit:
    ...
    e. Klik op **expand** en typ `https://slack.com` in het tekstvak **Identity provider issuer**.
