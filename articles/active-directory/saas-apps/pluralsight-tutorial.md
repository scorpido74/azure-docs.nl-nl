...
## <a name="configure-and-test-azure-ad-single-sign-on-for-pluralsight"></a>Eenmalige aanmelding van Azure AD configureren en testen voor Pluralsight
...
Als u eenmalige aanmelding van Azure AD wilt configureren en testen met Pluralsight, voert u de volgende procedures uit:
...
1. Zoek in de [Azure-portal](https://portal.azure.com/) op de integratiepagina van de toepassing **Pluralsight** de sectie **Beheren** en selecteer **Eenmalige aanmelding** .
...
Wanneer u op de tegel Pluralsight in het toegangsvenster klikt, zou u automatisch moeten worden aangemeld bij de instantie van Pluralsight waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [Pluralsight uitproberen met Azure AD](https://aad.portal.azure.com/)