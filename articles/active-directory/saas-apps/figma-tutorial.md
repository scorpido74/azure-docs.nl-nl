---
title: 'Zelf studie: Azure Active Directory de integratie van eenmalige aanmelding (SSO) met Figma | Microsoft Docs'
...
In deze zelf studie leert u hoe u Figma integreert met Azure Active Directory (Azure AD). Wanneer u Figma integreert met Azure AD, kunt u het volgende doen:

* Controle in azure AD die toegang heeft tot Figma.
* Zorg ervoor dat uw gebruikers automatisch worden aangemeld bij Figma met hun Azure AD-accounts.
...
* Figma-abonnement dat is ingeschakeld voor eenmalige aanmelding (SSO).
...
1. Typ in de sectie **toevoegen vanuit de galerie** **Figma** in het zoekvak.
1. Selecteer **Figma** uit het paneel resultaten en voeg vervolgens de app toe. Wacht een paar seconden wanneer de app aan uw Tenant is toegevoegd.

## <a name="configure-and-test-azure-ad-single-sign-on-for-figma"></a>Eenmalige aanmelding voor Azure AD configureren en testen voor Figma

Azure AD SSO met Figma configureren en testen met behulp van een test gebruiker met de naam **B. Simon**. Voor het werken met SSO moet u een koppelings relatie tot stand brengen tussen een Azure AD-gebruiker en de bijbehorende gebruiker in Figma.

Als u Azure AD SSO wilt configureren en testen met Figma, voltooit u de volgende bouw stenen:

1. **[Configureer Azure AD SSO](#configure-azure-ad-sso)** -om uw gebruikers in staat te stellen deze functie te gebruiken.
    * **[Een Azure AD-test gebruiker maken](#create-an-azure-ad-test-user)** : u kunt eenmalige aanmelding voor Azure AD testen met B. Simon.
    * **[Wijs de Azure AD-test gebruiker](#assign-the-azure-ad-test-user)** toe, zodat B. Simon de eenmalige aanmelding van Azure AD kan gebruiken.
1. **[FIGMA SSO configureren](#configure-figma-sso)** : voor het configureren van de instellingen voor eenmalige aanmelding aan de kant van de toepassing.
    * **[Maak een Figma-test gebruiker](#create-figma-test-user)** -om een equivalent van B. Simon in Figma te hebben dat is gekoppeld aan de Azure AD-representatie van de gebruiker.
...
1. Zoek in het [Azure Portal](https://portal.azure.com/)op de pagina Toepassings integratie van **Figma** de sectie **beheren** en selecteer **eenmalige aanmelding**.
...
In deze sectie schakelt u B. Simon in om eenmalige aanmelding van Azure te gebruiken door toegang te verlenen aan Figma.
...
- [Probeer Figma met Azure AD](https://aad.portal.azure.com/)