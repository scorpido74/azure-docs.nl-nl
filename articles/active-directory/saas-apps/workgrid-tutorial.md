...
Wanneer u op de Workgrid-tegel in het toegangsvenster klikt, wordt u automatisch aangemeld bij de instantie van Workgrid waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
