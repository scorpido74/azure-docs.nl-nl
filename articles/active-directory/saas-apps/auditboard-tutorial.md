---
title: 'Zelfstudie: Azure Active Directory-integratie met AuditBoard | Microsoft Documenten'
...
---
# <a name="tutorial-azure-active-directory-integration-with-auditboard"></a>Zelfstudie: Azure Active Directory-integratie met AuditBoard
...
4. In het gedeelte **Standaard SAML-configuratie** voert u de volgende stappen uit als u de toepassing in de door **IdP geïnitieerde** modus wilt configureren:
    ...
    c. Klik **op Extra URL's instellen** en voer de volgende stap uit als u de toepassing wilt configureren in de **gestarte SP-modus:**
