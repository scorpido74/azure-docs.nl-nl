---
title: 'Zelf studie: integratie Azure Active Directory met MindTickle | Microsoft Docs'
...
ms.locfileid: "73160557"
---
# <a name="tutorial-azure-active-directory-integration-with-mindtickle"></a>Zelf studie: integratie Azure Active Directory met MindTickle
...
4. Voer in de sectie **Standaard SAML-configuratie** de volgende stappen uit als u beschikt over een **bestand met metagegevens van de serviceprovider**:
    ...
    In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://<subdomain>.mindtickle.com`
