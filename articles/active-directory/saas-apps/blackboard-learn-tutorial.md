---
title: 'Zelf studie: Azure Active Directory-integratie met eenmalige aanmelding (SSO) met school bord leren | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-blackboard-learn"></a>Zelf studie: Azure Active Directory SSO-integratie (single sign-on) met school bord leren
