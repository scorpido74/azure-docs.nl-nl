...
In deze sectie maakt u een gebruiker met de naam B.Simon in Yuhu Property Management Platform. Neem contact op met het [ondersteuningsteam van Yuhu Property Management Platform](mailto:hello@yuhu.io) om de gebruikers toe te voegen in het Yuhu Property Management Platform-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.

## <a name="test-sso"></a>Eenmalige aanmelding testen

In deze sectie gaat u uw configuratie van Azure AD-eenmalige aanmelding testen via het toegangsvenster.

Wanneer u op de tegel Yuhu Property Management Platform klikt in het Toegangsvenster, wordt u automatisch aangemeld bij de instantie van Yuhu Property Management Platform waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
