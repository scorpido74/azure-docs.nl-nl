---
title: 'Zelf studie: Azure Active Directory integratie met school bord leren-shibboleth | Microsoft Docs'
...
ms.locfileid: "73158818"
---
# <a name="tutorial-azure-active-directory-integration-with-blackboard-learn---shibboleth"></a>Zelf studie: Azure Active Directory integratie met school bord leren-shibboleth
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    > [!NOTE]
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke aanmeldings-URL, id en antwoord-URL. Neem contact op met het [ondersteuningsteam van Blackboard Learn - Shibboleth](https://www.blackboard.com/forms/contact-us_form.aspx) om deze waarden te verkrijgen. U kunt ook verwijzen naar het patroon dat wordt weergegeven in de sectie **Standaard SAML-configuratie** in de Azure-portal.
