...
4. In het gedeelte **Standaard SAML-configuratie** voert u de volgende stappen uit als u de toepassing in de door **IDP** geïnitieerde modus wilt configureren:
    ...
    ![Domein- en URL-gegevens voor eenmalige aanmelding bij JDA Cloud Domain](common/idp-intiated.png)
...
5. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:
    ...
    ![Domein- en URL-gegevens voor eenmalige aanmelding bij JDA Cloud Domain](common/metadata-upload-additional-signon.png)
...
In deze sectie maakt u een gebruiker met de naam Britta Simon in JDA Cloud. Neem contact op met het  [ondersteuningsteam van JDA Cloud](https://support.jda.com/) om de gebruikers toe te voegen op het JDA Cloud-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.

### <a name="test-single-sign-on"></a>Eenmalige aanmelding testen

In deze sectie gaat u uw configuratie van Azure AD-eenmalige aanmelding testen via het toegangsvenster.

Wanneer u in het toegangsvenster op de tegel JDA Cloud klikt, wordt u automatisch aangemeld bij de instantie van JDA Cloud waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
