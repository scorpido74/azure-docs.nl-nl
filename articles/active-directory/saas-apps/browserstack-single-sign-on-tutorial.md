...
In dit gedeelte maakt u in BrowserStack Single Sign-on een gebruiker met de naam B.Simon. Neem contact op met het[ondersteuningsteam van BrowserStack Single Sign-on](mailto:support@browserstack.com) om de gebruikers toe te voegen in het BrowserStack Single Sign-on-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
...
- [BrowserStack Single Sign-on beveiligen met geavanceerde zichtbaarheid en besturingselement](/cloud-app-security/proxy-intro-aad)