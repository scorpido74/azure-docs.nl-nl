...
5. Selecteer in de sectie **beheerders referenties** de `https://mingle-t20b-scim.mingle.awsdev.infor.com/INFORSTS_TST/v2/scim` invoer in de **Tenant-URL**. Invoer van de Bearer-token waarde die eerder is opgehaald in het **geheime token**. Klik op **verbinding testen** om te controleren of Azure AD verbinding kan maken met infor CloudSuite. Als de verbinding mislukt, zorg er dan voor dat uw infor CloudSuite-account beheerders machtigingen heeft en probeer het opnieuw.
