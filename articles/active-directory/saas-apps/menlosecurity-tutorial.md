---
title: 'Zelfstudie: Azure Active Directory-integratie met Menlo-beveiliging | Microsoft Documenten'
...
2. Kies onder **Instellingen** voor **Verificatie** en voer de volgende acties uit:
    ...
    d. **SAML 2.0-eindpunt:** plak de **aanmeldings-URL** die u hebt gekopieerd van Azure-portal.

    e. **Service-id (Emittent)** : plak de **Azure AD-id** die u hebt gekopieerd van Azure-portal.

    f. **X.509-certificaat:** Open het **certificaat (Base64)** dat is gedownload van de Azure Portal in kladblok en plak het in dit vak.
