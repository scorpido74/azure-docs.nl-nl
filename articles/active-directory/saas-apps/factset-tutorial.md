...
Wanneer u in het toegangsvenster op de tegel FactSet klikt, zou u automatisch moeten worden aangemeld bij het exemplaar van FactSet waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
...
- [FactSet beveiligen met geavanceerde zichtbaarheid en besturingselementen](/cloud-app-security/proxy-intro-aad)