...
## <a name="configure-and-test-azure-ad-single-sign-on-for-dotcom-monitor"></a>Eenmalige aanmelding van Azure AD configureren en testen voor Dotcom-Monitor
...
Voltooi de volgende stappen om eenmalige aanmelding van Azure AD met Dotcom-Monitor te configureren en testen:
...
1. **[Eenmalige aanmelding voor Dotcom-Monitor configureren](#configure-dotcom-monitor-sso)** : als u de instellingen voor eenmalige aanmelding aan de toepassingszijde wilt configureren.
    * **[Testgebruiker voor Dotcom-Monitor maken](#create-dotcom-monitor-test-user)** : als u een tegenhanger van B.Simon in Dotcom-Monitor wilt hebben die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
1. Zoek in de [Azure-portal](https://portal.azure.com/) op de integratiepagina van de toepassing **Dotcom-Monitor** de sectie **Beheren** en selecteer **Eenmalige aanmelding** .
...
1. Bovendien worden in de Dotcom-Monitor-toepassing nog enkele kenmerken verwacht die als SAML-antwoord moeten worden doorgestuurd. Deze worden hieronder weergegeven. Deze kenmerken worden ook vooraf ingevuld, maar u kunt ze herzien volgens uw vereisten.
    ...
    > [!NOTE]
    > U vindt [hier](../develop/active-directory-enterprise-app-role-management.md) meer richtlijnen voor het maken van aangepaste rollen in Azure Active Directory.
...
Wanneer u in het toegangsvenster op de tegel Dotcom-Monitor klikt, zou u automatisch moeten worden aangemeld bij het exemplaar van Dotcom-Monitor waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
