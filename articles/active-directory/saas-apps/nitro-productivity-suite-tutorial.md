...
Wanneer u de tegel Nitro Productivity Suite in het toegangsvenster selecteert, wordt u automatisch aangemeld bij het exemplaar van Nitro Productivity Suite waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Aanmelden bij en het starten van apps vanuit de Mijn apps-portal](../user-help/my-apps-portal-end-user-access.md) voor meer informatie.
...
- [Nitro Productivity Suite beschermen met geavanceerde zichtbaarheid en controles](/cloud-app-security/proxy-intro-aad)