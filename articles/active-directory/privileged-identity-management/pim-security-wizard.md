...
> [!Important]
> De wizard Beveiliging is tijdelijk niet beschikbaar. Hartelijk dank voor uw geduld.
...
> [!WARNING]
> Het is belang rijk dat u ten minste één globale beheerder hebt en dat er meer dan één geprivilegieerde rol beheerder met een werk-of school account is (niet een Microsoft-account). Als er slechts één rol beheerder met beheerders rechten is, kan de organisatie Privileged Identity Management niet beheren als dat account wordt verwijderd.
