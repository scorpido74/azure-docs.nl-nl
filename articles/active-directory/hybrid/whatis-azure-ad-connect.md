...
- [Status controle](whatis-hybrid-identity-health.md) : Azure AD Connect Health kunnen robuuste bewaking bieden en een centrale locatie in de Azure Portal bieden om deze activiteit weer te geven. 
...
|Eenvoudig te implementeren en beheren|[Snelle agent installatie](how-to-connect-health-agent-install.md#installing-the-azure-ad-connect-health-agent-for-ad-fs)</br>Agent automatisch upgraden naar meest recente versie</br>Gegevens binnen enkele minuten beschikbaar in de portal|
