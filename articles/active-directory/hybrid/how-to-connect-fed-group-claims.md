...
Zie de document [methoden voor het toewijzen van gebruikers en groepen aan een app](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups) voor meer informatie over het beheren van groeps toewijzing aan toepassingen.
...
[Methoden voor het toewijzen van gebruikers en groepen aan een app](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups)

[Functie claims configureren](../../active-directory/develop/active-directory-enterprise-app-role-management.md)
