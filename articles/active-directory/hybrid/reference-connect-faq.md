...
Als u wilt controleren welke versie van Azure AD Connect op uw server is geïnstalleerd, gaat u naar configuratie scherm en zoekt u de geïnstalleerde versie van Microsoft Azure AD Connect door **Program ma's** > **Program ma's en onderdelen**te selecteren, zoals hier wordt weer gegeven:
