...
|-----|-----|-----|-----|-----|
|On-premises Active Directory|msExchUserHoldPolicies|Rechtstreeks|msExchUserHoldPolices|In van de uitwisseling van AD-gebruikers|

Uitgaand naar Azure AD:

|Omgekeerd kenmerk|Kenmerk naam|Stroom type|Azure AD-kenmerk|Synchronisatie regel|
|-----|-----|-----|-----|-----|
|Azure Active Directory|msExchUserHoldPolicies|Rechtstreeks|msExchUserHoldPolicies|Naar AAD – UserExchangeOnline|
...
|Active Directory kenmerk|Kenmerk naam|Stroom type|Omgekeerd kenmerk|Synchronisatie regel|
|-----|-----|-----|-----|-----|
|On-premises Active Directory|cloudMsExchUserHoldPolicies|Rechtstreeks|cloudMsExchUserHoldPolicies|In van AAD-gebruikers uitwisseling|
