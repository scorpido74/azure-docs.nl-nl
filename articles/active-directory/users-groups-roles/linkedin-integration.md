...
1. Selecteer **gebruikers instellingen**op de Blade **gebruikers** .
...
### <a name="get-the-current-list-of-selected-users"></a>De huidige lijst met geselecteerde gebruikers ophalen

1. Meld u aan bij Microsoft 365 met uw beheerders account.
1. Ga naar https://linkedinselectedusermigration.azurewebsites.net/. U ziet een lijst met gebruikers die zijn geselecteerd voor de verbindingen van LinkedIn-accounts.
...
1. Installeer de Azure AD-module door `Install-Module AzureAD` uit te voeren
