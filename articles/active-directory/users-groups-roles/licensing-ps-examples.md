...
Volledige functionaliteit voor op groepen gebaseerde licentie verlening is beschikbaar via de [Azure Portal](https://portal.azure.com). er zijn momenteel enkele nuttige taken die kunnen worden uitgevoerd met de bestaande [MSOnline Power shell-cmdlets](/powershell/module/msonline) en Microsoft Graph. In dit document vindt u voor beelden van wat er mogelijk is.
...
## <a name="assign-licenses-to-a-group"></a>Licenties toewijzen aan een groep

Gebruik het volgende voor beeld om licenties toe te wijzen aan een groep met behulp van Microsoft Graph:
