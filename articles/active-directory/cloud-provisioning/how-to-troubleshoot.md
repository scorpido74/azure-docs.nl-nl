...
1. Open **Services** op de server waarop de agent is geïnstalleerd of ga naar **Start** > **Voer** > **Services. msc**uit.
...
1. Vervang de sectie bestaande `<system.diagnostics>` door het volgende en alle tracerings berichten worden naar het bestand *ProvAgentTrace. log*.
