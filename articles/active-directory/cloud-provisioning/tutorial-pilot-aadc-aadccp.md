...
## <a name="create-custom-user-inbound-rule"></a>Een aangepaste regel voor binnenkomende gebruikers maken
 ...
 ![Menu synchronisatie regel Editor](media/how-to-cloud-custom-user-rule/user8.png)</br>
 ...
 4. Voer op de pagina **bereik filteren** de OE of beveiligings groep in die u op basis van de pilot wilt.  Als u wilt filteren op OE, voegt u het OE-gedeelte van de DN-naam toe. Deze regel wordt toegepast op alle gebruikers in die organisatie-eenheid.  Als DN eindigt op ' OE = Cpu's, DC = contoso, DC = com, voegt u dit filter toe.  Klik vervolgens op **Volgende**. 

    |Regel|Kenmerk|Operator|Waarde|
    |-----|----|----|-----|
    |Organisatie-eenheid bereik|REFERENTIES|ENDSWITH|DN-naam van de organisatie-eenheid.|
...
## <a name="create-custom-user-outbound-rule"></a>Uitgaande regel voor een aangepaste gebruiker maken
 ...
 3. Kies op de pagina **bereik filteren** de **waarde** **cloudNoFlow** gelijk aan. Klik vervolgens op **Volgende**.
...
4. Op het **scherm on-premises Provisioning agents** ziet u de agents die u hebt geïnstalleerd.  Controleer of de agent in kwestie is en is gemarkeerd als **uitgeschakeld**.  De agent is uitgeschakeld door standaard ![agents voor inrichting](media/how-to-install/verify1.png)</br>
...
![ligt](media/tutorial-existing-forest/scope1.png)</br>
 9. Klik op het scherm **optionele functies** op **volgende**.
 10. Klik in het scherm **gereed voor configuratie** op **configureren**.
