...
[Hybride Azure AD join configureren voor Windows-apparaten die zijn toegevoegd aan een domein en die federatieve gebruikmaken van ADFS](manage-stale-devices.md)
