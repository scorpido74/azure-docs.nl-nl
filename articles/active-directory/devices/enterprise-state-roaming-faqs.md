...
1. Zoek de GUID voor elke Azure AD-Tenant. Open de Azure Portal en selecteer een Azure AD-Tenant. De GUID voor de Tenant bevindt zich op de pagina eigenschappen voor de geselecteerde Tenant (https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/Properties), **Directory-id**met label. 
...
Ga in de **instellingen** -app naar **accounts** > **uw instellingen te synchroniseren**. Op deze pagina kunt u zien welk account wordt gebruikt om instellingen te roamen, en kunt u afzonderlijke groeps instellingen inschakelen of uitschakelen.
