...
### <a name="can-i-use-kerberos-constrained-delegation-in-the-remote-desktop-gateway-publishing-scenario"></a>Kan ik beperkte Kerberos-delegering gebruiken in het scenario voor het publiceren van Extern bureaublad-gateway?
...
Functies (gebeurtenis logboeken, Power shell en Extern bureaublad-services) in Windows-beheer centrum (WAC) of Extern bureaublad-webclient werken niet via Azure AD-toepassingsproxy.
