...
1. Selecteer **Eigenschappen** in de sectie **Beheren** om het deelvenster **Eigenschappen** te openen voor bewerken.
...
1. Neem even de tijd om de opties die beschikbaar zijn voor configuratie te bestuderen:
...
1. Gebruik de volgende tabellen als hulp bij het kiezen van de beste opties voor uw behoeften.
...
1. Selecteer in het Azure AD-portal **Bedrijfstoepassingen**. Zoek en selecteer vervolgens de toepassing die u wilt configureren.
1. Selecteer **Eigenschappen** in de sectie **Beheren** om het deelvenster **Eigenschappen** te openen voor bewerken. 
1. Selecteer het pictogram om het logo te uploaden.
