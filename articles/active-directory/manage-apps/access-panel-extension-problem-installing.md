---
title: De browser extensie voor het toepassings toegangs paneel installeren-Azure | Microsoft Docs
...
## <a name="web-browser-requirements"></a>Webbrowser vereisten
...
* Als u een andere URL gebruikt dan `https://myapps.microsoft.com`, configureert u de standaard-URL door het volgende te doen:
