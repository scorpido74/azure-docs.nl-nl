...
1.  Nadat de toepassing is geladen, opent u **Standaard SAML-configuratie**. Controleer of werk de waarde in het tekstvak antwoord-URL in om overeen te komen met de `AssertionConsumerServiceURL` waarde in de SAML-aanvraag.    
...
1. Neem contact op met de leverancier van de toepassing en deel de volgende gegevens:
