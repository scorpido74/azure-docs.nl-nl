...
| [Uitgeschakeld](#disabled-sso) | Cloud en on-premises | Kies uitgeschakelde eenmalige aanmelding wanneer de app niet gereed is om te worden geconfigureerd voor eenmalige aanmelding. Gebruikers moeten hun gebruikers naam en wacht woord elke keer invoeren wanneer ze deze toepassing starten.|
