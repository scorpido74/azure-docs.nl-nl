---
title: Gebruikerstokens in B2B-samenwerking begrijpen - Azure AD
description: Verwijzing naar gebruikerstoken voor Azure Active Directory B2B-samenwerking
...
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>Gebruikerstokens begrijpen in Azure AD B2B-samenwerking

Als u wilt weten hoe het token eruit ziet voor een B2B-samenwerkingsgebruiker, zijn hier de tokendetails aan toonder en token-inhoud voor een Azure Active Directory-gast (Azure AD) en een Microsoft-accountgast in de brontenant (voor tenantid 04dcc6ab-388a-4559-b527-fbec656300ea). Gebruik [https://jwt.io/](https://jwt.io/) of [https://jwt.ms/](https://jwt.ms/).
...
## <a name="microsoft-account-guest-token"></a>Gasttoken voor Microsoft-account
```
