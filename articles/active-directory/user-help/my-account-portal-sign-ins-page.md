...
## <a name="view-your-recent-sign-in-activity"></a>Uw recente aanmeldings activiteit weer geven
...
1. Typ op de pagina **recente activiteit controleren** de informatie waarnaar u wilt zoeken in de **Zoek** balk. Typ bijvoorbeeld `My Account` om te zoeken naar alle activiteiten die zijn verzameld door de app mijn account.
