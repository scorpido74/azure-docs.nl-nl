    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Hulp met Mijn profiel-portal (preview)</h3>
                        <p>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Hulp bij beveiligingsgegevens (preview)</h3>
                        <p>
                        <a href="/azure/active-directory/user-help/user-help-security-info-overview">Overzicht</a><br/>
                        <a href="/azure/active-directory/user-help/security-info-setup-signin">Instellen vanuit een prompt op de aanmeldingspagina</a><br/>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Hulp bij verificatie in twee stappen</h3>
                        <p>
                        <a href="/azure/active-directory/user-help/multi-factor-authentication-setup-auth-app">Een verificator-app instellen</a><br/>
                        <a href="/azure/active-directory/user-help/multi-factor-authentication-setup-phone-number">Een mobiel apparaat instellen</a><br/>
                        <a href="/azure/active-directory/user-help/multi-factor-authentication-setup-office-phone">Een kantoortelefoon instellen</a><br/>
                        <a href="/azure/active-directory/user-help/multi-factor-authentication-end-user-manage-settings">Uw instellingen beheren</a><br/>
                        <a href="/azure/active-directory/user-help/multi-factor-authentication-end-user-troubleshoot">Hulp bij veelvoorkomende problemen</a><br/>
                        <a href="/azure/active-directory/user-help/user-help-sign-in">Aanmelden</a>
                        </p>
                    </div>
                </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Hulp bij wachtwoord opnieuw instellen</h3>
                        <p>
                        <a href="/azure/active-directory/user-help/active-directory-passwords-reset-register">Registreren voor wachtwoordherstel</a><br/>
                        <a href="/azure/active-directory/user-help/security-info-setup-email">E-mail instellen</a><br/>
                        <a href="/azure/active-directory/user-help/security-info-setup-questions">Beveiligingsvragen instellen</a><br/>
                        <a href="/azure/active-directory/user-help/user-help-reset-password">Uw wachtwoord opnieuw instellen</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Hulp bij mijn apparaten beheren</h3>
                        <p>
                        <a href="/azure/active-directory/user-help/user-help-join-device-on-network">Uw werkapparaat toevoegen</a><br/>
                        <a href="/azure/active-directory/user-help/user-help-register-device-on-network">Uw persoonlijke apparaat registreren voor werk</a>
                        </p>
                    </div>
                </div>
            </div>
