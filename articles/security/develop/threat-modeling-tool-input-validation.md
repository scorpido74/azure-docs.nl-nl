...
| **Toepasselijke technologieën** | Algemeen |
| **Kenmerken**              | N.v.t.  |
| **Verwijzingen**              | [Beveiligings deel van IE8 V: uitgebreide beveiliging](https://blogs.msdn.com/ie/archive/2008/07/02/ie8-security-part-v-comprehensive-protection.aspx)  |
...
| **Toepasselijke technologieën** | Algemeen |
| **Kenmerken**              | N.v.t.  |
| **Verwijzingen**              | Niet- [beperkte bestands upload](https://www.owasp.org/index.php/Unrestricted_File_Upload), [tabel met bestands handtekeningen](https://www.garykessler.net/library/file_sigs.html) |
...
$('body').append(resHTML);   
```
Gebruik `innerHtml`niet; Gebruik `innerText`in plaats daarvan. Op dezelfde manier, `$("#elm").html()`in plaats van, gebruikt u`$("#elm").text()` 
