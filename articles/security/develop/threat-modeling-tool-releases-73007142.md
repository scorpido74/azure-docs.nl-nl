...
description: Documenteer de release opmerkingen voor de 7.3.00714.2 van het hulp programma voor het maken van bedreigings modellen.
author: jegeib
ms.author: jegeib
ms.service: security
ms.topic: article
...
Versie 7.3.00714.2 van de Microsoft Threat Modeling Tool (TMT) is uitgebracht op 14 2020 juli en bevat de volgende wijzigingen:
