...
| **Enddatabase** | <ul><li>[Zorg ervoor dat aanmeldings controle is ingeschakeld op SQL Server](#identify-sensitive-entities)</li><li>[Bedreigings detectie op Azure SQL inschakelen](#threat-detection)</li></ul> |
...
| **Toepasselijke technologieën** | Algemeen |
| **Kenmerken**              | N.v.t.  |
| **Verwijzingen**              | [Aanmeldings controle configureren](https://msdn.microsoft.com/library/ms175850.aspx) |
...
| **Verwijzingen**              | [Aan de slag met SQL Database detectie van bedreigingen](https://azure.microsoft.com/documentation/articles/sql-database-threat-detection-get-started/)|
...
| **Toepasselijke technologieën** | Algemeen |
| **Kenmerken**              | N.v.t. |
| **Verwijzingen**              | [Het verificatie type bewaken met behulp van Opslaganalyse](https://azure.microsoft.com/documentation/articles/storage-security-guide/#storage-analytics) |
...
| **Kenmerken**              | N.v.t.  |
| **Verwijzingen**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [Fortify Konink rijk](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_logging) |
...
| **Toepasselijke technologieën** | .NET Framework |
| **Kenmerken**              | N.v.t.  |
| **Verwijzingen**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [Fortify Konink rijk](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_audit_failure_handling) |
...
| **Toepasselijke technologieën** | Algemeen |
| **Kenmerken**              | N.v.t.  |
| **Verwijzingen**              | [Inleiding tot de bewaking van IoT Hub bewerkingen](https://azure.microsoft.com/documentation/articles/iot-hub-operations-monitoring/) |
