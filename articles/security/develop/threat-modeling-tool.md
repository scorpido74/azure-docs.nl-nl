...
De volgende tabel bevat belang rijke koppelingen om aan de slag te gaan met de Threat Modeling Tool: Zie ook: [systeem vereisten](threat-modeling-tool-releases.md)
