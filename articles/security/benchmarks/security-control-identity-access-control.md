...
description: Identiteits- en toegangscontrole voor beveiligingsbeheer
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
De identiteit en toegangsactiviteit van gebruikers in Azure Security Center controleren:
...
Azure AD-riskante aanmeldingen weergeven:
...
Bekijk het volgende beveiligingsbesturingselement: [Gegevensbeveiliging](security-control-data-protection.md)
