...
* **Opmerking**: Zie voor het oplossen van fouten met SSL-certificaat validatie[http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html][ssl_validation] 
