...
2. Zoek naar migratie, klik rechts van **micro soft. DataMigration**, selecteer **registreren**.
...
> [SQL Server migreren naar een Azure SQL database Managed instance online](tutorial-sql-server-managed-instance-online.md)
> [migrate SQL Server naar een enkele data base of gegroepeerde Data base in Azure SQL database offline](tutorial-sql-server-to-azure-sql.md)
