...
- Het virtuele netwerk dat Azure Database Migration Service voor dit scenario gebruikt, moet ook worden verbonden met het on-premises netwerk met behulp van ofwelhttps://docs.microsoft.com/azure/expressroute/expressroute-introduction) [VPN](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpngateways).
