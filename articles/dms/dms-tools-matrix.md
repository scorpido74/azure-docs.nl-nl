...
| Bron | Kiezen | Via<br/>Inventaris | Doel en SKU<br/>advies | TCO/ROI en<br/>Businesscase |
| --- | --- | --- | --- | --- |
...
| Bron | Kiezen | App-gegevens toegang<br/>Laag evaluatie | Database<br/>Beoordeling | Prestaties<br/>Beoordeling |
| --- | --- | --- | --- | --- |
...
| Bron | Kiezen | Schema | Gegevens<br/>Breken | Gegevens<br/>Aanschaffen |
| --- | --- | --- | --- | --- |
...
| Oracle | Azure DB voor PostgreSQL-<br/>Enkele server |  |  | [DMS](https://azure.microsoft.com/services/database-migration/) |
