...
Meld problemen met het gebruik van Event Grid op IoT Edge in [https://github.com/Azure/event-grid-iot-edge/issues](https://github.com/Azure/event-grid-iot-edge/issues).
...
* [Lokaal reageren op Blob Storage gebeurtenissen](react-blob-storage-events-locally.md)