...
description: In dit artikel vindt u een voor beeld van een Azure PowerShell script dat laat zien hoe u zich kunt abonneren op Event Grid gebeurtenissen voor een Blob Storage-account.
services: event-grid
