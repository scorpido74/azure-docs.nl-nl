...
description: In dit artikel wordt een voorbeeld van Azure CLI-script weergegeven waarin wordt weergegeven hoe u zich abonneren op gebeurtenissen voor een Azure Blob Storage-account.
services: event-grid
