...
description: Dit artikel bevat een voor beeld van een Azure CLI-script dat laat zien hoe u zich kunt abonneren op gebeurtenissen voor een Azure Blob Storage-account.
services: event-grid
