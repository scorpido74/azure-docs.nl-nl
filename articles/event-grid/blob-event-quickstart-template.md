...
* **Micro soft. Storage/Storage accounts**: een Azure Storage-account maken.
* **"Micro soft. Storage/Storage accounts/providers/eventSubscriptions**: een Azure Event grid-abonnement maken voor het opslag account. 
...
1. Selecteer de volgende koppeling om u aan te melden bij Azure en een sjabloon te openen. Met de sjabloon worden een sleutelkluis en een geheim gemaakt.
    ...
    [Implementeren naar Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-event-grid-subscription-and-storage%2Fazuredeploy.json)
