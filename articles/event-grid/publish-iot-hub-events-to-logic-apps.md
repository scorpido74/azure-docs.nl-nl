...
6. Selecteer **Nieuw filter toevoegen**. Vul de velden in met deze waarden:
   ...
   * **Waarde**: Voer `_Temperature` in om te filteren op gebeurtenissen die betrekking hebben op de Tempe ratuur.
