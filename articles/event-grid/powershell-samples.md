...
description: Dit artikel bevat een tabel met links naar voorbeelden van Azure PowerShell-scripts voor Azure Event Grid.
ms.topic: sample
ms.date: 07/07/2020
...
- [Abonneren op resourcegroep en filter voor een resource](scripts/event-grid-powershell-resource-group-filter.md) - Hiermee abonneert u zich op gebeurtenissen voor een resourcegroep en filtert u gebeurtenissen voor een resource. 

## <a name="event-grid-topics"></a>Event Grid-onderwerpen

- [Aangepast onderwerp maken](scripts/event-grid-powershell-create-custom-topic.md) - Hiermee wordt een aangepast Event Grid-onderwerp gemaakt en worden het eindpunt en de sleutel geretourneerd.  
