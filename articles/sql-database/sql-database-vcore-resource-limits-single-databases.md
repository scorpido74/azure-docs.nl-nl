...
## <a name="general-purpose-service-tier-for-provisioned-compute"></a>De servicelaag Algemeen voor de ingerichte compute
...
## <a name="general-purpose-service-tier-for-serverless-compute"></a>Algemeen servicelaag voor serverloze compute

De [Compute-laag zonder server](sql-database-serverless.md) is in preview.
...
## <a name="business-critical-service-tier-for-provisioned-compute"></a>De servicelaag Bedrijfskritiek voor de ingerichte compute
...
### <a name="gen5-compute-compute-part-1"></a>GEN5 Compute Compute (deel 1)
...
## <a name="hyperscale-service-tier-for-provisioned-compute"></a>Grootschalige-servicelaag voor ingerichte compute
