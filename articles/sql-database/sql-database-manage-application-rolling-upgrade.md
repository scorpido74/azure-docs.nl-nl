...
3. Voer het upgrade script uit `contoso-1-staging.azurewebsites.net`met `contoso-dr-staging.azurewebsites.net`, en de primaire Data Base voor fase ring (12). De wijzigingen in de Data Base worden automatisch gerepliceerd naar de fase ring secundair.
