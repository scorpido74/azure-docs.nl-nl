---
title: 'Eén Data Base: retentie van lange termijn back-ups beheren'
description: Meer informatie over het opslaan en herstellen van automatische back-ups voor een Azure SQL Database enkele of gegroepeerde Data base in azure Storage (Maxi maal tien jaar) met behulp van Azure Portal en Power shell
...
> [!IMPORTANT]
> Zie [LTR-ondersteuning voor een beheerd exemplaar](sql-database-long-term-retention.md#managed-instance-support)voor het beheerde exemplaar van Azure SQL database.
