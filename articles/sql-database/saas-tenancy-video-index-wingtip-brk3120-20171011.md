---
title: Video geïndexeerd, Azure SaaS SQL-app | Microsoft Docs
...
- *Inhoudelijk* [Multitenancy-patronen voor SaaS-data base met meerdere tenants][saas-concept-design-patterns-563e]
- *Studies* [De SaaS-toepassing Wingtip tickets][saas-how-welcome-wingtip-app-679t]
...
- [1. **(Start)** Welkomst-dia, 0:00:03](#anchor-image-wtip-min00001)
...
- [7. Database modellen voor multi tenants: voor-en nadelen, 0:11:59](#anchor-image-wtip-min01159)
- [8. Voor delen van het hybride model mengsels van MT/ST, 0:13:01](#anchor-image-wtip-min01301)
- [9. Single-tenant versus multi tenant: voor-en nadelen, 0:16:44](#anchor-image-wtip-min01644)
- [10. Pools zijn rendabel voor onvoorspelbare workloads, 0:19:36](#anchor-image-wtip-min01936)
...
- [14. Gebruik voor beeld van elastisch groep MYOB, 0:29:40](#anchor-image-wtip-min02940)
- [15. Leer van MYOB en andere Isv's, 0:31:36](#anchor-image-wtip-min03136)
- [16. Patronen die in het E2E SaaS-scenario zijn opgesteld, 0:43:15](#anchor-image-wtip-min04315)
- [17. Canonieke hybride SaaS-app met meerdere tenants, 0:47:33](#anchor-image-wtip-min04733)
...
- [22. De patronen verkennen, 0:56:20](#anchor-image-wtip-min05620)
- [23. Tenants inrichten en voorbereiden, 0:57:44](#anchor-image-wtip-min05744)
- [24. Tenants en toepassings verbindingen inrichten, 0:58:58](#anchor-image-wtip-min05858)
...
- [30. Belasting genereren en prestaties bewaken, 1:09:42](#anchor-image-wtip-min10942)
- [31. Schema beheer op schaal, 1:10:33](#anchor-image-wtip-min11033)
- [32. Gedistribueerde query in Tenant databases, 1:12:21](#anchor-image-wtip-min11221)
...
- [35. Haal Tenant gegevens op in SQL DW, 1:16:32](#anchor-image-wtip-min11632)
...
#### <a name="1-start-welcome-slide-00001"></a>1. *(Start)* Welkomst-dia, 0:00:01
...
[![Wingtip SaaS-app: Webtoepassing met meerdere tenants][image-wtip-min00505-web-app]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=300)
...
#### <a name="7-database-models-for-multi-tenant-pros-and-cons-00952"></a>7. Database modellen voor multi tenants: voor-en nadelen, 0:09:52
...
#### <a name="8-hybrid-model-blends-benefits-of-mtst-01229"></a>8. Voor delen van het hybride model mengsels van MT/ST, 0:12:29
...
#### <a name="10-pools-are-cost-effective-for-unpredictable-workloads-01749"></a>10. Pools zijn rendabel voor onvoorspelbare workloads, 0:17:49
...
#### <a name="14-myob-elastic-pool-usage-example-02930"></a>14. Gebruik voor beeld van elastisch groep MYOB, 0:29:30
...
#### <a name="15-learning-from-myob-and-other-isvs-03125"></a>15. Leer van MYOB en andere Isv's, 0:31:25
...
#### <a name="16-patterns-compose-into-e2e-saas-scenario-03142"></a>16. Patronen die in het E2E SaaS-scenario zijn opgesteld, 0:31:42
...
#### <a name="17-canonical-hybrid-multi-tenant-saas-app-04604"></a>17. Canonieke hybride SaaS-app met meerdere tenants, 0:46:04
...
#### <a name="22-exploring-the-patterns-05615"></a>22. De patronen verkennen, 0:56:15
...
#### <a name="23-provisioning-tenants-and-onboarding-05619"></a>23. Tenants inrichten en voorbereiden, 0:56:19
...
#### <a name="24-provisioning-tenants-and-application-connection-05752"></a>24. Tenants en toepassings verbindingen inrichten, 0:57:52
...
#### <a name="30-load-generation-and-performance-monitoring-10937"></a>30. Belasting genereren en prestaties bewaken, 1:09:37
...
#### <a name="32-distributed-query-across-tenant-databases-11118"></a>32. Gedistribueerde query in Tenant databases, 1:11:18
...
#### <a name="35-extract-tenant-data-into-sql-dw-11546"></a>35. Haal Tenant gegevens op in SQL DW, 1:15:46
...
[image-wtip-min00505-web-app]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min00505-wingtip-saas-app-mt-web.png "Wingtip SaaS-app: Webtoepassing met meerdere tenants"
