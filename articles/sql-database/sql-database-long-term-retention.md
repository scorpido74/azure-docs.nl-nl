...
description: Meer informatie over hoe Azure SQL Database ondersteuning biedt voor het opslaan van volledige database back-ups voor Maxi maal tien jaar via het Bewaar beleid voor de lange termijn.
...
ms.locfileid: "83771397"
---
# <a name="azure-sql-database-long-term-retention"></a>Azure SQL Database lange termijn retentie
...
Lange tijd retentie kan worden ingeschakeld voor enkelvoudige en gepoolde data bases en heeft een beperkte open bare Preview voor Azure SQL Database Managed instances. 
...
Het gebruik van een lange termijn voor het bewaren van back-ups met een Azure SQL Database beheerde instanties heeft de volgende beperkingen:
...
- [**Alleen Power shell**](sql-database-managed-instance-long-term-backup-retention-configure.md) : er is momenteel geen ondersteuning voor Azure Portal. LTR moet zijn ingeschakeld met behulp van Power shell. 
