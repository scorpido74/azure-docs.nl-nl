...
- Zie SHRINKDATABASE voor meer informatie `SHRINKDATABASE` over de opdracht [SHRINKDATABASE](https://docs.microsoft.com/sql/t-sql/database-console-commands/dbcc-shrinkdatabase-transact-sql).
