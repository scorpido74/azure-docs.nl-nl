---
title: Een beheerd exemplaar configureren
...
- Door [waarschuwingen te maken](sql-database-managed-instance-alerts.md) , kunt u waarschuwingen instellen voor gecontroleerde metrische gegevens, zoals CPU-gebruik, het verbruik van opslag ruimte, IOPS en andere voor een beheerd exemplaar. In deze hand leiding vindt u informatie over het inschakelen en configureren van waarschuwingen voor een beheerd exemplaar.
