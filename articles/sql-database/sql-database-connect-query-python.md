...
- [Python](https://python.org/downloads) 3 en verwante software
  ...
  Als u python en andere vereiste pakketten wilt installeren `sudo apt-get install python python-pip gcc g++ build-essential`, gebruikt u.
...
- [Python-ontwikkelaars centrum](https://azure.microsoft.com/develop/python/?v=17.23h)
