---
title: PowerShell-voorbeeld importeert BACPAC-bestand Azure SQL-database
...
| [Nieuw-azsqldatabaseimport](/powershell/module/az.sql/new-azsqldatabaseimport) | Hiermee importeert u een BACPAC-bestand en maakt u een nieuwe database op de server. |
