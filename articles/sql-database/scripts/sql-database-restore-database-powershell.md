---
title: PowerShell-voorbeeld-restore-backup-Azure SQL-database
description: Azure PowerShell-voorbeeldscript om een Azure SQL-enkele database te herstellen naar een eerder tijdstip van automatische back-ups
...
ms.locfileid: "73691550"
---
# <a name="use-powershell-to-restore-an-azure-sql-single-database-to-an-earlier-point-in-time"></a>PowerShell gebruiken om een azure SQL-enkele database te herstellen naar een eerder tijdstip

Met dit PowerShell-scriptvoorbeeld wordt een Azure SQL-database hersteld naar een specifiek tijdstip.  
...
| [Herstel-azsqldatabase](/powershell/module/az.sql/restore-azsqldatabase) | Hiermee wordt een zelfstandige of pooldatabase hersteld. |
|[Verwijder-azsqldatabase](/powershell/module/az.sql/remove-azsqldatabase) | Hiermee wordt een zelfstandige of Azure SQL-pooldatabase verwijderd. |
