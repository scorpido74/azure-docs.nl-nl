---
title: CLI-voorbeeld-backup-Azure SQL-database
description: Azure CLI-voorbeeldscript om een back-up van een Azure SQL-enkele database te maken op een Azure-opslagcontainer
...
---
# <a name="use-cli-to-backup-an-azure-sql-single-database-to-an-azure-storage-container"></a>CLI gebruiken om een back-up te maken van een Azure SQL-enkele database naar een Azure-opslagcontainer

In dit voorbeeld van Azure CLI wordt een back-up van een Azure SQL-database naar een Azure-opslagcontainer maakt.  
