...
Als door de [klant beheerde transparante gegevens versleuteling](transparent-data-encryption-byok-azure-sql.md) (BYOK) wordt gebruikt en de serverloze data base automatisch wordt onderbroken wanneer het verwijderen of intrekken van sleutels plaatsvindt, blijft de data base in de status automatisch onderbroken.  In dit geval wordt de data base in ongeveer 10 minuten niet meer toegankelijk nadat de data base is hervat.  Zodra de data base niet meer toegankelijk is, is het herstel proces hetzelfde als voor ingerichte Compute-data bases.  Als de serverloze data base online is wanneer de sleutel wordt verwijderd of ingetrokken, wordt de data base in ongeveer 10 minuten op dezelfde manier als bij ingerichte reken databases niet meer toegankelijk.
