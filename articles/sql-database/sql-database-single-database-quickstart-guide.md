---
title: Quick Start-afzonderlijke data bases
...
- [Maak een enkele data base met behulp van de Azure Portal](sql-database-single-database-get-started.md).
...
- Meer informatie over de [beheer-API](sql-database-single-databases-manage.md) die u kunt gebruiken om uw data bases te configureren.
