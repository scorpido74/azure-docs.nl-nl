---
title: Snelstart - enkele databases
...
- [Maak één database met de Azure-portal.](sql-database-single-database-get-started.md)
...
- [Eén database maken en configureren met PowerShell](scripts/sql-database-create-and-configure-database-powershell.md) of [Azure CLI](scripts/sql-database-create-and-configure-database-cli.md)
- [Uw enkele database bijwerken en resources schalen met PowerShell](scripts/sql-database-monitor-and-scale-database-powershell.md) of [Azure CLI](scripts/sql-database-monitor-and-scale-database-cli.md)
...
## <a name="hands-on-learning-modules"></a>Hands-on leermodules

Met de volgende Microsoft Learn-modules u gratis meer te weten komen over Azure SQL Database.

- [Een Azure SQL-database inrichten om toepassingsgegevens op te slaan](https://docs.microsoft.com/learn/modules/provision-azure-sql-db/)
- [Een ASP.NET-toepassing ontwikkelen en configureren die een Azure SQL-database opvraagt](https://docs.microsoft.com/learn/modules/develop-app-that-queries-azure-sql/)
...
- Meer informatie over de [beheer-API](sql-database-single-databases-manage.md) die u gebruiken om uw databases te configureren.
