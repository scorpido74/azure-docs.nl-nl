...
|[Bewaken met Azure Monitor-logboeken](saas-dbpertenant-log-analytics.md) | Meer informatie over het gebruik van [Azure monitor logboeken](../log-analytics/log-analytics-overview.md) voor het bewaken van grote hoeveel heden resources in meerdere groepen. |
