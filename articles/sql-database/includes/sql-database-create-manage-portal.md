...
![Pagina Azure SQL-Portal](../media/sql-database-technical-overview/azure-sql.png)
...
![Details van de tegel data bases](../media/sql-database-technical-overview/create-single-database.png)
