...
Meer informatie over hoe verkeer moet worden gemigreerd naar nieuwe gateways in bepaalde regio's, vindt u in het volgende artikel: [Azure SQL Database verkeer migratie naar nieuwere gateways](sql-database-gateway-migration.md)
