...
## <a name="maximum-storage-size"></a>Maximale opslagruimte
...
Met de ingebouwde firewall functie wordt Windows Firewall geconfigureerd op alle virtuele machines in het cluster om binnenkomende verbindingen van IP-adresbereiken toe te staan die alleen zijn gekoppeld aan micro soft-beheer-en implementatie computers en om te voor komen dat indringings door de netwerklaag worden beveiligd door beheerders.
...
## <a name="mitigate-network-risks"></a>Netwerk Risico's beperken  

**Hoe kan ik de netwerk Risico's beperken?**
...
## <a name="moving-mi"></a>MI verplaatsen

**Kan ik een beheerd exemplaar of het VNet verplaatsen naar een andere resource groep?**
