...
|**Kenmerken**|**Always Encrypted**|**Transparante gegevensversleuteling**|
|---|---|---|
...
|---|---|
|**Hoofd**|Toepassingen met een gekente gebruiker en een Data Base die geen hoge gelijktijdigheids-, schaal-en prestatie vereisten hebben. |
