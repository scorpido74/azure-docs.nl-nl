---
title: Beheerde instance Connect-toepassing
...
- Als u VNet-peering gebruikt om verbinding te maken met een Azure App Service gehoste toepassing en het beheerde exemplaar-VNet een openbaar IP-adres bereik heeft, moet u ervoor zorgen dat uw gehoste toepassings instellingen uw uitgaand verkeer mogen routeren naar open bare IP-netwerken. Volg de instructies in [regionale VNet-integratie](../app-service/web-sites-integrate-with-vnet.md#regional-vnet-integration).
