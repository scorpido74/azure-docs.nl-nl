...
1. Stel *$DemoScenario* = **3**in en _Genereer belasting met langere en frequentere bursts per data base_ om de intensiteit van de cumulatieve belasting van de groep te verg Roten zonder de piek belasting voor elke Data Base te wijzigen.
1. Druk op **F5** om een load toe te passen op al uw tenantdatabases.
