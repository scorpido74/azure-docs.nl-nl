...
> [!NOTE]
> Als u controle logboek streaming van beveiligings-telemetrie wilt inschakelen, raadpleegt [u controle instellen voor uw data base](sql-database-auditing.md#setup-auditing) en [audit logboeken in azure monitor logboeken en Azure Event hubs](https://techcommunity.microsoft.com/t5/Azure-SQL-Database/SQL-Audit-logs-in-Azure-Log-Analytics-and-Azure-Event-Hubs/ba-p/386242).
...
|---|---|---|
|sqlserver_process_core_percent<sup>1</sup>|Kern percentage van SQL Server proces|Het CPU-gebruiks percentage voor het SQL Server proces, zoals gemeten door het besturings systeem.|
|sqlserver_process_memory_percent<sup>1</sup> |Percentage proces geheugen SQL Server|Het percentage geheugen gebruik voor het SQL Server proces, zoals gemeten door het besturings systeem.|
