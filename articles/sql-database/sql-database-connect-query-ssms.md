...
2. Het dialoogvenster **Verbinding maken met server** wordt geopend. Voer de volgende informatie in:
   ...
   | **Server naam** | De volledig gekwalificeerde servernaam | Wat lijkt: **servername.database.Windows.net**. |
...
3. Selecteer **uitvoeren** op de werk balk om de query uit te voeren en gegevens op `Product` te `ProductCategory` halen uit de tabellen en.
