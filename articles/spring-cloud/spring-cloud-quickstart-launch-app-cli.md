...
Met Azure Spring Cloud kunt u eenvoudig een op Spring Boot gebaseerde microservicetoepassing uitvoeren in Azure.  Voordat u dit voorbeeld kunt uitvoeren, kunt u de [eenvoudige quickstart](spring-cloud-quickstart.md) proberen.
...
3. Ga naar de URL die met de vorige opdracht is opgehaald om de PiggyMetrics-toepassing uit te voeren.
    ![PiggyMetrics wordt uitgevoerd](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. Selecteer **gateway**
    ...
    ![PiggyMetrics-navigatie](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. Zoek de URL op de pagina **Gatewayoverzicht** ![PiggyMetrics-navigatie 2](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
