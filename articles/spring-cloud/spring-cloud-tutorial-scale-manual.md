---
title: 'Zelfstudie: Een toepassing schalen in azure lente Cloud | Microsoft Docs'
...
ms.locfileid: "72038907"
---
# <a name="tutorial-scale-an-application-in-azure-spring-cloud"></a>Zelfstudie: Een toepassing schalen in een Azure lente-Cloud
...
* **Cpu's**: Het Maxi maal toegestane aantal Cpu's is 4 per toepassings exemplaar. Het totale aantal Cpu's voor een toepassing is de waarde die hier is ingesteld, vermenigvuldigd met het aantal toepassings exemplaren.
...
Na een paar seconden worden de wijzigingen die u hebt aangebracht, weer gegeven op de pagina **overzicht** , met meer details die beschikbaar zijn op het tabblad **toepassings exemplaren** . Voor het schalen hoeft u geen code wijzigingen aan te brengen of opnieuw te implementeren.
