...
Microsoft werkt Azure-services bij om TLS-certificaten te gebruiken van een andere set basis-CA's (certificeringsinstanties). Deze wijziging wordt doorgevoerd omdat de huidige CA-certificaten [niet voldoen aan een van de forumbasislijnvereisten voor CA's/browsers](https://bugzilla.mozilla.org/show_bug.cgi?id=1649951).
