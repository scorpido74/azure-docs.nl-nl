...
De functie voor voorlopig verwijderen is in eerste instantie beschikbaar via de [rest](/rest/api/keyvault/)-, [cli](soft-delete-cli.md)-, [Power shell](soft-delete-powershell.md) [-en .net/C#-](/dotnet/api/microsoft.azure.keyvault?view=azure-dotnet) interfaces.
