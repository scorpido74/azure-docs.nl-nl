...
Voor .NET-toepassingen is de eenvoudigste manier om te werken met een beheerde identiteit via `Microsoft.Azure.Services.AppAuthentication` het pakket. Stappen om aan de slag te gaan:
