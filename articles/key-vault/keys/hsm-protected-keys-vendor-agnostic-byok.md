...
Gebruik de opdracht [AZ sleutel kluis Key Create](/cli/azure/keyvault/key?view=azure-cli-latest#az-keyvault-key-create) om een KEK te maken waarop de sleutel bewerkingen zijn `import`ingesteld. Noteer de sleutel-id`kid`() die wordt geretourneerd door de volgende opdracht. (U gebruikt de `kid` waarde in [stap 3](#step-3-generate-and-prepare-your-key-for-transfer).)
