...
De soft-delete-functie is in eerste instantie beschikbaar via de [INTERFACES REST,](/rest/api/keyvault/) [CLI,](key-vault-soft-delete-cli.md) [PowerShell](key-vault-soft-delete-powershell.md) en [.NET/C#.](/dotnet/api/microsoft.azure.keyvault?view=azure-dotnet)
...
Bij het maken van een nieuwe sleutelkluis is soft-delete standaard ingeschakeld. U een sleutelkluis maken zonder soft-delete via azure [CLI](key-vault-soft-delete-cli.md) of [Azure Powershell.](key-vault-soft-delete-powershell.md) Zodra soft-delete is ingeschakeld op een sleutelkluis, kan deze niet meer worden uitgeschakeld
...
Zuiveringsbeveiliging is een optioneel Key Vault-gedrag en is **standaard niet ingeschakeld.** Het kan worden ingeschakeld via [CLI](key-vault-soft-delete-cli.md#enabling-purge-protection) of [Powershell](key-vault-soft-delete-powershell.md#enabling-purge-protection).
