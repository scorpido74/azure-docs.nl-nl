...
Eerst moet u het inloggen op uw sleutelkluis inschakelen. Gebruik de volgende PowerShell-opdrachten. (U de volledige details in [dit artikel over key-vault-logging](../general/logging.md).)
