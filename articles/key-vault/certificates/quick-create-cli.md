...
description: Snel beginnen met het instellen en ophalen van een certificaat uit Azure Key Vault met Azure CLI
services: key-vault
author: msmbaldwin
manager: rkarlin
...
---
# <a name="quickstart-set-and-retrieve-a-certificate-from-azure-key-vault-using-azure-cli"></a>Snelstart: een certificaat instellen en ophalen uit Azure Key Vault met Azure CLI
...
Typ de onderstaande opdrachten om een zelfondertekend certificaat te maken met standaardbeleid genaamd **ExampleCertificate:**
