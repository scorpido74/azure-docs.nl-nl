...
* Toegang tot en beheer van objecten (sleutels en geheimen) die zijn opgeslagen in Key Vault zelf, via het Key Vault-specifieke eind punt [https://yourvaultname.vault.azure.net](https://yourvaultname.vault.azure.net)(bijvoorbeeld).  
