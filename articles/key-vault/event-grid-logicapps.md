...
1. Uw e-mail sjabloon bouwen:
    ...
    - **Onderwerp** en **Hoofdtekst**: typ hier het onderwerp en de tekst voor uw e-mail. Selecteer JSON-eigenschappen in het selectiehulpmiddel om dynamische inhoud op te nemen op basis van gegevens van gebeurtenissen. U kunt de gegevens van de gebeurtenis ophalen met behulp van `@{triggerBody()?['Data']}`.
