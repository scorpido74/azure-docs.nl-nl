...
ms.locfileid: "84236026"
---
# <a name="azure-policy-built-in-policy-definitions-for-key-vault"></a>Ingebouwde Azure Policy-beleidsdefinities voor Key Vault

Deze pagina is een index van ingebouwde [Azure Policy](../governance/policy/overview.md)-beleidsdefinities voor Key Vault. Zie [Ingebouwde Azure Policy-definities](../governance/policy/samples/built-in-policies.md) voor aanvullende ingebouwde modules voor Azure Policy voor andere services.
...
## <a name="key-vault-service"></a>Key Vault (service)
