...
U ook de uitvoeringsstatus van de aangepaste scriptextensie `commandToExecute` ophalen, inclusief de werkelijke argumenten die worden doorgegeven als de met Azure CLI:
