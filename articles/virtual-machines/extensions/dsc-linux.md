...
* `ConfigurationMode`: (optioneel, String) Hiermee geeft u op hoe DSC de configuratie moet Toep assen. Geldige waarden zijn ApplyOnly, ApplyAndMonitor en ApplyAndAutoCorrect.
