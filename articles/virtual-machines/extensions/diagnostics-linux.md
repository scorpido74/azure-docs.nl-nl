...
```
#### <a name="azure-cli-sample-for-installing-lad-30-extension-on-the-vmss-instance"></a>Voor beeld van Azure CLI voor het installeren van de LAD 3,0-extensie op het VMSS-exemplaar
