---
title: Afbeeldings bronnen weer geven, bijwerken en verwijderen met Power shell
description: Het weer geven, bijwerken en verwijderen van afbeeldings bronnen in de galerie met gedeelde afbeeldingen met behulp van Azure PowerShell.
author: cynthn
...
ms.locfileid: "82797004"
---
# <a name="list-update-and-delete-image-resources-using-powershell"></a>Afbeeldings bronnen weer geven, bijwerken en verwijderen met Power shell 

U kunt de resources van uw gedeelde afbeeldingen galerie beheren met Azure PowerShell.
