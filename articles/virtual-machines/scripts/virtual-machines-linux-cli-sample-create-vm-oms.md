---
title: Azure CLI-scriptvoorbeeld - een virtuele Linux-machine maken met Azure Monitor
description: Azure CLI-scriptvoorbeeld - een virtuele Linux-machine maken met Azure Monitor
...
| [azure vm extension set](/cli/azure/vm/extension) | Hiermee voert u de extensie van een virtuele machine uit op een virtuele machine. In dit geval wordt de extensie van de Azure Monitor-agent gebruikt om de Log Analytics-agent te installeren en de VM in te schrijven bij een Log Analytics-werkruimte. |
