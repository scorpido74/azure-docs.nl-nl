---
title: Voorbeeld van Azure PowerShell-script - Een virtuele Linux-machine maken
...
| [Set-AzVMOperatingSystem](/powershell/module/az.compute/set-azvmoperatingsystem) | Hiermee stelt u eigenschappen van het besturingssysteem voor een virtuele machine in. |
| [Set-AzVMSourceImage](/powershell/module/az.compute/set-azvmsourceimage) | Hiermee geeft u de installatiekopie voor een virtuele machine op. |
| [Add-AzVMNetworkInterface](/powershell/module/az.compute/add-azvmnetworkinterface) | Hiermee voegt u een netwerkinterface aan een virtuele machine toe. |
