---
title: Voorbeeldscript van PowerShell voor uploaden van gegeneraliseerde VHD naar Azure
...
| [Add-AzVhd](/powershell/module/az.compute/add-azvhd)                                               | Hiermee wordt een virtuele harde schijf geüpload van een on-premises virtuele machine naar een blob in een cloudopslagaccount in Azure.                                                                       |
| [New-AzImageConfig](/powershell/module/az.compute/new-azimageconfig)                               | Hiermee maakt u een configureerbaar installatiekopie-object.                                                                                                                                                 |
| [Set-AzImageOsDisk](/powershell/module/az.compute/set-azimageosdisk)                               | Hiermee stelt u de schijfeigenschappen van het besturingssysteem in voor een installatiekopie-object.                                                                                                                        |
| [New-AzImage](/powershell/module/az.compute/new-azimage)                                           | Hiermee maakt u een nieuwe installatiekopie.                                                                                                                                                                 |
...
| [Set-AzVMSourceImage](/powershell/module/az.compute/set-azvmsourceimage)                           | Hiermee geeft u een installatiekopie voor een virtuele machine op.                                                                                                                                            |
| [Set-AzVMOSDisk](/powershell/module/az.compute/set-azvmosdisk)                                     | Hiermee stelt u de schijfeigenschappen van het besturingssysteem in voor een virtuele machine.                                                                                                                      |
| [Set-AzVMOperatingSystem](/powershell/module/az.compute/set-azvmoperatingsystem)                   | Hiermee stelt u de schijfeigenschappen van het besturingssysteem in voor een virtuele machine.                                                                                                                      |
