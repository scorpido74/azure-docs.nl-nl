...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Hiermee wordt aan de virtuele machine de aangepaste scriptextensie toegevoegd die een script aanroept om WordPress te installeren. |
