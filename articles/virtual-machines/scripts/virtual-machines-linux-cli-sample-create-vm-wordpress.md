---
title: Voorbeeld van Azure CLI-script - Een virtuele Linux-machine maken met WordPress
...
| [az vm open-port](/cli/azure/vm) | Hiermee maakt u een regel voor de netwerkbeveiligingsgroep om binnenkomend verkeer toe te staan. In dit voorbeeld is poort 80 geopend voor HTTP-verkeer. |
| [az vm extension set](/cli/azure/vm) | Hiermee wordt aan de virtuele machine de aangepaste scriptextensie toegevoegd die een script aanroept om WordPress te installeren. |
