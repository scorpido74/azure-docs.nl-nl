---
title: Een beheerde schijf maken op basis van een momentopname (Windows) - PowerShell-voorbeeld
...
ms.locfileid: "86500987"
---
# <a name="create-a-managed-disk-from-a-snapshot-with-powershell-windows"></a>Een beheerde schijf maken met PowerShell op basis van een momentopname (Windows)
