---
title: Uw Linux VM's migreren naar Azure Premium Storage met Azure Site Recovery
...
2. Selecteer > Een > **bronbeheerback-up** en **siteherstel (OMS)** **maken**.**Management** U ook **Browse** > **Recovery Services Vault** > **Add**selecteren. 
3. Geef een gebied op waaraan VM's worden gerepliceerd. Selecteer voor migratie in dezelfde regio het gebied waar uw bron-VM's en bronopslagaccounts zich bevinden. 
...
* [Een virtuele harde schijf van Linux uploaden](upload-vhd.md)
