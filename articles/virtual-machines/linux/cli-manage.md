...
---
# <a name="common-azure-cli-commands-for-managing-azure-resources"></a>Algemene Azure CLI-opdrachten voor het beheer van Azure-resources
...
Voor gedetailleerde hulp bij specifieke opdracht regel opties en-opties kunt u de online-opdracht Help en-opties gebruiken door `az <command> <subcommand> --help`te typen.
