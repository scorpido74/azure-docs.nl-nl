...
Met Azure kunt u een VHD naar het platform brengen om te gebruiken als [Beheerde schijf](https://docs.microsoft.com/azure/virtual-machines/windows/faq-for-disks#managed-disks) of gebruiken als bron voor een installatiekopie. 
...
Dit zijn [vereisten](https://docs.microsoft.com/azure/virtual-machines/linux/create-upload-generic) voor het maken van een installatiekopie.
...
Inrichtingsagenten zijn niet vereist voor deze installatiekopieën, maar u wilt mogelijk ook de mogelijkheden voor het afhandelen van extensies hebben. U kunt de Linux-agent installeren, maar de inrichtingsoptie uitschakelen. Hoewel u geen inrichtingsagent nodig hebt, moet de installatiekopie voldoen aan [vereisten](https://docs.microsoft.com/azure/virtual-machines/linux/create-upload-generic) voor Azure-installatiekopieën.
...
Azure biedt ondersteuning voor Hyper-V generatie 1 (gen1) en generatie 2 (Gen2), Gen2 is de nieuwste generatie en biedt extra functionaliteit die Gen1 niet heeft. Bijvoorbeeld: groter geheugen, Intel-software Guard Extensions (Intel SGX) en gevirtualiseerd permanent geheugen (vPMEM). Virtuele machines van generatie 2 kunnen on-premises worden uitgevoerd, hebben enkele functies die nog niet worden ondersteund in Azure. Zie de sectie Functies en mogelijkheden voor meer informatie. Raadpleeg [dit artikel](https://docs.microsoft.com/azure/virtual-machines/windows/generation-2) voor meer informatie. Maak Gen2-installatiekopieën als u de extra functionaliteit nodig hebt.

Als u nog een eigen installatiekopie moet maken, controleert u of deze voldoet aan de [vereisten voor installatiekopieën](https://docs.microsoft.com/azure/virtual-machines/linux/create-upload-generic) en uploadt u deze naar Azure. Distributiespecifieke vereisten:
