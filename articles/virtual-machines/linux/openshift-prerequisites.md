---
title: Open Shift in vereisten voor Azure | Microsoft Docs
description: Vereisten voor het implementeren van open Shift in Azure.
...
- [Open Shift container platform implementeren](./openshift-container-platform.md)
