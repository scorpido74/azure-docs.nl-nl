...
-   Een gedeeld opslag cluster dat gebruikmaakt van Standard\_DS4\_v2 virtuele machines met Linux.
...
-   *Optioneel*. Een Witness-server. Dit is alleen nodig voor bepaalde eerdere versies van Db2 pureScale. In dit voor beeld wordt gebruikgemaakt van een standaard\_DS3\_v2 virtuele machine met Linux (gebruikt voor de DB2-pureScale).
