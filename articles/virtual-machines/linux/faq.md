...
Ja. De computer naam mag Maxi maal 64 tekens lang zijn. Zie [regels en beperkingen voor naam conventies](/azure/architecture/best-practices/naming-conventions) voor meer informatie over het benoemen van uw resources.

## <a name="are-there-any-resource-group-name-requirements"></a>Zijn er vereisten voor de naam van de resource groep?
Ja. De naam van de resource groep mag Maxi maal 90 tekens lang zijn. Zie [regels en beperkingen voor naam conventies](/azure/architecture/best-practices/naming-conventions) voor meer informatie over resource groepen.
