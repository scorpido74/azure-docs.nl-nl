---
title: Compute benchmark scores voor Azure Linux VM's
description: Vergelijk CoreMark compute benchmarkscores voor Azure VM's met Linux.
...
---
# <a name="compute-benchmark-scores-for-linux-vms"></a>Compute benchmark scores voor Linux VM's
De volgende CoreMark-benchmarkscores tonen rekenprestaties voor Azure's krachtige VM-line-up met Ubuntu. Compute benchmark scores zijn ook beschikbaar voor [Windows VM's](../windows/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

## <a name="av2---general-compute"></a>Av2 - Algemene rekenkracht
(3/15/2019 12:06:55 pbi 3897709)

| VM-grootte | CPU | vCPUs | NUMA-knooppunten | Geheugen(GiB) | Avg-score | StdDev StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_A1_v2 | Intel(R) Xeon(R) CPU E5-2660 0 bij 2,20 GHz | 1 | 1 | 1.9 | 6,483 | 120 | 1.85% | 273 |
...
| Standard_A2_v2 | Intel(R) Xeon(R) CPU E5-2660 0 bij 2,20 GHz | 2 | 1 | 3.9 | 13,161 | 194 | 1.48% | 266 |
...
| Standard_A2m_v2 | Intel(R) Xeon(R) CPU E5-2660 0 bij 2,20 GHz | 2 | 1 | 15.7 | 13,167 | 179 | 1.36% | 273 |
...
| Standard_A4_v2 | Intel(R) Xeon(R) CPU E5-2660 0 bij 2,20 GHz | 4 | 1 | 7.8 | 26,307 | 231 | 0.88% | 231 |
...
| Standard_A4m_v2 | Intel(R) Xeon(R) CPU E5-2660 0 bij 2,20 GHz | 4 | 1 | 31.4 | 26,238 | 292 | 1.11% | 259 |
...
| Standard_A8_v2 | Intel(R) Xeon(R) CPU E5-2660 0 bij 2,20 GHz | 8 | 1 | 15.7 | 53,237 | 687 | 1.29% | 266 |
...
| Standard_A8m_v2 | Intel(R) Xeon(R) CPU E5-2660 0 bij 2,20 GHz | 8 | 2 | 62.9 | 52,627 | 902 | 1.71% | 266 |
...
Opmerking: VM's uit de Av2-serie kunnen worden geïmplementeerd op verschillende hardwaretypen en -processors (zoals hierboven te zien is). Vm's uit de AV2-serie hebben CPU-prestaties en geheugenconfiguraties die het meest geschikt zijn voor instapworkloads zoals ontwikkeling en test. De grootte wordt beperkt om relatief consistente processorprestaties te bieden voor de lopende instantie, ongeacht de hardware waarop deze wordt geïmplementeerd; Software die gebruikmaakt van specifieke optimalisaties van nieuwere processoren, kan echter meer significante variatie zien tussen processortypen.
...
Opmerking: VM's uit de B-serie zijn geschikt voor workloads met burstable prestatie-eisen. VM-exemplaren accumuleren credits bij het gebruik van minder dan de basislijn. Wanneer de VM krediet heeft verzameld, kan de VM boven de basislijn barsten met maximaal 100% om te voldoen aan de vereisten voor korte CPU-burst.When the VM has accumulated credit, the VM can burst above the baseline using to 100% to meet short CPU burst requirements. Burst-tijd is afhankelijk van beschikbare credits die een functie is van vm-grootte en -tijd.  

CoreMark is een korte hardlooptest die doorgaans wordt voltooid binnen de beschikbare burst-credits.  Daarom vertegenwoordigen de bovenstaande getallen meestal de burst-prestaties van de VM, die weerspiegelen wat de korte, bursty-, workloads (typisch voor De B-reeks) prestaties meestal zullen zien.

## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - Algemene Compute + Premium Storage
...
## <a name="esv3---memory-optimized--premium-storage"></a>Esv3 - Geheugen geoptimaliseerd + Premium Storage
(12-02-2019 7:17:33 pbi 3897709)
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - Geheugen opt + Premium-opslag (geïsoleerd)
...
## <a name="ev3---memory-optimized"></a>Ev3 - Geheugen geoptimaliseerd
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 - Geheugen geoptimaliseerd (geïsoleerd)
...
## <a name="fsv2---compute--storage-optimized"></a>Fsv2 - Compute + Storage Geoptimaliseerd
...
## <a name="fs---compute-and-storage-optimized"></a>Fs - Geoptimaliseerd voor reken- en opslag
...
## <a name="f---compute-optimized"></a>F - Geoptimaliseerd berekenen
...
(12-02-2019 10:22:33 pbi 3897709)
...
## <a name="g---compute-optimized"></a>G - Geoptimaliseerd berekenen
(12-02-2019 10:23:51 pbi 3897709)
...
(12-02-2019 10:50:51 pbi 3897709)

| VM-grootte | CPU | vCPUs | NUMA-knooppunten | Geheugen(GiB) | Avg-score | StdDev StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_H8 | Intel(R) Xeon(R) CPU E5-2667 v3 bij 3,20 GHz | 8 | 1 | 55.0 | 149,859 | 734 | 0.49% | 175 |
| Standard_H8m | Intel(R) Xeon(R) CPU E5-2667 v3 bij 3,20 GHz | 8 | 1 | 110.2 | 149,931 | 657 | 0.44% | 147 |
| Standard_H16 | Intel(R) Xeon(R) CPU E5-2667 v3 bij 3,20 GHz | 16 | 2 | 110.2 | 282,083 | 6,738 | 2.39% | 84 |
| Standard_H16m | Intel(R) Xeon(R) CPU E5-2667 v3 bij 3,20 GHz | 16 | 2 | 220.4 | 282,106 | 7,013 | 2.49% | 84 |
| Standard_H16mr | Intel(R) Xeon(R) CPU E5-2667 v3 bij 3,20 GHz | 16 | 2 | 220.4 | 282,167 | 6,889 | 2.44% | 84 |
| Standard_H16r | Intel(R) Xeon(R) CPU E5-2667 v3 bij 3,20 GHz | 16 | 2 | 110.2 | 280,837 | 6,587 | 2.35% | 84 |
...
(12-02-2019 10:22:29 pbi 3897709)
...
## <a name="m---memory-optimized"></a>M - Geheugen geoptimaliseerd
(4/11/2019 7:30:39 pm pbi 3897709)

| VM-grootte | CPU | vCPUs | NUMA-knooppunten | Geheugen(GiB) | Avg-score | StdDev StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_M8-2ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 2 | 1 | 215.2 | 22,605 | 29 | 0.13% | 42 |
| Standard_M8-4ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 4 | 1 | 215.2 | 44,488 | 183 | 0.41% | 42 |
| Standard_M16-4ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 4 | 1 | 430.6 | 44,451 | 269 | 0.61% | 42 |
| Standard_M16-8ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 8 | 1 | 430.6 | 88,238 | 1,243 | 1.41% | 42 |
| Standard_M32-8ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 8 | 1 | 861.2 | 88,521 | 1,353 | 1.53% | 42 |
| Standard_M32-16ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 16 | 1 | 861.2 | 174,674 | 3,104 | 1,78% | 42 |
| Standard_M64 | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 64 | 2 | 1,007.9 | 683,022 | 11,929 | 1.75% | 42 |
| Standard_M64-16 ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 16 | 2 | 1,763.9 | 169,386 | 4,737 | 2.80% | 42 |
| Standard_M64-32ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 32 | 2 | 1,763.9 | 337,599 | 4,738 | 1.40% | 42 |
| Standard_M64m | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 64 | 2 | 1,763.9 | 677,466 | 14,478 | 2.14% | 42 |
| Standard_M64ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 64 | 2 | 1,763.9 | 675,342 | 16,577 | 2.45% | 42 |
| Standard_M64s | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 64 | 2 | 1,007.9 | 674,785 | 15,983 | 2,37% | 42 |
| Standard_M128 | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 128 | 4 | 2,015.9 | 1,334,218 | 21,126 | 1.58% | 42 |
| Standard_M128-32ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 32 | 4 | 3,831.1 | 334,873 | 5,005 | 1.49% | 42 |
| Standard_M128-64ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 64 | 4 | 3,831.1 | 667,808 | 18,145 | 2.72% | 42 |
| Standard_M128m | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 128 | 4 | 3,831.1 | 1,335,873 | 19,642 | 1.47% | 42 |
| Standard_M128ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 128 | 4 | 3,831.1 | 1,329,151 | 24,295 | 1,83% | 42 |
| Standard_M128s | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 128 | 4 | 2,015.9 | 1,329,923 | 20,117 | 1.51% | 42 |
| Standard_M16ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 16 | 1 | 430.6 | 174,686 | 2,704 | 1.55% | 35 |
| Standard_M32ls | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 32 | 1 | 251.9 | 344,069 | 3,372 | 0.98% | 42 |
| Standard_M32ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 32 | 1 | 861.2 | 343,226 | 4,884 | 1.42% | 84 |
| Standard_M32ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 32 | 2 | 861.2 | 336,526 | 4,396 | 1.31% | 7 |
| Standard_M32ts | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 32 | 1 | 188.9 | 341,112 | 5,491 | 1.61% | 35 |
| Standard_M64ls | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 64 | 2 | 503.9 | 676,026 | 18,078 | 2,67% | 42 |
| Standard_M8ms | Intel(R) Xeon(R) CPU E7-8890 v3 bij 2,50 GHz | 8 | 1 | 215.2 | 88,066 | 1,391 | 1.58% | 42 |
...
(12-02-2019 11:08:03 pbi 3897709)

| VM-grootte | CPU | vCPUs | NUMA-knooppunten | Geheugen(GiB) | Avg-score | StdDev StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6 | Intel(R) Xeon(R) CPU E5-2690 v3 bij 2,60 GHz | 6 | 1 | 55.0 | 102,211 | 658 | 0.64% | 259 |
| Standard_NC12 | Intel(R) Xeon(R) CPU E5-2690 v3 bij 2,60 GHz | 12 | 1 | 110.2 | 203,523 | 2,293 | 1,13% | 259 |
| Standard_NC24 | Intel(R) Xeon(R) CPU E5-2690 v3 bij 2,60 GHz | 24 | 2 | 220.4 | 382,897 | 8,712 | 2.28% | 259 |
| Standard_NC24r | Intel(R) Xeon(R) CPU E5-2690 v3 bij 2,60 GHz | 24 | 2 | 220.4 | 383,171 | 9,166 | 2.39% | 259 |

## <a name="nds--gpu-enabled"></a>ND's- GPU ingeschakeld
...
(12-02-2019 11:08:13 pbi 3897709)

| VM-grootte | CPU | vCPUs | NUMA-knooppunten | Geheugen(GiB) | Avg-score | StdDev StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NV6 | Intel(R) Xeon(R) CPU E5-2690 v3 bij 2,60 GHz | 6 | 1 | 55.0 | 101,728 | 2,094 | 2.06% | 259 |
| Standard_NV12 | Intel(R) Xeon(R) CPU E5-2690 v3 bij 2,60 GHz | 12 | 1 | 110.2 | 203,903 | 1,724 | 0.85% | 252 |
| Standard_NV24 | Intel(R) Xeon(R) CPU E5-2690 v3 bij 2,60 GHz | 24 | 2 | 220.4 | 379,879 | 8,737 | 2.30% | 259 |


## <a name="about-coremark"></a>Over CoreMark
Linux nummers werden berekend door het uitvoeren van [CoreMark](https://www.eembc.org/coremark/faq.php) op Ubuntu. CoreMark is geconfigureerd met het aantal threads dat is ingesteld op het aantal virtuele CPU's en gelijktijdigheid ingesteld op PThreads. Het doelaantal iteraties werd aangepast op basis van de verwachte prestaties om een runtime van ten minste 20 seconden (meestal veel langer) te bieden. De eindscore vertegenwoordigt het aantal voltooide iteraties gedeeld door het aantal seconden dat nodig was om de test uit te voeren. Elke test werd ten minste zeven keer uitgevoerd op elke VM. Testrundatums hierboven weergegeven. Tests worden uitgevoerd op meerdere VM's in openbare Azure-regio's waarin de VM werd ondersteund op de datum waarop deze is uitgevoerd. Basic A- en B-serie (Burstable) worden niet weergegeven omdat de prestaties variabel zijn. N-serie niet weergegeven omdat ze GPU-centric zijn en Coremark meet de GPU-prestaties niet.

## <a name="next-steps"></a>Volgende stappen
* Zie [Groottes voor virtuele machines voor](sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)opslagcapaciteiten, schijfdetails en aanvullende overwegingen voor het kiezen tussen VM-formaten.
* Als u de CoreMark-scripts op Linux VM's wilt uitvoeren, downloadt u het [CoreMark-scriptpakket](https://download.microsoft.com/download/3/0/5/305A3707-4D3A-4599-9670-AAEB423B4663/AzureCoreMarkScriptPack.zip).
