...
* [Ls-series](https://docs.microsoft.com/azure/virtual-machines/linux/sizes-previous-gen#ls-series) en [Lsv2-series](../lsv2-series.md)
...
Als u een VM maakt met Windows Server 2012 als besturingssysteem, selecteert u de VM SKU van generatie 1 (BIOS) of generatie 2 (UEFI), die er als volgt uitzien:
