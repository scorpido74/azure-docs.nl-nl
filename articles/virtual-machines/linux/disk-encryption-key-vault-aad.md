...
Azure Disk Encryption is geïntegreerd met [Azure Key Vault](https://azure.microsoft.com/documentation/services/key-vault/) om u te helpen de schijfversleutelingssleutels en -geheimen in uw key vault-abonnement te beheren en te beheren. U een sleutelkluis maken of een bestaande kluis gebruiken voor Azure Disk Encryption. Zie [Aan de slag met Azure Key Vault](../../key-vault/key-vault-get-started.md) en Uw [sleutelkluis beveiligen](../../key-vault/key-vault-secure-your-key-vault.md)voor meer informatie over sleutelkluizen. U een Resource Manager-sjabloon, Azure PowerShell of de Azure CLI gebruiken om een sleutelkluis te maken. 
...
### <a name="create-a-key-vault-with-a-resource-manager-template"></a><a name="bkmk_KVRM"></a>Een sleutelkluis maken met een resourcemanagersjabloon
...
## <a name="set-up-an-azure-ad-app-and-service-principal"></a><a name="bkmk_ADapp"></a>Een Azure AD-app en serviceprincipal instellen 
...
### <a name="set-up-an-azure-ad-app-and-service-principal-with-azure-powershell"></a><a name="bkmk_ADappPSH"></a>Een Azure AD-app en serviceprincipal instellen met Azure PowerShell 
...
### <a name="set-up-an-azure-ad-app-and-service-principal-with-azure-cli"></a><a name="bkmk_ADappCLI"></a>Een Azure AD-app en serviceprincipal instellen met Azure CLI
...
### <a name="set-up-an-azure-ad-app-and-service-principal-though-the-azure-portal"></a><a name="bkmk_ADappRM"></a>Een Azure AD-app en serviceprincipal instellen via de Azure-portal
...
## <a name="set-the-key-vault-access-policy-for-the-azure-ad-app"></a><a name="bkmk_KVAP"></a>Het toegangsbeleid voor belangrijke vaults instellen voor de Azure AD-app
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-powershell"></a><a name="bkmk_KVAPPSH"></a>Het toegangsbeleid voor belangrijke vaults voor de Azure AD-app instellen met Azure PowerShell
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-cli"></a><a name="bkmk_KVAPCLI"></a>Het toegangsbeleid voor belangrijke vaults voor de Azure AD-app instellen met Azure CLI
Gebruik [het az keyvault-setbeleid](/cli/azure/keyvault#az-keyvault-set-policy) om het toegangsbeleid in te stellen. Zie [Sleutelkluis beheren met CLI 2.0](../../key-vault/key-vault-manage-with-cli2.md#authorizing-an-application-to-use-a-key-or-secret)voor meer informatie.
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-the-portal"></a><a name="bkmk_KVAPRM"></a>Het toegangsbeleid voor belangrijke vaults voor de Azure AD-app instellen met de portal
...
## <a name="set-key-vault-advanced-access-policies"></a><a name="bkmk_KVper"></a>Beleid voor geavanceerde toegangsbeleid voor belangrijke vaults instellen
...
### <a name="set-key-vault-advanced-access-policies-with-azure-powershell"></a><a name="bkmk_KVperPSH"></a>Geavanceerde toegangsbeleidsregels voor belangrijke vault instellen met Azure PowerShell
...
### <a name="set-key-vault-advanced-access-policies-using-the-azure-cli"></a><a name="bkmk_KVperCLI"></a>Geavanceerde toegangsbeleidsregels voor sleutelkluizen instellen met behulp van de Azure CLI
...
### <a name="set-key-vault-advanced-access-policies-through-the-azure-portal"></a><a name="bkmk_KVperrm"></a>Geavanceerde toegangsbeleidsregels voor sleutelkluizen instellen via de Azure-portal
...
## <a name="set-up-a-key-encryption-key-optional"></a><a name="bkmk_KEK"></a>Een sleutelversleutelingssleutel instellen (optioneel)
Als u een sleutelversleutelingssleutel (KEK) wilt gebruiken voor een extra beveiligingslaag voor versleutelingssleutels, voegt u een KEK toe aan uw sleutelkluis. Gebruik de [cmdlet Add-AzKeyVaultKey Om](/powershell/module/az.keyvault/add-azkeyvaultkey) een sleutelversleutelingssleutel in de sleutelkluis te maken. U ook een KEK importeren van uw on-premises key management HSM. Zie [Key Vault Documentation voor](../../key-vault/key-vault-hsm-protected-keys.md)meer informatie. Wanneer een sleutelversleutelingssleutel is opgegeven, gebruikt Azure Disk Encryption die sleutel om de versleutelingsgeheimen te verpakken voordat u naar Key Vault gaat. 
...
## <a name="certificate-based-authentication-optional"></a><a name="bkmk_Cert"></a>Verificatie op basis van certificaten (optioneel)
...
## <a name="certificate-based-authentication-and-a-kek-optional"></a><a name="bkmk_CertKEK"></a>Verificatie op basis van certificaten en een KEK (optioneel)
...
> [!IMPORTANT]
> Azure AD-verificatie op basis van certificaten wordt momenteel niet ondersteund op Linux-VM's.
