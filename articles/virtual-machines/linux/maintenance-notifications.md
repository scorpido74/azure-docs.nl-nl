---
title: Onderhouds meldingen voor Linux-Vm's in azure verwerken
...
Met de volgende aanroep wordt onderhoud gestart op een VM als `IsCustomerInitiatedMaintenanceAllowed` is ingesteld op True.
