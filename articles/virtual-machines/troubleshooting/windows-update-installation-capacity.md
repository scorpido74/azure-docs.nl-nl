...
In dit geval kan het besturings systeem (OS) de installatie van een Windows Update (KB) niet volt ooien omdat een kern bestand niet kan worden gemaakt op het bestands systeem. Op basis van deze fout code kan het besturings systeem geen bestanden naar de schijf schrijven.
