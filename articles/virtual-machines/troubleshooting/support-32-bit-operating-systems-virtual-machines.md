...
ms.locfileid: "71846535"
---
# <a name="support-for-32-bit-operating-systems-in-azure-virtual-machines"></a>Ondersteuning voor 32-bits besturings systemen in azure virtual machines

Microsoft Azure kunnen gebruikers nu hun 32-bits Windows-besturings systemen overzetten naar Azure. Omdat sommige van deze besturings systemen al hun einde van de levens cyclus voor ondersteuning hebben bereikt, biedt micro soft mogelijk geen aanvullende ondersteuning voor hen. Er wordt ook geen ondersteuning geboden voor op Linux of Berkeley (Software Distribution) gebaseerde besturings systemen die worden uitgevoerd op een Microsoft Azure virtuele machine (VM).
...
* [Ondersteuning voor Linux-en open-source technologie in azure](https://support.microsoft.com/help/2941892/support-for-linux-and-open-source-technology-in-azure)
...
* [Meer informatie over ondersteuning voor Windows Server 2008 SP2 32-bits gespecialiseerde installatie kopieën in azure](https://docs.microsoft.com/windows-server/get-started/uploading-specialized-ws08-image-to-azure)
* [Meer informatie over ondersteuning voor de migratie van installatie kopieën van Windows Server 2008 naar Azure met behulp van Azure Site Recovery](https://docs.microsoft.com/azure/site-recovery/migrate-tutorial-windows-server-2008)
