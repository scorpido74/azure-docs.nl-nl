---
title: Prestaties van VM-formaat in de HB-serie - Azure Virtual Machines | Microsoft Documenten
description: Meer informatie over prestatietestresultaten voor VM-formaten uit de HB-serie in Azure.
...
ms.locfileid: "79534198"
---
# <a name="hb-series-virtual-machine-sizes"></a>Virtuele machineformaten uit de HB-serie

Er zijn verschillende prestatietests uitgevoerd op hb-serie maten. Hieronder volgen enkele van de resultaten van deze prestatietests.


| Workload                                        | HB                    |
|-------------------------------------------------|-----------------------|
| STREAM Triade                                    | ~260 GB/s (32-33 GB/s per CCX)  |
| Krachtige Linpack (HPL)                  | ~1.000 GigaFLOPS (Rpeak), ~860 GigaFLOPS (Rmax) |
| RDMA-latentie & bandbreedte                        | 2,35usec, 96,5 Gb/s   |
| FIO op lokale NVMe SSD                           | ~ 1,7 GB / s leest, ~ 1,0 GB / s schrijft      |  
| IOR op 4 * Azure Premium SSD (P30 Managed Disks, RAID0)**  | ~ 725 MB / s leest, ~ 780 MB / schrijft   |



## <a name="infiniband-send-latency"></a>InfiniBand verzenden latentie
Mellanox Perftest.
...
## <a name="osu-mpi-latency-test"></a>OSU MPI-latentietest
...
| #bytes  | Latentie [microseconde] (MPICH 3.3 + CH4) | Latentie [microseconde] (OpenMPI 4.0.0) | Latentie [microseconde] (MVAPICH2 2.3) | Latentie [microseconde] (Intel MPI 2019) |
|------|----------|----------|----------|----------|
...
## <a name="mpi-bandwidth"></a>MPI-bandbreedte
...
| #Size            | Bandbreedte (MB/s) | Bandbreedte (Gb/s) |
|------------------|------------------|------------------|
| 2                | 4,03             | 0.03             |
| 4                | 8.2              | 0,07             |
| 8                | 16.15            | 0.13             |
