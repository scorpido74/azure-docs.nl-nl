...
De FLANG-compiler is een recente toevoeging aan de AOCC-suite (toegevoegde versie van april 2018) en is momenteel beschikbaar voor ontwikkel aars om te downloaden en te testen. Op basis van Fortran 2008 biedt AMD een uitbrei ding van dehttps://github.com/flangcompiler/flang)github-versie van FLANG (. De FLANG-compiler ondersteunt alle clang-compiler opties en een extra aantal FLANG-specifieke compiler opties.
