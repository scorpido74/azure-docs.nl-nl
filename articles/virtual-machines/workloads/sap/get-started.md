...
- Wat is Azure Storage het meest geschikt voor mijn scenario? [Azure Storage typen voor SAP-workload](./planning-guide-storage.md) lezen
...
In deze sectie vindt u de plannings-en implementatie documentatie voor SAP NetWeaver, SAP LaMa en Business One in Azure. De documentatie is gericht op de basis beginselen en het gebruik van niet-HANA-data bases met een SAP-werk belasting op Azure. De documenten en artikelen voor hoge Beschik baarheid zijn ook de basis voor SAP HANA hoge Beschik baarheid in azure

## <a name="sap-netweaver-and-s4hana-high-availability"></a>SAP NetWeaver en S/4HANA hoge Beschik baarheid
Een hoge Beschik baarheid van SAP Application Layer en DBMS wordt beschreven in de details die beginnen met het document [Azure virtual machines hoge Beschik baarheid voor SAP NetWeaver](./sap-high-availability-guide-start.md)



## <a name="integrate-azure-ad-with-sap-services"></a>Azure AD integreren met SAP-services
In deze sectie vindt u informatie over het configureren van SSO met de meeste SAP SaaS-en PaaS-Services, NetWeaver en Fiori 
...
- 09/28/2020: het toevoegen van een nieuwe opslag bewerkings handleiding voor SAP HANA met behulp van Azure NetApp Files met het document [NFS v 4.1-volumes op Azure NetApp files voor SAP Hana](./hana-vm-operations-netapp.md)
- 09/23/2020: nieuwe gecertificeerde Sku's voor HLI toevoegen in [beschik bare sku's voor HLI](./hana-available-skus.md) 
- 09/20/2020: wijzigingen in document [overwegingen voor Azure virtual machines DBMS-implementatie voor SAP-werk belasting](./dbms_guide_general.md), [SQL Server Azure virtual machines DBMS-implementatie voor SAP NetWeaver](./dbms_guide_sqlserver.md), [Azure virtual machines Oracle DBMS](./dbms_guide_oracle.md)-implementatie voor SAP-WORKLOAD, [IBM Db2 Azure virtual machines DBMS](./dbms_guide_ibm.md) -implementatie voor SAP-werk belasting zodat deze kan worden aangepast aan de nieuwe configuratie suggestie die de binaire DBMS-en SAP binaire bestanden in verschillende Azure-schijven afsluit U kunt ook zeer schijf aanbevelingen toevoegen aan de verschillende hand leidingen.
- 09/08/2020: wijziging in [hoge Beschik baarheid van SAP Hana op virtuele machines van Azure op SLES](./sap-hana-high-availability.md) om stonith definities te verduidelijken
- 09/03/2020: Wijzig in [SAP Hana opslag configuraties van virtuele Azure-machines](./hana-vm-operations-storage.md) om aan te passen aan een minimale 2 IOPS per capaciteit van 1 GB met een ultra schijf
- 09/02/2020: Wijzig in [beschik bare sku's voor HLI](./hana-available-skus.md) voor meer doorzichtigheid in wat sku's Hana gecertificeerd zijn
...
- 08/21/2020: nieuwe besturingssysteem versie toevoegen aan [compatibele besturings systemen voor Hana grote instanties](./os-compatibility-matrix-hana-large-instance.md) als beschikbaar besturings systeem voor HLI-eenheden van het type I en II
...
- 08/14/2020: het toevoegen van een schijf configuratie advies voor Db2 in artikel [IBM Db2 Azure virtual machines DBMS-implementatie voor SAP-workload](./dbms_guide_ibm.md)
- 08/11/2020: RHEL 7,6 toevoegen aan [compatibele besturings systemen voor Hana grote instanties](./os-compatibility-matrix-hana-large-instance.md) als beschikbaar besturings systeem voor HLI-eenheden van het type I
- 08/10/2020: introductie van kosten bewuste SAP HANA opslag configuratie in [SAP Hana Azure virtual machine-opslag configuraties](./hana-vm-operations-storage.md) en het maken van updates voor [SAP-workloads op Azure: controle lijst voor planning en implementatie](./sap-deployment-checklist.md)
...
- 23 juli 2020: de [SAP Hana large instances voor opslaan op is toegevoegd met een Azure reservation](../../../cost-management-billing/reservations/prepay-hana-large-instances-reserved-capacity.md) -artikel waarin wordt uitgelegd wat u moet weten voordat u een SAP Hana large instances reservering aanschaft en de aankoop kunt doen
- 16 juli 2020: beschrijving van het gebruik van Azure PowerShell voor het installeren van een nieuwe VM-extensie voor SAP in de [implementatie handleiding](deployment-guide.md)
- Juli 04, 2020: release van  [Azure monitor voor SAP-oplossingen (preview)](./azure-monitor-overview.md)
- 1 juli 2020: er wordt een minder dure opslag configuratie voorgesteld op basis van de Azure Premium Storage burst-functionaliteit in document [SAP Hana opslag configuraties voor virtuele Azure-machines](./hana-vm-operations-storage.md) 
- 24 juni 2020: wijziging in het [instellen van pacemaker op sles in azure](./high-availability-guide-suse-pacemaker.md) voor het vrijgeven van nieuwe verbeterde Azure Fence-agent en meer robuuste STONITH configuratie voor apparaten, gebaseerd op de Azure Fence-agent 
- 24 juni 2020: wijziging in het [instellen van pacemaker op RHEL in azure](./high-availability-guide-rhel-pacemaker.md) voor het vrijgeven van meer ROBUUSTe STONITH-configuratie
- 23 juni 2020: wijzigingen in [Azure virtual machines planning en implementatie van de SAP NetWeaver](./planning-guide.md) Guide en inleiding van [Azure Storage types voor SAP-werkbelasting](./planning-guide-storage.md) gids
...
- 16 juni 2020: wijziging in de [connectiviteit van open bare eind punten voor vm's met behulp van Azure Standard ILB in SAP ha-scenario's](./high-availability-guide-standard-load-balancer-outbound-connections.md) om een koppeling toe te voegen aan SuSE open bare Cloud infrastructuur 101 documentatie 
- 10 juni 2020: nieuwe HLI-Sku's toevoegen aan [beschik bare sku's voor HLI](./hana-available-skus.md) en [SAP Hana (grote exemplaren) opslag architectuur](./hana-storage-architecture.md)
- 21 mei 2020: wijziging in het [instellen van pacemaker op sles in azure](./high-availability-guide-suse-pacemaker.md) en het [instellen van pacemaker op RHEL in azure](./high-availability-guide-rhel-pacemaker.md) om een koppeling toe te voegen aan [open bare-eindpunt connectiviteit voor Vm's met behulp van Azure Standard ILB in SAP ha-scenario's](./high-availability-guide-standard-load-balancer-outbound-connections.md)  
- 19 mei 2020: toevoegen van belang rijk bericht dat geen hoofd volume groep wordt gebruikt bij gebruik van LVM voor HANA-gerelateerde volumes in [SAP Hana opslag configuraties van virtuele Azure-machines](./hana-vm-operations-storage.md)
- 19 mei 2020: een nieuw ondersteund besturings systeem voor HANA grote instantie type II toevoegen in [compatibele besturings systemen voor Hana grote instanties](/- azure/virtual-machines/workloads/sap/os-compatibility-matrix-hana-large-instance)
- 12 mei 2020: wijziging in de [connectiviteit van open bare eind punten voor vm's met behulp van Azure Standard ILB in SAP ha-scenario's](./high-availability-guide-standard-load-balancer-outbound-connections.md) om koppelingen bij te werken en informatie toe te voegen voor de firewall configuratie van een derde partij
- 11 mei 2020: wijziging van de [hoge Beschik baarheid van SAP Hana op virtuele machines van Azure op SLES](./sap-hana-high-availability.md) om de resource persistentie in te stellen op 0 voor de netcat-resource, omdat dit leidt tot meer gestroomlijnde failover 
- 05 mei 2020: wijzigingen in [Azure virtual machines planning en implementatie van SAP NetWeaver](./planning-guide.md) om aan te duiden dat Gen2-implementaties beschikbaar zijn voor Mv1 VM-familie
- 24 april 2020: wijzigingen in [SAP Hana uitschalen met stand-by-knoop punt op virtuele machines van Azure met ANF op SLES](./sap-hana-scale-out-standby-netapp-files-suse.md), in [SAP Hana uitschalen met het stand-by-knoop punt op Azure vm's met ANF op RHEL](./sap-hana-scale-out-standby-netapp-files-rhel.md), [hoge Beschik baarheid voor SAP net-Weaver](./high-availability-guide-suse-netapp-files.md) op Azure Vm's op SLES met ANF en [hoge Beschik baarheid voor SAP](./high-availability-guide-rhel-netapp-files.md) NetWeaver op Azure vm's op RHEL met ANF
- 22 april 2020: wijziging van de [hoge Beschik baarheid van SAP Hana op virtuele machines van Azure op SLES](./sap-hana-high-availability.md) om meta kenmerk `is-managed` uit de instructies te verwijderen, omdat dit een conflict veroorzaakt met het plaatsen van het cluster in of uit de onderhouds modus
- 21 april 2020: SQL Azure DB toegevoegd als ondersteund DBMS voor SAP (Hybris) commerce platform 1811 en hoger in artikelen [wat SAP-software ondersteunt voor Azure-implementaties](./sap-supported-product-on-azure.md) en [SAP-certificeringen en-configuraties die worden uitgevoerd op Microsoft Azure](./sap-certifications.md)
- 16 april 2020: SAP HANA als ondersteund DBMS voor SAP (Hybris) commerce platform in artikelen toegevoegd [wat SAP-software wordt ondersteund voor Azure-implementaties](./sap-supported-product-on-azure.md) en [SAP-certificeringen en-configuraties die worden uitgevoerd op Microsoft Azure](./sap-certifications.md)
- 13 april 2020: corrigeren op exacte SAP ASE-release nummers in [SAP ASE Azure virtual machines DBMS-implementatie voor SAP-workload](./dbms_guide_sapase.md)
- 2020 van april 07: wijziging in het [instellen van pacemaker op sles in azure](./high-availability-guide-suse-pacemaker.md) om de Cloud-netconfig-Azure-instructies te verduidelijken
- 6 april 2020: wijzigingen in [SAP Hana uitschalen met een stand-by-knoop punt op virtuele machines van Azure met Azure NetApp files op SLES](./sap-hana-scale-out-standby-netapp-files-suse.md) en in [SAP Hana uitschalen met het stand-by-knoop punt op virtuele machines van Azure met Azure NetApp files op RHEL](./sap-hana-scale-out-standby-netapp-files-rhel.md) om verwijzingen naar NetApp [tr-4435](https://www.netapp.com/us/media/tr-4746.pdf) te verwijderen (vervangen door [tr-4746](https://www.netapp.com/us/media/tr-4746.pdf))
- 31 maart 2020: wijziging in [hoge Beschik baarheid van SAP Hana op Azure-vm's op SLES](./sap-hana-high-availability.md) en [hoge Beschik baarheid van SAP Hana op Azure vm's op RHEL](./sap-hana-high-availability-rhel.md) om instructies toe te voegen hoe Stripe-grootte moet worden opgegeven bij het maken van striped volumes
- 27 maart 2020: wijziging in [hoge Beschik baarheid voor SAP NW op Azure vm's op SLES met ANF for SAP-toepassingen](./high-availability-guide-suse-netapp-files.md) om de opties voor het bestands systeem te koppelen aan NetApp TR-4746 (de optie synchronisatie koppelen verwijderen)
- 26 maart 2020: wijziging in [hoge Beschik baarheid voor SAP NetWeaver op Azure vm's in de SLES-hand leiding voor multi-sid](./high-availability-guide-suse-multi-sid.md) om referentie toe te voegen aan NetApp TR-4746
- 26 maart 2020: wijziging in [hoge Beschik baarheid voor SAP NetWeaver op Azure vm's op SLES voor SAP-toepassingen](./high-availability-guide-suse.md), [hoge Beschik baarheid voor SAP net-Weaver op Azure vm's op SLES met Azure NetApp files voor SAP-toepassingen](./high-availability-guide-suse-netapp-files.md), [hoge Beschik baarheid voor NFS op Azure vm's op SLES](./high-availability-guide-suse-nfs.md), [hoge Beschik baarheid voor SAP NetWeaver op Azure vm's in de RHEL-hand leiding voor meerdere sid's,](./high-availability-guide-suse-multi-sid.md)hoge [Beschik baarheid voor SAP NetWeaver op Azure Vm's op RHEL voor SAP-toepassingen en](./high-availability-guide-rhel.md) hoge [beschik BAARHEID voor sap netweaver op Azure vm's op RHEL met Azure NetApp files voor SAP-toepassingen voor](./high-availability-guide-rhel-netapp-files.md) het bijwerken van diagrammen Azure Load Balancer
- 19 maart 2020: belang rijke revisie van document [Quick Start: hand matige installatie van SAP Hana met één exemplaar op azure virtual machines](./hana-get-started.md) voor de [installatie van SAP HANA op Azure virtual machines](./hana-get-started.md)
- 17 maart 2020: wijzigen in instellen van [pacemaker op SuSE Linux Enterprise Server in azure](./high-availability-guide-suse-pacemaker.md) om de SBD-configuratie-instelling te verwijderen die niet meer nodig is
- 16 2020 maart: uitleg van het scenario voor kolom certificering in SAP HANA IaaS gecertificeerd platform in [welke SAP-software wordt ondersteund voor Azure-implementaties](./sap-supported-product-on-azure.md)
...
- 11 maart 2020: wijziging in [Azure virtual machines planning en implementatie van de SAP net-Weaver uitleg van](./planning-guide.md) de virtuele machines van de eerste en tweede generatie
- 10 maart 2020: Wijzig in [SAP Hana opslag configuraties van virtuele Azure-machines](./hana-vm-operations-storage.md) om echte bestaande doorvoer limieten van ANF te verduidelijken
- 9 maart 2020: wijziging in [hoge Beschik baarheid voor SAP NetWeaver op Azure vm's op SuSE Linux Enterprise Server voor SAP-toepassingen](./high-availability-guide-suse.md), [hoge Beschik baarheid voor SAP net-Weaver op azure vm's op SuSE Linux Enterprise Server met Azure NetApp files voor SAP-toepassingen](./high-availability-guide-suse-netapp-files.md), [hoge Beschik baarheid voor NFS op Azure-vm's op SuSE Linux Enterprise Server](./high-availability-guide-suse-nfs.md), het [instellen van pacemaker op SuSE Linux Enterprise Server in azure, een](./high-availability-guide-suse-pacemaker.md) [hoge Beschik baarheid van IBM Db2 LUW op Azure-vm's in SUSE Linux Enterprise Server met pacemaker](./dbms-guide-ha-ibm.md), hoge beschik [baarheid van SAP Hana op Azure-Vm's op SuSE Linux Enterprise Server](./sap-hana-high-availability.md) en [hoge Beschik baarheid voor SAP NetWeaver op Azure vm's in de SLES-hand leiding voor multi-sid](./high-availability-guide-suse-multi-sid.md) 
- 05 maart 2020: structuur wijzigingen en wijzigingen in de inhoud voor Azure-regio's en Azure virtual machines in [azure virtual machines planning en implementatie voor SAP net-Weaver](./planning-guide.md)
