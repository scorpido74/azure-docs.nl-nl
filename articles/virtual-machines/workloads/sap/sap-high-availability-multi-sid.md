...
description: Meer informatie over het maken van een multi-SID-configuratie met een hoge Beschik baarheid van SAP NetWeaver op virtuele Windows-machines.
