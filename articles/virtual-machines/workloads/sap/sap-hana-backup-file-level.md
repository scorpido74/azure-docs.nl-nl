...
Een andere optie, die meer vrijheid biedt met betrekking tot de totale capaciteit, is Azure Blob-opslag. Hoewel één BLOB ook is beperkt tot 1 TB, is de totale capaciteit van één BLOB-container momenteel 500 TB. Daarnaast biedt klanten de keuze om dit te selecteren &quot;cool&quot; Blob-opslag, die een kosten voordelen heeft. Zie [Azure Blob-opslag: dynamische, gekoelde en archief toegangs lagen](https://docs.microsoft.com/azure/storage/blobs/storage-blob-storage-tiers?tabs=azure-portal) voor meer informatie over cool Blob Storage.
