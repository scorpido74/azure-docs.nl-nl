...
![YaST-cluster-configure-csync2](media/HowToHLI/HASetupWithStonith/yast-cluster-configure-csync2.png) . png Voeg knooppunt namen toe en klik vervolgens op aanbevolen bestanden toevoegen.
