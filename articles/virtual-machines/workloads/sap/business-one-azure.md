...
Met betrekking tot SQL Server zijn de basis overwegingen voor implementatie zoals beschreven in de [Azure virtual machines DBMS-implementatie voor SAP](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/dbms-guide) NetWeaver van toepassing. in dit document worden de overwegingen voor SAP HANA beschreven.
...
Zelfs als u alleen geïnteresseerd bent in bedrijven, kan het document [Azure virtual machines planning en implementatie voor SAP](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/planning-guide) NetWeaver een goede bron van informatie zijn.
...
- [SLA voor Virtual Machines](https://azure.microsoft.com/support/legal/sla/virtual-machines/v1_8/)
...
Voor het implementeren van SQL Server als DBMS voor bedrijven One, gaat u naar het document [SQL Server Azure virtual machines DBMS-implementatie voor SAP](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/dbms_guide_sqlserver)NetWeaver. 

Ruwe schattingen voor de DBMS-zijde voor SQL Server zijn:

| Aantal gebruikers | vCPU's | Geheugen | Voor beeld van VM-typen |
| --- | --- | --- | --- |
...
Voor een hoge Beschik baarheid en herstel na nood gevallen om SAP HANA als Data Base voor bedrijven in azure, moet u de documentatie lezen [SAP Hana hoge Beschik baarheid voor virtuele Azure-machines](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-availability-overview) en de documentatie waarnaar wordt gezocht in dat document .
