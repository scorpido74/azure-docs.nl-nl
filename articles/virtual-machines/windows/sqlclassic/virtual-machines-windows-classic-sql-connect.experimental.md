...
Er kunnen meerdere virtuele machines worden gemaakt in dezelfde Cloud service. Zie [virtuele machines verbinden met een virtueel netwerk of een Cloud service](/previous-versions/azure/virtual-machines/windows/classic/connect-vms-classic#connect-vms-in-a-standalone-cloud-service)voor meer informatie over dit scenario voor virtuele machines. In dit scenario probeert een client op één virtuele machine verbinding te maken met SQL Server die worden uitgevoerd op een andere virtuele machine in dezelfde Cloud service.
...
> [!NOTE]
> Wanneer u deze methode gebruikt om met SQL Server te communiceren, gelden voor alle uitgaande gegevens van het Azure-Data Center normale [prijzen voor uitgaande gegevens overdracht](https://azure.microsoft.com/pricing/details/data-transfers/).
> 
> 
...
Met virtuele netwerken kunt u ook uw Azure-Vm's toevoegen aan een domein. Lid worden van een domein is de enige manier om Windows-verificatie met SQL Server te gebruiken. De andere verbindings scenario's vereisen SQL-verificatie met gebruikers namen en wacht woorden.
...
Voordat u verbinding kunt maken met het exemplaar van SQL Server vanaf een andere virtuele machine of het Internet, moet u de volgende taken uitvoeren:
