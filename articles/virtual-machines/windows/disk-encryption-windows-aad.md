...
3. Nadat u de sjabloon hebt geïmplementeerd, controleert u de status van de VM-versleuteling met behulp van uw voorkeurs methode:
     ...
     -  Selecteer de virtuele machine en klik vervolgens op **schijven** onder de kop **instellingen** om de versleutelings status in de portal te controleren. In de grafiek onder **versleuteling**ziet u of deze is ingeschakeld. 
           ![Azure Portal-schijf versleuteling ingeschakeld @ no__t-1
...
## <a name="bkmk_RunningWinVM"></a>Versleuteling inschakelen op bestaande of actieve Windows-Vm's met IaaS
...
### <a name="bkmk_RunningWinVMPSH"></a>Versleuteling inschakelen op bestaande of actieve Vm's met Azure PowerShell 
...
### <a name="bkmk_RunningWinVMCLI"></a>Versleuteling inschakelen op bestaande of actieve Vm's met Azure CLI
...
### <a name="bkmk_RunningWinVMwRM"> </a>De Resource Manager-sjabloon gebruiken
...
### <a name="bkmk_VHDprePSH"></a> Virtuele machines met vooraf versleutelde vhd's versleutelen met Azure PowerShell
