...
description: Meer informatie over de meest voorkomende fouten en oplossingen die zich voordoen tijdens de migratie van IaaS-resources van Azure Service Management naar de Azure Resource Manager-stack.
author: tanmaygore
manager: vashan
