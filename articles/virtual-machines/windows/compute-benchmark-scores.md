---
title: Benchmark scores berekenen voor Azure Windows-Vm's | Microsoft Docs
...
| Size | vCPU's | NUMA-knoop punten | CPU | Uitvoerbewerkingen | Gem. basis tempo | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
