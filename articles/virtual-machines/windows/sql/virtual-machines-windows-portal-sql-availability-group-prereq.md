---
title: 'SQL Server-beschikbaarheids groepen: Azure virtual machines-vereisten | Microsoft Docs'
...
ms.locfileid: "70100737"
---
# <a name="complete-the-prerequisites-for-creating-always-on-availability-groups-on-azure-virtual-machines"></a>De vereisten voor het maken van AlwaysOn-beschikbaarheids groepen op Azure virtual machines volt ooien
...
2. Klik **+** om een nieuw object te maken in de portal.
...
3. Selecteer subnetten onder **instellingen** in het virtuele netwerkvan **autoHAVNET** .
...
Nadat u het netwerk, subnetten, beschikbaarheids sets en een Internet gerichte load balancer hebt gemaakt, bent u klaar om de virtuele machines voor de domein controllers te maken.
...
| **Veld** | Value |
| --- | --- |
| **Name** |Eerste domein controller: *ad-Primary-DC*.</br>Tweede domein controller *ad-secundair-DC*. |
| **Type VM-schijf** |SSD |
...
15. Klik op **Install**. De virtuele machine van **ad-Primary-DC** wordt automatisch opnieuw opgestart.
...
1. Maak verbinding met de server via de Remote Desktop Protocol (RDP) met behulp van het  *\<account\>MachineName \DomainAdmin* .
...
1. Klik met derechter muisknop op aanmeldingen. Klik op **nieuwe aanmelding**.
...
1. Ken de volgende machtigingen toe `[NT AUTHORITY\SYSTEM]` aan elk SQL Server-exemplaar:
