...
Als u dit voor deel wilt inschakelen, gaat u naar de resource van de [SQL Server virtuele machine](virtual-machines-windows-sql-manage-portal.md#access-the-sql-virtual-machines-resource), selecteert **u configureren** onder instellingen en kiest u vervolgens de optie voor **nood herstel** onder **SQL Server-licentie**. Schakel het selectie vakje in om te bevestigen dat deze SQL Server virtuele machine wordt gebruikt als passieve replica en selecteer vervolgens **Toep assen** om uw instellingen op te slaan. 

![DR-replica in azure configureren](media/virtual-machines-windows-sql-high-availability-dr/dr-replica-in-portal.png)
