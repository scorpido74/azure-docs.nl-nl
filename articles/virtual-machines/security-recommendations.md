...
Zie [Wat is Azure Security Center?](../security-center/security-center-intro.md)voor algemene informatie over Azure Security Center.
...
| Zorg ervoor dat uw virtuele machines actueel blijven. | U kunt de [updatebeheer](../automation/update-management/update-mgmt-overview.md) -oplossing in azure Automation gebruiken om updates van het besturings systeem voor uw Windows-en Linux-computers in azure te beheren. | [Ja](../security-center/security-center-apply-system-updates.md) |
...
| Gebruik meerdere Vm's voor grotere tolerantie en meer Beschik baarheid. | Als uw VM toepassingen uitvoert die Maxi maal beschikbaar moeten zijn, gebruikt u meerdere Vm's of [beschikbaarheids sets](../virtual-machines/windows/manage-availability.md). | - |
...
| Aanbeveling | Opmerkingen | Security Center |
|-|----|--|
| De schijven van het besturings systeem versleutelen. | [Azure Disk Encryption](../security/azure-security-disk-encryption-overview.md) helpt u bij het versleutelen van uw Windows-en Linux IaaS-VM-schijven. Zonder de benodigde sleutels zijn de inhoud van versleutelde schijven onleesbaar. Schijf versleuteling beveiligt opgeslagen gegevens van onbevoegde toegang die anders mogelijk zouden zijn als de schijf is gekopieerd.| [Ja](../security-center/security-center-apply-disk-encryption.md) |
| Gegevens schijven versleutelen. | [Azure Disk Encryption](../security/azure-security-disk-encryption-overview.md) helpt u bij het versleutelen van uw Windows-en Linux IaaS-VM-schijven. Zonder de benodigde sleutels zijn de inhoud van versleutelde schijven onleesbaar. Schijf versleuteling beveiligt opgeslagen gegevens van onbevoegde toegang die anders mogelijk zouden zijn als de schijf is gekopieerd.| -  |
...
| Aanbeveling | Opmerkingen | Security Center |
|-|----|--|
| VM-verificatie centraliseren. | U kunt de verificatie van uw Windows-en Linux-Vm's centraliseren door gebruik te maken van [Azure Active Directory-verificatie](../active-directory/develop/authentication-scenarios.md). | - |

## <a name="monitoring"></a>Bewaking

| Aanbeveling | Opmerkingen | Security Center |
|-|----|--|
| Bewaak uw Vm's. | U kunt [Azure monitor voor VM's](../azure-monitor/insights/vminsights-overview.md) gebruiken om de status van uw Azure-vm's en virtuele-machine schaal sets te bewaken. Prestatie problemen met een virtuele machine kunnen leiden tot onderbrekingen in de service, waardoor het beveiligings principe van Beschik baarheid wordt geschonden. | - |
...
Neem contact op met uw toepassings provider voor meer informatie over aanvullende beveiligings vereisten. Zie voor meer informatie over het ontwikkelen van beveiligde toepassingen [documentatie voor beveiligde ontwikkel aars](../security/fundamentals/abstract-develop-secure-apps.md).