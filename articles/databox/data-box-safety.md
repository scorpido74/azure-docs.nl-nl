...
pictogram ![Warning ](./media/data-box-safety/warning_icon.png)
 ![Read veiligheids waarschuwing ](./media/data-box-safety/read_safety_and_health_information_icon.png) **informatie over lees veiligheid en gezondheid**
...
| Diapictogram | Beschrijving |
|:--- |:--- |
| ![Danger pictogram ](./media/data-box-safety/warning_icon.png) **gevaar.** |Duidt op een gevaarlijke situatie die, indien dat niet wordt vermeden, leidt tot dood of ernstige schade. Dit signaal Word is beperkt tot de meest extreme situaties. |
| ![Warning pictogram ](./media/data-box-safety/warning_icon.png) **waarschuwing.** |Duidt op een gevaarlijke situatie die, indien dat niet wordt vermeden, kan leiden tot overlijden of ernstige schade. |
| ![Warning pictogram ](./media/data-box-safety/warning_icon.png) **voorzichtig!** |Duidt op een gevaarlijke situatie die, indien dat niet wordt vermeden, kan leiden tot kleine of gemiddelde schade. |
| ](./media/data-box-safety/notice_icon.png) kennisgeving ![Notice pictogram **:** |Geeft aan dat de informatie die belang rijk is, maar niet met een risico is betrokken. |
| ![Electrical schok-pictogram ](./media/data-box-safety/electrical_shock_hazard_icon.png) **gevaar voor elektrische schokken** |Hoge spanning. |
| Pictogram voor ![Heavy gewicht ](./media/data-box-safety/heavy_weight_hazard_icon.png) **zwaar gewicht** | |
| ![No pictogram voor gebruikers-service onderdelen ](./media/data-box-safety/no_user_serviceable_parts_icon.png) geen door de **gebruiker** bewaarde onderdelen |Doe geen toegang tenzij het goed is getraind. |
| ![Read pictogram voor een veiligheids waarschuwing ](./media/data-box-safety/read_safety_and_health_information_icon.png) **eerst alle instructies lezen** | |
| Pictogram ![Tip risico ](./media/data-box-safety/tip_hazard_icon.png) **risico op fooien** | |

## <a name="handling-precautions"></a>Voorzorgsmaatregelen verwerken

![Warning pictogram ](./media/data-box-safety/warning_icon.png) ![Electrical schok pictogram ](./media/data-box-safety/electrical_shock_hazard_icon.png)![No onderdeel gebruikers service onderdelen ](./media/data-box-safety/no_user_serviceable_parts_icon.png) **waarschuwing** 
...
![Warning pictogram ](./media/data-box-safety/warning_icon.png) pictogram ![Heavy gewicht ](./media/data-box-safety/heavy_weight_hazard_icon.png) **waarschuwing.** 
...
![Warning pictogram ](./media/data-box-safety/warning_icon.png) ![Tip pictogram risico ](./media/data-box-safety/tip_hazard_icon.png) **waarschuwing.**
...
![Warning pictogram ](./media/data-box-safety/warning_icon.png) **waarschuwing.**
...
![Warning pictogram ](./media/data-box-safety/warning_icon.png) ![Electrical schok pictogram ](./media/data-box-safety/electrical_shock_hazard_icon.png) **waarschuwing.**
...
![Warning pictogram ](./media/data-box-safety/warning_icon.png) **Let op:**
...
](./media/data-box-safety/notice_icon.png) kennisgeving ![Notice pictogram **:**
