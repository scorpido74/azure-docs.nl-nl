...
2.  > **Waar wordt uw werk belasting uitgevoerd?** Selecteer **Azure**. **Backup Goal** In **waarvan wilt u een back-up maken?** Selecteer **virtuele machine** >  **OK**. Hiermee wordt de VM-extensie in de kluis geregistreerd.
