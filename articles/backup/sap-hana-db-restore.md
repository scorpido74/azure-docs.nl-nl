...
* Selecteer in het menu **configuratie herstellen** onder **waar u wilt herstellen**de optie **Data Base overschrijven** > **OK**.
...
![Herstel punt](media/sap-hana-db-restore/restore-point.png)
