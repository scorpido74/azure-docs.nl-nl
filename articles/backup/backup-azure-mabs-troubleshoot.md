...
| Backup | Fout bij het openen van bestanden/gedeelde mappen | Wijzig de antivirus instellingen, zoals wordt voorgesteld in dit artikel, om [antivirus software op de DPM-server uit te voeren](https://docs.microsoft.com/system-center/dpm/run-antivirus-server?view=sc-dpm-2019).|
