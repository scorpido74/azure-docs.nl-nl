...
| Backup | Fout bij het openen van bestanden/gedeelde mappen | Wijzig de antivirus instellingen zoals aanbevolen in het TechNet-artikel [Voer antivirus software op de DPM-server uit](https://technet.microsoft.com/library/hh757911.aspx).|
