...
| **Versies van besturings systemen**            | SLES 12 met SP2, SP3 of SP4; SLES 15 met SP1 <br><br>   **Preview** -RHEL 7,4, 7,6, 7,7 en 8,1  <br>     [Ga](https://docs.microsoft.com/azure/backup/tutorial-backup-sap-hana-db) aan de slag met SAP Hana Backup Preview voor RHEL (7,4, 7,6, 7,7 en 8,1). Voor verdere query's schrijft u naar ons [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com) .                |                                             |
