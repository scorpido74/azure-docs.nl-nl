---
title: Veelgestelde vragen over Azure Backup Server en DPM (Data Protection Manager)
description: In dit artikel vindt u antwoorden op veelgestelde vragen over de Microsoft Azure Backup-Server (MABS) en DPM.
