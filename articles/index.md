...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Introductiehandleiding voor Azure-ontwikkelaars</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Cloud Adoption Framework voor Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Gratis Azure-cursussen van Pluralsight</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="visually-hidden">Documentatie voor Microsoft Azure</h1>
        <ul class="pivots">
            <li>
                        ...
                        <ul id="get-started1" class="cardsL">
                            <li>
                                <div class="container intro">
                                    <h2 class="likeAnH1">Aan de slag met Azure</h2>
                                    <p>Ontdek onze populairste services met snelstartgidsen, voorbeelden en zelfstudies.</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Infrastructuur implementeren</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/virtual-machines/linux/">Virtuele Linux-machines</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/">Virtuele Windows-machines</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Resources beveiligen en beheren</h3>
                                                <ul class="noBullet">
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Gegevens en AI beheren</h3>
                                                <h4>Relationele databases</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/sql-database/">SQL Database as a Service</a></li>
                                                    <li><a class="barLink" href="/azure/sql-database-edge/">SQL-database voor Edge</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/sql/">SQL Server in een Azure-VM</a></li>
                                                    <li><a class="barLink" href="/azure/sql-data-warehouse/">Synapse Analytics (voorheen SQL DW)</a></li>
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                            <img src="https://docs.microsoft.com/media/common/i_mobile-app-developement.svg" alt=""> Mobiele app van Azure </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Uw vaardigheden ontwikkelen met Microsoft Learn</h3>
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/tour-azure-portal/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/tour-azure-services-and-features.svg" alt=""> Een rondleiding maken door de Azure-services en -functies </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/principles-cloud-computing/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/principles-cloud-computing.svg" alt=""> De principes van cloudcomputing </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/control-azure-services-with-cli/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/control-azure-services-with-cli.svg" alt=""> Azure-services beheren via de CLI </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/automate-azure-tasks-with-powershell/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/automate-azure-tasks-with-powershell.svg" alt=""> Azure-taken automatiseren met behulp van PowerShell-scripts </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/browse/?products=azure">Meer interactief leren...</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://docs.microsoft.com/azure/index#pivot=products&panel=all">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Alle Azure-services weergeven<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <ul id="products">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/bing-entities-search/">
                                                ...
                                                <p>Bing Entiteiten zoeken-API</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/sql-data-warehouse/">
                                                ...
                                                <p>Azure Synapse Analytics (voorheen SQL DW)</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>SQL Server op Virtual Machines</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/integrations">
                                                ...
                                                <p>Integratie van ontwikkelhulpprogramma's</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cli">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/media-services/media-services-manage-channels-overview">
                                                ...
                                                <p>Live streaming en streaming on demand</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/azure-government/">
                                                ...
                                                <p>Azure van de Amerikaanse overheid</p>
                                            </a>
                                        </li>
                                        <li>
                    ...
                    <li>
                        ...
                        <ul id="ai" class="cardsA">
                            <li class="fullSpan">
                                <h2>Kunstmatige intelligentie en Machine Learning</h2>
                            </li>
                            <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Apps, websites en bots voorzien van intelligentie, zodat deze kunnen zien, horen, spreken en begrijpen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Machine learning en AI-modellen bouwen, implementeren en beheren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Intelligente, serverloze botservice die schaalt op aanvraag</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Een Azure Databricks-werkruimte met Spark-clusters maken</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Synapse Analytics (voorheen SQL DW)</h3>
                                                    <p>Onbeperkte analyseservice met ongeëvenaarde tijd tot inzicht</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HDInsight</h3>
                                                    <p>Cloudclusters voor Hadoop, Spark, R Server, HBase en Storm inrichten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Een snelle en zeer schaalbare service om logboek- en telemetriegegevens te verkennen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Realtime analyse van snel veranderende gegevensstromen van toepassingen en apparaten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gedistribueerde analyseservice die het werken met big data eenvoudig maakt</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Indrukwekkende, volledig interactieve gegevensvisualisaties insluiten in uw applicaties</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Apache Spark in de cloud voor essentiële implementaties</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Verwerking van gegevensstromen in realtime vereenvoudigd voor big data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Predictive analytics, machine learning en statistische modellen bouwen voor big data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Sterk schaalbare, veilige Data Lake-opslag ingebouwd in Blob-opslag</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>NFS-bestandsservice op Enterprise-niveau, mogelijk gemaakt door NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Een gebruiksvriendelijke en veilige service voor het delen van big data met externe organisaties</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Netwerken voor consortiumblockchains bouwen, beheren en uitbreiden</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Uw blockchain met de cloud verbinden zonder het zware werk</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Eenvoudig tokens in grootboeken definiëren, maken en beheren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Maximaal beschikbare, oneindig schaalbare cloudtoepassingen en API's maken</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Server op Virtual Machines</h3>
                                                    <p>Zakelijke SQL Server-apps hosten in de cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>De grootste SAP HANA-workloads uitvoeren van alle hyperschaal-cloudproviders</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CycleCloud</h3>
                                                    <p>HPC- en grote rekenclusters van elke schaal maken, beheren, uitvoeren en optimaliseren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cognitive Services</h3>
                                                    <p>Azure Cognitive Services-containers gebruiken met Docker, Kubernetes, AKS en Container Instances</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Relationele database-engine, geoptimaliseerd voor IoT- en Edge-implementaties.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Een beheerde MariaDB-databaseservice voor app-ontwikkelaars</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>De complexiteit van uw cloudmigratie vereenvoudigen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio</h3>
                                                    <p>Volledig uitgeruste, geïntegreerde werkomgeving (IDE) voor Android, iOS, Windows, web en cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Visual Studio Code is een toegankelijke, krachtige broncode-editor voor Windows, macOS en Linux die u kunt uitvoeren op uw computer.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SDK's</h3>
                                                    <p>Cloud-apps bouwen met de programmeertalen die u al kent</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integratie van ontwikkelhulpprogramma's</h3>
                                                    <p>Hulpprogramma's van derden om u te helpen bij uw Azure-ontwikkeling</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CLI</h3>
                                                    <p>Rechtstreeks toegang tot de cloud vanuit opdrachtregelprogramma's</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Snelle, schaalbare parameteropslag voor app-configuratie</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Problemen in uw web-apps en services detecteren en sorteren en diagnoses uitvoeren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Labs maken in de cloud voor leslokaal-, ontwikkel-, test- en andere scenario's (voorheen DevTest Labs)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Verzend apps sneller door de toepassingslevenscycli te automatiseren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integratie van ontwikkelhulpprogramma's</h3>
                                                    <p>Azure uitbreiden met populaire extensies</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HockeyApp</h3>
                                                    <p>Mobiele apps implementeren, feedback en foutrapporten verzamelen en het gebruik controleren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>On-premises adreslijsten synchroniseren en eenmalige aanmelding inschakelen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Organisatorisch beleid maken en implementeren om gevoelige gegevens te beheren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Meer informatie over hoe u onze best practices en begeleiding kunt gebruiken om uw cloudoplossingen in Azure te beveiligen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#integration">Integratie</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Service Bus</h3>
                                                    <p>Verbinding maken in meerdere privé- en openbare cloudomgevingen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hiermee bouwt u snel digitale landbouwoplossingen in de cloud.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Financiële dienstverlening</h3>
                                                    <p>Oplossingen en gebruiksgevallen voor de financiële dienstverlening.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gezondheids- en levenswetenschappen</h3>
                                                    <p>Oplossingen en gebruiksgevallen voor gezondheidszorg en biowetenschappen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Productie</h3>
                                                    <p>Oplossingen en gebruiksgevallen voor de productiesector.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Retail</h3>
                                                    <p>Oplossingen en gebruiksgevallen voor de retailsector.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bent u nieuw bij Azure IoT?</h3>
                                                    <p>Ontdek hier welke service aan uw behoeften voldoet</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Central</h3>
                                                    <p>Het maken van IoT-oplossingen versnellen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Plug en Play</h3>
                                                    <p>Apparaten verbinden met uw IoT-oplossing zonder apparaatcode te schrijven</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT-oplossingsversnellers</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Digitale replica's van ruimten en infrastructuur maken</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zero-touch, just-in-time inrichting voor Azure IoT Hub</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Sphere</h3>
                                                    <p>Zeer goed beveiligde, verbonden apparaten op basis van een MCU maken</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Beheer en governance</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Inkomend verkeer omleiden voor betere prestaties en een hoge beschikbaarheid</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Beveiliging &amp; naleving</h3>
                                                    <p>Detectie en preventie van bedreigingen inschakelen via geavanceerde cloudbeveiliging</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Portal</h3>
                                                    <p>Bouw, beheer en bewaak alle Azure-producten in één geïntegreerde console</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vereenvoudig hoe u uw app-resources beheert</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cloud Shell</h3>
                                                    <p>Azure-beheer stroomlijnen met een browsergebaseerde shell</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Blijf altijd en overal verbonden met uw Azure-resources</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Op herhaalbare wijze cloudomgevingen implementeren en bijwerken met behulp van samenstelbare artefacten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Op grote schaal resources verkennen met een uitgebreide querytaal</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Migrate</h3>
                                                    <p>Uw on-premises VM's eenvoudig ontdekken, beoordelen, op maat maken en naar Azure migreren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Klantenresources op schaal beheren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Video en audio op de benodigde schaal coderen, opslaan en streamen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Encoding</h3>
                                                    <p>Codering op studioniveau met de kracht van de cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Live streaming en streaming on demand</h3>
                                                    <p>Lever inhoud aan vrijwel alle apparaten met de schaal die is afgestemd op bedrijfsbehoeften</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Eén speler waarmee u alles kunt afspelen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Inhoud veilig leveren met AES, PlayReady, Widevine en FairPlay</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Krijg meer inzicht dankzij videobestanden met services voor spreken en zien</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Video Indexer</h3>
                                                    <p>Uw multimediabestanden toegankelijker en beter vindbaar maken</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Digital Twins</h3>
                                                    <p>Bouw IoT-oplossingen van de volgende generatie voor ruimtelijke intelligentie</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Maak mixed reality-ervaringen voor ruimtelijk inzicht voor meerdere gebruikers</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bouw naar hartelust met een veelzijdig sensorapparaat</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DNS</h3>
                                                    <p>Uw DNS-domein hosten in Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>VPN Gateway</h3>
                                                    <p>Veilige, cross-premises verbinding tot stand brengen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Maximaal beschikbare en schaalbare netwerkbeveiligingsservice in de cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gecentraliseerde bescherming voor uw webtoepassingen bieden, van veelvoorkomende aanvallen tot beveiligingsproblemen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Optimale internetconnectiviteit voor toegang tot het Microsoft-netwerk</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Evalueren hoe netwerkinfrastructuur impact heeft op de prestaties van uw klant</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Privétoegang tot services die worden gehost op het Azure-platform, waardoor uw gegevens nooit het Microsoft-netwerk verlaten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Een wereldwijd gedistribueerde service voor beveiligingsbeheer</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Toegewezen HSM</h3>
                                                    <p>Opslag van cryptografische sleutels in Azure gebruiken</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Uw bedrijf tegen bedreigingen beschermen in de cloud en on-premises</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Op rollen gebaseerd toegangsbeheer</h3>
                                                    <p>Toegang tot Azure-resources beheren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Microsoft Azure van de Amerikaanse overheid</h3>
                                                    <p>Toepassingen bouwen en hosten voor missies van de Amerikaanse overheid in een toegewezen exemplaar van Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Toepassingen bouwen en hosten in overeenstemming met het beleid en de richtlijnen voor de verwerking van gegevens die zijn opgesteld door de Chinese overheid</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Beheerde schijven</h3>
                                                    <p>Permanente, beveiligde schijfopslag voor virtuele Azure-machines</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Flexibele, op bestanden gebaseerde workloads in Azure uitvoeren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Oplossing voor hybride opslagoptimalisatie voor HPC-omgevingen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Opslagverkenner</h3>
                                                    <p>Eenvoudig opslag beheren vanaf elke locatie met Windows, macOS en Linux</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Voordelige, veilige cloudopslag voor zelden gebruikte gegevens</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure NetApp Files</h3>
                                                    <p>Netwerkbestandsservices op Enterprise-niveau, mogelijk gemaakt door NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Voeg eenvoudig realtime webfuncties toe</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows Virtual Desktop</h3>
                                                    <p>Lever een virtuele bureaubladervaring aan elk apparaat op cloudschaal</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure voor .NET-ontwikkelaars </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure voor Python-ontwikkelaars </h3>
                                                <p>
                                                    <a href="/azure/python">Aan de slag</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/?view=azure-python">API-naslaginformatie</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure voor Node.js-ontwikkelaars </h3>
                                                <p>
                                                    <a href="/azure/javascript/">Aan de slag</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure voor Java-ontwikkelaars </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure voor Go-ontwikkelaars </h3>
                                                <p>
                                                    <a href="/azure/go/">Aan de slag</a>
                                                </p>
                                                <p>
                                                    <a href="https://godoc.org/github.com/Azure/azure-sdk-for-go">API-naslaginformatie</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure CLI </h3>
                                                ...
                                                <p>
                                                    <a href="/cli/azure/reference-index">Naslaginformatie</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/powershell/azure/get-started-azureps">Aan de slag</a>
                                                </p>
                                                <p>
                                                    <a href="/powershell/azure/overview">Naslaginformatie</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure Portal</h3>
                                                <p>
                                                    <a href="/azure/azure-portal/">Aan de slag</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure mobile app</h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">Aan de slag</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=navigation+cta&utm_content=download+vs2017">Download voor Windows</a>
                                                </p>
                                                 <p>
                                                    <a href="https://visualstudio.microsoft.com/vs/mac/">Download voor Mac</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Docker </h3>
                                                ...
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780681">Download voor Visual Studio Code</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780682">Download voor Azure DevOps</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Java-hulpprogramma's </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/api/overview/azure/maven/readme">Maven-invoegtoepassingen</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/azure/java-azure-tools">IntelliJ en Eclipse</a>
                                                </p>
                                                <p>
...
Azure Resource Manager </h3>
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/resources/templates/">Voorbeeldsjablonen</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/templates/">Naslaginformatie</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=722418">Download voor Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708342">Download voor Mac</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708343">Download voor Windows</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Service Fabric-SDK en -hulpprogramma's </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started">Download voor Windows</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-linux">Download voor Linux</a>
                                                </p>
                                                <p>
...
SQL-hulpprogramma's </h3>
                                                ...
                                                <p>
                                                    <a href="/sql/tools/overview-sql-tools">Alle SQL-hulpprogramma's bekijken</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure Dev Spaces </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/azure-dev-spaces">Aan de slag</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-netcore">Downloaden voor .NET Core en VS Code</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-netcore-visualstudio">Downloaden voor .NET Core en Visual Studio</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-nodejs">Downloaden voor Node.js</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
