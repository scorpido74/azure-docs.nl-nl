...
1. Geef de parameter waarden voor de toewijzing van de blauw druk op:
   ...
   - **Artefact parameters**
     ...
     |StorageAccount|Resource Manager-sjabloon|storageAccountType (Storage account)|Standard_GRS|De opslag-SKU. De standaard waarde is _Standard_LRS_.|
...
1. Selecteer de toewijzing weigeren en selecteer vervolgens de pagina **geweigerde machtigingen** aan de linkerkant.
   ...
   De weiger toewijzing verhindert alle bewerkingen met de **\*** -en- **actie** configuratie, maar biedt Lees toegang door ** \*/Read** uit te **sluiten.**
