---
title: Canada Federal PBMM-blauwdrukvoorbeeld implementeren
description: Stappen implementeren voor het Canada Federal PBMM-blauwdrukvoorbeeld, inclusief details van de parameterparameters voor blauwdrukken.
ms.date: 09/05/2019
ms.topic: sample
...
---
# <a name="deploy-the-canada-federal-pbmm-blueprint-samples"></a>De Canadese federale PBMM-blauwdrukvoorbeelden implementeren

Als u de Canada Federal PBMM-blauwdrukvoorbeelden wilt implementeren, moeten de volgende stappen worden genomen:
...
1. Zoek het **Canada Federal PBMM-blauwdrukvoorbeeld** onder _Andere voorbeelden_ en selecteer Dit voorbeeld **gebruiken**.
...
1. Selecteer **Blauwdruk publiceren** boven aan de pagina. Geef op de nieuwe pagina aan de rechterkant een **versie** voor uw exemplaar van het blauwdrukvoorbeeld. Deze eigenschap is handig voor als u later een wijziging aanbrengt. **Geef change notes** zoals "Eerste versie gepubliceerd uit de Canada Federal PBMM blauwdruk monster." Selecteer vervolgens **Publiceren** onder aan de pagina.
...
|\[Preview\]: Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : |Beleidstoewijzing |Log Analytics-werkruimte-id waarvoor VM's moeten worden geconfigureerd |Dit is de ID (GUID) van de Log Analytics-werkruimte waarvoor de VM's moeten worden geconfigureerd. |
|\[Preview\]: Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : |Beleidstoewijzing |Lijst met resourcetypen waarmee diagnostische logboeken zijn ingeschakeld |Lijst met resourcetypen om te controleren of diagnostische logboekinstelling niet is ingeschakeld. Acceptabele waarden zijn te vinden op [azure monitor diagnostische logboekenschema's.](../../../../azure-monitor/platform/diagnostic-logs-schema.md#supported-log-categories-per-resource-type) |
|\[Preview\]: Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : |Beleidstoewijzing |Beheerdersgroep |Groep. Voorbeeld: `Administrator; myUser1; myUser2` |
|\[Preview\]: Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : Audit Canada Federal PBMM controls and deploy specific VM Extensions to support audit requirements Preview : |Beleidstoewijzing |Lijst met gebruikers die moeten worden opgenomen in de groep Windows VM-beheerders |Een lijst met gescheiden punten van puntkomma's die moeten worden opgenomen in de lokale groep Administrators. Voorbeeld: `Administrator; myUser1; myUser2` |
...
Nu u de stappen hebt bekeken om het Voorbeeld van Canada Federal PBMM te implementeren, gaat u naar de volgende artikelen voor meer informatie over het overzicht en het toewijzen van beheer:

> [!div class="nextstepaction"]
> [Canada Federal PBMM blauwdrukken - Overzicht](./index.md)
> [Canada Federale PBMM blauwdrukken - Controle mapping](./control-mapping.md)
