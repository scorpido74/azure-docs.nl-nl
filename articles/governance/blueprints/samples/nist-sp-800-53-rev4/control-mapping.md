---
title: Besturingselementen van het blauwdrukvoorbeeld NIST SP 800-53 R4
description: Toewijzing van besturingselementen van het blauwdrukvoorbeeld NIST SP 800-53 R4. Elke beheeroptie wordt toegewezen aan een of meer Azure-beleidsregels die helpt bij de evaluatie.
ms.date: 05/14/2020
ms.topic: sample
...
## <a name="ac-16-security-attributes"></a>Beveiligingskenmerken van AC-16
...
Nu u de toewijzing van beheeropties van blauwdruk NIST SP 800-53 R4 hebt bekeken, kunt u naar de volgende artikelen gaan voor informatie over de blauwdruk en de implementatie van dit voorbeeld:

> [!div class="nextstepaction"]
> [Blauwdruk NIST SP 800-53 R4 - Overzicht](./index.md)
> [Blauwdruk NIST SP 800-53 R4 blueprint - Stappen implementeren](./deploy.md)
