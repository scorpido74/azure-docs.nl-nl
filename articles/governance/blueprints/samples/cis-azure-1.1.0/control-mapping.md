...
Versleuteling door Azure Storage wordt ingeschakeld voor alle nieuwe en bestaande opslagaccounts en kan niet worden uitgeschakeld. (Dit is een standaard Azure-functie; er is geen beleids toewijzing.)
...
Deze blauw druk wijst een [Azure Policy](../../../policy/overview.md) definitie toe waarmee u ervoor kunt zorgen dat MySQL-database servers TLS/SSL-verbindingen afdwingen.
...
Deze blauw druk wijst een [Azure Policy](../../../policy/overview.md) definitie toe waarmee u ervoor kunt zorgen dat PostgreSQL database servers TLS/SSL-verbindingen afdwingen.
...
> [CIS Microsoft Azure stichtings-benchmark blauw drukken-overzicht](./index.md)
> van[CIS Microsoft Azure stichtings bebenchmarking blauw druk-stappen implementeren](./deploy.md)
