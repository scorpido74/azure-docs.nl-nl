---
title: IRS 1075 blueprint sample controls IRS 1075 blueprint sample controls IRS 1075 blueprint sample controls IRS 1
description: Controle mapping van de IRS 1075 blauwdruk monster. Elk besturingselement wordt toegewezen aan een of meer Azure-beleidsregels die helpen bij de beoordeling.
ms.date: 11/20/2019
ms.topic: sample
...
## <a name="9321-ac-2-7-account-management--role-based-schemes"></a>9.3.2.1 AC-2 (7) Accountbeheer | Op rollen gebaseerde regelingen
...
## <a name="9321-ac-2-12-account-management--account-monitoring--atypical-usage"></a>9.3.2.1 AC-2 (12) Accountbeheer | Accountmonitoring / Atypisch gebruik
...
## <a name="9314-ac-4-information-flow-enforcement"></a>9.3.1.4 AC-4 Handhaving van informatiestromen
...
## <a name="9315-ac-5-separation-of-duties"></a>9.3.1.5 AC-5 Scheiding van rechten
...
## <a name="9316-ac-6-7-least-privilege--review-of-user-privileges"></a>9.3.1.6 AC-6 (7) Minste voorrecht | Beoordeling van gebruikersbevoegdheden
...
## <a name="93112-ac-17-1-remote-access--automated-monitoring--control"></a>9.3.1.12 AC-17 (1) Toegang op afstand | Geautomatiseerde controle / controle
...
## <a name="9313-au-3-2-content-of-audit-records--centralized-management-of-planned-audit-record-content"></a>9.3.1.3 AU-3 (2) Inhoud van de controleverslagen | Gecentraliseerd beheer van de inhoud van geplande auditrecord
...
## <a name="9335-au-5-response-to-audit-processing-failures"></a>9.3.3.5 AU-5 Reactie op fouten in de verwerking van controles
...
## <a name="9336-au-6-4-audit-review-analysis-and-reporting--central-review-and-analysis"></a>9.3.3.6 AU-6 (4) Controle, analyse en rapportage | Centrale evaluatie en analyse
...
## <a name="93311-au-12-audit-generation"></a>9.3.3.11 AU-12 Audit Generatie
...
## <a name="9357-cm-7-2-least-functionality--prevent-program-execution"></a>9.3.5.7 CM-7 (2) Minste functionaliteit | Programma-uitvoering voorkomen
...
## <a name="9357-cm-7-5-least-functionality--authorized-software--whitelisting"></a>9.3.5.7 CM-7 (5) Minste functionaliteit | Geautoriseerde software / whitelisting
...
## <a name="9366-cp-7-alternate-processing-site"></a>9.3.6.6 CP-7 Alternatieve verwerkingslocatie
...
## <a name="9372-ia-2-1-identification-and-authentication-organizational-users--network-access-to-privileged-accounts"></a>9.3.7.2 IA-2 (1) Identificatie en authenticatie (gebruikers van de organisatie) | Netwerktoegang tot geprivilegieerde accounts
...
## <a name="9372-ia-2-2-identification-and-authentication-organizational-users--network-access-to-non-privileged-accounts"></a>9.3.7.2 IA-2 (2) Identificatie en authenticatie (gebruikers van organisatorische gegevens) | Netwerktoegang tot niet-bevoorrechte accounts
...
## <a name="9375-ia-5-1-authenticator-management--password-based-authentication"></a>9.3.7.5 IA-5 (1) AuthenticatorBeheer | Verificatie op basis van wachtwoord
...
## <a name="93143-ra-5-vulnerability-scanning"></a>9.3.14.3 RA-5 Kwetsbaarheid scannen
...
## <a name="93165-sc-7-boundary-protection"></a>9.3.16.5 SC-7 Grensbeveiliging
...
## <a name="93165-sc-7-3-boundary-protection--access-points"></a>9.3.16,5 SC-7 (3) Grensbeveiliging | Toegangspunten
...
## <a name="93165-sc-7-4-boundary-protection--external-telecommunications-services"></a>9.3.16,5 SC-7 (4) Grensbeveiliging | Externe telecommunicatiediensten
...
## <a name="96163-sc-8-1-transmission-confidentiality-and-integrity--cryptographic-or-alternate-physical-protection"></a>9.6.16.3 SC-8 (1) Vertrouwelijkheid en integriteit van de transmissie | Cryptografische of alternatieve fysieke bescherming
...
## <a name="93166-sc-28-1-protection-of-information-at-rest--cryptographic-protection"></a>9.3.16.6 SC-28 (1) Bescherming van informatie in rust | Cryptografische bescherming
...
## <a name="93172-si-2-flaw-remediation"></a>9.3.17.2 SI-2 Foutherstel
...
## <a name="93173-si-3-malicious-code-protection"></a>9.3.17.3 SI-3 Beveiliging van schadelijke code
...
## <a name="93173-si-3-1-malicious-code-protection--central-management"></a>9.3.17.3 SI-3 (1) Bescherming tegen kwaadaardige code | Centraal beheer
...
## <a name="93174-si-4-information-system-monitoring"></a>9.3.17.4 SI-4 Informatiesysteemmonitoring
...
## <a name="93174-si-4-18-information-system-monitoring--analyze-traffic--covert-exfiltration"></a>9.3.17.4 SI-4 (18) Monitoring van het informatiesysteem | Verkeer analyseren / Geheime exfiltratie
...
Nu u de beheertoewijzing van de IRS 1075-blauwdruk hebt bekeken, bezoekt u de volgende artikelen om meer te weten te komen over de blauwdruk en hoe u dit voorbeeld implementeert:

> [!div class="nextstepaction"]
> [IRS 1075 blauwdruk - Overzicht](./index.md)
> [IRS 1075 blauwdruk - Deploy stappen](./deploy.md)
