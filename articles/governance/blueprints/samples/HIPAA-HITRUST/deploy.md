---
title: Voor beeld van HIPAA HITRUST-blauw druk
description: Implementeer stappen voor het voor beeld van de HIPAA HITRUST-blauw druk, inclusief blauw drukken-artefact parameter Details.
ms.date: 12/03/2019
ms.topic: sample
...
---
# <a name="deploy-the-hipaa-hitrust-blueprint-sample"></a>Het voor beeld van HIPAA HITRUST-blauw druk implementeren

Voor het implementeren van het voor beeld van de HIPAA HITRUST-blauw druk moeten de volgende stappen worden uitgevoerd:
...
1. Zoek het voor beeld van **HIPAA HITRUST** -blauw druk onder _andere voor beelden_ en selecteer **dit voor beeld gebruiken**.
...
1. Selecteer **blauw druk** aan de bovenkant van de pagina publiceren. Geef op de pagina Nieuw aan de rechter kant een **versie** op voor uw kopie van het voor beeld van de blauw druk. Deze eigenschap is handig als u later een wijziging aanbrengt. Geef **wijzigings notities** op zoals ' eerste versie gepubliceerd vanuit het HITRUST HIPAA-voor beeld. ' Selecteer vervolgens **publiceren** onder aan de pagina.
...
|\[Voor\]beeld: audit HITRUST HIPAA Controls en implementeer specifieke VM-extensies ter ondersteuning van de controle vereisten |Beleidstoewijzing |Groep Administrators |Gegroepeerd. Voorbeeld: `Administrator; myUser1; myUser2` |
...
Nu u de stappen voor het implementeren van het HITRUST HIPAA-voor beeld hebt bekeken, gaat u naar de volgende artikelen voor meer informatie over het overzicht en de beheer toewijzing:

> [!div class="nextstepaction"]
> [HITRUST HIPAA-blauw drukken-Overview](./index.md)
> [HITRUST HIPAA-schema's-Control mapping](./control-mapping.md)
