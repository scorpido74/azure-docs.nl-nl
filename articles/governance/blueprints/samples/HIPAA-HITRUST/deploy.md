...
Voor het implementeren van het blauwdrukvoorbeeld HIPAA HITRUST moeten de volgende stappen worden uitgevoerd:
...
|\[Preview\]: HITRUST HIPAA-besturingselementen controleren en specifieke VM-extensies implementeren ter ondersteuning van de controlevereisten |Beleidstoewijzing |Id van de Log Analytics-werkruimte waarvoor VM's moeten worden geconfigureerd |Dit is de id (GUID) van de Log Analytics-werkruimte waarvoor de VM's moeten worden geconfigureerd. |
...
|\[Preview\]: HITRUST HIPAA-besturingselementen controleren en specifieke VM-extensies implementeren ter ondersteuning van de controlevereisten |Beleidstoewijzing |Beheerdersgroep |Groep. Voorbeeld: `Administrator; myUser1; myUser2` |
...
Nu u de stappen voor het implementeren van het blauwdrukvoorbeeld HIPAA HITRUST hebt bekeken, raadpleegt u de volgende artikelen voor informatie over het overzicht en de toewijzing van besturingselementen:

> [!div class="nextstepaction"]
> [Overzicht van HITRUST HIPAA-blauwdrukken](./index.md)
> [Besturingselementen toewijzen met HITRUST HIPAA-blauwdrukken](./control-mapping.md)
