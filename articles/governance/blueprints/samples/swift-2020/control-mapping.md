...
- \[Voor\]beeld: Vereisten implementeren voor het controleren van virtuele Linux-machines die externe verbindingen van accounts zonder wacht woorden toestaan
...
- \[Voor\]beeld: Controle resultaten weer geven van Linux-Vm's waarvoor de machtigingen voor het passwd-bestand niet zijn ingesteld op 0644
...
- \[Voor\]beeld: Controle resultaten weer geven van Windows-Vm's die het opnieuw gebruiken van de voor gaande 24 wacht woorden toestaan
