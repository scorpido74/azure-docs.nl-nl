...
- \[preview\]: controle resultaten van Linux-Vm's met accounts zonder wacht woorden weer geven
- \[preview\]: vereisten implementeren voor het controleren van virtuele Linux-machines met accounts zonder wacht woorden
- \[preview\]: controle resultaten weer geven van Windows-Vm's die geen wacht woorden opslaan met omkeer bare versleuteling
