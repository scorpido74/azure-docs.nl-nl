...
- \[Voor\]beeld: Minimum aantal eigen aren voor abonnement controleren
...
- \[Voor\]beeld: Resultaten van de evaluatie van SQL-beveiligings problemen bewaken in Azure Security Center
...
- \[Voor\]beeld: Audit accounts met schrijf machtigingen waarvoor geen MFA is ingeschakeld voor een abonnement
- \[Voor\]beeld: Externe accounts met eigenaars machtigingen voor een abonnement controleren
- \[Voor\]beeld: Externe accounts met schrijfmachtigingen voor een abonnement controleren
...
- \[Voor\]beeld: Afgeschafte accounts met eigenaars machtigingen voor een abonnement controleren
- \[Voor\]beeld: Externe accounts met eigenaars machtigingen voor een abonnement controleren
- \[Voor\]beeld: Externe accounts met schrijfmachtigingen voor een abonnement controleren
...
- \[Voor\]beeld: Alleen HTTPS controleren voor een functie-app
- \[Voor\]beeld: Alleen HTTPS-toegang voor een webtoepassing controleren
- \[Voor\]beeld: Alleen HTTPS-toegang controleren voor een API-app
- \[Voor\]beeld: Ontbrekende BLOB-versleuteling voor opslag accounts controleren
...
- \[Voor\]beeld: Niet-versleutelde VM-schijven in Azure Security Center bewaken
...
- \[Voor\]beeld: Mogelijke app-white list in Azure Security Center bewaken
...
- \[Voor\]beeld: Ontbrekende Endpoint Protection in Azure Security Center controleren
- \[Voor\]beeld: Ontbrekende systeem updates bewaken in Azure Security Center
- \[Voor\]beeld: Beveiligings problemen met het besturings systeem in Azure Security Center bewaken
- \[Voor\]beeld: Resultaten van de evaluatie van SQL-beveiligings problemen bewaken in Azure Security Center
...
- \[Voor\]beeld: Bewaak strikte netwerk toegang in Azure Security Center
- \[Voor\]beeld: Niet-beveiligde netwerk eindpunten bewaken in Azure Security Center
