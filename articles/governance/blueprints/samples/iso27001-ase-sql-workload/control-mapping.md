---
title: Voor beeld-ISO 27001 ASE/SQL workload blauw druk-besturings element toewijzing
...
- \[Preview @ no__t-1: Minimum aantal eigen aren voor abonnement controleren
- \[Preview @ no__t-1: Maximum aantal eigen aars voor een abonnement controleren
...
- \[Preview @ no__t-1: Resultaten van de evaluatie van SQL-beveiligings problemen bewaken in Azure Security Center
...
- \[Preview @ no__t-1: Linux VM-accounts zonder wacht woorden controleren
- \[Preview @ no__t-1: Virtuele Linux-machines controleren op externe verbindingen van accounts zonder wacht woorden
...
- \[Preview @ no__t-1: Controle accounts met eigenaars machtigingen waarvoor geen MFA is ingeschakeld voor een abonnement
...
- \[Preview @ no__t-1: Externe accounts met schrijfmachtigingen voor een abonnement controleren
...
- \[Preview @ no__t-1: Controle accounts met eigenaars machtigingen waarvoor geen MFA is ingeschakeld voor een abonnement
- \[Preview @ no__t-1: Controle accounts met lees machtigingen waarvoor geen MFA is ingeschakeld voor een abonnement
- \[Preview @ no__t-1: Audit accounts met schrijf machtigingen waarvoor geen MFA is ingeschakeld voor een abonnement
- \[Preview @ no__t-1: VM-extensie implementeren om machtigingen van het passwd-VM-bestand te controleren
...
- \[Preview @ no__t-1: Afgeschafte accounts in een abonnement controleren
- \[Preview @ no__t-1: Afgeschafte accounts met eigenaars machtigingen voor een abonnement controleren
- \[Preview @ no__t-1: Externe accounts met eigenaars machtigingen voor een abonnement controleren
- \[Preview @ no__t-1: Externe accounts met schrijfmachtigingen voor een abonnement controleren
...
- \[Preview @ no__t-1: VM-extensie implementeren om te controleren of Windows VM de vereisten voor wachtwoord complexiteit afdwingt
- \[Preview @ no__t-1: VM-extensie implementeren voor het controleren van de maximale wachtwoord duur van Windows-VM'S 70 dagen
- \[Preview @ no__t-1: VM-extensie implementeren om een minimale wachtwoord duur van Windows-VM'S te controleren 1 dag
...
- \[Preview @ no__t-1: VM-extensie implementeren om te controleren of Windows VM de voor gaande 24 wacht woorden niet toestaat
- \[Preview @ no__t-1: Controleren of Windows VM vereisten voor wachtwoord complexiteit afdwingt
- \[Preview @ no__t-1: Maximale wachtwoord duur van Windows-VM'S 70 dagen controleren
- \[Preview @ no__t-1: Minimale wacht woord leeftijd van Windows-VM controleren 1 dag
- \[Preview @ no__t-1: Controleren of Windows VM-wacht woorden ten minste 14 tekens bevatten
- \[Preview @ no__t-1: Controleren of de Windows-VM de voor gaande 24 wacht woorden niet toestaat
...
- \[Preview @ no__t-1: Alleen HTTPS controleren voor een functie-app
- \[Preview @ no__t-1: Alleen HTTPS-toegang voor een webtoepassing controleren
- \[Preview @ no__t-1: Alleen HTTPS-toegang controleren voor een API-app
- \[Preview @ no__t-1: Ontbrekende BLOB-versleuteling voor opslag accounts controleren
...
- \[Preview @ no__t-1: Controleren of Windows VM wacht woorden niet kan opslaan met behulp van omkeer bare versleuteling
- \[Preview @ no__t-1: Niet-versleutelde VM-schijven in Azure Security Center bewaken
...
- \[Preview @ no__t-1: Controleren Dependency Agent-implementatie-VM-installatie kopie (OS) niet vermeld
- \[Preview @ no__t-1: Controleren Dependency Agent implementatie in VMSS-VM-installatie kopie (OS) niet vermeld
- \[Preview @ no__t-1: Implementatie van Log Analytics agent controleren-VM-installatie kopie (OS) niet vermeld
- \[Preview @ no__t-1: Log Analytics agent implementatie controleren in VMSS-VM-installatie kopie (OS) niet vermeld
...
- \[Preview @ no__t-1: Mogelijke app-white list in Azure Security Center bewaken
...
- \[Preview @ no__t-1: Ontbrekende Endpoint Protection in Azure Security Center controleren
- \[Preview @ no__t-1: Ontbrekende systeem updates bewaken in Azure Security Center
- \[Preview @ no__t-1: Beveiligings problemen met het besturings systeem in Azure Security Center bewaken
- \[Preview @ no__t-1: Resultaten van de evaluatie van SQL-beveiligings problemen bewaken in Azure Security Center
...
- \[Preview @ no__t-1: Niet-beveiligde netwerk eindpunten bewaken in Azure Security Center
