---
title: Tag governance beheren
description: Gebruik het effect wijzigen van Azure Policy om een tag governance model te maken en af te dwingen op nieuwe en bestaande resources.
ms.date: 11/04/2019
ms.topic: tutorial
