...
- Azure Portal:
  ...
  1. Start de Azure Policy-service in Azure Portal door **Alle services** te selecteren en dan **Beleid** te zoeken en te selecteren.
     ...
     :::image type="content" source="../media/rego-for-aks/search-policy.png" alt-text="Beleid zoeken in alle services" border="false":::

  1. Selecteer **deel nemen** aan de linkerkant van de pagina Azure Policy.

     :::image type="content" source="../media/rego-for-aks/join-aks-preview.png" alt-text="Word lid van het beleid voor AKS preview" border="false":::
...
1. Installeer versie _0.4.0_ van de Azure cli preview-uitbrei ding `aks-preview`voor AKS,:
   ...
   > [!NOTE]
   > Als u de uitbrei ding _voor AKS-preview_ eerder hebt geïnstalleerd, installeert u `az extension update --name aks-preview` de updates met behulp van de opdracht.
...
- Azure Portal
  ...
  1. Selecteer **beleid (preview-versie)** aan de linkerkant van de Kubernetes-service pagina.
     ...
     :::image type="content" source="../media/rego-for-aks/policies-preview-from-aks-cluster.png" alt-text="Beleids regels van het AKS-cluster" border="false":::

  1. Selecteer op de hoofd pagina de knop **invoeg toepassing inschakelen** .

     :::image type="content" source="../media/rego-for-aks/enable-policy-add-on.png" alt-text="De Azure Policy voor de invoeg toepassing voor AKS inschakelen" border="false":::
...
- Azure Portal
  ...
  1. Op de hoofd pagina selecteert u de knop **invoeg toepassing uitschakelen** .
     ...
     :::image type="content" source="../media/rego-for-aks/disable-policy-add-on.png" alt-text="De Azure Policy voor de invoeg toepassing AKS uitschakelen" border="false":::
