...
description: Voor deze voor beeld van een beleids definitie moeten resources voldoen aan het soort patroon dat is gedefinieerd in een para meter voor naam conventies.
ms.date: 01/23/2019
ms.topic: sample
