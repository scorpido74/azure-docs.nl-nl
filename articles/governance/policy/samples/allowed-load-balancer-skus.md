...
description: Voor deze voor beeld-beleids definitie moeten load balancers gebruikmaken van een goedgekeurde SKU die is gedefinieerd in een para meter.
ms.date: 01/23/2019
ms.topic: sample
