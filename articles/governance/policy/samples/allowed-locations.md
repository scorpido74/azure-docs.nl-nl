...
description: Voor deze voor beeld van een beleids definitie moeten alle resources worden geïmplementeerd op de goedgekeurde locaties die in een para meter zijn gedefinieerd.
ms.date: 01/26/2019
ms.topic: sample
