...
description: Deze voor beeld van een beleids definitie vereist dat netwerk interfaces een goedgekeurd subnet gebruiken dat is gedefinieerd in een para meter.
ms.date: 01/23/2019
ms.topic: sample
