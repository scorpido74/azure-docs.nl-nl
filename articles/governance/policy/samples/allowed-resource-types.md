...
description: Deze voorbeeld beleids definitie zorgt ervoor dat alleen goedgekeurde resource typen die in een para meter zijn gedefinieerd, worden geïmplementeerd.
ms.date: 01/23/2019
ms.topic: sample
