...
description: In dit voor beeld van een beleids definitie wordt gecontroleerd of een extensie die in een para meter is gedefinieerd, niet is geïmplementeerd op een virtuele machine.
ms.date: 01/23/2019
ms.topic: sample
