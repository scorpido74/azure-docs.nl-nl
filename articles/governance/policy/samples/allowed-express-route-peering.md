...
description: Voor deze voor beeld van een beleids definitie moet ExpressRoute opgegeven peering locaties gebruiken die zijn gedefinieerd in een para meter.
ms.date: 01/23/2019
ms.topic: sample
