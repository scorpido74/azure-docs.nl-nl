...
- _veld_ geeft aan in welke [alias](../concepts/definition-structure.md#aliases) leden moeten worden geëvalueerd. Hier bekijken we de alias _matrix_ **securityRules\[ \* ** van de netwerk beveiligings groep.
