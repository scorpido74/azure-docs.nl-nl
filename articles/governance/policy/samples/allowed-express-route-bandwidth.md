---
title: 'Voorbeeld: toegestane ExpressRoute-bandbreedte'
description: Voor deze voor beeld van een beleids definitie moet ExpressRoute een opgegeven set band breedtes gebruiken die zijn gedefinieerd in een para meter.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463740"
---
# <a name="sample---allowed-expressroute-bandwidth"></a>Voorbeeld: toegestane ExpressRoute-bandbreedte

Dit beleid vereist dat ExpressRoute een specifieke set bandbreedten gebruiken. U geeft een matrix met SKU's op die kunnen worden opgegeven voor ExpressRoute.
