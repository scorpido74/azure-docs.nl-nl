...
description: Voor deze voorbeeld beleids definitie is een tag en een waarde gedefinieerd in een para meter voor een resource groep.
ms.date: 01/31/2019
ms.topic: sample
