---
title: "Voor beeld: controleren op regio's zonder Network Watcher"
description: In dit voor beeld van een beleids definitie wordt gecontroleerd of Network Watcher niet is ingeschakeld voor een opgegeven regio die is gedefinieerd in een para meter.
ms.date: 01/23/2019
ms.topic: sample
...
Dit beleid controleert of Network Watcher is ingeschakeld voor een bepaalde regio. U geeft de naam op van de regio waarin u wilt controleren of Network Watcher is ingeschakeld.
