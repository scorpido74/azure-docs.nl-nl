...
description: Voor deze voor beeld van een beleids definitie moeten aangepaste installatie kopieën afkomstig zijn van een goedgekeurde resource groep die is gedefinieerd in een para meter.
ms.date: 01/23/2019
ms.topic: sample
