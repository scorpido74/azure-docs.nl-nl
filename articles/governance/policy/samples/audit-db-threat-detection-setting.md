...
description: Deze voorbeeldbeleidsdefinitie controleert of het beveiligingsmeldingenbeleid van SQL-databases is ingesteld op de specifieke status.
ms.date: 01/23/2019
ms.topic: sample
