...
- [Computers tellen binnen het bereik van gastconfiguratiebeleidsregels](#count-gcmachines)
...
## <a name="count-machines-in-scope-of-guest-configuration-policies"></a><a name="count-gcmachines"></a>Computers tellen binnen het bereik van gastconfiguratiebeleidsregels

Hiermee wordt het aantal virtuele Azure-machines en met Arc verbonden servers die geschikt zijn voor toewijzingen aan de [Azure Policy-gastconfiguratie](../../policy/concepts/guest-configuration.md) weergegeven.
