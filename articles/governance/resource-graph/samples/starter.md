...
## <a name="a-namecount-resourcescount-azure-resources"></a>@no__t Azure-0Count-resources
...
## <a name="a-nameshow-storageshow-resources-that-contain-storage"></a><a name="show-storage"/>Show bronnen die opslag bevatten
...
Deze query wordt op dat patroon uitgebreid zodat alleen resultaten worden meegenomen waarbij **Eigenschappen. ipaddress**
 @ no__t-2, om alleen de **Eigenschappen. ipaddress**te retour neren en te `limit` de resultaten bovenaan
...
## <a name="a-nameshow-aliasesshow-aliases-for-a-virtual-machine-resource"></a><a name="show-aliases"/>Show-aliassen voor een resource van een virtuele machine
