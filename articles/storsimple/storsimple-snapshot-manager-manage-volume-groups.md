...
| Geïmporteerd |In de **geïmporteerde** kolom ziet u het aantal geïmporteerde volumes. Als deze eigenschap is ingesteld op **True**, wordt met deze kolom aangegeven dat een volume groep is geïmporteerd uit het Azure Portal en niet is gemaakt in StorSimple Snapshot Manager. |
