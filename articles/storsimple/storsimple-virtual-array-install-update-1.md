...
6. Open de map waarin de bestanden zich bevinden.
    ...
    - Een bestand dat cumulatieve updates bevat voor de `windows8.1-kb4034681-x64`augustus. Voor meer informatie over wat er in dit pakket is opgenomen, gaat u naar [maandelijkse beveiligings update van augustus](https://support.microsoft.com/help/4034681/windows-8-1-windows-server-2012-r2-update-kb40346810).
...
6. Herhaal de stappen 2-4 om de Windows-beveiligings oplossing te installeren met behulp van bestands `windows8.1-kb4012213-x64`. De virtuele matrix wordt opnieuw opgestart na de installatie en u moet zich aanmelden bij de lokale webgebruikersinterface.
