...
description: Hierin wordt beschreven hoe u de Web-UI van StorSimple Virtual array gebruikt om update 0,6 toe te passen met behulp van de methode Azure Portal en Hot Fix.
services: storsimple
