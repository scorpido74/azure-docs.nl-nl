---
title: Veilig StorSimple-apparaat installeren en uitvoeren
...
![Pictogram](./media/storsimple-safety/IC740885.png) waarschuwings pictogram Lees beveiliging **Lees de informatie over de veiligheid en de status**
...
| ![Er zijn geen onderdelen](./media/storsimple-safety/IC740879.png) die door de gebruiker kan worden onderhouden **No User Serviceable Parts** |Doe geen toegang tenzij het goed is getraind. |
| ![Lees het pictogram beveiligings melding](./media/storsimple-safety/IC740885.png)**eerst alle instructies lezen** | |
| ![](./media/storsimple-safety/IC740886.png) **Waarschuwings pictogram Tip** -risico | |
...
![](./media/storsimple-safety/IC740879.png) ![Waarschuwing waarschuwings pictogram tip](./media/storsimple-safety/IC740886.png) **waarschuwings pictogram.**
