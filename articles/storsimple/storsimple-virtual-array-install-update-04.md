---
title: Updates installeren op StorSimple Virtual Array | Microsoft Documenten
...
---
# <a name="install-update-04-on-your-storsimple-virtual-array"></a>Installeer Update 0.4 op uw StorSimple Virtual Array

## <a name="overview"></a>Overzicht

In dit artikel worden de stappen beschreven die nodig zijn om Update 0.4 op uw StorSimple Virtual Array te installeren via de lokale webgebruikersinterface en via de Azure-portal. U moet software-updates of hotfixes toepassen om uw StorSimple Virtual Array up-to-date te houden. 
...
> [!IMPORTANT]
> Als u update 0.1- of GA-softwareversies uitvoert, moet u de hotfix-methode via de lokale webgebruikersinterface gebruiken om update 0.3 te installeren. Als u Update 0.2 of hoger uitvoert, raden we u aan de updates te installeren via de Azure-portal.
...
3. Voer in het zoekvak van de Microsoft Update Catalog het KB-nummer (Knowledge Base) in van het hotfix dat u wilt downloaden. Typ **3216577** voor Update 0.4 en klik op **Zoeken**.
   
    De hotfix-vermelding wordt bijvoorbeeld **StorSimple Virtual Array Update 0.4**weergegeven.
...
5. Nadat de herstart is voltooid, wordt u naar de **aanmeldingspagina** geleid. Ga naar > **Onderhoudssoftware-update**om te controleren of de **Maintenance**apparaatsoftware is bijgewerkt in de lokale webgebruikersinterface. De weergegeven softwareversie moet **10.0.0.0.0.10289.0** zijn voor Update 0.4.
   
   > [!NOTE]
   > We rapporteren de softwareversies op een iets andere manier in de lokale webgebruikersinterface en de Azure-portal. De lokale webgebruikersinterface rapporteert bijvoorbeeld **10.0.0.0.0.10289** en de Azure-portal rapporteert **10.0.10289.0** voor dezelfde versie.
