---
title: StorSimple 8000-serie apparaat implementeren in overheidsportal | Microsoft Documenten
description: Beschrijft de stappen en aanbevolen procedures voor het implementeren van het apparaat uit de StorSimple 8000-serie met update 3 en hoger en de service in de Azure Government-portal.
services: storsimple
...
---
# <a name="deploy-your-on-premises-storsimple-device-in-the-government-portal"></a>Implementeer uw on-premises StorSimple-apparaat in het overheidsportaal

[!INCLUDE [storsimple-8000-eol-banner](../../includes/storsimple-8000-eol-banner.md)]

## <a name="overview"></a>Overzicht
Welkom bij de implementatie van Microsoft Azure StorSimple-apparaten. Deze implementatiezelfstudies zijn van toepassing op de StorSimple 8000-serie met Update 3-software of hoger in de Azure Government-portal. Deze reeks zelfstudies bevat een configuratiechecklist, een lijst met configuratievereisten en gedetailleerde configuratiestappen voor uw StorSimple-apparaat.
...
> [!NOTE]
> De StorSimple-implementatiegegevens die zijn gepubliceerd op de website van Microsoft Azure zijn alleen van toepassing op apparaten uit de StorSimple 8000-serie. Ga voor volledige informatie over de apparaten uit [http://onlinehelp.storsimple.com/](http://onlinehelp.storsimple.com)de 7000-serie naar: . Raadpleeg de [Introductiehandleiding van het StorSimple-systeem](http://onlinehelp.storsimple.com/111_Appliance/) voor informatie over de implementatie van de 7000-serie.


## <a name="deployment-steps"></a>Implementatiestappen
Voer de volgende verplichte stappen uit om uw StorSimple-apparaat te configureren en te verbinden met uw StorSimple-apparaatbeheerfunctie. Naast de vereiste stappen zijn er optionele stappen en procedures die u mogelijk moet uitvoeren tijdens de implementatie. In de stapsgewijze implementatie-instructies wordt aangeven wanneer u deze optionele stappen moet uitvoeren.

| Stap | Beschrijving |
| --- | --- |
| **Voorwaarden** |Deze moeten zijn worden voltooid ter voorbereiding van de implementatie. |
| [Checklist voor implementatieconfiguratie](#deployment-configuration-checklist) |Gebruik deze controlelijst om informatie te verzamelen en te registreren voorafgaand aan en tijdens de implementatie. |
| [Implementatievereisten](#deployment-prerequisites) |Deze valideren dat de omgeving klaar is voor implementatie. |
|  | |
| **STAPSGEWIJZE IMPLEMENTATIE** |Deze stappen zijn vereist om uw StorSimple-apparaat in productie te nemen. |
| [Stap 1: Een nieuwe service maken](#step-1-create-a-new-service) |Stel cloudbeheer en -opslag voor uw StorSimple-apparaat in. *Sla deze stap over als u een bestaande service hebt voor andere StorSimple-apparaten.* |
| [Stap 2: de serviceregistratiesleutel ophalen](#step-2-get-the-service-registration-key) |Gebruik deze sleutel om uw StorSimple-apparaat te registreren en aan te sluiten op de beheerservice. |
...
| [Stap 4: De minimale apparaatinstelling voltooien](#step-4-complete-minimum-device-setup) </br>Optioneel: het StorSimple-apparaat bijwerken. |Gebruik de managementservice om de installatie van het apparaat te voltooien en het in te schakelen voor opslag. |
...
| [Stap 7: een volume koppelen, initialiseren en formatteren](#step-7-mount-initialize-and-format-a-volume) </br>Optioneel: MPIO configureren. |Verbind uw servers met de iSCSI-opslag die is geleverd door het apparaat. Configureer optioneel MPIO om ervoor te zorgen dat uw servers koppelings-, netwerk- en interfacefouten kunnen verdragen. |
...
Met een StorSimple-apparaatbeheerfunctie kunt u meerdere StorSimple-apparaten beheren. Voer de volgende stappen uit om een nieuw exemplaar van de StorSimple Device Manager-service te maken.
...
Wanneer de StorSimple-apparaatbeheerfunctie bedrijfsklaar is, moet u de serviceregistratiesleutel ophalen. Deze sleutel wordt gebruikt om uw StorSimple-apparaat te registreren en aan te sluiten op de service.

Voer de volgende stappen uit in het portaal van de overheid.
...
Voer de volgende stappen uit in de Azure Government-portal om de minimale apparaatinstelling te voltooien.
...
Voer de volgende stappen uit in het portaal van de overheid om een volumecontainer te maken.

[!INCLUDE [storsimple-8000-create-volume-container](../../includes/storsimple-8000-create-volume-container.md)]

## <a name="step-6-create-a-volume"></a>Stap 6: een volume maken
Wanneer u een volumecontainer hebt gemaakt, kunt u een opslagvolume inrichten op het StorSimple-apparaat voor uw servers. Voer de volgende stappen uit in het overheidsportaal om een volume te maken.

> [!IMPORTANT]
> StorSimple Device Manager kan alleen dun ingerichte volumes maken.  U kunt echter geen gedeeltelijk ingerichte volumes maken.
...
Voer de volgende stappen uit in het overheidsportaal om een geplande back-up te maken.
...
Voer de volgende stappen uit in de portal van de overheid op de **servicepagina van StorSimple Device Manager.**
...
Voer de volgende stappen uit in de portal van de overheid om een on-demand handmatige back-up te maken voor één volume op uw StorSimple-apparaat.

[!INCLUDE [Create a manual backup](../../includes/storsimple-8000-create-manual-backup.md)]

## <a name="next-steps"></a>Volgende stappen
* Configureer een [virtueel apparaat](storsimple-8000-cloud-appliance-u2.md).
* Gebruik de [StorSimple Device Manager-service](storsimple-8000-manager-service-administration.md) om uw StorSimple-apparaat te beheren.
