...
| 2 |Controleren| De bewaking van opslag gebruik voor de virtuele StorSimple-serie wordt vanaf 30 juni 2017 afgeschaft. Deze actie is van invloed op de bewakings grafieken op de StorSimple Apparaatbeheer-service die wordt uitgevoerd op StorSimple virtuele arrays (1200-model). Deze release bevat updates waarmee de gebruiker de bewaking van opslag gebruik voor de virtuele matrices kan blijven gebruiken na 30 juni 2017.|
