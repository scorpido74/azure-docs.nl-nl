...
Azure biedt een geïntegreerde weergave voor het bewaken en beheren van uw IoT-beveiliging als onderdeel van uw algehele beveiligingsoplossing via Azure Security Center. Als u een toepassingsontwikkelaar bent, u de IoT Hub-weergave gebruiken om de beveiliging van uw IoT-toepassing te beheren.

## <a name="what-is-azures-unique-value-proposition-for-iot-security"></a>Wat is azure's unieke waardepropositie voor IoT-beveiliging?
...
Ja. Azure Security Center for IoT is afhankelijk van Azure IoT-connectiviteit en -infrastructuur.

## <a name="do-i-have-to-install-an-agent"></a>Moet ik een agent installeren?

Installatie van agenten op uw IoT-apparaten is niet verplicht om het Microsoft Azure Security Center for IoT in te schakelen. U kiezen tussen de volgende drie opties, het verkrijgen van verschillende niveaus van beveiligingsbewaking en beheermogelijkheden op basis van uw selectie:
...
Azure Security Center voor IoT-agent biedt dekking op apparaatniveau voor apparaatconfiguratie, gedrag en toegang (door de configuratie te scannen), proces & connectiviteit. De Azure Security Center for IoT-beveiligingsagent scant geen bedrijfsgerelateerde gegevens of activiteiten.

## <a name="where-can-i-get-the-azure-security-center-for-iot-security-agent"></a>Waar kan ik het Azure Security Center voor IoT-beveiligingsagent krijgen?
...
Connectiviteit, toegang, firewallconfiguratie, proceslijst & OS-basislijn worden verzameld door de agent.

## <a name="how-much-data-will-the-agent-generate"></a>Hoeveel gegevens genereert de agent?

Het genereren van agentgegevens wordt aangestuurd door apparaat-, toepassings-, verbindingstype- en klantagentconfiguratie. Vanwege de grote variabiliteit tussen apparaten en IoT-oplossingen raden we u aan de agent eerst in een lab of testinstelling te implementeren om de specifieke configuratie te observeren, te leren en in te stellen die aan uw behoeften voldoet, terwijl de hoeveelheid gegenereerde gegevens wordt gemeten. Na het starten van de service biedt de Azure Security Center for IoT-agent operationele aanbevelingen voor het optimaliseren van de doorvoer van agenten om u te helpen bij het configuratie- en aanpassingsproces.

## <a name="how-can-i-control-my-billing"></a>Hoe kan ik mijn facturering beheren?

Azure Security Center for IoT biedt configureerbare agentscans, gegevensbuffers en de mogelijkheid om aangepaste waarschuwingen te maken die de hoeveelheid gegevens die door de agent worden gegenereerd, verhogen of verminderen.
...
1. Controleer of het [type agent past op het aangewezen OS-platform van uw apparaat](how-to-deploy-agent.md)
...
De beveiligingsagent is ontworpen om automatisch opnieuw te werken bij elk apparaat opnieuw opstarten.

## <a name="can-the-agent-affect-the-performance-of-the-device-or-other-installed-software"></a>Kan de agent de prestaties van het apparaat of andere geïnstalleerde software beïnvloeden?

De agent verbruikt machineresources als elke andere toepassing/proces en mag de normale apparaatactiviteit niet verstoren. Resourceverbruik op het apparaat waarop de agent wordt uitgevoerd, is gekoppeld aan de installatie en configuratie. We raden u aan uw agentconfiguratie te testen in een opgenomen omgeving, samen met de interoperabiliteit met uw andere IoT-toepassingen en -functionaliteit, voordat u probeert te implementeren in een productieomgeving.

## <a name="im-making-some-maintenance-on-the-device-can-i-turn-off-the-agent"></a>Ik ben wat onderhoud aan het apparaat aan het doen. Kan ik de agent uitschakelen?
