...
Log Analytics-opname in Azure IoT Hub is standaard uitgeschakeld in de Azure Security Center for IoT-oplossing. U kunt dit als volgt inschakelen voor gebruik met de beveiligingsmodule voor Azure RTOS: 
