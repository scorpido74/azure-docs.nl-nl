...
## <a name="azure-security-center-for-iot-alerts-available-for-customization"></a>Azure Security Center voor IoT-waarschuwingen die beschikbaar zijn voor aanpassing 



| Ernst | Naam van waarschuwing | Gegevensbron | Beschrijving | Voorgestelde herstel|
|---|---|---|---|---|
