...
- [De Azure Cosmos DB-resourceprovider registreren voor uw Azure-abonnement](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#register-resource-provider) 
- [Uw Azure Key Vault-exemplaar configureren](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#configure-your-azure-key-vault-instance)
-  [Een toegangsbeleid toevoegen aan uw Azure Key Vault-exemplaar](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#add-an-access-policy-to-your-azure-key-vault-instance)
- [Een sleutel genereren in Azure Key Vault](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#generate-a-key-in-azure-key-vault)
...
:::image type="content" source="media/bring-your-own-key/bring-your-own-key-keypicker.png" alt-text="Azure API for FHIR maken":::
...
:::image type="content" source="media/bring-your-own-key/bring-your-own-key-database.png" alt-text="Azure API for FHIR maken":::
