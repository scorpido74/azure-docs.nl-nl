...
Versie 0.9.0 bevat ondersteuning voor uitvoer compressie. Dit komt overeen met het uitvoeren van `-bgzip`, gevolgd door `-tabix` op de VCF-of gvcf-uitvoer. Zie [Veelgestelde vragen](frequently-asked-questions-genomics.md)voor meer informatie. 
