...
Als u nog niet bekend bent met SQL Server op virtuele machines in azure, raadpleegt u de *SQL Server op de overzichts video van Azure VM* van onze diep gaande [Azure SQL-video reeks](https://channel9.msdn.com/Series/Azure-SQL-for-Beginners?WT.mc_id=azuresql4beg_azuresql-ch9-niner):
