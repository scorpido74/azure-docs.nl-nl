...
* Maak een back-up naar een URL en herstel deze vanuit de URL naar de Azure-VM.
...
## <a name="backup-to-a-url-and-restore"></a>Back-up naar een URL en herstellen
