...
Meer informatie over het [beheerde SQL-exemplaar van Azure CLI API](../managed-instance/api-references-create-manage-instance.md#azure-cli-create-and-manage-managed-instances).
