...
ms.locfileid: "84049923"
---
# <a name="business-critical-tier---azure-sql-database--sql-managed-instance"></a>Bedrijfskritiek laag-Azure SQL Database & beheerde instantie van SQL 
...
-   **Minimale io-latentie vereisten** : werk belastingen waarvoor een snelle reactie van de opslaglaag (gemiddeld 1-2 milliseconden) nodig is, moeten bedrijfskritiek-laag gebruiken. 
...
-   **Langlopende trans acties waarmee gegevens worden gewijzigd**. Trans acties die langere tijd worden geopend, voor komen dat logboek bestanden worden afgekapt, waardoor de logboek grootte en het aantal [virtuele logboek bestanden (VLF)](https://docs.microsoft.com/sql/relational-databases/sql-server-transaction-log-architecture-and-management-guide#physical_arch)kunnen toenemen. Een groot aantal VLFs kan het herstel van de data base na een failover vertragen.
