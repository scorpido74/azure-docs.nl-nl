...
- Als u data bases met periodieke of onvoorspelbare gebruiks patronen migreert, overweeg dan het gebruik van een [serverloze](serverless-tier-overview.md) Compute-laag.
