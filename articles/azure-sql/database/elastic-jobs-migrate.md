---
title: Migreren naar nieuwe Elastic Database-taken (preview-versie)
...
ms.locfileid: "88121184"
---
# <a name="migrate-to-the-new-elastic-database-jobs-preview"></a>Migreren naar de nieuwe taak voor Elastic Database (preview-versie)
...
Als u uw referenties wilt migreren, voert u de volgende opdracht uit door in het `$agent` Power shell-object van eerdere versie door te geven.
...
- Hoofd niveau doelen die servers en data bases zijn, worden gemigreerd naar een nieuwe doel groep \<serverName\> met de naam (, \<databaseName\> ) die alleen het hoofd niveau doel bevat.
...
- Taken met meerdere triggers met verschillende schema's zijn onderverdeeld in meerdere taken met het naamgevings schema: " \<jobName\> ( \<scheduleName\> )".
