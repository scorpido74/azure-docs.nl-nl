...
- [SQL-verbindingsfouten opsporen, diagnose vaststellen en problemen oplossen](troubleshoot-common-connectivity-issues.md)
...
- Een overzicht van [resource Health](../../application-gateway/resource-health-overview.md) weer geven
