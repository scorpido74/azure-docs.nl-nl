---
title: 'PowerShell: Een database kopiëren naar een nieuwe server'
description: Microsoft Azure PowerShell-voorbeeldscript voor het kopiëren van een SQL-database naar een nieuwe server
...
ms.locfileid: "91321472"
---
# <a name="use-powershell-to-copy-a-database-to-a-new-server"></a>PowerShell gebruiken om een database naar een nieuwe server te kopiëren
[!INCLUDE[appliesto-sqldb](../../includes/appliesto-sqldb.md)]

Dit Microsoft Azure PowerShell-scriptvoorbeeld maakt een kopie van een in Azure SQL Database bestaande database op een nieuwe server.
