...
![Bewakings dashboard voor gegevens synchronisatie](./media/sql-data-sync-monitor-sync/sync-monitoring-dashboard.png)
...
![E-mail meldingen voor gegevens synchronisatie](./media/sql-data-sync-monitor-sync/sync-email-notifications.png)
...
4.  Gebruik het opgegeven bestand onder **Runbook file** `DataSyncLogPowerShellRunbook` . Stel het **type Runbook** in op als `PowerShell` . Geef een naam op voor het runbook.
...
8.  Stel de naam van de variabele in `DataSyncLogLastUpdatedTime` en stel het type in op DateTime.
...
-   Problemen oplossen-problemen [met SQL Data Sync oplossen in azure](sql-data-sync-troubleshoot.md)
...
-   [Wat is de Azure SQL Database-service?](../../sql-database/sql-database-technical-overview.md)
