...
description: Meer informatie over de service tier voor algemeen gebruik voor Azure SQL Database en Azure SQL Managed instance.
...
ms.locfileid: "84049909"
---
# <a name="general-purpose-service-tier---azure-sql-database--sql-managed-instance"></a>Service tier voor algemeen gebruik-Azure SQL Database & SQL Managed instance
...
Azure SQL Database en Azure SQL Managed instance zijn gebaseerd op SQL Server data base engine-architectuur die is aangepast voor de cloud omgeving, zodat de beschik baarheid van 99,99% ook in het geval van infrastructuur fouten kan worden gegarandeerd. 
