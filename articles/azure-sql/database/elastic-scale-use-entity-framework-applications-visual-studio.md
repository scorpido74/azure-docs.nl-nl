...
Zie [Elastic database extra woorden lijst](elastic-scale-glossary.md)voor termen definities.
...
1. Fysieke database verbindingen maken via de client interfaces voor Elastic data base van de Shard-toewijzings beheer.
