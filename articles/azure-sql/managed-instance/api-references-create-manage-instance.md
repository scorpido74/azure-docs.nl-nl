...
description: Meer informatie over het maken en beheren van Azure SQL Managed instances.
...
ms.locfileid: "84046318"
---
# <a name="managed-api-reference-for-azure-sql-managed-instances"></a>Naslag informatie over beheerde API'S voor Azure SQL Managed instances
[!INCLUDE[appliesto-sqlmi](../includes/appliesto-sqlmi.md)]

U kunt Azure SQL Managed instances maken en beheren met behulp van de Azure Portal, Power shell, Azure CLI, REST API en Transact-SQL. In dit artikel vindt u een overzicht van de functies en API die u kunt gebruiken om een beheerd exemplaar te maken en te configureren.

## <a name="azure-portal-create-a-managed-instance"></a>Azure Portal: een beheerd exemplaar maken

Zie [Quick Start: Create a SQL Managed instance](instance-create-quickstart.md)(Engelstalig) voor een Snelstartgids waarmee u kunt zien hoe u een SQL database beheerd exemplaar maakt.
...
> [!TIP]
> Zie voor voor beelden van Power shell-scripts [Quick start script: SQL Managed instance maken met Power shell-bibliotheek](https://blogs.msdn.microsoft.com/sqlserverstorageengine/20../../quick-start-script-create-azure-sql-managed-instance-using-powershell/).

| Cmdlet | Beschrijving |
| --- | --- |
|[New-AzSqlInstance](https://docs.microsoft.com/powershell/module/az.sql/new-azsqlinstance)|Hiermee maakt u een beheerd exemplaar van Azure SQL |
...
|[Set-AzSqlInstance](https://docs.microsoft.com/powershell/module/az.sql/set-azsqlinstance)|Hiermee worden eigenschappen ingesteld voor een door Azure SQL beheerd exemplaar|
...
|[New-AzSqlInstanceDatabase](https://docs.microsoft.com/powershell/module/az.sql/new-azsqlinstancedatabase)|Hiermee maakt u een Azure SQL Managed instance-data base|
...
> [!TIP]
> Voor Quick starts die aangeven dat u een SQL beheerd exemplaar moet configureren en er verbinding mee moet maken met behulp van SQL Server Management Studio in micro soft Windows, Zie [Quick Start: Azure VM configureren om verbinding te maken met een door Azure SQL beheerd exemplaar](connect-vm-instance-configure.md) en [Quick Start: Configureer een punt-naar-site-verbinding met een Azure SQL Managed instance van on-premises](point-to-site-p2s-configure.md).
> [!IMPORTANT]
