---
title: Service-naar-service-verificatie-Data Lake Storage Gen1-REST API
...
De uitvoer van de aanvraag bevat een autorisatie token (aangeduid door `access-token` in de onderstaande uitvoer) dat u vervolgens doorgeeft aan uw REST API-aanroepen. Sla het verificatie token op in een tekst bestand. u hebt deze nodig wanneer REST-aanroepen naar Data Lake Storage Gen1 worden uitgevoerd.
