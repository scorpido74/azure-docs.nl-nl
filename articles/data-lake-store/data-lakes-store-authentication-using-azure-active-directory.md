...
Zie  [verificatie scenario's voor Azure Active Directory](../active-directory/develop/authentication-vs-authorization.md) voor meer informatie over het gebruik van Azure Active Directory voor verificatie.
