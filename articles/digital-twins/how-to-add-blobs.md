...
| **naam** |Tekenreeks | Een mensen vriendelijke naam voor de BLOB |
| **voert** | Tekenreeks | Het type Blob-kan *type* en *typeId* niet gebruiken  |
...
| **beschrijvingen** | Tekenreeks | Aangepaste beschrijving van de BLOB |
| **bestanden** | Tekenreeks | Hiermee wordt aangegeven of de BLOB gedeeld kan worden`None`: `Tree`Enum `Global`[,,] |
...
| **Juiste** | Tekenreeks | De volledige naam van de BLOB |
...
[![Apparaat-blobs](media/how-to-add-blobs/blobs-device-api-swagger-img.png)](media/how-to-add-blobs/blobs-device-api-swagger-img.png#lightbox)
