...
## <a name="converting-industry-standard-models"></a>In de industrie gangbare modellen converteren

Als u bestaande modellen buiten Azure Digital Apparaatdubbels hebt die zijn gebaseerd op een industrie standaard, zoals RDF of OWL, moet u **deze converteren naar DTDL** om ze te kunnen gebruiken met Azure Digital apparaatdubbels. De DTDL-versie wordt vervolgens de bron van waarheid voor het model in azure Digital Apparaatdubbels.

Zie voor meer informatie over dit proces [*procedures: model standaard modellen converteren*](how-to-convert-models.md).
