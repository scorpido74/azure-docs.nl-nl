...
|----------------------------|----------|----------|---------|---------|--------------|------------|--------|----------|----------|-------------|
|          |US - centraal|VS - oost|VS - oost 2|VS - west 2|Frankrijk - centraal|Europa - noord|Verenigd Koninkrijk Zuid|Europa - west|Japan - oost|Azië - zuidoost|
| **Computing**                         |            |              |           |           |                |              |          |             |            |                |
