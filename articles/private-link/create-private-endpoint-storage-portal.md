...
2. Voer @ no__t-0 in, een bericht dat er ongeveer als volgt uitziet:
    ```azurepowershell
    Server:  UnKnown
...
3. Voer *myResourceGroup* FOR **de naam van de resource groep** in en selecteer **verwijderen**. 
