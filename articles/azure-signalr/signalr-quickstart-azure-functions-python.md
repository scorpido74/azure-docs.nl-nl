...
---
# <a name="quickstart-create-a-chat-room-with-azure-functions-and-signalr-service-using-python"></a>Snelstart: een chatroom maken met Azure-functies en SignalR-service met Python
...
Installeer de [Azure Functions Core Tools](https://github.com/Azure/azure-functions-core-tools#installing) (versie 2.7.1505 of hoger) om Python Azure Function-apps lokaal uit te voeren.
...
1. Open in uw codeeditor de map *src/chat/python* in de gekloonde opslagplaats.
...
1. Python-functies zijn ingedeeld in mappen. In elke map zijn twee bestanden: *function.json* definieert de bindingen die worden gebruikt in de functie, en * \_ \_\_\_init .py* is het hoofd van de functie. Deze functie-app bevat twee HTTP-geactiveerde functies:
...
1. In de terminal met de virtuele omgeving geactiveerd, zorg ervoor dat u in de *src / chat / python* map. Installeer de benodigde Python-pakketten met PIP.
