...
ms.locfileid: "67176404"
---
## <a name="clone-the-sample-application"></a>De voorbeeldtoepassing klonen

Terwijl de service wordt geïmplementeerd, gaan we met code werken. Kloon de [voorbeeld-app vanuit GitHub](https://github.com/Azure-Samples/signalr-service-quickstart-serverless-chat), stel de SignalR Service-verbindingsreeks in en voer de toepassing lokaal uit.
