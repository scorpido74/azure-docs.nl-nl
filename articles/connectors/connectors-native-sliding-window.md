---
title: Taken plannen voor het afhandelen van aaneengesloten gegevens Azure Logic Apps
...
1. Stel het interval en de frequentie voor het terugkeerpatroon in. In dit voor beeld stelt u deze eigenschappen in om elke week uw werk stroom uit te voeren.
   ...
   | Eigenschap | Verplicht | JSON-naam | Type | Beschrijving |
   |----------|----------|-----------|------|-------------|
   | **Spoedig** | Nee | spoedig | Tekenreeks | De duur voor het uitstellen van elk terugkeer patroon met de [datum tijd specificatie ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Durations) |
