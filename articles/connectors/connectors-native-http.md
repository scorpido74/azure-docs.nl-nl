...
Als u inhoud wilt afhandelen die `multipart/form-data` in HTTP-aanvragen typt, kunt u een JSON-object met de `$content-type` en `$multipart` kenmerken toevoegen aan de hoofd tekst van de HTTP-aanvraag met behulp van deze indeling.
