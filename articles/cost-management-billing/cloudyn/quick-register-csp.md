...
description: Bekijk de details van de registratieprocedure voor het maken van een Cloudyn-proefabonnement en het aanmelden bij de Cloudyn-portal.
author: bandersmsft
ms.author: banders
ms.date: 03/12/2020
ms.topic: quickstart
...
> Zie [Verbinding maken met de Partner Center API](/partner-center/develop/set-up-api-access-in-partner-center) voor meer informatie.
>
...
>
>Cloudyn is compatibel met het Microsoft Secure Application-model. Zie [Het Secure Application Model-framework inschakelen](/partner-center/develop/enable-secure-app-model) voor meer informatie.
