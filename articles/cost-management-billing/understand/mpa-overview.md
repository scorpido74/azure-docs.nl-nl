...
U kunt de factuur bekijken en de gerelateerde documenten, zoals het bestand met gebruiksgegevens en het prijzenoverzicht, downloaden in de Azure Portal. Zie [Facturen voor een Microsoft Partner-overeenkomst downloaden](download-azure-invoice.md) voor meer informatie.
