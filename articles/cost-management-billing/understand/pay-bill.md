...
De standaardbetalingsmethode van uw factureringsprofiel kan een creditcard zijn of een cheque/directe overboeking. Als u Azure-tegoeden hebt, worden deze elke factureringsperiode automatisch toegepast op uw factuur. Zie [Betalen via factuur](../manage/pay-by-invoice.md) als u in aanmerking wilt komen voor betaling met cheque/directe overboeking.
...
1. Klik in de blade **Overzicht** op het tabblad *Samenvatting*.
    ...
    ![schermopname van het tabblad Samenvatting](./media/pay-bill/billing-account-overview.png)
...
1. Klik op de blauwe knop **Nu betalen**.
    ...
    ![schermopname van de knop Nu betalen](./media/pay-bill/paynow-button-overview.png)
