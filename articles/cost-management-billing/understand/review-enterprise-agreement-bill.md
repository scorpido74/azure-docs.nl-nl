...
Deze zelf studie is alleen van toepassing op Azure-klanten met een Azure-Enterprise Agreement.

In deze zelfstudie leert u het volgende:

> [!div class="checklist"]
> * Gefactureerde kosten controleren
> * Overschrijding kosten van service controleren
> * Marketplace-factuur bekijken

## <a name="prerequisites"></a>Vereisten

Als u de kosten op uw factuur wilt inzien en controleren, moet u een Enterprise-beheerder zijn. Zie [Inzicht in Azure Enterprise Overeenkomst-beheerdersrollen in Azure](../manage/understand-ea-roles.md) voor meer informatie. Als u niet weet wie de Enterprise-beheerder is voor uw organisatie, neemt u [contact](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade) op met de ondersteuning.

## <a name="review-invoiced-charges-for-most-customers"></a>Gefactureerde kosten voor de meeste klanten bekijken

Deze sectie is niet van toepassing op Azure-klanten in Australië, Japan of Singapore.

U ontvangt een Azure-factuur wanneer een van de volgende gebeurtenissen plaatsvindt tijdens uw factureringsperiode:

- **Service overschrijding**: de gebruiks kosten van uw organisatie overschrijden uw tegoed.
- **Kosten worden afzonderlijk in rekening gebracht**: de services die door uw organisatie worden gebruikt, vallen niet onder het tegoed. U wordt gefactureerd voor de volgende services, ongeacht het saldo van uw tegoed:
    - Canonical
...
- **Kosten voor Marketplace**: Azure Marketplace-aankopen en-gebruik vallen niet onder het tegoed van uw organisatie. U wordt gefactureerd voor Marketplace-kosten, ongeacht het saldo van uw tegoed. In de Enterprise-portal kan een Enterprise-beheerder Marketplace-aankopen in- en uitschakelen.
...
![Scherm opname van de optie M + C in de gebruiks samenvatting.](./media/review-enterprise-agreement-bill/ea-portal-usage-sumary-cm-option.png)
...
![Scherm opname van het tabblad Download gebruik](./media/review-enterprise-agreement-bill/ea-portal-download-usage.png)

## <a name="review-invoiced-charges-for-other-customers"></a>Gefactureerde kosten voor andere klanten bekijken
...
- **Service overschrijding**: de gebruiks kosten van uw organisatie overschrijden uw tegoed.
- **Kosten worden afzonderlijk in rekening gebracht**: de services die door uw organisatie worden gebruikt, vallen niet onder het tegoed. U ontvangt een factuur voor de volgende services:
    - Canonical
    - Citrix XenApp Essentials
    - Citrix XenDesktop
    - Geregistreerde gebruiker
    ...
    - Visual Studio Professional (maandelijks)
    - Visual Studio Professional (jaarlijks)
- **Kosten voor Marketplace**: Azure Marketplace-aankopen en-gebruik vallen niet onder het tegoed van uw organisatie en worden afzonderlijk in rekening gebracht. In de Enterprise-portal kan een Enterprise-beheerder Marketplace-aankopen in- en uitschakelen.
...
## <a name="review-service-overage-charges-for-other-customers"></a>Service overschrijding-kosten voor andere klanten controleren
...
Meld u aan bij de [Azure EA-Portal](https://ea.azure.com) en selecteer vervolgens **rapporten**. Wijzig in de rechterbovenhoek van het tabblad de weergave van**M** in **C** en selecteer de periode die op de factuur wordt vermeld.  
...
![Scherm afbeelding met een geavanceerde down load voor het downloaden van het rapport.](./media/review-enterprise-agreement-bill/ea-portal-download-usage-advanced.png)
...
### <a name="review-marketplace-invoice"></a>Marketplace-factuur bekijken
...
Meld u aan bij de [Enter prise Portal](https://ea.azure.com) en selecteer vervolgens **rapporten**. Wijzig in de rechterbovenhoek van het tabblad de weergave van**M** in **C** en selecteer de periode die op de factuur wordt vermeld.  

![Scherm opname van de optie M + C voor de gebruiks samenvatting.](./media/review-enterprise-agreement-bill/ea-portal-usage-sumary-cm-option.png)  

Het totaal bij **Azure Marketplace** moet overeenkomen met dat bij **Totale verkoop** op uw Marketplace-factuur. Ga naar **Gebruiksgegevens downloaden** voor meer informatie over uw gebruikskosten. Onder de **kosten voor Marketplace** selecteert u **Downloaden**. De prijs van Marketplace omvat een BTW zoals bepaald door de uitgever. Klanten ontvangen geen afzonderlijke factuur van de uitgever om de belasting voor de trans actie te innen.

![Scherm opname van de download optie onder kosten voor Marketplace.](./media/review-enterprise-agreement-bill/ea-portal-download-usage-marketplace.png)
