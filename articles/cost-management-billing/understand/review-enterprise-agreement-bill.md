...
![Voorbeeld met gegevens voor prijzenoverzicht](./media/review-enterprise-agreement-bill/ea-create-view-price-sheet-information.png)
...
![Voorbeeld van het downloaden van een oud prijzenoverzicht](./media/review-enterprise-agreement-bill/create-ea-view-price-sheet-download-historical-price-list.png)
...
- **Rapport met gebruiksoverzicht**: Hierin ziet u **zowel** kosten op basis van gebruik als maandelijkse kosten voor Azure Marketplace.
