...
| Locatie | product/regio | Alles |   |
| Naar gebruik |   | Alles |   |
| Meter categorie | lineItem/product code | Alles |   |
| Subcategorie van de meter | lineitem/UsageType | Alles |   |
...
| GUID | N/A | Alles | GUID van Azure meter. |
| Servicenaam | product/ProductName | Alles | Als product/ProductName null is, wordt lineItem/product code gebruikt. |
| Serviceniveau |   |   |   |
...
| Tag | resourceTags/\* | Alles | Het voor voegsel _gebruiker:_ wordt verwijderd uit door de gebruiker gedefinieerde labels om cross-Cloud tags toe te staan. Het voor voegsel _AWS:_ blijft intact. |
| Facturerings account-ID | bill/PayerAccountId | Beheergroep |   |
| Naam facturerings account | N/A | Beheergroep | Account namen worden verzameld met behulp van de AWS-organisatie-API. |
...
Bij het verkrijgen van toegang tot AWS-API's kunnen extra kosten in rekening worden gebracht.
