---
title: Voor waarden in het prijzen overzicht van uw micro soft-klanten overeenkomst-Azure
...
| Product  | De naam van het product waarmee de kosten worden berekend. Bijvoorbeeld: Basic SQL DB versus Standard SQL DB  |
...
| serviceFamily  | Type Azure-service. Ex: compute, Analytics, Security |
