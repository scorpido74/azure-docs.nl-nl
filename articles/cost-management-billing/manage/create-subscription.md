...
U kunt ook programmatisch extra abonnementen maken. Zie [Programmatisch Azure-abonnementen maken](../../azure-resource-manager/management/programmatically-create-subscription.md) voor meer informatie.
