---
title: Azure EA-prijzen
description: Beschrijving van het prijsoverzicht van Azure EA
author: bandersmsft
...
ms.locfileid: "89442408"
---
# <a name="azure-ea-pricing"></a>Azure EA-prijzen

In dit artikel vindt u een overzicht van de prijzen voor Enterprise-klanten van Azure.
...
Sommige services beginnen met aanbiedingsprijzen die gelden als ze voor de eerste keer worden geïntroduceerd. Deze kunnen een later tijdstip worden verhoogd.
...
- Zie [Enterprise Enrollment-facturen](ea-portal-enrollment-invoices.md) voor meer informatie.