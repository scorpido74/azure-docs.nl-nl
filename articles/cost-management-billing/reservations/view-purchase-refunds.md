...
Zie [Azure Cost Management Power BI-app voor Enterprise Agreements](../costs/analyze-cost-data-azure-cost-management-power-bi-template-app.md) voor meer informatie.

## <a name="use-apis-to-get-reservation-transactions"></a>Reserveringsacties weergeven met API's

Gebruikers van Enterprise Agreement (EA) en de Microsoft-klantovereenkomst kunnen gegevens over reserveringstransacties ophalen aan de hand van de informatie in [Reserveringstransacties - Lijst-API](/rest/api/consumption/reservationtransactions/list).
