...
3. Selecteer **Automatisch een nieuwe reservering aanschaffen na vervaldatum**.  
  ![Voorbeeld van verlenging van een reservering](./media/reservation-renew/reservation-renewal.png)
...
- Zie [Wat zijn Azure-reserveringen?](save-compute-costs-reservations.md) voor meer informatie over Azure-reserveringen.
