...
De volgende stap is het [implementeren van uw toepassing naar Azure web apps met git](app-service/quickstart-php.md) (maar niet alle informatie die er relevant is). 
