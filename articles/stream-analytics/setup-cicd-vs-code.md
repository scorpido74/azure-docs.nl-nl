...
## <a name="deploy-with-azure-pipelines"></a>Implementeren met Azure-pijp lijnen
...
2. Selecteer de **+** naast de **Agent taak** en zoek naar de implementatie van een *Azure-resource groep*. Voer de volgende para meters in:
   ...
   |Locatie van sjabloon| *Gekoppeld artefact*|
   |Sjabloon| $ (Build. ArtifactStagingDirectory) \drop\myASAJob.JobTemplate.json |
   ...
   |Implementatie modus|Incrementele|

3. Selecteer in de vervolg keuzelijst taken de optie **taak op productie omgeving implementeren**.

4. Selecteer de **+** naast de **Agent taak** en zoek naar de implementatie van een *Azure-resource groep*. Voer de volgende para meters in:
