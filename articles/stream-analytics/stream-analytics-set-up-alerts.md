...
|Runtime-fouten|Groter dan|Totaal|0|Controleer de activiteiten of Diagnostische logboeken en breng de gewenste wijzigingen aan in de invoer, query of uitvoer.|
...
|Fouten bij het deserialiseren van de invoer|Groter dan|Totaal|0|Controleer de activiteiten of Diagnostische logboeken en breng de gewenste wijzigingen aan in de invoer. Zie [problemen oplossen Azure stream Analytics met Diagnostische logboeken](stream-analytics-job-diagnostic-logs.md) voor meer informatie over Diagnostische logboeken|

## <a name="get-help"></a>Hulp krijgen

Zie [waarschuwings meldingen ontvangen](../monitoring-and-diagnostics/insights-receive-alert-notifications.md)voor meer informatie over het configureren van waarschuwingen in de Azure Portal.  
