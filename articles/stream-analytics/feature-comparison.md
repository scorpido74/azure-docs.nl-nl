...
|C#aangepaste code functie en deserializer|Alleen-lezen modus|Ja|Nee|
|Java script UDF en UDA     |Ja         |Ja         |Alleen op Windows         |
|Machine Learning-service     |Ja, maar de query kan niet worden getest        |Ja         |Nee         |
