---
title: Aangepaste .NET-deserialers voor Azure Stream Analytics Cloud taken
...
2. Dubbel **Klik onder invoer op** **input. json**. Gebruik de standaard configuraties, met uitzonde ring van de volgende instellingen:
   ...
   |-------|---------------|
   |Bron|Blobopslag|
   |Bron|Kies gegevensbron van het huidige account|
   ...
   |Bron|Laden van ASA-project referentie of CodeBehind|
