...
| Uitvoertype | Ondersteuning voor partitionering | Partitiesleutel  | Aantal schrijvers van uitvoer |
| --- | --- | --- | --- |
...
| Uitvoertype |    Maximale bericht grootte | Optimalisatie van Batch grootte |
| :--- | :--- | :--- |
