...
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. De naam voor de webrole. De naam van de rol moet uniek zijn.|  
|enableNativeCodeExecution|booleaans|Optioneel. De standaard waarde is `true`; uitvoering van systeem eigen code en volledig vertrouwen zijn standaard ingeschakeld. Stel dit kenmerk in `false` op het uitschakelen van systeem eigen code voor de webfunctie en gebruik in plaats daarvan Azure gedeeltelijk vertrouwen.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. Een unieke naam voor het lokale archief.|  
|cleanOnRoleRecycle|booleaans|Optioneel. Hiermee wordt aangegeven of het lokale archief moet worden gereinigd wanneer de rol opnieuw wordt gestart. De standaard waarde `true`is.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. Een unieke naam voor het externe eind punt.|  
|Protocolsubstatus|tekenreeks|Vereist. Het transport protocol voor het externe eind punt. Mogelijke waarden voor een webrole `HTTP`zijn, `HTTPS` `UDP`,, of. `TCP`|  
...
|ignoreRoleInstanceStatus|booleaans|Optioneel. Wanneer de waarde van dit kenmerk is ingesteld op `true`, wordt de status van een service genegeerd en wordt het eind punt niet verwijderd door de Load Balancer. Stel deze waarde in `true` op nuttig voor het opsporen van fouten in de bezette instanties van een service. De standaardwaarde is `false`. **Opmerking:**  Een eind punt kan nog steeds verkeer ontvangen, zelfs wanneer de rol niet de status gereed heeft.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. Een unieke naam voor het interne eind punt.|  
|Protocolsubstatus|tekenreeks|Vereist. Het transport protocol voor het interne eind punt. Mogelijke waarden zijn `HTTP`, `TCP`, `UDP`, of `ANY`.<br /><br /> Een waarde van `ANY` geeft aan dat een protocol, elke poort, is toegestaan.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. Een unieke naam voor het eind punt.|  
...
|Protocolsubstatus|tekenreeks|Vereist. Het transport protocol voor het interne eind punt. Mogelijke waarden zijn `udp` en `tcp`. Gebruiken `tcp` voor HTTP/HTTPS-verkeer.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|poort|int|Vereist. De poort voor het interne eind punt. Dit heeft hetzelfde effect als het instellen van `FixedPortRange` de minimum-en maximum waarde op dezelfde poort.<br /><br /> Mogelijke waarden variëren tussen 1 en 65535, inclusief (Azure SDK-versie 1,7 of hoger).|  
...
|aantal|tekenreeks|Vereist. De maximum poort in het bereik. Mogelijke waarden variëren tussen 1 en 65535, inclusief (Azure SDK-versie 1,7 of hoger).|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. Een naam voor dit certificaat, dat wordt gebruikt om ernaar te verwijzen wanneer het is gekoppeld aan een HTTPS `InputEndpoint` -element.|  
...
|storeName|tekenreeks|Vereist. De naam van het certificaat archief waar dit certificaat zich bevindt op de lokale computer. Mogelijke waarden `My`zijn de ingebouwde winkel namen, `Root`, `CA` `Trust` `Disallowed` `TrustedPeople` `TrustedPublisher` `AuthRoot`,,,,,, `AddressBook`, of een aangepaste archief naam. Als een aangepaste archief naam is opgegeven, wordt het archief automatisch gemaakt.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. De naam van de omgevings variabele die moet worden ingesteld.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. De naam van de website of toepassing.|  
|physicalDirectory|tekenreeks|De locatie van de inhoudsmap voor de hoofdmap van de site. De locatie kan worden opgegeven als een absoluut pad of relatief ten opzichte van de locatie. csdef.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. Hiermee geeft u een naam op voor het identificeren van de virtuele toepassing.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. Hiermee geeft u een naam op voor de virtuele map.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|name|tekenreeks|Vereist. Hiermee geeft u een naam op om de binding aan te duiden.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|path|tekenreeks|Vereist. Relatief of absoluut pad van een lokale map waarvan de inhoud wordt gekopieerd naar de virtuele machine van Azure. De uitbrei ding van omgevings variabelen in het mappad wordt ondersteund.|  
