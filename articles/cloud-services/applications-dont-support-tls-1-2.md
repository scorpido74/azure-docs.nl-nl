...
Gebruik de volgende code als voor beeld voor het maken van een script waarmee oudere protocollen en coderings suites worden ingeschakeld.   Voor de doel einden van deze documentatie krijgt dit script de naam: TLSsettings. ps1. 
  
```Powershell
...
Maak een CMD-bestand met de volgende informatie. 
...
## <a name="step-4-validation"></a>Stap 4: validatie 
