...
|protocol|string|Vereist. Het transport protocol voor het externe eind punt. Voor een werk rollen zijn mogelijke waarden `HTTP`, `HTTPS`, `UDP`of `TCP`.|
