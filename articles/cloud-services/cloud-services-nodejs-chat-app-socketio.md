...
1. Maak een lokale kopie van de opslag plaats met behulp van de knop **klonen** . U kunt ook de **zip** -knop gebruiken om het project te downloaden.
   ...
   ![Er wordt een browser https://github.com/LearnBoost/socket.io/tree/master/examples/chatvenster weer gegeven met het pictogram zip-down load gemarkeerd](./media/cloud-services-nodejs-chat-app-socketio/socketio-22.png)
