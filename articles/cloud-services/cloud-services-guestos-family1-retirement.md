...
Als u wilt weten welke van uw Cloud Services worden uitgevoerd, kunt u het volgende script uitvoeren in Azure PowerShell, maar u moet [Azure PowerShell eerst instellen](/powershell/azureps-cmdlets-docs) . Meer informatie over het script vindt u in [Azure Guest OS Family 1 end of Life: juni 2014](https://blogs.msdn.com/b/ryberry/archive/2014/04/02/azure-guest-os-family-1-end-of-life-june-2014.aspx).
