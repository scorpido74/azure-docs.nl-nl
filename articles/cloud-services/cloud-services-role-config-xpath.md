...
| Coderen |var x = RoleEnvironment. IsEmulated; |
...
| Coderen |var deploymentId = RoleEnvironment. DeploymentId; |
...
| Coderen |var-ID = RoleEnvironment.CurrentRoleInstance.Id; |
...
| Coderen |var UD = RoleEnvironment. CurrentRoleInstance. UpdateDomain; |
...
| Coderen |var FD = RoleEnvironment. CurrentRoleInstance. FaultDomain; |
...
| Coderen |var rName = RoleEnvironment.CurrentRoleInstance.Role.Name; |
...
| Coderen |var setting = RoleEnvironment. GetConfigurationSettingValue ("Setting1"); |
...
| Coderen |var localResourcePath = RoleEnvironment. GetLocalResource ("LocalStore1"). RootPath; |
...
| Coderen |var localResourceSizeInMB = RoleEnvironment. GetLocalResource ("LocalStore1"). MaximumSizeInMegabytes; |
...
| Coderen |var-protocol = RoleEnvironment. CurrentRoleInstance. InstanceEndpoints ["Endpoint1"]. Protocolsubstatus |
...
| Coderen |var Address = RoleEnvironment. CurrentRoleInstance. InstanceEndpoints ["Endpoint1"]. IPEndpoint. Address |
...
| Coderen |var-poort = RoleEnvironment. CurrentRoleInstance. InstanceEndpoints ["Endpoint1"]. IPEndpoint. Port; |

## <a name="example"></a>Voorbeeld
Hier volgt een voor beeld van een werk rollen die een opstart taak maakt met een omgevings variabele met de naam `TestIsEmulated` ingesteld op de [XPath-waarde@emulated](#app-running-in-emulator). 
