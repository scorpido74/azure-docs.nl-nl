---
title: Binnenkomend internetverkeer filteren met Azure Firewall DNAT met behulp van de portal
...
2. Selecteer op de startpagina van de Azure-portal **Resourcegroepen**en selecteer **Vervolgens Toevoegen**.
...
2. Selecteer **onder Netwerken**virtuele **netwerken**.
...
10. Voor **adresbereik**typt u **10.0.1.0/26**.
11. Gebruik de andere standaardinstellingen en selecteer **Vervolgens Maken**.
...
1. Selecteer het **virtuele VN-Hub-netwerk.**
2. Selecteer **Peerings**onder **Instellingen**.
3. Selecteer **Toevoegen**.
4. Typ **Peer-HubSpoke** voor de **naam van het peering van VN-Hub naar VN-Spoke.**
5. Selecteer **VN-Spoke** voor het virtuele netwerk.
6. Typ **Peer-SpokeHub** voor **naam van peering van VN-Spoke to VN-Hub.**
7. Voor **Doorgestuurd verkeer van VN-Spoke toestaan met VN-Hub** selecteer **ingeschakeld**.
8. Selecteer **OK**.
...
1. Typ **Srv-Workload**voor **virtuele machinenaam**.
1. Selecteer **bij Regio**dezelfde locatie die u eerder hebt gebruikt.
...
1. Selecteer **VN-Spoke**voor **virtueel netwerk**.
2. Bij **Subnet** selecteert u **SN-Workload**.
3. Selecteer **Geen** **voor openbaar IP-adres** .
4. Selecteer **Geen voor** **openbare binnenkomende poorten**. 
2. Verlaat de andere standaardinstellingen en selecteer **Volgende: Beheer**.

**Beheer**

1. Selecteer **Uitschakelen** **voor diagnostische gegevens.**
1. Selecteer **Controleren + maken**.

**Review + Maken**

Bekijk het overzicht en selecteer **Vervolgens Maken**. Het duurt enkele minuten voordat dit is voltooid.
...
1. Selecteer op de startpagina van de portal de optie **Een resource maken**.
2. Selecteer **Netwerken**en selecteer na **Topaanbieding** **alles weergeven**.
...
7. Nadat de implementatie is voltooid, gaat u naar de **RG-DNAT-Test resourcegroep** en selecteert u de **FW-DNAT-testfirewall.**
...
8. Selecteer **Maken**.
9. Selecteer **Vernieuwen**en selecteer vervolgens de routetabel **RT-FWroute.**
...
2. Selecteer op de **fw-DNAT-testpagina** onder **Instellingen**de optie **Regels**. 
3. Selecteer **NAT-regelverzameling toevoegen**. 
