...
2. Selecteer **Volgende: IP-adressen** .
3. Bij **IPv4-adresruimte** typt u **10.5.0.0/16** .
6. Onder **Subnetnaam** selecteert u **standaard** .
7. Bij **Naam** typt u **AzureFirewallSubnet** . De firewall zal zich in dit subnet bevinden, en de subnetnaam **moet** AzureFirewallSubnet zijn.
8. Bij **Adresbereik** typt u **10.5.0.0/26** . 
9. Selecteer **Opslaan** .
...
4. Bij **IPv4-adresruimte** typt u **10.6.0.0/16** .
6. Onder **Subnetnaam** selecteert u **standaard** .
7. Bij **Naam** typt u **SN-Workload** .
8. Bij **Adresbereik** typt u **10.6.0.0/24** . 
9. Selecteer **Opslaan** .
10. Selecteer **Controleren + maken** .
11. Selecteer **Maken** .
...
2. Selecteer bij **Regio** **(VS) VS - oost** .
3. Selecteer **Volgende : IP-adressen**
4. Bij **IPv4-adresruimte** typt u **192.168.0.0/16** .
5. Onder **Subnetnaam** selecteert u **standaard** .
7. Typ **SN-Corp** bij **Naam** .
8. Bij **Adresbereik** typt u **192.168.1.0/24** . 
9. Selecteer **Opslaan** .
10. Selecteer **Controleren + maken** .
11. Selecteer **Maken** .
