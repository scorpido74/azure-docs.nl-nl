...
ms.locfileid: "86246953"
---
# <a name="preview-features-in-azure-cognitive-search"></a>Preview-functies in azure Cognitive Search

Dit artikel bevat een uitgebreide lijst met alle functies die in de preview-versie worden weer gegeven. Deze previewfunctie wordt aangeboden zonder service level agreement en wordt niet aanbevolen voor productieworkloads. Zie [Supplemental Terms of Use for Microsoft Azure Previews (Aanvullende gebruiksvoorwaarden voor Microsoft Azure-previews)](https://azure.microsoft.com/support/legal/preview-supplemental-terms/) voor meer informatie.
...
| [**moreLikeThis**](search-more-like-this.md) | Query | Zoekt documenten die relevant zijn voor een specifiek document. Deze functie heeft eerdere voor beelden. | Voeg deze query parameter toe aan [Zoek documenten (rest)](https://docs.microsoft.com/rest/api/searchservice/search-documents) -aanroepen met API-Version = 2020-06 -30-preview, 2019-05-06-preview, 2016-09-01-preview of 2017-11-11-preview. |
