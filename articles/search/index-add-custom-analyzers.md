...
## <a name="create-custom-analyzers"></a>Aangepaste analyse functies maken
 ...
 De `tokenizer_name` is de naam van een tokenizer, `token_filter_name_1` `token_filter_name_2` de namen van de `char_filter_name_1` token filters `char_filter_name_2` en de namen van de teken filters (Zie de tabellen [Tokenizers](#Tokenizers), [token filters](#TokenFilters) en char filters voor geldige waarden).
