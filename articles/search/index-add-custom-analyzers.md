---
title: Aangepaste analyse functies toevoegen aan teken reeks velden in een index
...
ms.locfileid: "72790163"
---
# <a name="add-custom-analyzers-to-an-azure-cognitive-search-index"></a>Aangepaste analyse functies toevoegen aan een Azure Cognitive Search-index
...
|[pattern](https://lucene.apache.org/core/6_6_1/analyzers-common/org/apache/lucene/analysis/pattern/PatternTokenizer.html)|PatternTokenizer|Deze tokenizer maakt gebruik van regex-patroon vergelijking om afzonderlijke tokens te maken.<br /><br /> **Opties**<br /><br /> [patroon](https://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html) (type: teken reeks)-regulier expressie patroon. De standaard waarde is \w +. <br /><br /> [Flags](https://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html#field_summary) (type: String): reguliere expressie vlaggen. De standaard waarde is een lege teken reeks. Toegestane waarden: CANON_EQ, CASE_INSENSITIVE, COMMENTS, DOTALL, LITERAL, MEERREGELIGE, UNICODE_CASE, UNIX_LINES<br /><br /> groep (type: int): welke groep u wilt extra heren in tokens. De standaard waarde is-1 (splitsen).|
