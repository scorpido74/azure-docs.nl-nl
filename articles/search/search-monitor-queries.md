...
description: Bewaak de metrische gegevens van query's voor prestaties en door voer. Verzamel en analyseer invoer van query reeksen in Diagnostische logboeken.
manager: nitinme
author: HeidiSteen
ms.author: heidist
