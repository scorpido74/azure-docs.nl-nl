...
+ [API-verwijzing voor de client bibliotheek](/dotnet/api/overview/azure/search.documents-readme)
...
+ [Azure.Search.Document API-naslag informatie](/dotnet/api/overview/azure/search.documents-readme)