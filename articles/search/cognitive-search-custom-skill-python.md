...
Er wordt ook een nieuwe HTTP-geactiveerde functie gemaakt in de map **samen voegen** van het functie-app-project. Hierin ziet u een bestand met de naam '\__init__. py ' met deze inhoud:
