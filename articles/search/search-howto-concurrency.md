...
Dit code fragment illustreert de toevoeging van een synonymMap aan een index die al bestaat. Deze code is afkomstig uit het [C#-voor beeld van synoniem voor Azure Cognitive Search](search-synonyms-tutorial-sdk.md).
...
Raadpleeg de [synoniemen C#](https://github.com/Azure-Samples/search-dotnet-getting-started/tree/master/DotNetHowToSynonyms) -voor beelden voor meer context informatie over het veilig bijwerken van een bestaande index.
