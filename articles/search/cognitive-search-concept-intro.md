...
| Gegevens bron  | Een object dat door een Indexeer functie wordt gebruikt om verbinding te maken met een externe gegevens bron van ondersteunde typen in Azure. | Zie [Indexeer functies](search-indexer-overview.md) |
...
+ [Voor beeld: een aangepaste vaardigheid maken voor cognitieve ZoekC#opdrachten ()](cognitive-search-create-custom-skill-example.md)
...
U kunt REST-`api-version=2019-05-06` op aanvragen of de .NET SDK gebruiken. 
...
+ [Snelstartgids: Probeer cognitieve zoek functie in een portal-overzicht](cognitive-search-quickstart-blob.md)
+ [Zelf studie: meer informatie over de cognitieve Zoek-Api's](cognitive-search-tutorial-blob.md)
