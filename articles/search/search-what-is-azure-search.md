...
Nadat u een index hebt gevuld, kunt u [zoekquery’s verzenden](search-query-overview.md) naar het service-eindpunt met behulp van eenvoudige HTTP-aanvragen met [REST API](/rest/api/searchservice/Search-Documents) of de [.NET SDK](https://docs.microsoft.com/dotnet/api/microsoft.azure.search.idocumentsoperations).
