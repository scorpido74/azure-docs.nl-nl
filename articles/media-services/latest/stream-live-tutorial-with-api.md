...
Als u de gebeurtenis wilt bekijken, kopieert u de streaming-URL die u hebt ontvangen tijdens het uitvoeren van de code die wordt beschreven in een streaming-Locator maken. U kunt een media speler van uw keuze gebruiken. [Azure Media Player](https://amp.azure.net/libs/amp/latest/docs/index.html) is beschikbaar om uw stream te testen op https://ampdemo.azureedge.net.
