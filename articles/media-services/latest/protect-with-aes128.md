...
* Referenties ophalen die nodig zijn voor het gebruik van Media Services Api's door [toegangs-api's](./access-api-howto.md)te volgen.
...
1. Maak een [streaming-Locator](/rest/api/media/streaminglocators).
