...
ms.locfileid: "92525125"
---
<!--Create a basic audio transform REST-->

Met de volgende Azure REST-opdracht wordt een basis audio-activum gemaakt. Vervang de waarden `subscriptionID` , `resourceGroup` en `amsAccountName` met de waarden waarmee u momenteel werkt. Geef uw asset een naam door hier in te stellen `assetName` .
