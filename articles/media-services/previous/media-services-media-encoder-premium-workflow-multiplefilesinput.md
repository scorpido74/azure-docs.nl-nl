...
Hieronder ziet u de C#-code die de XML-configuratie van een bestand leest, deze bijwerkt met de juiste video bestands naam en door gegeven aan de taak in een taak:
