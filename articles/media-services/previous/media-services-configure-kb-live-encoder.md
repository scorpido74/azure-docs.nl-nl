...
2. Geef de naam van een kanaal, het beschrijvingsveld is optioneel. Onder kanaal instellingen selecteert u **standaard** voor de optie Live encoding, waarbij het invoer protocol is ingesteld op **RTMP**. U kunt alle andere instellingen omdat laten. Zorg ervoor dat het **nieuwe kanaal nu starten** is geselecteerd.
