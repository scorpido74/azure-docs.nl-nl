...
## <a id="upload"></a>Een nieuwe Asset maken en een video bestand uploaden met REST API
...
## <a id="publish_get_urls"></a>De Asset publiceren en Url's voor streamen en progressief downloaden ophalen met REST API
