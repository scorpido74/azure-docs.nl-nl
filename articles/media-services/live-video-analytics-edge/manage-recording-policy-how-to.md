...
* Hiermee geeft u op dat wanneer de blobs ouder zijn dan 30 dagen, ze worden verplaatst van de [laag Hot Access naar cool](https://docs.microsoft.com/azure/storage/blobs/storage-blob-storage-tiers?tabs=azure-portal).
...
* Updates voor het levenscyclus beheer beleid zijn niet direct. Zie [deze sectie met veelgestelde vragen](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#faq) voor meer informatie.
