---
title: Voorbeelden van Azure CLI - Een aangepaste VM-installatiekopie gebruiken
description: Met dit Azure CLI-script maakt u een virtuele-machineschaalset die gebruikmaakt van een aangepaste VM-installatiekopie als bron voor VM-exemplaren.
author: axayjo
ms.author: akjosh
ms.topic: sample
