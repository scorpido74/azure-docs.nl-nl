---
title: Snelstart - Een virtuele machineschaalset maken met Azure CLI
description: Ga aan de slag met uw implementaties door te leren hoe u snel een virtuele machineschaalset maken met Azure CLI.
author: cynthn
