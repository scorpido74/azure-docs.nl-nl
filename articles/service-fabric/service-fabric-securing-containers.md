...
De container service of het proces is verantwoordelijk voor het importeren van de certificaat bestanden in de container. Als u het certificaat wilt importeren, kunt `setupentrypoint.sh` u scripts gebruiken of aangepaste code uitvoeren in het container proces. Hier volgt een voorbeeld code in C# voor het importeren van het PFX-bestand:
