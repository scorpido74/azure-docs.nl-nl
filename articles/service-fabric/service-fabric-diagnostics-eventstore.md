...
* Partitie: gebeurtenissen van een specifieke partitie die wordt geïdentificeerd door `partitionId`
* Partitie Replica's: gebeurtenissen van alle replica's/instanties binnen een specifieke partitie die wordt geïdentificeerd door `partitionId`
