---
title: XML-schemabeschrijvingen azure service fabric-servicemodel
description: Een beschrijving van het XML-schema van het servicestructuurservicemodel, inclusief locatie en een samenvatting van componenten.
ms.topic: reference
ms.date: 12/10/2018
...
# <a name="service-model-xml-schema-documentation"></a>XML-schemadocumentatie voor servicemodel
In dit artikel wordt het schemabestand ServiceFabricServiceModel.xsd dat is geïnstalleerd met de Service Fabric SDK documenteerd.  Standaard is het schemabestand geïnstalleerd op *C:\Program Files\Microsoft SDKs\Service Fabric\schema's\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Naamruimtebindingen

|Voorvoegsel|Naamruimte URI|
|---|---|
|Xs|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Componentoverzicht 
De volgende componenten zijn gedefinieerd in ServiceFabricServiceModel.xsd:
...
- [3 elementgroepen](service-fabric-service-model-schema-element-groups.md)
- [16 kenmerkgroepen](service-fabric-service-model-schema-attribute-groups.md)
