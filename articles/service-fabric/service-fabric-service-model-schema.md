---
title: XML-schema beschrijvingen van Azure Service Fabric service model
description: Een beschrijving van het XML-schema van het Service Fabric-service model, inclusief de locatie en een samen vatting van de onderdelen.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639187"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Documentatie over het XML-schema van het service model
In dit artikel wordt het ServiceFabricServiceModel. XSD-schema bestand gedocumenteerd dat is geïnstalleerd met de Service Fabric SDK.  Het schema bestand wordt standaard geïnstalleerd in *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.XSD*.

## <a name="namespace-bindings"></a>Naam ruimte bindingen

|Voorvoegsel|Naam ruimte-URI|
|---|---|
|X'en|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Onderdeel overzicht 
De volgende onderdelen worden gedefinieerd in ServiceFabricServiceModel. xsd:
- [257 elementen](service-fabric-service-model-schema-elements.md)
- [112 toe](service-fabric-service-model-schema-complex-types.md)
- [1 simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [3 element groepen](service-fabric-service-model-schema-element-groups.md)
- [16 kenmerk groepen](service-fabric-service-model-schema-attribute-groups.md)
