...
Declareert een certificaat dat wordt gebruikt voor het versleutelen van gevoelige gegevens in het toepassings manifest. De auteur van de toepassing gebruikt de Invoke-ServiceFabricEncryptSecret cmdlet om de gevoelige informatie te versleutelen, die wordt gekopieerd naar een para meter in de sectie ConfigOverrides.
...
Als deze eigenschap waar is, wordt de waarde van deze para meter versleuteld. De ontwikkelaar van de toepassing is verantwoordelijk voor het maken van een certificaat en met behulp van de cmdlet Invoke-ServiceFabricEncryptSecret om gevoelige informatie te versleutelen. De certificaat gegevens die worden gebruikt om de waarde te versleutelen, worden opgegeven in de sectie certificaten. Dit kenmerk is afgeschaft. Gebruik het kenmerk type.
...
Met deze waarde wordt het type waarde gedefinieerd dat u hebt opgegeven in het kenmerk value. Dit kan SecretsStoreRef/versleuteld/niet-leesbaar zijn.
Als deze is ingesteld op SecretsStoreRef, halen we de referentie waarde op uit de SecretStore.
Indien ingesteld op versleuteld, is de ontwikkelaar van de toepassing verantwoordelijk voor het maken van een certificaat en met behulp van de cmdlet Invoke-ServiceFabricEncryptSecret om gevoelige informatie te versleutelen.
