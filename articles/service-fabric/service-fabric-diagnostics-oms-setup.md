...
U kunt de sjabloon als een resource manager-upgrade naar uw cluster implementeren met behulp `New-AzResourceGroupDeployment` van de API in de module Azure PowerShell. Een voor beeld van een opdracht is:
