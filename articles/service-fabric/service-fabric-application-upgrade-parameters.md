...
| --- | --- |
| toepassings-id  |ID van de toepassing die wordt bijgewerkt. <br> Dit is doorgaans de volledige naam van de toepassing zonder het URI-schema ' Fabric: '. Met ingang van versie 6,0 worden hiërarchische namen gescheiden met het \~-teken. Als de naam van de toepassing bijvoorbeeld ' Fabric:/Mijntoep/app1 ' is, is de toepassings-id ' Mijntoep\~app1 ' in 6.0 + en ' Mijntoep/app1 ' in vorige versies.|
