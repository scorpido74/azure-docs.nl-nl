---
title: XML-schemagroepen van Azure Service Fabric-servicemodel
description: Beschrijft de elementgroepen in het XML-schema van het servicemodel Service Fabric.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "79282079"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-fabric-service-model-xml-schema-elements"></a>XML-schema-elementen van servicefabric-servicemodel

## <a name="partitiondescriptiongroup-group"></a>Groep PartitionDescriptionGroup
Hiermee definieert u het partitieschema voor een service.
...
#### <a name="uniformint64partition"></a>UniformInt64Partitie
...
#### <a name="namedpartition"></a>Benoemde Partitie
...
## <a name="scalingpolicymechanismgroup-group"></a>Groep ScalingPolicyMechanismGroup
Hiermee definieert u het schalingsmechanisme.
...
#### <a name="instancecountscalingmechanism"></a>InstanceCountScalingMechanism InstanceCountScalingMechanism
...
## <a name="scalingpolicytriggergroup-group"></a>Groep ScalingPolicyTriggerGroup
Hiermee definieert u de schaaltrigger.
...
#### <a name="averagepartitionloadscalingtrigger"></a>GemiddeldepartitionloadScalingTrigger
...
#### <a name="averageserviceloadscalingtrigger"></a>GemiddeldeServiceLoadScalingTrigger
