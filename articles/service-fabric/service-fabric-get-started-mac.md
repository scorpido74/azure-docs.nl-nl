...
1. Werk de configuratie van de Docker-daemon op uw host bij met de volgende instellingen en start de Docker-daemon opnieuw op: 
    ...
    >[!NOTE]
    >
    >Het wijzigen van de daemon rechtstreeks in docker is aanbevolen omdat de locatie van het bestand daemon. json kan variëren van computer naar machine. Bijvoorbeeld, ~/Library/Containers/com.docker.docker/Data/database/com.docker.driver.amd64-linux/etc/docker/daemon.json.
    >
