...
Als u een stateless service wilt maken, moet u een `InstanceCount`definiëren. Met het aantal instanties wordt het aantal exemplaren gedefinieerd van de toepassings logica van de stateless service die in het cluster moet worden uitgevoerd. Het verhogen van het aantal exemplaren is de aanbevolen manier om een stateless service te schalen.
