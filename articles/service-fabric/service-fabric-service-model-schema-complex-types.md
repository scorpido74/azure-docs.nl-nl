---
title: Complexe typen Azure Service Fabric service model XML-schema
...
Sectie naam van de ConfigPackage-Settings.xml.
...
#### <a name="mountpoint"></a>Koppel punt
...
Als voor de container status controle is ingeschakeld en er docker-rapporten health_status gebeurtenis voor deze container, wordt deze in Service Fabric opgenomen als onderdeel van de door het systeem gemelde status. Als health_status een slechte status heeft Service Fabric wordt een status waarschuwing gerapporteerd. Deze waarde is standaard ingesteld op waar.
...
Als voor de container status controle is ingeschakeld en er docker-rapporten health_status gebeurtenis voor deze container Service Fabric, wordt de container opnieuw gestart wanneer health_status gerapporteerd door docker is beschadigd.
...
## <a name="containerhostentrypointtype-complextype"></a>ContainerHostEntryPointType complex type
...
Gebruik de standaard referenties voor de opslag plaats die zijn opgegeven in clusterManifest.xml in plaats van de referenties die zijn opgegeven in de tag ' RepositoryCredentials ' in ApplicationManifest.xml.
...
## <a name="containernetworkpolicytype-complextype"></a>ContainerNetworkPolicyType complex type
...
## <a name="dllhostentrypointtype-complextype"></a>DllHostEntryPointType complex type
...
Met deze waarde wordt de beveiliging van de waarde van het kenmerk gedefinieerd. Het kan SecretsStoreRef/versleuteld/niet-leesbaar zijn.
Als deze eigenschap is ingesteld op SecretsStoreRef, verwijst de waarde naar een geheim dat is opgeslagen in de SecureStore van het cluster, waarnaar wordt verwezen tijdens de activering.
...
#### <a name="port"></a>Poort
De poort wordt vervangen door de poort die wordt bepaald door Microsoft Azure Service Fabric na de registratie bij Http.sys of BFE.
...
Het type voor de omgevings variabele. Dit kan tekst zonder opmaak/versleuteld/SecretsStoreRef zijn.
...
## <a name="exehostentrypointtype-complextype"></a>ExeHostEntryPointType complex type
...
|---|---|
|naam|Parameter|
|type|[Parameter type](#parametertype-complextype)|
|minOccurs|1|
|maxOccurs|unbounded|
...
Deze waarde bepaalt het type wacht woord dat u hebt opgegeven in het kenmerk ' wacht woord '. Dit kan SecretsStoreRef/versleuteld/niet-leesbaar zijn.
Als deze is ingesteld op SecretsStoreRef, halen we de referentie waarde op uit de SecretStore.
Indien ingesteld op versleuteld, is de ontwikkelaar van de toepassing verantwoordelijk voor het maken van een certificaat en het gebruik van de cmdlet invoke-ServiceFabricEncryptSecret om gevoelige informatie te versleutelen.
...
## <a name="runaspolicytype-complextype"></a>RunAsPolicyType complex type
...
```
## <a name="securityaccesspolicytype-complextype"></a>SecurityAccessPolicyType complex type
...
## <a name="serviceandservicegrouptypestype-complextype"></a>ServiceAndServiceGroupTypesType complex type
...
## <a name="servicefabricruntimeaccesspolicytype-complextype"></a>ServiceFabricRuntimeAccessPolicyType complex type
...
Door de gebruiker gedefinieerde type-id voor een service groep, bijvoorbeeld ' ActorQueueSGType '. Deze waarde wordt in het ApplicationManifest.xml-bestand gebruikt om de service groep te identificeren.
...
#### <a name="packagesharingpolicy"></a>Packages haring Policy
...
## <a name="servicepackagecontainerpolicytype-complextype"></a>ServicePackageContainerPolicyType complex type
...
#### <a name="servicetypename"></a>ServiceTypeName
Door de gebruiker gedefinieerde type-id voor een service. Bijvoorbeeld ' queue type ' of ' CalculatorType '. Deze waarde wordt in het ApplicationManifest.xml-bestand gebruikt om de service te identificeren.
...
## <a name="statefulservicegrouptype-complextype"></a>StatefulServiceGroupType complex type
...
```
## <a name="statelessservicegrouptype-complextype"></a>StatelessServiceGroupType complex type
