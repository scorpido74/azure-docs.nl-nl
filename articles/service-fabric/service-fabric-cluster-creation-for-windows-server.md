...
1. De telemetrie-pijp lijn probeert de volgende gegevens eenmaal per dag te uploaden naar [https://vortex.data.microsoft.com/collect/v1](https://vortex.data.microsoft.com/collect/v1) . Het is een upload van het hoogste aantal en heeft geen invloed op de functionaliteit van het cluster. De telemetrie wordt alleen verzonden vanuit het knoop punt dat de primaire failover Manager uitvoert. Geen andere knoop punten verzenden telemetrie.
