...
1. Open het */voting/VotingDataService/src/statefulservice/VotingDataService.java* -bestand in Verkenner. Stel een onderbrekings punt in op de eerste regel code in het `try` blok in de methode `addItem` (regel 80).
