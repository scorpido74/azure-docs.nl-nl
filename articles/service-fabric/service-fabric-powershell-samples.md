...
description: Meer informatie over het maken en beheren van Azure-Service Fabric clusters,-apps en-services met behulp van Power shell.
ms.topic: sample
ms.date: 11/29/2018
ms.custom: mvc
...
---
# <a name="azure-service-fabric-powershell-samples"></a>Voor beelden van Azure Service Fabric Power shell
