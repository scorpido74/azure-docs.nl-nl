...
description: Zelfstudie over het gebruik van toepassingscontracten in Azure Blockchain Workbench Preview.
ms.date: 10/14/2019
ms.topic: tutorial
ms.reviewer: brendal
