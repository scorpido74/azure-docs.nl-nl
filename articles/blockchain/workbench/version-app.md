---
title: 'Block Chain-toepassings versie: Azure Block Chain workbench'
...
1. Ga in een webbrowser naar het webadres van Blockchain Workbench, Voor beeld: `https://{workbench URL}.azurewebsites.net/` Zie [Block Chain Workbench web URL](deploy.md#blockchain-workbench-web-url) voor informatie over het vinden van uw Block Chain Workbench-webadres
