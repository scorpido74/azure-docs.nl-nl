...
* Proxy servers configureren (indien nodig)
  ...
  1. Pas de configuratie van de proxy server toe op de pagina**algemene installatie** van het **cluster** > of de detail pagina van de **core-bestands groep** .
...
Als u de communicatie van Cluster beheer wilt versleutelen, gebruikt u de pagina Algemene instellingen voor **cluster** > **installatie** om te selecteren welk certificaat moet worden gebruikt voor het beheer van TLS.
...
![Cluster Round-Robin DNS-diagram-gedetailleerde ALT-tekst koppeling](media/fxt-cluster-config/fxt-rrdns-diagram.png) 
onderstaande afbeelding[gedetailleerde tekst beschrijving](https://azure.github.io/Avere/legacy/Azure-FXT-EdgeFilerDNSconfiguration-alt-text.html)
...
Geef de DNS-server op die het cluster gebruikt op de pagina **cluster** > **beheer netwerk** instellingen. De instellingen op die pagina zijn onder andere:
