...
| Alert type | Enterprise Agreement | Microsoft-klantovereenkomst | Web direct/Pay-As-You-Go |
|---|---|---|---|
| Budget | ✔ | ✔ | ✔ |
| Tegoed | ✔ |✘ | ✘ |
...
When you view the details of a dismissed alert, you can reactivate it if manual action is needed. In de volgende afbeelding ziet u een voorbeeld.
