...
| **Field name** | **Beschrijving** | **Partner Center equivalent** |
| --- | --- | --- |
...
| meterRegion | De datacenterlocatie voor bepaalde services waarbij de prijs is gebaseerd op de datacenterlocatie. | The regional location of a data center for services, where applicable and populated. |
...
| Termijn | Hiermee wordt de geldigheidstermijn van de aanbieding weergegeven. For example, reserved instances show 12 months of a yearly term of the reserved instance. For one-time purchases or recurring purchases, the term displays one month for SaaS, Azure Marketplace, and support. Not applicable for Azure consumption. | N/A |
...
| Locatie | Normalized location of the resource. | N/A |
...
| Hoeveelheid | Measured quantity purchased or consumed. The amount of the meter used during the billing period. | Number of units. Ensure it matches the information in your billing system during reconciliation. |
...
| additionalInfo | Servicespecifieke metagegevens. Bijvoorbeeld een installatiekopie voor een virtuele machine. | Any additional information not covered in other columns. The service-specific metadata. Bijvoorbeeld een installatiekopie voor een virtuele machine.|
...
Then, call the asynchronous operation property value. Bijvoorbeeld:
