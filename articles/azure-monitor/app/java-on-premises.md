...
Volg [de gedetailleerde instructies](./java-in-process-agent.md) voor alle omgevingen, waaronder on-premises.

 ## <a name="next-steps"></a>Volgende stappen

* [De instructies voor het downloaden van de Java-Agent ophalen](./java-in-process-agent.md)
