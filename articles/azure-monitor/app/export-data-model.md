...
| context. device. onmedium |tekenreeks |Host-besturings systeem |
...
| context. locatie. plaats |tekenreeks |Afgeleid van client, indien bekend |
...
| context.operation.id |tekenreeks |Items met dezelfde bewerkings-id worden weer gegeven als gerelateerde items in de portal. Doorgaans de aanvraag-id. |
...
| internal.data.id |tekenreeks | De unieke id die wordt toegewezen wanneer een item wordt opgenomen in Application Insights |
...
| id van aanvraag [0] |tekenreeks |Bewerkings-id |
