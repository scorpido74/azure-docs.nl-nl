...
### <a name="create-a-telemetry-processor-c"></a>Een telemetrie-processorC#maken ()
...
### <a name="java-telemetry-initializers"></a>Initialisatie functies voor Java-telemetrie

[Documentatie voor Java SDK](https://docs.microsoft.com/java/api/com.microsoft.applicationinsights.extensibility.telemetryinitializer?view=azure-java-stable)
...
Registreer vervolgens de aangepaste initialisatie functie in uw applicationinsights. XML-bestand.
...
Telemetriegegevens in opentellingen python zijn eenvoudigweg call back-functies die worden aangeroepen om telemetriegegevens te verwerken voordat ze worden geëxporteerd. De call back-functie moet een gegevens type [envelop](https://github.com/census-instrumentation/opencensus-python/blob/master/contrib/opencensus-ext-azure/opencensus/ext/azure/common/protocol.py#L86) accepteren als para meter. Als u het exporteren van telemetrie wilt uitfilteren, moet u ervoor zorgen dat de call back-functie `False`retourneert. U kunt het schema voor Azure Monitor gegevens typen weer geven in de enveloppen [.](https://github.com/census-instrumentation/opencensus-python/blob/master/contrib/opencensus-ext-azure/opencensus/ext/azure/common/protocol.py)
