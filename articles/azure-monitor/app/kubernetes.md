...
> [!IMPORTANT]
> Deze functionaliteit is momenteel beschikbaar als open bare preview.
...
> [!NOTE]
> Omdat Service-Mesh gegevens uit de kabel opneemt, kunnen we het versleutelde verkeer niet onderscheppen. Gebruik een niet-versleuteld Protocol (bijvoorbeeld HTTP) voor verkeer dat het cluster niet verlaat. Voor extern verkeer dat moet worden versleuteld, kunt u [SSL-beëindiging instellen](https://kubernetes.io/docs/concepts/services-networking/ingress/#tls) bij de ingangs controller.
