...
> De momenteel aanbevolen versie werkt alleen voor [Java via een zelfstandige agent](https://docs.microsoft.com/azure/azure-monitor/app/java-in-process-agent).
