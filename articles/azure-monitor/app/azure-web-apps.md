...
ms.locfileid: "74230303"
---
# <a name="monitor-azure-app-service-performance"></a>Monitor Azure App Service performance
...
## <a name="automate-monitoring"></a>Automate monitoring
...
|App setting name |  Definitie | Waarde |
|-----------------|:------------|-------------:|
