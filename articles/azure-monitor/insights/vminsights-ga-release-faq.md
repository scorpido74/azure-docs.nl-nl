...
description: Azure Monitor voor VM's is een oplossing in azure met een combi natie van de status-en prestatie bewaking van het besturings systeem van de virtuele machine van Azure, en voor het automatisch detecteren van toepassings onderdelen en afhankelijkheden met andere resources en het toewijzen van de communicatie tussen de toepassingen. In dit artikel vindt u antwoorden op veelgestelde vragen over de GA-versie.
ms.subservice: ''
ms.topic: conceptual
author: bwren
ms.author: bwren
...
We hebben in januari 2020 een nieuwe versie van Azure Monitor voor VM's uitgebracht, vóór onze GA aankondiging. Klanten die Azure Monitor voor VM's inschakelen, ontvangen nu de GA-versie, maar bestaande klanten die gebruikmaken van de versie van Azure Monitor voor VM's van Q4 2019 en eerder, worden gevraagd om te upgraden. Deze veelgestelde vragen bieden richt lijnen voor het uitvoeren van een upgrade op schaal als u grote implementaties in meerdere werk ruimten hebt.
