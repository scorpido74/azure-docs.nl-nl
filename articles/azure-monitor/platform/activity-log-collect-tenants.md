---
title: Activiteiten logboeken voor meerdere tenants in Azure Monitor
...
1. Selecteer in de Azure Portal **een resource maken**  >  **Internet of Things**  >  **Event hubs**.
...
1. Selecteer in het Azure Portal **Monitor**  >  **activiteiten logboek**controleren.
...
- Een trigger voor een [Event Hub connector](/connectors/eventhubs/) om te lezen vanuit de Event Hub.
...
1. Kies in het Azure Portal **een resource maken**  >  **bedrijfsintegratie**  >  **logische app**.
...
De [Azure log Analytics Data Collector](/connectors/azureloganalyticsdatacollector/) -actie neemt het object van de actie opstellen op en verzendt het naar een log Analytics-werk ruimte.
