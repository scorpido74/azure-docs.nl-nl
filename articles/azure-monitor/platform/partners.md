...
[Meer informatie.](https://www.servicenow.com/solutions/aiops.html)
...
SquaredUp voor Azure maakt het eenvoudig om uw Azure-toepassingen netter te visualiseren. Het biedt u real-time, interactieve Dash boards. U kunt inzoomen op abonnementen, resource groepen, tags en individuele resources om de metrische gegevens te bekijken, zoals CPU, de meeste binnenkomende verbindingen, Application Insights reactie tijd, de totale kosten en de status van de samen vatting, en een detail analyse te maken om de gerelateerde informatie te bekijken, zoals waarschuwingen, Log Analytics gebeurtenissen, meer gedetailleerde metrische gegevens of om gerelateerde informatie te bekijken uit de andere hulpprogram ma's die , Dynatrace, PagerDuty of Pingdom bijvoorbeeld.  U kunt uw eigen Dash boards aanpassen, publiceren en delen met individuen of op intranet pagina's. 

[Meer informatie.](https://squaredup.com/)
