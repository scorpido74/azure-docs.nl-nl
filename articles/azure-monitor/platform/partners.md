...
Circonus is een micro Services-bewakings-en analyse platform dat is gebouwd voor on-premises of SaaS-implementaties. Het is volledig geautomatiseerde API-georiënteerd platform is beter schaalbaar en betrouwbaarder dan systemen die worden bewaakt. Circonus is ontwikkeld voor de vereisten van DevOps en biedt waarschuwingen op basis van percentiel, grafieken, Dash boards en machine learning-informatie die bedrijfs optimalisatie mogelijk maakt. Circonus controleert uw Microsoft Azure cloud resources en hun toepassingen in realtime. U kunt Circonus gebruiken voor het verzamelen en bijhouden van metrische gegevens voor de variabelen die u wilt meten voor uw resources en toepassingen. Met Circonus krijgt u inzicht in het resource gebruik van Azure, de prestaties van toepassingen en de operationele status.
...
Het Microsoft Azure DSM en Microsoft Azure Event hub-protocol kunnen worden gedownload via [de website van IBM-ondersteuning](https://www.ibm.com/support). Informatie over [de integratie mat Azure vindt u hier][qradar-doc].
...
[turbonomic-doc]: https://turbonomic.com/solutions/technologies/azure-cloud/ "Introductie van Turbonomic."
