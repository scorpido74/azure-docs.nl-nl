...
U kunt een nieuwe faciliteit toevoegen door de naam ervan te typen en op **+** te klikken. Voor elke faciliteit worden alleen berichten met de geselecteerde Ernst verzameld.  Controleer de ernst van de specifieke faciliteit die u wilt verzamelen. U kunt geen aanvullende criteria opgeven om berichten te filteren.
...
| Hostnaam |De naam van het systeem dat het bericht verzendt. |
...
| Syslog &#124; samenvatten AggregatedValue = Count () per computer |Aantal syslog-records per computer. |
| Syslog &#124; samenvatten AggregatedValue = Count () per faciliteit |Aantal syslog-records per faciliteit. |
