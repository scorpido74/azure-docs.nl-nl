...
* [Lees het overzicht van het Azure-activiteiten logboek](./platform-logs-overview.md)
* [Een waarschuwing instellen op basis van een gebeurtenis in een activiteiten logboek](./alerts-log-webhook.md)
