...
![Para meter toevoegen](media/view-designer-conversion-tasks/add-parameter.png)
...
Para meters kunnen worden gebruikt in query's door accolades toe {} om de naam van de para meter. Meer informatie over para meters vindt u in de [werkmappen-documentatie over para meters](https://github.com/microsoft/Application-Insights-Workbooks/blob/master/Documentation/Parameters/Parameters.md).
...
Het resulterende raster ziet er ongeveer als volgt uit: ![sparkline voor beeld](media/view-designer-conversion-tasks/sparkline-example.png)
...
- [Tegel conversies](view-designer-conversion-tiles.md)
