...
| --- | --- | --- |
| operation |ja |de waarde moet ' Scale ' zijn |
...
| properties |ja |de waarde moet leeg zijn {} of sleutel-waardeparen kunnen bevatten |
...
| operation |ja |Voor een verhoging van de instanties wordt het ' uitschalen ' en voor een afname van de instanties de waarde ' schaalt in ' |
