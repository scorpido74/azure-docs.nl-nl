...
Zie [overzicht van het Azure-activiteiten logboek](./platform-logs-overview.md)voor specifieke schema Details over alle andere waarschuwingen voor activiteiten Logboeken.
