...
ms.locfileid: "84803929"
---
# <a name="format-of-azure-monitor-resource-logs-archived-to-a-storage-account"></a>Indeling van Azure Monitor bron logboeken die zijn gearchiveerd in een opslag account
...
* De BLOB-indeling wordt gewijzigd voor alle diagnostische instellingen in alle abonnementen tegelijk. Voor de eerste PT1H.jsvan het bestand dat voor 1 november wordt verzonden, wordt deze nieuwe indeling gebruikt. De namen van de BLOB en de container blijven hetzelfde.
