...
|DataProcessed|Verwerkte gegevens|Bytes|Totaal|Hoeveelheid gegevens waarmee de firewall wordt gepasseerd|Geen dimensies|
|FirewallHealthState|Status van Firewall|Procent|Average|Hiermee wordt de status van de firewall aangegeven|Status, reden|
|SNATPortUtilization|Gebruik van SNAT-poort|Procent|Average|Het percentage SNAT-poorten dat door de firewall is gebruikt|Geen dimensies|
...
|Percentage processor tijd van Average_|Percentage processor tijd|Aantal|Average|Percentage processor tijd van Average_|Computer, ObjectName, INSTANCENAME, CounterPath, hebben|
...
|diff_backup_size_bytes|Grootte van differentiële back-upopslag|Bytes|Maximum|Cumulatieve differentiële back-upopslag. Is van toepassing op Algemeen en Bedrijfskritiek-data bases. Is momenteel niet van toepassing op instantie-data bases beheren.|Geen dimensies|
...
|full_backup_size_bytes|Opslag grootte voor volledige back-up|Bytes|Maximum|Cumulatieve opslag grootte voor volledige back-ups. Is van toepassing op Algemeen en Bedrijfskritiek-data bases. Is momenteel niet van toepassing op instantie-data bases beheren.|Geen dimensies|
...
|log_backup_size_bytes|Opslag grootte van logboek back-up|Bytes|Maximum|Cumulatieve opslag grootte van logboek back-up. Is van toepassing op Algemeen en Bedrijfskritiek-data bases. Is momenteel niet van toepassing op instantie-data bases beheren.|Geen dimensies|
