...
## <a name="cli"></a>CLI
Gebruik [AZ monitor Activity-Log](../samples/cli-samples.md#view-activity-log-for-a-subscription) om het activiteiten logboek op te halen uit de cli. Hier volgen enkele algemene voor beelden.
