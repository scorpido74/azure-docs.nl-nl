...
| Azure Storage | Exporteer het activiteiten logboek naar Azure Storage voor het archiveren. | [Activiteiten logboek archiveren](./resource-logs.md#send-to-azure-storage)  |
| Event Hubs | Het activiteiten logboek streamen naar andere locaties met Event Hubs | [Activiteiten logboek streamen naar Event hub](./resource-logs.md#send-to-azure-event-hubs). |
...
| Service | Doel | Description | Referentie |
|:---|:---|:---|:---|
