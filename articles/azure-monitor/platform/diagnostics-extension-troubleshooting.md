...
Als de resource-id onjuist is, controleert u de para meters voor de **configuratie**van de **Diagnostische gegevens** en  >  **Metrics**  >  **ResourceId** bekijkt u of de resource-id juist is ingesteld.
...
```
Er wordt een nieuw bestand `<relevantLogFile>.csv` met de naam gemaakt in hetzelfde pad als het bijbehorende `.tsf` bestand.
