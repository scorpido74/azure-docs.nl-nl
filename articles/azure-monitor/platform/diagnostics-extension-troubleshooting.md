...
De bewakings agent verzamelt logboeken en artefacten als `.tsf`-bestanden. Het `.tsf` bestand kan niet worden gelezen, maar u kunt het als volgt converteren naar een `.csv`:
