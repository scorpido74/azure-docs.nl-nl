...
ms.locfileid: "84234476"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-monitor"></a>Ingebouwde Azure Policy-beleidsdefinities voor Azure Monitor

Deze pagina is een index van ingebouwde [Azure Policy](../../governance/policy/overview.md)-beleidsdefinities voor Azure Monitor. Zie [Ingebouwde Azure Policy-definities](../../governance/policy/samples/built-in-policies.md) voor aanvullende ingebouwde modules voor Azure Policy voor andere services.
