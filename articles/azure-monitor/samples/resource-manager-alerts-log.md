...
## <a name="number-of-results-alert-rule"></a>Waarschuwingsregel voor aantal resultaten
Met het volgende voorbeeld wordt een [waarschuwingsregel voor aantal resultaten](../platform/alerts-unified-log.md#metric-measurement-alert-rules) gemaakt.
...
## <a name="metric-measurement-alert"></a>Waarschuwing voor metrische gegevens
Met het volgende voorbeeld wordt een [waarschuwingsregel voor metrische gegevens](../platform/alerts-unified-log.md#metric-measurement-alert-rules) gemaakt.
