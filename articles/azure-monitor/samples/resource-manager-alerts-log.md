---
title: Resource Manager-voorbeeldsjablonen voor logboekquerywaarschuwingen
description: Azure Resource Manager-voorbeeldsjablonen voor het implementeren van Azure Monitor-logboekquerywaarschuwingen.
ms.subservice: logs
ms.topic: sample
author: bwren
ms.author: bwren
...
## <a name="number-of-results-template-up-to-version-2018-04-16"></a>Aantal resultaten-sjabloon (tot versie 2018-04-16)
Met het volgende voorbeeld wordt een [waarschuwingsregel voor aantal resultaten](../platform/alerts-unified-log.md#count-of-the-results-table-rows) gemaakt.

### <a name="notes"></a>Opmerkingen

- Dit voorbeeld bevat een [webhookpayload](../platform/alerts-log-webhook.md). Als de waarschuwingsregel geen webhook moet activeren, verwijdert u het element **customWebhookPayload**.
...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Metrische meting-sjabloon (tot versie 2018-04-16)
Met het volgende voorbeeld wordt een [waarschuwingsregel voor metrische gegevens](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value) gemaakt.
...
## <a name="template-for-all-resource-types-from-version-2020-05-01-preview"></a>Sjabloon voor alle brontypen (vanaf versie 2020-05-01-preview)
In het volgende voorbeeld wordt een regel gemaakt die elke resource als doel kan hebben.
