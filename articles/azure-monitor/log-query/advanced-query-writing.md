...
Gebruik `let` om resultaten toe te wijzen aan een variabele en Raadpleeg deze verderop in de query:
...
met `datatable` kunt u een set gegevens definiëren. U geeft een schema en een set waarden op en vervolgens de tabel in alle andere query-elementen. U kunt bijvoorbeeld een tabel met RAM-gebruik maken en de gemiddelde waarde per uur berekenen:
