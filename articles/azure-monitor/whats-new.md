...
- [Azure monitor door de klant beheerde sleutel](./platform/customer-managed-keys.md) toegevoegd voor asynchrone bewerkingen
- [Beheer log Analytics-werk ruimten in azure monitor](./platform/manage-access.md) -bijgewerkte secties met aangepaste Logboeken.

### <a name="alerts"></a>Waarschuwingen

- [Actie regels voor door Azure monitor waarschuwingen](./platform/alerts-action-rules.md) toegevoegde video.
- [Overzicht van waarschuwings-en meldings bewaking in door Azure](./platform/alerts-overview.md) toegevoegde video.

### <a name="application-insights"></a>Application Insights

- [Toepassings toewijzing in azure-toepassing Insights](./app/app-map.md) -Cloud rolnaams configuratie voor de Java-Agent is toegevoegd.
- [Azure-toepassing Insights-API](./app/status-monitor-v2-api-reference.md) -referentie voor .net-agents-geconsolideerde API-verwijzing.
- [IP-adressen die worden gebruikt door Application Insights en log Analytics](./app/ip-addresses.md) geactualiseerde IP-adressen voor app Insights-en log Analytics-api's, webhooks voor actie groepen, Azure Amerikaanse overheid.
- [Java-toepassingen overal bewaken](./app/java-standalone-config.md) -nieuw artikel
- [Java-toepassingen bewaken in elke omgeving](./app/java-in-process-agent.md) -nieuw artikel
- [Java-toepassingen bewaken die worden uitgevoerd in een omgeving](./app/java-standalone-arguments.md) -nieuw artikel
- [Java-toepassingen bewaken die on-premises worden uitgevoerd](./app/java-on-premises.md) -nieuw artikel
- [Application Insights verwijderen in Visual Studio](./app/remove-application-insights.md) -nieuw artikel
- [Telemetrie-bemonstering in azure-toepassing Insights](./app/sampling.md) -correctie in het voor beeld met een vaste frequentie in python.

### <a name="containers"></a>Containers

- [Azure Red Hat open Shift v4. x configureren met Azure monitor voor containers](./insights/container-insights-azure-redhat4-setup.md) -nieuw artikel
- [ServiceNow Sync-problemen hand matig oplossen](./platform/itsmc-resync-servicenow.md) -nieuw artikel
- [Stoppen met het bewaken van uw Azure en Red Hat open Shift v4-cluster](./insights/container-insights-optout-openshift-v4.md) -nieuw artikel
- Het [bewaken van uw Azure Red Hat open Shift v3-cluster beëindigen](./insights/container-insights-optout-openshift-v3.md) -nieuw artikel
- [Stoppen met het bewaken van uw hybride Kubernetes-cluster](./insights/container-insights-optout-hybrid.md) -nieuw artikel

### <a name="insights"></a>Inzichten

- [Azure-sleutel kluizen controleren met Azure monitor voor sleutel kluizen (preview)](./insights/key-vault-insights-overview.md) -nieuw artikel

### <a name="logs"></a>Logboeken

- [Azure Monitor service limieten](./service-limits.md) -toegevoegde gebruikers query beperking.
- Het [gebruik en de kosten voor Azure monitor logboeken beheren](./platform/manage-cost-storage.md) -facturering voor logboek clusters. Er is een Kusto-query toegevoegd waarmee klanten met een verouderde prijs categorie per knoop punt kunnen bepalen of ze moeten worden verplaatst naar een reserverings laag per GB of capaciteit.

### <a name="metrics"></a>Metrische gegevens

- [Geavanceerde functies van Azure Metrics Explorer](./platform/metrics-charts.md) toegevoegde aggregatie sectie.

### <a name="workbooks"></a>Werkmappen

- [Azure monitor werkmappen en Azure Resource Manager sjablonen](./platform/workbooks-automate.md) -Resource Manager-sjabloon voor het implementeren van een werkmap sjabloon toevoegen.

## <a name="march-2020"></a>Maart 2020

### <a name="general"></a>Algemeen

- [Overzicht van Azure monitor](./overview.md) : Azure monitor overzichts video is toegevoegd.
- [Azure monitor door de klant beheerde sleutel configuratie](./platform/customer-managed-keys.md) -algemene updates.
- [Azure monitor gegevens referentie](/azure/azure-monitor/reference/) -nieuwe site.

### <a name="alerts"></a>Waarschuwingen

- [Waarschuwingen voor activiteiten logboek maken, weer geven en beheren in azure monitor](./platform/alerts-activity-log.md) -aanvullende uitleg van de Resource Manager-sjabloon.
- [Begrijpen hoe metrische waarschuwingen werken in Azure Monitor.](./platform/alerts-metric-overview.md) -Bijgewerkt voor overheids ondersteuning.
- [Problemen met Azure monitor waarschuwingen en meldingen oplossen](./platform/alerts-troubleshoot.md) -nieuw artikel

### <a name="application-insights"></a>Application Insights

- [Automatiseer Azure-toepassing Insights met Power shell](./app/powershell.md) toegevoegde ARMClient-voor beelden.
- [Continue export van telemetrie van Application Insights](./app/export-telemetry.md) -tabel toevoegen met details van de export structuur.
- [Schakel snapshot debugger voor .net-apps in azure app service](./app/snapshot-debugger-appservice.md) toegevoegde Resource Manager-sjabloon voor beeld in.
- Het [gebruik en de kosten voor Azure-toepassing inzichten](./app/pricing.md) -informatie over gegevens limieten beheren.
- [Bewaak python-toepassingen met Azure monitor (preview)](./app/opencensus-python.md) -toegevoegde standaard metrische gegevens.
- [Ondersteuning voor bron toewijzing voor Java script-toepassingen-Azure Monitor Application Insights](./app/source-map-support.md) -nieuw artikel.

### <a name="containers"></a>Containers

- [Azure monitor Veelgestelde vragen](./faq.md) : Update voor Azure monitor voor containers.
...
- [Optimaliseer logboek query's in](./log-query/query-optimization.md) een door Azure monitor toegevoegde CPU-voor waarde voor XML en JSON-parsering.
- [Azure log Analytics-werk ruimte verwijderen en herstellen](./platform/delete-workspace.md) : toegevoegde probleem oplossing.
- [Gebruik Azure monitor-logboeken met Azure Logic apps en energie automatisering](./platform/logicapp-flow-connector.md) -bijgewerkt voor nieuwe Azure monitor connector.

### <a name="metrics"></a>Metrische gegevens

- [Afschaffing van de metrische schijf gegevens in het Azure Portal](./platform/portal-disk-metrics-deprecation.md) -nieuw artikel.
- [Zelf studie: een grafiek met metrische gegevens maken in azure monitor](./learn/tutorial-metrics-explorer.md) toegevoegde video.

### <a name="platform-logs"></a>Platformlogboeken

- [Verzamel en analyseer Azure-activiteiten logboek in azure monitor](./platform/activity-log-collect.md) -herschrijven om het verzamelen van activiteiten logboek met Diagnostische instellingen beter te verklaren.

### <a name="virtual-machines"></a>Virtuele machines

- [Virtuele Azure-machines bewaken met Azure monitor](./insights/monitor-vm-azure.md) -nieuw artikel.
- [Snelstartgids: virtuele machines van Azure bewaken met Azure monitor](./learn/quick-monitor-azure-vm.md) -bijgewerkt om Azure monitor voor VM's toe te voegen.
- [Waarschuwingen van Azure monitor voor VM's](./insights/vminsights-alerts.md) -nieuw artikel
- [Azure monitor voor VM's overzicht inschakelen](./insights/vminsights-enable-overview.md) : bijgewerkte koppelingen naar agent downloaden.

Algemene updates voor algemene Beschik baarheid van Azure Monitor voor VM's
...
- [Azure Monitor voor VM's inschakelen met behulp van Azure Policy](./insights/vminsights-enable-at-scale-policy.md) 
- [Prestaties van grafieken met Azure Monitor voor VM's](./insights/vminsights-performance.md)
- [Logboeken van Azure Monitor voor VM's opvragen](./insights/vminsights-log-search.md)
- [App-afhankelijkheden met Azure Monitor voor VM's weer geven](./insights/vminsights-maps.md) 

### <a name="visualizations"></a>Visualisaties

- [Gegevens visualiseren van Azure monitor](./visualizations.md) -bijgewerkt om de geplande afschaffing van de weer gave-Designer te noteren.
...
- [Diagnostische gegevens opslaan en weer geven in azure Storage](../cloud-services/diagnostics-extension-to-storage.md) -volledig herschreven en bijgewerkt.
...
- [Application Insights voor Worker-service-apps (niet-http-apps)](./app/worker-service.md) -standaard logboek registratie niveau toegevoegd aan C#-code. Bijgewerkte pakket referentie versie.
...
- Als u een bijdrage wilt leveren aan Azure Monitor documentatie, raadpleegt u de [hand leiding voor docs-inzenders](/contribute/).
