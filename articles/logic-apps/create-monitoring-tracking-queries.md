...
1. Beginnen met een lege query of beschik bare bestaande query's.
   ...
   * Als u wilt controleren of er bestaande query's beschikbaar zijn, selecteert u op de werk balk van de query de optie **query's** > **geschiedenis**, waarin query's van eerdere query's worden uitgevoerd, of selecteer **query Verkenner**, waarin vooraf gedefinieerde query's worden weer gegeven.
