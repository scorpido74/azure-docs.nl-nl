...
## <a name="add-condition"></a>Voor waarde toevoegen
...
1. Voeg een voor waarde toe op de gewenste locatie. 
   ...
   Wanneer u aan het einde van uw werk stroom een voor waarde wilt toevoegen, kiest u **nieuwe stap** > **een actie toevoegen**aan de onderkant van uw logische app.

1. Voer in het zoekvak ' condition ' in als uw filter. Selecteer deze actie: **voor waarde controle**

   ![Voor waarde toevoegen](./media/logic-apps-control-flow-conditional-statement/add-condition.png)
...
1. Bouw uw voor waarde in het vak **voor de voor waarde** . 
   ...
   Als u een andere rij wilt toevoegen aan uw voor waarde, kiest u **toevoegen** > **rij toevoegen**. 
