...
* [Zelf studie: doorlopende integratie voor Azure Resource Manager sjablonen met Azure-pijp lijnen](../azure-resource-manager/templates/template-tutorial-use-azure-pipelines.md)
