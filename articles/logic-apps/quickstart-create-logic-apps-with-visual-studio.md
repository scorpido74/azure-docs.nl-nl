...
1. Zoek in het dialoog venster **resource toevoegen** in het zoekvak `logic app`en selecteer een **logische app**. Geef de logische app een naam en selecteer **toevoegen**.
