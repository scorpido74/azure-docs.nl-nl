...
Als u een bovenliggende/onderliggende relatie tot stand hebt gebracht voor dit downstream-apparaat (vereist voor X. 509-verificatie, maar optioneel voor symmetrische-sleutel verificatie), kunt u de connection string vereenvoudigen door de gateway rechtstreeks aan te roepen als de host van de verbinding. Bijvoorbeeld: 
