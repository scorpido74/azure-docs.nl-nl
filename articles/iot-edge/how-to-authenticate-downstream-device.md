...
Zie het voor beeld van een node. js-programma voor het verifiëren van IoT Hub met X. 509-certificaten, het voor beeld van de node. js IoT SDK [simple_sample_device_x509. js](https://github.com/Azure/azure-iot-sdk-node/blob/master/device/samples/simple_sample_device_x509.js) . Enkele van de belangrijkste regels van dit voor beeld zijn hier opgenomen om het verificatie proces te demonstreren.
