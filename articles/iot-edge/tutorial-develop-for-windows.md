...
* Een IoT Edge module-project met de naam **IotEdgeModule1**.
  * Het **Program.cs** -bestand bevat de standaard code van de C#-module die wordt geleverd met de project sjabloon. De standaard module maakt invoer van een bron en geeft deze door aan IoT Hub.
