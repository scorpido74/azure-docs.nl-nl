...
2. Kopieer de waarde van de **verbindings reeks (primaire sleutel)** of **verbindings reeks (secundaire sleutel)** .
...
De waarde voor de para meter `device-id` is hoofdletter gevoelig. Kopieer de aanhalings tekens rond het connection string niet.
