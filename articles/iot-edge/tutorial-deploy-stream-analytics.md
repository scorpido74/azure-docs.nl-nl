...
1. Op het tabblad **routes** definieert u hoe berichten worden door gegeven tussen modules en de IOT hub. Berichten worden gemaakt met behulp van naam/waarde-paren. Vervang de standaard `route` en `upstream` naam en waarden door de paren die in de volgende tabel worden weer gegeven, de volgende naam/waarde-paren, waarbij exemplaren van _{modulenaam}_ worden vervangen door de naam van de Azure stream Analytics module.
