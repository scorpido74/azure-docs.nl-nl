...
* Upload de volledige BLOB (met behulp van `Put Blob`-bewerking) en upload op blok niveau (met behulp van `Put Block`, `Put Block List` en `Append Block` bewerkingen).
