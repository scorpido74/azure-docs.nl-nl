---
title: Opties voor ondersteuning en hulp voor Azure IoT | Microsoft Docs
description: Help en ondersteuning krijgen voor vragen of problemen bij het maken van oplossingen met Azure IoT-services.
author: philmea
ms.author: phil
...
Als u nieuwe functies wilt aanvragen, plaatst u deze op Azure Feedback. Deel uw ideeën om Azure IoT-services te verbeteren voor de toepassingen die u ontwikkelt:

| Service                       | URL voor Azure Feedback |
|-------------------------------|---------------|
| Azure IoT (Hub, DPS, SDK's)                    | https://feedback.azure.com/forums/321918-azure-iot |
| Azure IoT Central             | https://feedback.azure.com/forums/911455-azure-iot-central |
| Azure IoT-apparaatcatalogus      | https://feedback.azure.com/forums/916948-azure-iot-device-catalog |
| Azure IoT Edge                | https://feedback.azure.com/forums/907045-azure-iot-edge |
| Azure IoT-oplossingsversnellers | https://feedback.azure.com/forums/916438-azure-iot-solution-accelerators |
...
Lees informatie over belangrijke productupdates, roadmap en aankondigingen in [Azure-updates](https://azure.microsoft.com/updates/?category=iot).

Nieuws en informatie over Azure IoT wordt gedeeld in de [Azure-blog](https://azure.microsoft.com/blog/topics/internet-of-things/) en op de [Internet of Things-show op Channel 9](https://channel9.msdn.com/Shows/Internet-of-Things-Show).

U kunt ook uw ervaringen delen, deelnemen en leren van experts in de [Techcommunity van Internet of Things](https://techcommunity.microsoft.com/t5/Internet-of-Things-IoT/ct-p/IoT).
