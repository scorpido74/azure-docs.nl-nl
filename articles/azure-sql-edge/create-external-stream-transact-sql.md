...
Azure SQL Edge ondersteunt momenteel alleen de volgende stream-invoer en-uitvoer.

**Stroom invoer**: Hiermee worden de verbindingen met een gegevens bron gedefinieerd waaruit de gegevens stroom moet worden gelezen
- Edge hub
- Kafka (ondersteuning voor Kafka-invoer is momenteel alleen beschikbaar voor Intel/AMD64-versies van Azure SQL Edge.)

**Uitvoer**van de stream: Hiermee worden de verbindingen met een gegevens bron gedefinieerd om de gegevens stroom naar te schrijven. 
- Edge hub
