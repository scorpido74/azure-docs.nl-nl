...
U moet een agent implementeren op een toegewezen Linux-machine (VM of on-premises) ter ondersteuning van de communicatie tussen Check Point en Azure Sentinel. In het volgende diagram worden de instellingen in het geval van een virtuele Linux-machine in azure beschreven.
...
## <a name="step-2-forward-check-point-logs-to-the-syslog-agent"></a>STAP 2: controle punt logboeken naar de syslog-agent sturen
