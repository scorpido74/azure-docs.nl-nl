---
title: Een groep maken waarvoor schijf versleuteling is ingeschakeld
...
ms.locfileid: "89038538"
---
# <a name="create-a-pool-with-disk-encryption-enabled"></a>Een groep maken waarvoor schijf versleuteling is ingeschakeld
...
![Scherm afbeelding van de configuratie optie voor schijf versleuteling in de Azure Portal.](./media/disk-encryption/portal-view.png)
...
![Scherm opname van de configuratie doelen van de schijf versleuteling in de Azure Portal.](./media/disk-encryption/disk-encryption-configuration-target.png)
