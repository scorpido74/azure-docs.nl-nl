...
* Script ondersteunt alleen Public Load Balancer upgrade. Voor interne basis Load Balancer-upgrade maakt u een standaard interne Load Balancer als uitgaande verbinding niet gewenst is en maakt u een standaard interne Load Balancer en standaard openbaar Load Balancer als de uitgaande verbinding is vereist.
