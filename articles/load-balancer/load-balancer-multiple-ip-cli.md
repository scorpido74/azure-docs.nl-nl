...
8. Maak uw back-mailadres groepen- *contosopool* en *fabrikampool*, een [test](../virtual-machines/linux/create-cli-complete.md?toc=%2fazure%2fvirtual-network%2ftoc.json) - *http*en uw regels voor taak verdeling- *HTTPc* en *HTTPf*:
