...
U kunt ook een [ha-poort](load-balancer-ha-ports-overview.md) maken Load Balancer regel met behulp van de onderstaande configuratie met Standard Load Balancer.
