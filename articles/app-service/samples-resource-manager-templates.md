...
|**App configureren**||
| [App-certificaat uit Key Vault](https://github.com/Azure/azure-quickstart-templates/tree/master/201-web-app-certificate-from-key-vault)| Hiermee wordt een App Service app-certificaat uit een Azure Key Vault geheim geïmplementeerd en gebruikt voor TLS/SSL-binding. |
...
| [App met aangepast domein en SSL](https://github.com/Azure/azure-quickstart-templates/tree/master/201-web-app-custom-domain-and-ssl)| Hiermee wordt een App Service-app met een aangepaste hostnaam geïmplementeerd en wordt een app-certificaat opgehaald van Key Vault voor TLS/SSL-binding. |
