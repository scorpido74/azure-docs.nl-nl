...
- Een bestaande TLS-binding verwijderen, bijvoorbeeld tijdens het vernieuwen van het certificaat (Zie [certificaat vernieuwen](configure-ssl-certificate.md#renew-certificate)).
