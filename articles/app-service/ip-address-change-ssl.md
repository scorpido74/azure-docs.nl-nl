...
1. Selecteer in de sectie SSL-bindingen de record met de hostnaam. In de editor die wordt geopend, kiest u **SNI SSL** in de vervolg keuzelijst **SSL-type** en klikt u op **binding toevoegen**. Wanneer het bericht geslaagde bewerking wordt weer gegeven, is het bestaande IP-adres vrijgegeven.
...
In dit artikel wordt uitgelegd hoe u een wijziging van een IP-adres voorbereidt die is geïnitieerd door Azure. Zie [SSL-en SSL-IP-adressen in azure app service](overview-inbound-outbound-ips.md)voor meer informatie over IP-adressen in azure app service.
