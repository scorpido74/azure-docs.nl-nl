...
Meer informatie over het binden van een aangepast SSL-certificaat aan App Service.

> [!div class="nextstepaction"]
> [Een SSL-certificaat binden aan Azure App Service](configure-ssl-bindings.md)
