...
Deze hand leiding bevat belang rijke concepten en instructies voor container opslag Linux-apps in App Service. Als u Azure App Service nog nooit hebt gebruikt, volgt u eerst de Snelstartgids en [zelf studie](tutorial-custom-container.md?pivots=container-linux) van de [aangepaste container](quickstart-custom-container.md?pivots=container-linux) . Er is ook een Snelstartgids en [zelf studie](tutorial-multi-container-app.md)voor [apps met meerdere containers](quickstart-multi-container.md) .
...
> [!NOTE]
> U kunt ook [uw eigen permanente opslag configureren](configure-connect-to-azure-storage.md?pivots=platform-linux).
