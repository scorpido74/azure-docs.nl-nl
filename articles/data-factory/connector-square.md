...
|:--- |:--- |:--- |
| type | De eigenschap type moet worden ingesteld op: **Square** | Ja |
| connectionProperties | Een groep eigenschappen die definieert hoe verbinding moet worden gemaakt met het kwadraat. | Ja |
