...
1. Open de werkset **Activiteiten** en vouw **Verplaatsen en transformeren** uit. Sleep de **gegevens kopiëren** activiteit vanuit de werkset **activiteiten** naar het ontwerp oppervlak voor pijp lijnen. U kunt ook zoeken naar activiteiten in de werkset **Activities**. Geef **CopyFromBlobToBlob** op bij **Naam**.
   ![het maken van een activiteit voor het kopiëren van gegevens](./media/quickstart-create-data-factory-portal/copy-activity.png)
...
1. Voordat u een pijplijn activeert, moet u eerst entiteiten publiceren in Data Factory. Als u wilt publiceren, selecteert u **Alles publiceren** bovenaan. 
    ![alle](./media/quickstart-create-data-factory-portal/publish-all.png) publiceren
...
1. Ga naar het tabblad **Monitor** aan de linkerkant. Gebruik de knop **Vernieuwen** om de lijst te vernieuwen.
...
1. Ga naar het tabblad **Monitor** aan de linkerkant. Selecteer **Vernieuwen** om de lijst te vernieuwen. U ziet dat de pijplijn één keer per minuut wordt uitgevoerd vanaf het moment van publiceren tot de eindtijd. 
