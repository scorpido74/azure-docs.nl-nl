...
| JSON-element | Beschrijving | Type | Toegestane waarden | Verplicht |
|:--- |:--- |:--- |:--- |:--- |
...
| **startTime**| De eerste instantie, die in het verleden kan zijn. Het eerste trigger interval is (**StartTime**, **StartTime** + **interval**). | Datum/tijd | Een datum/tijd-waarde. | Ja |
| **endTime**| De laatste instantie, die in het verleden kan zijn. | Datum/tijd | Een datum/tijd-waarde. | Ja |
