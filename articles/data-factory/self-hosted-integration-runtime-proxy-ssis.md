...
Schakel op de pagina **Geavanceerde instellingen** het selectie vakje **zelf gehost Integration runtime als proxy voor uw Azure-SSIS Integration runtime** in, selecteer uw zelf-hostende IR-en Azure Blob Storage gekoppelde service voor fase ring en geef desgewenst een BLOB-container naam op voor het **pad voor tijdelijke bestanden** .
