---
title: Gegevens stapsgewijs laden met PowerShell
description: Dit PowerShell-script laat zien hoe u Azure Data Factory gebruiken om gegevens stapsgewijs te kopiëren van een Azure SQL-database naar een Azure Blob Storage.
...
---
# <a name="powershell-script---incrementally-load-data-by-using-azure-data-factory"></a>PowerShell-script - Gegevens stapsgewijs laden met Azure Data Factory

Dit voorbeeld PowerShell-script laadt alleen nieuwe of bijgewerkte records van een brongegevensarchief naar een gootsteengegevensarchief na de eerste volledige kopie van gegevens van de bron naar de gootsteen.  
