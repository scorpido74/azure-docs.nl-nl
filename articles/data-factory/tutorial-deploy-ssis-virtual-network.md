...
- **Virtueel netwerk**.
    ...
    - Zorg ervoor dat u geen Azure-beleid hebt waarmee wordt voor komen dat de volgende resources worden gemaakt onder de resource groep/het abonnement waartoe het virtuele netwerk behoort:
...
Gebruik de Azure Portal naar een virtueel netwerk voordat u een Azure-SSIS IR wilt toevoegen.
