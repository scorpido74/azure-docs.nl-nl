...
|:--- |:--- |:--- |
| Lokale map op Integration Runtime computer: <br/><br/>Voor beelden: D:\\\* of D:\folder\subfolder\\* |In JSON: `D:\\`<br/>Op gebruikers interface: `D:\` |In JSON: `.\\` of `folder\\subfolder`<br>Op gebruikers interface: `.\` of `folder\subfolder` |
