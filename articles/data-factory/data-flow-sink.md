...
![Opties op het tabblad sink, met inbegrip van de optie Sink voor automatisch toewijzen](media/data-flow/sink1.png "1")
...
![Opties op de](media/data-flow/opt001.png "sink-opties") optimaliseren
...
![Het tabblad toewijzing met de velden die zijn toegewezen aan kolommen in de gegevensset](media/data-flow/multi1.png "meerdere opties")

Als u de kolom toewijzingen opnieuw wilt instellen, selecteert u **opnieuw toewijzen**.

![Het tabblad]wastafel(media/data-flow/sink1.png "één")
...
Op ![regels gebaseerde toewijzing](media/data-flow/rules4.png "op") basis van een regel
...
![Het tabblad instellingen, met SQL-Sink-opties](media/data-flow/alter-row2.png "SQL-opties")
...
SQL-verwerkings scripts voor ![scripts vóór en na](media/data-flow/prepost1.png "de SQL-") verwerking
...
![SQL-gegevensset-instellingen, waarin wordt weer gegeven waar u de tabel naam wilt bewerken](media/data-flow/dataset2.png "SQL-schema")
