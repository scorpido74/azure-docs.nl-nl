...
kolom(media/data-flow/columnpattern2.png "patronen") kolom ![patronen]
...
(media/data-flow/pattern2.png "patroon") typen voor ![kolom patroon typen]
...
kolom(media/data-flow/position.png "positie") kolom ![positie]
...
toewijzing op basis van ![regel toewijzings](media/data-flow/rule2.png "regel")
