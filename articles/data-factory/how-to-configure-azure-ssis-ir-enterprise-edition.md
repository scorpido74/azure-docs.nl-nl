...
2.  Wanneer u de Azure-SSIS IR inricht of opnieuw configureert met Power shell, voert u `Set-AzDataFactoryV2IntegrationRuntime` uit met **Enter prise** als de waarde voor de **editie** -para meter voordat u de Azure-SSIS IR start. Hier volgt een voorbeeld script:
