...
Als u AzureDTExec wilt gebruiken, downloadt en installeert u de meest recente versie van SSMS. Dit is versie 18,3 of hoger. Down load deze van [deze website](/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017).
...
Het aanroepen van AzureDTExec biedt vergelijk bare opties als het aanroepen van dtexec. Zie [Dtexec Utility](/sql/integration-services/packages/dtexec-utility?view=sql-server-2017)(Engelstalig) voor meer informatie. Dit zijn de opties die momenteel worden ondersteund:
