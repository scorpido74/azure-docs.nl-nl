...
Hiermee wordt de huidige tijds tempel opgehaald als UTC. U kunt een optionele tijd zone door geven in de vorm ' GMT ', ' PST ', ' UTC ', ' America/Caymaneilanden '. Deze wordt standaard ingesteld op de huidige tijd zone* ``currentUTC() == toTimestamp('2050-12-12 19:18:12') -> false``
...
Wordt geconverteerd naar de tijds tempel van UTC. U kunt eventueel de tijd zone in de vorm ' GMT ', ' PST ', ' UTC ', ' America/Caymaneilanden ' door geven. Deze wordt standaard ingesteld op de huidige tijd zone* ``fromUTC(currentTimeStamp()) == toTimestamp('2050-12-12 19:18:12') -> false``
...
Hiermee wordt gecontroleerd of de rij is gemarkeerd voor verwijderen. Voor trans formaties waarbij meer dan één invoer stroom wordt gemaakt, kunt u de (1-op-basis) index van de stroom door geven. De standaard waarde voor de index van de stroom is 1* ``isDelete()``
* ``isDelete(1)``
___
### <code>isError</code>
<code><b>isError([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Hiermee wordt gecontroleerd of de rij als fout is gemarkeerd. Voor trans formaties waarbij meer dan één invoer stroom wordt gemaakt, kunt u de (1-op-basis) index van de stroom door geven. De standaard waarde voor de index van de stroom is 1* ``isError()``
* ``isError(1)``
___
### <code>isIgnore</code>
<code><b>isIgnore([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Hiermee wordt gecontroleerd of de rij is gemarkeerd om te worden genegeerd. Voor trans formaties waarbij meer dan één invoer stroom wordt gemaakt, kunt u de (1-op-basis) index van de stroom door geven. De standaard waarde voor de index van de stroom is 1* ``isIgnore()``
* ``isIgnore(1)``
___
### <code>isInsert</code>
<code><b>isInsert([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Hiermee wordt gecontroleerd of de rij is gemarkeerd voor invoegen. Voor trans formaties waarbij meer dan één invoer stroom wordt gemaakt, kunt u de (1-op-basis) index van de stroom door geven. De standaard waarde voor de index van de stroom is 1* ``isInsert()``
* ``isInsert(1)``
___
### <code>isMatch</code>
<code><b>isMatch([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Hiermee wordt gecontroleerd of de rij overeenkomt bij het opzoeken. Voor trans formaties waarbij meer dan één invoer stroom wordt gemaakt, kunt u de (1-op-basis) index van de stroom door geven. De standaard waarde voor de index van de stroom is 1* ``isMatch()``
* ``isMatch(1)``
___
### <code>isNull</code>
...
Hiermee wordt gecontroleerd of de rij is gemarkeerd voor bijwerken. Voor trans formaties waarbij meer dan één invoer stroom wordt gemaakt, kunt u de (1-op-basis) index van de stroom door geven. De standaard waarde voor de index van de stroom is 1* ``isUpdate()``
* ``isUpdate(1)``
___
### <code>isUpsert</code>
<code><b>isUpsert([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Hiermee wordt gecontroleerd of de rij is gemarkeerd voor invoegen. Voor trans formaties waarbij meer dan één invoer stroom wordt gemaakt, kunt u de (1-op-basis) index van de stroom door geven. De standaard waarde voor de index van de stroom is 1* ``isUpsert()``
* ``isUpsert(1)``
___
### <code>kurtosis</code>
...
Links wordt de teken reeks met de opgegeven opvulling gematteerd tot deze een bepaalde lengte heeft. Als de teken reeks gelijk is aan of groter is dan de lengte, wordt deze bijgesneden tot de * ``lpad('dumbo', 10, '-') -> '-----dumbo'`` lengte 
* ``lpad('dumbo', 4, '-') -> 'dumb'`` 
* ' ' lpad (' Dumbo ', 8, ' < > ') > ' < ><dumbo'``
___
### <code>LTrim</code>
...
De duur in milliseconden voor het aantal milliseconden* ``seconds(2) -> 2L``
___
### <code>min</code>
...
Hiermee wordt het aantal maanden tussen twee datums opgehaald. U kunt de berekening afronden. U kunt een optionele tijd zone door geven in de vorm ' GMT ', ' PST ', ' UTC ', ' America/Caymaneilanden '. De lokale tijd zone wordt als standaard waarde gebruikt.
...
Met rechts wordt de teken reeks met de opgegeven opvulling gematteerd tot deze een bepaalde lengte heeft. Als de teken reeks gelijk is aan of groter is dan de lengte, wordt deze bijgesneden tot de * ``rpad('dumbo', 10, '-') -> 'dumbo-----'``lengte 
* ``rpad('dumbo', 4, '-') -> 'dumb'`` 
* ``rpad('dumbo', 8, '<>') -> 'dumbo<><'`` 
___
### <code>rtrim</code>van RTrim</code>
...
Hiermee wordt de tijds tempel geconverteerd naar UTC. U kunt een optionele tijd zone door geven in de vorm ' GMT ', ' PST ', ' UTC ', ' America/Caymaneilanden '. Deze wordt standaard ingesteld op de huidige tijd zone* ``toUTC(currentTimeStamp()) == toTimestamp('2050-12-12 19:18:12') -> false``
