---
title: Gegevens kopiëren van Marketo met Azure Data Factory (Preview)
...
| clientSecret | Het clientgeheim van uw Marketo-service. Markeer dit veld als een SecureString om het veilig op te slaan in Data Factory, of [verwijs naar een geheim dat is opgeslagen in Azure Key Vault](store-credentials-in-key-vault.md). | Ja |
...
Als u wilt kopiëren van gegevens uit Marketo, stelt u het brontype in de kopieeractiviteit naar **MarketoSource**. De volgende eigenschappen worden ondersteund in de kopieeractiviteit **source** sectie:
