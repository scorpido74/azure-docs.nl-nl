...
Als u geheimen uit [Azure Key Vault](../../key-vault/general/overview.md) moet halen bij het implementeren van Azure Data Factory-entiteiten met behulp van sjablonen, geeft u de **sleutelkluis** en **de geheime naam** op zoals weergegeven in het volgende voorbeeld:
