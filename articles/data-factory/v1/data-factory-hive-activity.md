...
Het volgende logboek is een voor beeld van een spel logboek, dat een komma (`,`) gescheiden is en de volgende velden bevat: ProfileID, SessionStart, duration, SrcIPAddress en GameType.
