...
| [Pijp lijnen met para meters voor Azure Machine Learning](https://github.com/Azure/Azure-DataFactory/tree/master/SamplesV1/ParameterizedPipelinesForAzureML) |Het voor beeld biedt een end-to- C# end-code voor het implementeren van N pijp lijnen voor het scoren en opnieuw trainen van elk met een andere regio parameter, waarbij de lijst met regio's afkomstig is uit een para meters. txt-bestand, dat deel uitmaakt van dit voor beeld. |
...
| [BLOB-bestand verwijderen](https://github.com/Azure/Azure-DataFactory/tree/master/SamplesV1/DeleteBlobFileFolderCustomActivity) | In dit voor beeld wordt C# een bestand gedemonstreerd dat kan worden gebruikt als onderdeel van de aangepaste .net-activiteit van ADF om bestanden van de bron Azure Blob-locatie te verwijderen nadat de bestanden zijn gekopieerd.|
