...
Wanneer u gegevens transformeert in de toewijzing van gegevens stromen, kunt u bestanden lezen en schrijven vanuit Azure Blob-opslag in JSON, AVRO, tekst met scheidings tekens of Parquet-indeling. Zie [bron transformatie in toewijzing van gegevens stroom](data-flow-source.md) en [sink-trans formatie in gegevens stroom toewijzen](data-flow-sink.md)voor meer informatie.
