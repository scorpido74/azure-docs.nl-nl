...
1. Wanneer u uw Azure-SSIS IR inricht of opnieuw configureert met Power shell, kunt u aangepaste Setup toevoegen/verwijderen door de `Set-AzDataFactoryV2IntegrationRuntime`-cmdlet uit te voeren voordat u de Azure-SSIS IR start.
