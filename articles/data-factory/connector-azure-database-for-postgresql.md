...
Om gegevens te kopiëren uit een Azure Database for PostgreSQL, stelt u het brontype in de kopieeractiviteit naar **AzurePostgreSqlSource**. De volgende eigenschappen worden ondersteund in de kopieeractiviteit **source** sectie:
