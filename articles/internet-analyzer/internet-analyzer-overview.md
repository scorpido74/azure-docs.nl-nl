...
Internet Analyzer behandelt vragen met betrekking tot de prestaties van de Cloud, implementeert naar een nieuwe of meer Azure-regio's, of test nieuwe toepassingen en de platformen voor het leveren van inhoud in azure, zoals [Azure front deur](https://azure.microsoft.com/services/frontdoor/) en [Microsoft Azure CDN](https://azure.microsoft.com/services/cdn/). 
