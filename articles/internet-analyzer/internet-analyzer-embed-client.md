...
Internet Analyzer vereist toegang tot Azure en andere micro soft-Services om goed te laten functioneren. Zorg ervoor dat u `fpc.msedge.net` toegang hebt tot het netwerk en eventuele vooraf geconfigureerde eind punt-url's (zichtbaar via [cli](internet-analyzer-cli.md)) voordat u de client insluit.
