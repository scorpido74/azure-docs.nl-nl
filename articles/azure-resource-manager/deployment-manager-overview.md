...
U kunt een stap definiëren die vóór of na de implementatie bewerking moet worden uitgevoerd. Momenteel zijn alleen de stappen `wait` en ' status controle ' beschikbaar.
