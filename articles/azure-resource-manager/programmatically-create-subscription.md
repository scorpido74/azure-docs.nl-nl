...
Installeer eerst deze preview-module door `Install-Module Az.Subscription -AllowPrerelease`uit te voeren. Installeer een recente versie van PowerShellGet in de [PowerShellGet-module ophalen](/powershell/scripting/gallery/installing-psget)om ervoor te zorgen dat `-AllowPrerelease` werkt.
