...
In dit artikel hebt u geleerd hoe u de status controle integreert in azure Deployment Manager. Doorgaan met het volgende artikel voor meer informatie over het implementeren van met Deployment Manager.
