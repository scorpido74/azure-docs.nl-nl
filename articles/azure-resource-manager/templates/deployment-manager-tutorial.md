...
* De [naslaginformatie voor Azure Deployment Manager REST API](/rest/api/deploymentmanager/).
...
> Sla een kopie van de projectnaam op. U gebruikt dezelfde projectName in de gehele zelfstudie.
...
Open de container vanuit de Azure-portal en controleer of de mappen met **binaire bestanden** en **sjablonen** en de bestanden zijn geüpload.
...
* **projectName**: deze naam wordt gebruikt voor het maken van de namen van de Deployment Manager-resources. Wanneer bijvoorbeeld 'jdoe' wordt gebruikt, is de naam van de servicetopologie **jdoe**ServiceTopology.  De resourcenamen worden gedefinieerd in de sectie met variabelen van deze sjabloon.
...
2. Vul de parameterwaarden in:
    ...
    * **projectName**: voer een tekenreeks met 4-5 tekens in. Deze naam wordt gebruikt om voor Azure unieke resourcenamen te maken.
...
* **projectName**: deze naam wordt gebruikt voor het maken van de namen van de Deployment Manager-resources. Wanneer u bijvoorbeeld 'jdoe' gebruikt, is de naam van de implementatie **jdoe**Rollout.  De namen worden gedefinieerd in de sectie met variabelen van de sjabloon.
...
1. Voer het script uit om de servicetopologie te implementeren.
    ...
    Als u dit script uitvoert vanuit een andere PowerShell-sessie dan de sessie waaruit u het script [De artefacten voorbereiden](#prepare-the-artifacts) hebt uitgevoerd, moet u eerst de variabelen opnieuw invullen, waaronder **$resourceGroupName** en **$filepath**.
...
4. Controleer de voortgang van de implementatie met behulp van het volgende PowerShell-script:
    ...
    De Deployment Manager PowerShell-cmdlets moeten worden geïnstalleerd voordat u deze cmdlet kunt uitvoeren. Zie Vereisten. De schakeloptie -Verbose kan worden gebruikt om de gehele uitvoer te bekijken.
