...
* Zie [resources implementeren met Resource Manager-sjablonen en Azure PowerShell](deploy-powershell.md)voor een inleiding tot het implementeren van sjablonen.
