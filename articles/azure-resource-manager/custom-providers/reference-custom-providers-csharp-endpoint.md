---
title: Rest- C# eindpunt referentie van aangepaste provider
...
Dit artikel is een eenvoudige referentie voor een gerust C# eind punt van een aangepaste provider. Als u niet bekend bent met aangepaste Azure-providers, raadpleegt u [het overzicht van aangepaste resource providers](overview.md).
