...
---
# <a name="deploy-associations-for-a-custom-provider-using-azure-policy"></a>Koppelingen voor een aangepaste provider implementeren met behulp van Azure-beleid
