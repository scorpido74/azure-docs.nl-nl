---
title: Azure Resource Manager groepen beheren door gebruik te maken van Azure PowerShell | Microsoft Docs
description: Gebruik Azure PowerShell om uw Azure Resource Manager groepen te beheren.
...
Meer informatie over het gebruik van Azure PowerShell met [Azure Resource Manager](resource-group-overview.md) voor het beheren van uw Azure-resource groepen. Zie [Azure-resources beheren met Azure PowerShell](./manage-resources-powershell.md)voor meer informatie over het beheer van Azure-resources.
...
Zie [test-AzResourceGroupDeployment](https://docs.microsoft.com/powershell/module/Az.Resources/Test-AzResourceGroupDeployment?view=azps-1.3.0)om een implementatie van een resource groep te valideren.

## <a name="deploy-a-resource-group-and-resources"></a>Een resource groep en-resources implementeren

U kunt een resource groep maken en resources voor de groep implementeren met behulp van een resource manager-sjabloon. Zie [resource groep maken en resources implementeren](./deploy-to-subscription.md#create-resource-group-and-deploy-resources)voor meer informatie.
...
U kunt de resources in de groep verplaatsen naar een andere resource groep. Zie voor meer informatie [Resources verplaatsen naar een nieuwe resourcegroep of een nieuw abonnement](./resource-group-move-resources.md).
...
U kunt Tags Toep assen op resource groepen en resources om uw assets logisch te organiseren. Zie [Tags gebruiken om uw Azure-resources te organiseren](./resource-group-using-tags.md#powershell)voor meer informatie.
...
Als u de para meter `-IncludeParameterDefaultValue` gebruikt bij het exporteren van de sjabloon, bevat de sjabloon parameter een standaard waarde die is ingesteld op de huidige waarde. U kunt deze standaard waarde gebruiken of de standaard waarde overschrijven door door te geven in een andere waarde.
...
Als u de para meter `-SkipResourceNameParameterization` gebruikt bij het exporteren van de sjabloon, worden para meters voor resource namen niet opgenomen in de sjabloon. In plaats daarvan wordt de resource naam rechtstreeks op de resource ingesteld op de huidige waarde. U kunt de naam niet aanpassen tijdens de implementatie.
