---
title: Visual Studio code gebruiken om Azure Resource Manager sjablonen te maken
...
![Inkleuring van Visual Studio code Resource Manager-hulpprogram ma's](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-colorization.png)
...
- Ingebouwde functie namen
    ...
    ![Functies van de IntelliSense-uitbrei dingen voor Visual Studio code Resource Manager-hulpprogram ma's](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-intellisense-functions.png)

- Parameter verwijzingen

    ![IntelliSense-para meters voor Visual Studio code Resource Manager-hulpprogram ma's](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-intellisense-parameters.png)

- Verwijzingen naar variabelen

    ![IntelliSense-variabelen voor Visual Studio code Resource Manager-hulpprogram ma's](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-intellisense-variables.png)

- eigenschappen van resourceGroup ()

    ![Functies van de IntelliSense-uitbrei dingen voor Visual Studio code Resource Manager-hulpprogram ma's](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-intellisense-resourcegroup.png)
...
![Hand tekening functie extensies van Visual Studio code Resource Manager-hulpprogram ma's](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-signature-function.png)
...
![Visual Studio code Resource Manager-hulpprogram ma's uitbrei dingen bekijken editor](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-peek-editor.png)
...
![Uitbrei dingen van Visual Studio code Resource Manager-hulpprogram ma's alle verwijzingen zoeken](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-find-all-references.png)
...
![Uitbrei dingen voor de toewijzing van Visual Studio code Resource Manager-hulpprogram ma's](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-hover-parameters.png)
...
![Bestemmings accolades van Visual Studio code Resource Manager-hulpprogram ma's](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-brace-matching.png)
