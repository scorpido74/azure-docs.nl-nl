---
title: Azure Resource Manager groepen beheren door gebruik te maken van de Azure Portal | Microsoft Docs
...
Meer informatie over het gebruik van de [Azure Portal](https://portal.azure.com) met [Azure Resource Manager](resource-group-overview.md) voor het beheren van uw Azure-resource groepen. Zie [Azure-resources beheren met behulp van de Azure portal voor het](./manage-resources-portal.md)beheer van Azure-resources.
...
Zie voor meer informatie [bronnen vergren delen om onverwachte wijzigingen te voor komen](./resource-group-lock-resources.md).

## <a name="tag-resource-groups"></a>Label resource groepen

U kunt Tags Toep assen op resource groepen en resources om uw assets logisch te organiseren. Zie [Tags gebruiken om uw Azure-resources te organiseren](./resource-group-using-tags.md#portal)voor meer informatie.

## <a name="export-resource-groups-to-templates"></a>Resource groepen exporteren naar sjablonen

Zie voor meer informatie over het exporteren van sjablonen [één en meerdere resources exporteren naar sjabloon-Portal](export-template-portal.md).
