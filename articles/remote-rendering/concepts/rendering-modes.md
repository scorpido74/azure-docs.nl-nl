...
* [ConnectToRuntimeParams struct van C#](/dotnet/api/microsoft.azure.remoterendering.connecttoruntimeparams)
* [C++ AzureSession:: ConnectToRuntime ()](/cpp/api/remote-rendering/azuresession#connecttoruntime)
* [Structuur van C++ ConnectToRuntimeParams](/cpp/api/remote-rendering/connecttoruntimeparams)
