---
title: 'Extern werken met Bastion: Azure Bastion'
description: Op deze pagina wordt beschreven hoe u Azure Bastion kunt gebruiken om op afstand te werken vanwege de COVID-19 Pandemic.
services: bastion
author: mialdrid
ms.service: bastion
ms.topic: conceptual
...
Azure Bastion speelt een rol in de ondersteuning van externe werk scenario's door gebruikers met Internet verbinding toe te staan om toegang te krijgen tot Azure virtual machines. In het bijzonder kunnen IT-beheerders hun toepassingen op elk gewenst moment en overal ter wereld beheren.

>[!NOTE]
>In dit artikel wordt beschreven hoe u Azure Bastion, azure, micro soft Network en het Azure-partner ecosysteem kunt gebruiken om op afstand te werken en om netwerk problemen te verhelpen die u tegen komt vanwege COVID-19-crisis.
>

## <a name="securely-access-virtual-machines"></a>Veilige toegang tot virtuele machines
