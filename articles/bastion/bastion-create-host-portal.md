...
1. Klik op de start pagina in de [Azure Portal](https://portal.azure.com)op **+ een resource maken**.
...
1. Open de [Azure Portal](https://portal.azure.com). Navigeer naar uw virtuele machine en klik vervolgens op **verbinding maken**.
