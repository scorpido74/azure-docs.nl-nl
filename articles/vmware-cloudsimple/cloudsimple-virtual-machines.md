...
description: Meer informatie over virtuele machines van CloudSimple en hun voor delen. U kunt virtuele VMware-machines beheren vanuit het Azure Portal.
author: sharaths-cs
ms.author: dikamath
ms.date: 08/20/2019
ms.topic: article
...
* Meer informatie over het gebruik [van virtuele VMware-machines in azure](quickstart-create-vmware-virtual-machine.md)
* Meer informatie over [het toewijzen van uw Azure-abonnement](azure-subscription-mapping.md)
