---
title: 'Azure VMware-oplossingen (AVS): een virtuele machine in azure maken met VM-sjablonen'
description: Hierin wordt beschreven hoe u virtuele machines in azure maakt met behulp van VM-sjablonen in de VMware-infra structuur voor uw AVS-Privécloud
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/16/2019
ms.topic: article
...
U kunt een virtuele machine maken in de Azure Portal met behulp van VM-sjablonen op de VMware-infra structuur die uw AVS-beheerder heeft ingeschakeld voor uw abonnement.

## <a name="sign-in-to-azure"></a>Aanmelden bij Azure

Meld u aan bij de [Azure Portal](https://portal.azure.com).

## <a name="create-avs-virtual-machine"></a>Virtuele AVS-machine maken
...
4. Voer basis informatie in Klik op **volgende: grootte**.
    ...
    | Privécloud | De Privécloud die u wilt maken voor de virtuele machine. |
...
## <a name="view-list-of-avs-virtual-machines"></a>Lijst met virtuele AVS-machines weer geven
...
3. Selecteer de waarop uw Privécloud is gemaakt.
    ...
    ![Lijst met AVS-Virtual Machines](media/list-cloudsimple-virtual-machines.png)

De lijst met virtuele AVS-machines bevat virtuele machines die zijn gemaakt op basis van Azure Portal.  Virtuele machines die zijn gemaakt in de Privécloud-vCenter in de toegewezen vCenter-resource groep, worden weer gegeven in de lijst.  
