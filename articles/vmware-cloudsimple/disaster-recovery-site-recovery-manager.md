...
2. Maak een gebruiker in uw Privécloud voor vSphere-replicatie en-beveiligings-en-installatie. Hieronder wordt uitgelegd [in de vCenter-gebruikers interface: Maak een gebruiker in de Privécloud voor vRA &-beveiligings](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation)-installatie.
...
5. Firewall regels configureren voor vRA. Hieronder wordt uitgelegd [in CloudSimple-portal: Firewall regels configureren voor vRA](#cloudsimple-portal-configure-firewall-rules-for-vra).
...
#### <a name="vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation"></a>vCenter-gebruikers interface: Een gebruiker in een Privécloud maken voor de installatie van vRA en het beveiligings-exemplaar
...
1. [vCenter-gebruikers interface: Een-of-programma installeren](#vcenter-ui-install-srm)
2. [CloudSimple-portal: Firewall regels configureren voor een-de](#cloudsimple-portal-configure-firewall-rules-for-srm)
3. [vCenter-gebruikers interface: Configure-out configureren](#vcenter-ui-configure-srm)
4. [CloudSimple-portal: de bevoegdheden voor deescaleren](#cloudsimple-portal-de-escalate-privileges)

#### <a name="vcenter-ui-install-srm"></a>vCenter-gebruikers interface: Een-of-programma installeren

Nadat u zich hebt aangemeld bij vCenter met de soln-beheerders referenties, volgt u de VMware-documentatie voor het uitvoeren van de server installatie in het implementatie model ' twee-site topologie met één vCenter-exemplaar per platform Services-controller ', zoals beschreven in deze [VMware document](https://docs.vmware.com/en/Site-Recovery-Manager/6.5/com.vmware.srm.install_config.doc/GUID-F474543A-88C5-4030-BB86-F7CC51DADE22.html). De installatie-instructies voor de 6,5 is beschikbaar in het VMware-document [installatie van site Recovery Manager](https://docs.vmware.com/en/Site-Recovery-Manager/6.5/com.vmware.srm.install_config.doc/GUID-437E1B65-A17B-4B4B-BA5B-C667C90FA418.html).

#### <a name="cloudsimple-portal-configure-firewall-rules-for-srm"></a>CloudSimple-portal: Firewall regels configureren voor een-de
...
#### <a name="vcenter-ui-configure-srm"></a>vCenter-gebruikers interface: Configure-out configureren
...
* [Bandbreedte vereisten voor vSphere-replicatie berekenen](https://kb.vmware.com/s/article/2037268)
