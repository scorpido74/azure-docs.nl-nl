---
title: Creëer & zoek ankers in Swift
description: Uitgebreide uitleg over het maken en lokaliseren van ankers met Azure Spatial Anchors in Swift.
...
---
# <a name="how-to-create-and-locate-anchors-using-azure-spatial-anchors-in-swift"></a>Ankers maken en lokaliseren met Azure Spatial Anchors in Swift

> [!div  class="op_single_selector"]
> * [Unity](create-locate-anchors-unity.md)
> * [Doelstelling-C](create-locate-anchors-objc.md)
> * [Swift](create-locate-anchors-swift.md)
> * [Android Java](create-locate-anchors-java.md)
> * [C++/NDK](create-locate-anchors-cpp-ndk.md)
> * [C++/WinRT](create-locate-anchors-cpp-winrt.md)

Met Azure Spatial Anchors kunt u ankers delen tussen verschillende apparaten. Het ondersteunt verschillende ontwikkelomgevingen. In dit artikel gaan we dieper in op het gebruik van de Azure Spatial Anchors SDK in Swift om:
...
- Basiskennis over Swift.
- Basiskennis over <a href="https://developer.apple.com/arkit/" target="_blank">ARKit.</a>
...
Meer informatie over de [tokenVereiste](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsessiondelegate#tokenrequired) protocolmethode.
...
Meer informatie over de [startmethode.](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsession#start)
...
Meer informatie over de [processFrame-methode.](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsession#processframe)
...
Meer informatie over de methode [updateAnkereigenschappen.](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsession#updateanchorproperties)
...
Meer informatie over de [vervaldatum.](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchor#expiration)
...
Meer informatie over de [createWatcher-methode.](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsession#createwatcher)
...
Meer informatie over de [protocolmethode anker.](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsessiondelegate#anchorlocated)
...
Meer informatie over de [verwijderingsmethode.](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsession#deleteanchor)
...
Meer informatie over de [stopmethode.](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsession#stop)
...
Meer informatie over de [resetmethode.](https://docs.microsoft.com/objectivec/api/spatial-anchors/asacloudspatialanchorsession#reset)
