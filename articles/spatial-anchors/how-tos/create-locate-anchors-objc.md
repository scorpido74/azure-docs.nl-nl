---
title: Ankers & lokaliseren in doelstelling-C
description: Diepgaande uitleg over het maken en lokaliseren van ankers met Azure Spatial Anchors in Objective-C.
...
---
# <a name="how-to-create-and-locate-anchors-using-azure-spatial-anchors-in-objective-c"></a>Ankers maken en lokaliseren met Azure Spatial Anchors in Objective-C
...
Met Azure Spatial Anchors kunt u ankers delen tussen verschillende apparaten. Het ondersteunt verschillende ontwikkelomgevingen. In dit artikel gaan we dieper in op het gebruik van de Azure Spatial Anchors SDK in Doelstelling-C om:
...
- Basiskennis over doelstelling-C.
