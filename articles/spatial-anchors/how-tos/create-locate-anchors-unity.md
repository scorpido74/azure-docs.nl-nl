---
title: Ankers in eenheid maken & vinden
...
Meer informatie over de eigenschap [Expires](https://docs.microsoft.com/dotnet/api/microsoft.azure.spatialanchors.cloudspatialanchor.expiration) .
