...
description: Uitgebreide uitleg over het maken en lokaliseren van ankers met behulp van Azure spatiale ankers in C++/WinRT.
...
---
# <a name="how-to-create-and-locate-anchors-using-azure-spatial-anchors-in-cwinrt"></a>Ankers maken en vinden met behulp van Azure spatiale ankers in C++/WinRT
