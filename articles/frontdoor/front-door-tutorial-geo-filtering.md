---
title: Zelf studie-WAF-beleid voor geo-filtering configureren-Azure front deur
...
Zoek de naam van de resource groep die het voorste deur profiel bevat met `Get-AzResourceGroup`behulp van. Maak vervolgens een `geoPolicy` beleids object dat `nonUSBlockRule` gebruikmaakt van [New-AzFrontDoorWafPolicy](/powershell/module/az.frontdoor/new-azfrontdoorwafpolicy) in de opgegeven resource groep die het voorste deur profiel bevat. U moet een unieke naam opgeven voor het beleid voor geo-filtering. 
