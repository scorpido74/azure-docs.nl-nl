---
title: Azure Resource Manager sjabloon voorbeelden-Azure front deur
description: Voor beelden van Azure Resource Manager sjablonen voor Azure front deur
services: frontdoor
documentationcenter: ''
author: sharad4u
...
De volgende tabel bevat koppelingen naar Azure Resource Manager-implementatie model sjablonen voor Azure front-deur. 
...
| [Onboarding van een aangepast domein met de voor deur](https://github.com/Azure/azure-quickstart-templates/tree/master/101-front-door-custom-domain)| Een aangepast domein aan uw Front Door toevoegen. |
| [Voor deur maken met geo-filtering](https://github.com/Azure/azure-quickstart-templates/tree/master/101-front-door-geo-filtering)| Een voor deur maken die verkeer van bepaalde landen/regio's toestaat/blokkeert. |
...
| [Configureer de voor deur om actie te ondernemen met specifieke http-para meters](https://github.com/Azure/azure-quickstart-templates/tree/master/201-front-door-waf-http-params)| Hiermee wordt een Front Door geconfigureerd zodat bepaald verkeer op basis van http-parameters in de inkomende aanvraag wordt toegestaan of geblokkeerd door aangepaste regels te gebruiken voor toegangsbeheer met http-parameters. |
| [Drempel waarde voor de voor deur configureren](https://github.com/Azure/azure-quickstart-templates/tree/master/201-front-door-rate-limiting)| Hiermee wordt een Front Door geconfigureerd om de snelheid van inkomend verkeer voor een bepaalde front-endhost te beperken. |
| | |
