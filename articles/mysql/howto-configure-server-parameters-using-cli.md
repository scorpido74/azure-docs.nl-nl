...
In dit voor beeld worden details weer gegeven van de configuratie parameter server van het **\_langzame query\_logboek** voor server **mydemoserver.mysql.database.Azure.com** onder resource groep **myresourcegroup.**
```azurecli-interactive
...
Voor het bijwerken van de configuratie parameter van de **\_langzame query\_logboek** server van server **mydemoserver.mysql.database.Azure.com** onder resource groep **myresourcegroup.**
```azurecli-interactive
...
Met de volgende opdracht wordt de configuratie parameter van de **tijd\_zone** server van server **mydemoserver.mysql.database.Azure.com** onder resource groep **myresourcegroup** naar **VS/Pacific**bijgewerkt.
