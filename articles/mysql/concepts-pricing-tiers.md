...
description: Meer informatie over de verschillende prijsniveaus voor Azure Database voor MySQL, waaronder rekengeneraties, opslagtypen, opslaggrootte, vCores, geheugen en back-upbewaarperioden.
author: jan-eng
ms.author: janeng
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "79269443"
---
# <a name="azure-database-for-mysql-pricing-tiers"></a>Azure Database voor MySQL-prijsniveaus

U een Azure Database voor MySQL-server maken in een van de drie verschillende prijsniveaus: Basic, General Purpose en Memory Optimized. De prijsniveaus worden gedifferentieerd naar de hoeveelheid compute in vCores die kunnen worden ingericht, geheugen per vCore en de opslagtechnologie die wordt gebruikt om de gegevens op te slaan. Alle resources zijn ingericht op MySQL-serverniveau. Een server kan een of meerdere databases hebben.
...
De opslag die u indient, is de hoeveelheid opslagcapaciteit die beschikbaar is voor uw Azure Database voor MySQL-server. De opslag wordt gebruikt voor de databasebestanden, tijdelijke bestanden, transactielogboeken en de MySQL-serverlogboeken. De totale hoeveelheid opslagruimte die u indient, definieert ook de I/O-capaciteit die beschikbaar is voor uw server.
...
>
> Alle andere regio's ondersteunen maximaal 4 TB opslagruimte en maximaal 6000 IOPS.
>
...
Zie de pagina serviceprijzen voor de meest actuele [prijsinformatie.](https://azure.microsoft.com/pricing/details/mysql/) Als u de gewenste kosten wilt zien voor de gewenste configuratie, [worden](https://portal.azure.com/#create/Microsoft.MySQLServer) de maandelijkse kosten weergegeven op het tabblad **Prijslaag** op basis van de opties die u selecteert. Als u geen Azure-abonnement hebt, u de azure-prijscalculator gebruiken om een geschatte prijs te krijgen. Selecteer op de website van de [Azure-prijscalculator](https://azure.microsoft.com/pricing/calculator/) de optie **Items toevoegen,** vouw de categorie **Databases** uit en kies **Azure Database voor MySQL** om de opties aan te passen.
