---
title: Video's Azure Database for MySQL
description: Op deze pagina vindt u de video-inhoud die relevant is voor Learning Azure Database for MySQL, het beheerde MySQL-aanbod van micro soft in Azure.
author: savjani
ms.author: pariks
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "94532406"
---
# <a name="azure-database-for-mysql-videos"></a>Video's Azure Database for MySQL

Deze pagina bevat video-inhoud voor het leren over Azure Database for MySQL.
...
## <a name="how-to-get-started-with-the-new-azure-database-for-mysql-service"></a>Aan de slag met de nieuwe Azure Database for MySQL-service
