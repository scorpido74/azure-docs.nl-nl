---
title: CLI-script - Schaalserver - Azure Database voor MySQL
...
Dit voorbeeld CLI-script schaalt compute en storage voor één Azure Database voor MySQL-server na het opvragen van de statistieken. Compute kan omhoog of omlaag schalen. Opslag kan alleen worden opgeschaald.
...
| [az mysql server update](/cli/azure/mysql/server#az-mysql-server-update) | Updates eigenschappen van de MySQL-server. |
...
- Meer informatie over [Azure Database voor MySQL-gegevensen en -opslag](../concepts-pricing-tiers.md)
