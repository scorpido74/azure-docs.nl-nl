---
title: CLI-script-server herstellen-Azure Database for MySQL
...
| [az mysql server restore](/cli/azure/mysql/server#az-mysql-server-restore) | Een server herstellen uit een back-up. |
