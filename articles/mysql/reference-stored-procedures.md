...
Zie [replicatie van inkomende gegevens configureren voor het](howto-data-in-replication.md)instellen van replicatie van inkomende gegevens tussen een bron en een replica in azure database for MySQL.
