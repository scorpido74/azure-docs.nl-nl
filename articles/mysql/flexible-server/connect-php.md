...
Installeer PHP op uw eigen server of maak een Azure-[web-app](https://docs.microsoft.com/azure/app-service/overview) die PHP omvat.  Raadpleeg [firewallregels maken en beheren](./how-to-manage-firewall-portal.md) voor meer informatie over het maken van firewallregels.
