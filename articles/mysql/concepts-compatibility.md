...
| **Programmeer taal** | **Stuurprogrammamodel** | **Links** | **Compatibele versies** | **Incompatibele versies** | **Opmerkingen** |
| :----------------------- | :--------- | :-------- | :---------------------- | :------------------------ | :-------- |
...
| Aan de slag | Ga naar MySQL-stuur programma | https://github.com/go-sql-driver/mysql/releases | 1,3, 1,4 | 1,2 en vóór | Gebruik `allowNativePasswords=true` in de connection string voor versie 1,3. Versie 1,4 bevat een oplossings-en `allowNativePasswords=true` is niet meer vereist. |
