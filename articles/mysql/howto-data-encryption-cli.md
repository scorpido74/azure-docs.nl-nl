---
title: Gegevensversleuteling - Azure CLI - Azure Database voor MySQL
description: Meer informatie over het instellen en beheren van gegevensversleuteling voor uw Azure Database voor MySQL met behulp van de Azure CLI.
author: kummanish
ms.author: manishku
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "81459097"
---
# <a name="data-encryption-for-azure-database-for-mysql-by-using-the-azure-cli"></a>Gegevensversleuteling voor Azure Database voor MySQL met behulp van de Azure CLI

Meer informatie over het gebruik van de Azure CLI voor het instellen en beheren van gegevensversleuteling voor uw Azure Database voor MySQL.
...
* Maak in de gemaakte Azure Key Vault de sleutel die wordt gebruikt voor de gegevensversleuteling van de Azure Database voor MySQL.
...
* De sleutel moet de volgende kenmerken hebben om te gebruiken als een door de klant beheerde sleutel:
  * Geen vervaldatum
  * Niet uitgeschakeld
  * Uitvoeren **van get,** **wrap,** **uitpakken** bewerkingen

## <a name="set-the-right-permissions-for-key-operations"></a>De juiste machtigingen instellen voor belangrijke bewerkingen

1. Er zijn twee manieren om de beheerde identiteit voor uw Azure Database voor MySQL te verkrijgen.
...
2. Stel de **sleutelmachtigingen** in (**Get**, **Wrap**, **Uitpakken**) voor de **principal**, de naam van de MySQL-server.
...
1. Gegevensversleuteling inschakelen voor de Azure Database voor MySQL met behulp van de sleutel die is gemaakt in de Azure Key Vault.
...
## <a name="additional-capability-for-the-key-being-used-for-the-azure-database-for-mysql"></a>Aanvullende mogelijkheden voor de sleutel die wordt gebruikt voor de Azure Database voor MySQL
