---
title: Beveiliging in Azure Database for MySQL-één server
description: Een overzicht van de beveiligings functies in Azure Database for MySQL-één server.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
---
# <a name="security-in-azure-database-for-mysql---single-server"></a>Beveiliging in Azure Database for MySQL-één server
