...
>[!NOTE]
> Windows virtueel bureau blad ondersteunt alleen het publiceren van apps met installatie locaties `C:\Program Files\WindowsApps`die beginnen met.
