...
description: Meer informatie over het vaststellen en oplossen van veelvoorkomende fouten met connectiviteit van apparaten voor Azure IoT Hub DPS
author: xujing-ms
manager: nberdy
ms.service: iot-dps
services: iot-dps
...
9. Als er resultaten zijn, zoekt `OperationName`u naar, `ResultSignature` `ResultType`, en `ResultDescription` (fout bericht) om meer details te krijgen over de fout.
