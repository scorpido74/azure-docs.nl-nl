...
4. Selecteer in het menu Visual Studio de optie **fout opsporing** > **starten zonder fout opsporing** om de oplossing uit te voeren. De app leest en toont een **_registratie-id_** en een **_goedkeurings sleutel_**. Noteer of kopieer deze waarden. Deze worden gebruikt in de volgende sectie voor apparaatinschrijving. 
...
7. Selecteer in het menu Visual Studio de optie **fout opsporing** > **starten zonder fout opsporing** om de oplossing uit te voeren. In de prompt om het project opnieuw op te bouwen, selecteert u **Ja**om het project opnieuw te bouwen voordat u het uitvoert.
