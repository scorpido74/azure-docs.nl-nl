...
- [Node.js v4.0+](https://nodejs.org). In deze quickstart wordt de [Node.js Service-SDK](https://github.com/Azure/azure-iot-sdk-node) hieronder geïnstalleerd.
