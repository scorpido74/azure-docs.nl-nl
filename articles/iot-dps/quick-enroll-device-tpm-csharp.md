---
title: 'TPM-apparaat inschrijven bij Azure Device Provisioning Service met C #'
description: 'Quick Start: TPM-apparaat inschrijven bij Azure IoT Hub Device Provisioning Service (DPS) met behulp van de Service-SDK van C#. In deze snelstart wordt gebruikgemaakt van afzonderlijke inschrijvingen.'
author: wesmc7777
ms.author: wesmc
ms.date: 11/08/2019
ms.topic: quickstart
...
---
# <a name="quickstart-enroll-tpm-device-to-iot-hub-device-provisioning-service-using-c-service-sdk"></a>Quick Start: TPM-apparaat inschrijven voor IoT Hub Device Provisioning Service met behulp van de Service SDK van C#

[!INCLUDE [iot-dps-selector-quick-enroll-device-tpm](../../includes/iot-dps-selector-quick-enroll-device-tpm.md)]

In dit artikel wordt beschreven hoe u programmatisch een afzonderlijke inschrijving voor een TPM-apparaat in de Azure IoT Hub Device Provisioning Service maakt met behulp van de [C# Service-SDK](https://github.com/Azure/azure-iot-sdk-csharp) en een voor beeld van een C# .net core-toepassing. U kunt eventueel een gesimuleerd TPM-apparaat bij de inrichtings service inschrijven met behulp van deze afzonderlijke registratie vermelding. Hoewel deze stappen op zowel Windows-als Linux-computers werken, wordt in dit artikel een Windows-ontwikkel computer gebruikt.
...
1. Beschrijving Als u aan het eind van deze Quick Start een gesimuleerd apparaat wilt inschrijven, volgt u de procedure in [een gesimuleerd TPM-apparaat maken en inrichten met behulp](quick-create-simulated-device-tpm-csharp.md) van de SDK van C#-apparaten tot de stap waarin u een goedkeurings sleutel voor het apparaat ontvangt. Sla de goedkeurings sleutel, registratie-ID en, optioneel, de apparaat-ID op omdat u deze later in deze Quick start moet gebruiken.
...
1. Geef het project de naam *CreateTpmEnrollment*en druk op **maken**.
    ...
    ![Een klassiek Windows-bureau blad van Visual C# configureren](media/quick-enroll-device-tpm-csharp/configure-tpm-app-vs2019.png)
...
1. Voeg de volgende velden toe aan `Program` de klasse, zodat u de hieronder vermelde wijzigingen kunt aanbrengen.
   ...
   * Als u deze Snelstartgids samen met het [maken en inrichten van een gesimuleerd TPM-apparaat met behulp van de SDK van de C#-apparaat](quick-create-simulated-device-tpm-csharp.md) voor het inrichten van een gesimuleerd apparaat gebruikt, vervangt u de goedkeurings sleutel en registratie-id door de waarden die u hebt genoteerd in die Snelstartgids. U kunt de apparaat-ID vervangen door de waarde die in die Snelstartgids is voorgesteld, uw eigen waarde gebruiken of de standaard waarde in dit voor beeld gebruiken.
...
Als u de stappen hebt uitgevoerd in de Snelstartgids [een gesimuleerd TPM-apparaat maken en inrichten met behulp](quick-create-simulated-device-tpm-csharp.md) van de SDK van de C#-apparaat, kunt u door gaan met de overige stappen in deze Snelstartgids om uw gesimuleerde apparaat in te schrijven. Volg niet de stappen voor het maken van een afzonderlijke inschrijving via Azure Portal.
...
1. Als u de stappen in [een gesimuleerd TPM-apparaat maken en inrichten met behulp van C# Device SDK](quick-create-simulated-device-tpm-csharp.md) hebt gevolgd om een gesimuleerd TPM-apparaat te maken, voert u de volgende stappen uit:
