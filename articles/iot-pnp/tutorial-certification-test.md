...
1. Kies de [verificatie methode](../iot-dps/concepts-security.md#attestation-mechanism) om uw apparaat in te RICHTEN op AICS met behulp van de [Azure-IOT hub Device Provisioning Service](../iot-dps/about-iot-dps.md).
   * Als u een [x. 509-certificaat](../iot-hub/iot-hub-security-x509-get-started.md#prerequisites)gebruikt, uploadt u het gegenereerde x. 509-certificaat. U kunt de voorbeeld code bekijken die laat zien hoe u X. 509-certificaten gebruikt: [C](https://github.com/Azure/azure-iot-sdk-c/blob/master/iothub_client/samples/iothub_ll_client_x509_sample/iothub_ll_client_x509_sample.c), [C#](../iot-hub/iot-hub-security-x509-get-started.md).
