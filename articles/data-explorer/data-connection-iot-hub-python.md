---
title: Een IoT Hub-gegevensverbinding maken voor Azure Data Explorer met Python
description: In dit artikel leert u hoe u een IoT Hub-gegevensverbinding voor Azure Data Explorer maakt met Python.
...
ms.locfileid: "77669519"
---
# <a name="create-an-iot-hub-data-connection-for-azure-data-explorer-by-using-python-preview"></a>Een IoT Hub-gegevensverbinding voor Azure Data Explorer maken met Python (Voorbeeld)
...
* [Een IoT-hub met een gedeeld toegangsbeleid geconfigureerd](ingest-data-iot-hub.md#create-an-iot-hub).
...
| iot_hub_resource_id | *Resource-id* | De resource-ID van uw IoT-hub die de gegevens bevat voor opname.|
...
| consumer_group | *$Default* | De consumentengroep van uw eventhub.|
