---
title: Wat is de opslaghiërarchie van Azure NetApp-bestanden | Microsoft Documenten
...
---
# <a name="what-is-the-storage-hierarchy-of-azure-netapp-files"></a>Wat is de opslaghiërarchie van Azure NetApp-bestanden
...
> [!IMPORTANT] 
> Azure NetApp Files biedt momenteel geen ondersteuning voor bronmigratie tussen abonnementen.
...
- Een capaciteitsgroep kan pas worden verwijderd als alle volumes binnen de capaciteitsgroep zijn verwijderd.
...
- Een volume kan niet worden verplaatst over capaciteitsgroepen. <!--Within the same NetApp account, you can move a volume across pools.  -->   
  In het [onderstaande conceptuele diagram van opslaghiërarchie](#conceptual_diagram_of_storage_hierarchy) u de volumes bijvoorbeeld niet verplaatsen van Capaciteitsgroep 1 naar Capaciteitsgroep 2.
- Een volume kan pas worden verwijderd als alle momentopnamen zijn verwijderd.
