---
title: Pushmeldingen verzenden naar Xamarin.Forms-apps met Azure Notification Hubs via een back-endservice | Microsoft Docs
description: Leer hoe u meldingen kunt pushen naar Xamarin.Forms-apps die gebruik maken van Azure Notification Hubs via een back-endservice.
...
ms.locfileid: "85248935"
---
# <a name="tutorial-send-push-notifications-to-xamarinforms-apps-using-azure-notification-hubs-via-a-backend-service"></a>Zelfstudie: Pushmeldingen verzenden naar Xamarin.Forms-apps met Azure Notification Hubs via een back-endservice  

[![Voorbeeld downloaden](./media/notification-hubs-backend-service-xamarin-forms/download.png) Het voorbeeld downloaden](https://github.com/xamcat/mobcat-samples/tree/master/notification_hub_backend_service)  

In deze zelfstudie gebruikt u [Azure Notificatie Hubs](https://docs.microsoft.com/azure/notification-hubs/notification-hubs-push-notification-overview) om meldingen naar een [Xamarin.Forms](https://dotnet.microsoft.com/apps/xamarin/xamarin-forms)-app naar **Android** en **iOS** te pushen.  
...
> * [Een Xamarin.Forms-app voor meerdere platforms maken.](#create-a-cross-platform-xamarinforms-application)
...
* [Xamarin](https://dotnet.microsoft.com/apps/xamarin) en [Xamarin.Forms](https://dotnet.microsoft.com/apps/xamarin/xamarin-forms).

De beschikbare stappen zijn voor [Visual Studio voor Mac](https://visualstudio.microsoft.com/vs/mac/), maar u kunt het proces ook volgen met [Visual Studio 2019](https://visualstudio.microsoft.com/vs).
...
In deze sectie maakt u de [ASP.NET Core Web API](https://dotnet.microsoft.com/apps/aspnet/apis)-back-end om de [registratie van het apparaat](https://docs.microsoft.com/azure/notification-hubs/notification-hubs-push-notification-registration-management#what-is-device-registration) en het versturen van meldingen naar de mobiele Xamarin.Forms-app af te handelen.

[!INCLUDE [Create an ASP.NET Core Web API backend application](../../includes/notification-hubs-backend-service-web-api.md)]

## <a name="create-a-cross-platform-xamarinforms-application"></a>Een Xamarin.Forms-app op verschillende platforms maken

In deze sectie maakt u een mobiele [Xamarin. Forms](https://dotnet.microsoft.com/apps/xamarin/xamarin-forms)-app die pushmeldingen implementeert op verschillende platforms.
...
U zou nu een basis Xamarin.Forms-app moeten hebben die via een back-endservice is verbonden met een notification hub en die meldingen kan verzenden en ontvangen.
...
* [Xamarin in Windows installeren](https://docs.microsoft.com/xamarin/get-started/installation/windows)
