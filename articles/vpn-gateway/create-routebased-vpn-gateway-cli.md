...
description: Maak snel een op route gebaseerde Azure VPN-gateway met behulp van de Azure CLI, voor een VPN-verbinding met een on-premises netwerk of voor het verbinden van virtuele netwerken.
