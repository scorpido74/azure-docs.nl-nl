...
description: Meer informatie over het maken van een op route gebaseerde Azure VPN-gateway met behulp van Azure CLI. Een VPN-gateway gebruiken om verbinding te maken met uw on-premises netwerk.
