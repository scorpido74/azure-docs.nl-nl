...
description: Meer informatie over het configureren van Azure VPN-gateways om te voldoen aan cryptografische vereisten voor zowel cross-premises S2S VPN-tunnels als Azure VNet-naar-VNet-verbindingen.
