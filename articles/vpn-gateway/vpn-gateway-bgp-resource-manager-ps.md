...
* Installeer de Azure Resource Manager Power shell-cmdlets. Zie [Azure PowerShell installeren en configureren](/powershell/azure/) voor meer informatie over het installeren van de PowerShell-cmdlets. 
