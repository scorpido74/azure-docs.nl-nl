...
## <a name="signin"></a>Aanmelden en variabelen instellen
...
## 1. <a name="vnet"> </a>de resource groep, het VNet en het open bare IP-adres maken
...
## 2. <a name="radius"> </a>uw RADIUS-server instellen
...
## 4. <a name="addradius"> </a>Voeg de RADIUS-server en de client adres groep toe
...
## 5. <a name="vpnclient"> </a>down load het configuratie pakket voor de VPN-client en stel de VPN-client in
...
## <a name="connect"></a>6. Maak verbinding met Azure
