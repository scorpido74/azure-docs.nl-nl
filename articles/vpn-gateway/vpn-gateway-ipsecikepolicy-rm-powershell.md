...
## <a name="about"></a>IPsec-en IKE-beleids parameters voor Azure VPN-gateways
...
## <a name ="workflow"></a>Deel 1: werk stroom om IPsec/IKE-beleid te maken en in te stellen
...
## <a name ="params"></a>Deel 2: ondersteunde cryptografische algoritmen & sleutel sterktes
...
> [!IMPORTANT]
> 1. **De configuratie van uw on-premises VPN-apparaat moet overeenkomen met de volgende algoritmen en para meters die u opgeeft in het Azure IPsec/IKE-beleid:**
...
## <a name ="crossprem"></a>Deel 3: een nieuwe S2S-VPN-verbinding maken met het IPsec/IKE-beleid
...
## <a name ="vnet2vnet"></a>Deel 4: een nieuwe VNet-naar-VNet-verbinding maken met het IPsec/IKE-beleid
...
## <a name ="managepolicy"></a>Deel 5: het IPsec/IKE-beleid voor een verbinding bijwerken
