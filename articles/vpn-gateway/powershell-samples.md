---
title: Azure PowerShell-voorbeelden voor VPN Gateway
description: Gebruik deze Azure PowerShell-scripts voor het maken van VPN-gateways, het maken van site-naar-site- en Vnet-naar-Vnet-verbindingen en het downloaden van sjablonen voor VPN-apparaten.
