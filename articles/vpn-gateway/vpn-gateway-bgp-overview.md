...
U ook reclame maken voor grotere voorvoegsels die sommige van uw VNet-adresvoorvoegsels kunnen bevatten, zoals een grote privé-IP-adresruimte (bijvoorbeeld 10.0.0.0/8). Let op, hoewel de voorvoegsels niet identiek kunnen zijn aan een van uw VNet-voorvoegsels. Routes die identiek zijn aan uw VNet-voorvoegsels worden geweigerd.
