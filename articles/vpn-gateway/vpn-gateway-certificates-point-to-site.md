...
description: Maak een zelfondertekend basis certificaat, Exporteer de open bare sleutel en Genereer client certificaten voor P2S met behulp van Power shell op Windows 10 of Windows Server 2016.
