...
description: Meer informatie over het instellen van waarschuwingen op basis van bron logboek gebeurtenissen van Azure VPN Gateway, met behulp van Azure Monitor Log Analytics.
