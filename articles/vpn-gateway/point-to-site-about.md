...
## <a name="authentication"></a>Hoe worden P2S VPN-clients geverifieerd?
...
## <a name="gwsku"></a>Welke gateway-Sku's ondersteunen P2S VPN?
...
## <a name="IKE/IPsec policies"></a>Welke IKE/IPsec-beleids regels zijn geconfigureerd op VPN-gateways voor P2S?


**IKEv2**

|**Sterkte** | **Volledig** | **PRF** | **DH-groep** |
|---        | ---           | ---       | ---   |
...
## <a name="TLS policies"></a>Welke TLS-beleids regels zijn geconfigureerd op VPN-gateways voor P2S?
**TLS**
...
## <a name="faqradius"></a>Veelgestelde vragen over RADIUS-verificatie
