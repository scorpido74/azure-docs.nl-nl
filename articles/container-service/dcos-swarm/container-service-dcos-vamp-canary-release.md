...
1. Klik op de ![ nieuwe gebruikers interface: bewerken ](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) naast **gewicht**.
...
1. Klik op de pagina Sava/sava_cluster/webport- **gateways** op de Blade ![ -UI-bewerken ](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) om een **voor waarde** toe te voegen aan de route Sava/sava_cluster/Sava: 1.0.0/webport. 

2. Voer de voor waarde **User-agent = = Firefox** in en klik op de gebruiker van de ![ gebruikers interface-opslaan ](./media/container-service-dcos-vamp-canary-release/vamp_ui_save.png) .
...
3. Klik op ![ de gebruikers interface van vernieuwd-bewerken ](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) om de **sterkte** van de voor waarde te wijzigen.
 
4. Stel de **sterkte** in op 100% en klik op de functie van de ![ gebruikers interface-opslaan om op te ](./media/container-service-dcos-vamp-canary-release/vamp_ui_save.png) slaan.
...
5. Wijzig ten slotte het gewicht van de gateway om alle resterende verkeer (alle niet-Firefox-gebruikers) te verzenden naar de nieuwe Sava: 1.1.0. Klik op ![ de nieuwe gebruikers interface-bewerken ](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) naast **gewicht** en stel de wegings verdeling in op 100% wordt omgeleid naar de route Sava/sava_cluster/Sava: 1.1.0/webport.
...
* Ontwikkel documenten voor het maken van een automation-automatisering in Node.js en voer deze uit als de [werk stromen](https://docs.vamp.io/how-vamp-works/concepts-and-components#workflows).
