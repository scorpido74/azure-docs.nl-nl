...
1. Toegang tot uw DC/OS-gebruikers interface via `http://localhost:80/` . Ga in de DC/OS-gebruikers interface naar het tabblad **universum** en zoek naar **Dynatrace**.
