...
5. Vul het test formulier in en klik op **OK**.
   ...
   | Drempelwaarde voor beschadigde status |Aantal opeenvolgende test pogingen voordat de container een slechte status heeft. |
...
7. Vul het load balancer formulier in en klik op **OK**.
   ...
   | Back-endpoort |De interne en open bare poort van de container voor het routeren van verkeer naar. |
   | Back-end-pool |De containers in deze groep zijn het doel voor deze load balancer. |
