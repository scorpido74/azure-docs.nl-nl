...
Toegang tot uw DC/OS- `http://localhost:80/`gebruikers interface via. In de DC/OS-gebruikers interface navigeert u naar het ' universum ' aan de linkerkant en zoekt u naar ' Datadog ' en klikt u op installeren.
