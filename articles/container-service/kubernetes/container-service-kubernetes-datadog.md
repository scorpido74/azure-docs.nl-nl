...
U kunt testen of u het `az` hulp programma hebt geïnstalleerd door het volgende uit te voeren:
...
U kunt testen of u het `kubectl` hulp programma hebt geïnstalleerd door het volgende uit te voeren:
