...
Er is ondersteuning voor open-source DC/OS, Docker Swarm en Kubernetes. Zie het [overzicht](container-service-intro-kubernetes.md) voor meer informatie.
 
