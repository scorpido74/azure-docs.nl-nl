...
In dit artikel wordt beschreven hoe u een Azure Database for MariaDB-server kunt configureren om verbindingen voor een minimale TLS-versie af te dwingen en alle verbindingen met een lagere TLS-versie te weigeren, waardoor de netwerk beveiliging wordt verbeterd.
