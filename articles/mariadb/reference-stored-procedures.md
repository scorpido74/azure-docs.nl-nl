---
title: Beheer opgeslagen procedures - Azure Database voor MariaDB
description: Ontdek welke opgeslagen procedures in Azure Database voor MariaDB nuttig zijn om u te helpen bij het configureren van gegevens-in replicatie, het instellen van de tijdzone en het doden van query's.
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
---
# <a name="azure-database-for-mariadb-management-stored-procedures"></a>Azure Database voor opgeslagen procedures voor MariaDB-beheer

Opgeslagen procedures zijn beschikbaar in Azure Database voor MariaDB-servers om uw MariaDB-server te beheren. Dit omvat het beheren van de verbindingen, query's en het instellen van gegevens-in-replicatie van uw server.  
...
Als u Gegevens-in-replicatie wilt instellen tussen een stramien en een replica in Azure Database voor MariaDB, raadpleegt u [hoe u Gegevens-in-replicatie configureert.](howto-data-in-replication.md)

## <a name="other-stored-procedures"></a>Andere opgeslagen procedures

De volgende opgeslagen procedures zijn beschikbaar in Azure Database voor MariaDB om uw server te beheren.
