---
title: Methode voor het instellen van een persoonlijke koppeling voor de Azure Database for MariaDB-Portal (preview)
...
1. Geef in **Azure database for MariaDB** deze informatie op:
    ...
    |Version  | Selecteer de database versie van de MariaDB-server die vereist is.|
