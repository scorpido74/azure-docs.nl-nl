---
title: Een server herstellen in Azure Database for MariaDB
...
1. Selecteer **data bases** > **Azure database for MariaDB**. U kunt ook **MariaDB** in het zoekvak typen om de service te vinden.
