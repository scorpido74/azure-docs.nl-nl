...
> ```
> 
> Als ze niet zijn geregistreerd, gebruikt u de volgende opdracht om *Microsoft.OperationsManagement* en *Microsoft.OperationalInsights* te registreren:
> 
> ```azurecli
