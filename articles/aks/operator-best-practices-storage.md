---
title: 'Best practices voor Opera tors: opslag in azure Kubernetes Services (AKS)'
...
| Ongestructureerde gegevens, bestandssysteem bewerkingen | [BlobFuse (preview-versie)][blobfuse] | Ja | Ja | Ja | Nee |
...
Azure Files zijn momenteel beschikbaar in de laag Standard-prestatie. Azure disks is beschikbaar in de Standard-en Premium-prestatie lagen:
...
Als uw toepassingen Azure-schijven vereisen als opslag oplossing, moet u een geschikte VM-grootte voor het knoop punt plannen en kiezen. De hoeveelheid CPU en geheugen is niet de enige factor wanneer u een VM-grootte kiest. De opslag mogelijkheden zijn ook belang rijk. Zowel de VM-grootten *Standard_B2ms* als *Standard_DS2_v2* bevatten bijvoorbeeld een vergelijk bare hoeveelheid CPU-en geheugen bronnen. De mogelijke opslag prestaties verschillen, zoals wordt weer gegeven in de volgende tabel:

| Type en grootte van knoop punt | vCPU | Geheugen (GiB) | Maximaal aantal gegevensschijven | Maxi maal aantal IOPS niet in cache geplaatste schijven | Maxi maal aantal door Voer (MBps) niet in cache |
|--------------------|------|--------------|----------------|------------------------|--------------------------------|
| Standard_B2ms      | 2    | 8            | 4              | 1\.920                  | 22,5                           |
| Standard_DS2_v2    | 2    | 7            | 8              | 6\.400                  | 96                             |

Hier kan *Standard_DS2_v2* dubbel het aantal gekoppelde schijven hebben en drie tot vier keer de hoeveelheid IOPS en schijf doorvoer. Als u alleen de kern Compute-resources en de vergeleken kosten hebt bekeken, kunt u de grootte van de *Standard_B2ms* -VM kiezen en de prestaties en beperkingen van de opslag hebben. Werk samen met uw Application Development-team om inzicht te krijgen in hun opslag capaciteit en prestatie behoeften. Kies de juiste VM-grootte voor de AKS-knoop punten om te voldoen aan de prestatie vereisten of deze te overschrijden. Basislijn toepassingen regel matig om de VM-grootte naar behoefte aan te passen.
...
Met een permanente volume claim (PVC) kunt u zo nodig dynamisch opslag maken. De onderliggende Azure-schijven worden gemaakt als peul aanvragen. In de pod-definitie vraagt u een volume te maken en aan te koppelen aan een ontworpen koppel traject
