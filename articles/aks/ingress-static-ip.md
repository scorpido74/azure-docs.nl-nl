...
Gebruik de opdracht om de certificaat verlener te maken `kubectl apply -f cluster-issuer.yaml` .
...
Gebruik de opdracht om de certificaat bron te maken `kubectl apply -f certificates.yaml` .
