...
De `istio-proxy` container is automatisch geïnjecteerd door Istio om het netwerkverkeer van en naar uw componenten te beheren, zoals wordt weergegeven in de volgende voorbeelduitvoer:
