...
```
Configureer [op rollen gebaseerde Access Control (RBAC)](https://docs.microsoft.com/azure/aks/azure-ad-rbac) om extra beveiligings groepen voor uw clusters te configureren.
