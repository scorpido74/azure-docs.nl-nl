...
Lees de [Aanbevolen procedures voor AKS-cluster beveiliging][best-practices-security] meer informatie over [op hosts gebaseerde versleuteling](/azure/virtual-machines/linux/disk-encryption#host-based-encryption).
