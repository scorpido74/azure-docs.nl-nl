...
> [!IMPORTANT]
> U hebt de volgende RBAC-machtiging nodig Automanage te kunnen inschakelen: De rol van **Eigenaar** of **Inzender** en de rollen **Beheerders voor gebruikerstoegang**.
