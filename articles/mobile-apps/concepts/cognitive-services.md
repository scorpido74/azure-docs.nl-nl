---
title: Kunst matige intelligentie gebruiken om bedrijfs problemen op te lossen met Azure Cognitive Services
description: Meer informatie over de service om intelligente mobiele toepassingen te bouwen die worden aangedreven door kunst matige intelligentie.
author: codemillmatt
...
- **Vision**
    - Afbeeldings codes, miniaturen
    - OCR (hand schrift herkenning)
    - Gezichtsdetectie
    - Emotion-detectie
    - Video inzichten
    - Afbeeldings-en video toezicht
    - Aangepaste afbeeldings herkenning

- **Spraak**
    - Spraak naar tekst (Speech transcriptie)
    - Aangepaste spraak transcriptie (complexe woorden, ruis omgeving)
    - Tekst naar spraak
    - Luidspreker-ID en verificatie
    - Real-time spraak omzetting
...
- **Besluit** 
    - Content moderator
    - Persoonlijke levering van inhoud
    - Anomalie detectie

- **Zoeken**
    - Automatische Zoek suggesties 
    - Uitbreiden van entiteits gegevens
...
- Ondersteuning voor containers voor Cognitive Services
 ...
 ## <a name="references"></a>Verwijzingen
   ...
   - [Ondersteuning voor containers](/azure/cognitive-services/cognitive-services-container-support)
