...
- [Documentatie voor Azure Blob-opslag](/azure/storage/blobs/storage-blobs-introduction)
...
**Referentie**
- [Azure Portal](https://portal.azure.com)
- [Documentatie over Azure Files](/azure/storage/files/storage-files-introduction)
