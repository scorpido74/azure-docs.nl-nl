...
In dit artikel vindt u specifieke informatie over de ondersteuning voor lezen en schrijven voor alle XML-tags en bekende tekst geometrie typen. Het bevat ook informatie over de manier waarop gescheiden ruimtelijke gegevens worden geparseerd in de ruimtelijke IO-module.
...
| Element naam         | Lezen    | Schrijven   | Opmerkingen                                                                                                                      |
|----------------------|---------|---------|----------------------------------------------------------------------------------------------------------------------------|
...
| `atom:link`          | ja     | ja     |                                                                                                                            |
| `atom:name`          | ja     | ja     |                                                                                                                            |
| `BalloonStyle`       | gedeeltelijke | gedeeltelijke | `displayMode` wordt niet ondersteund. Geconverteerd naar een `PopupTemplate`. Als u wilt schrijven, voegt u een `popupTemplate` eigenschap toe als een eigenschap van de functie waarvoor u deze wilt schrijven. |
| `begin`              | ja     | ja     |                                                                                                                            |
| `color`              | ja     | ja     | Bevat `#AABBGGRR` en `#BBGGRR`. Geparseerd naar een CSS-kleur teken reeks                                                           |
| `colorMode`          | ja     | nee      |                                                                                                                            |
| `coordinates`        | ja     | ja     |                                                                                                                            |
| `Data`               | ja     | ja     |                                                                                                                            |
| `description`        | ja     | ja     |                                                                                                                            |
...
| `Link`               | ja     | nee      | Alleen de eigenschap `href` wordt ondersteund voor netwerk koppelingen.                                                                   |
...
| `text`               | ja     | ja     | Het vervangen van `$[geDirections]` wordt niet ondersteund                                                                          |
| `textColor`          | ja     | ja     |                                                                                                                            |
| `TimeSpan`           | ja     | ja     |                                                                                                                            |
| `TimeStamp`          | ja     | ja     |                                                                                                                            |
| `value`              | ja     | ja     |                                                                                                                            |
| `viewRefreshMode`    | gedeeltelijke | nee      |  Als er wordt verwezen naar een WMS-service, wordt alleen `onStop` ondersteund voor de grond overlays. Voegt `BBOX=[bboxWest],[bboxSouth],[bboxEast],[bboxNorth]` toe aan de URL en wordt bijgewerkt als de kaart wordt verplaatst.  |
| `visibility`         | ja     | ja     |                                                                                                                            |
| `west`               | ja     | ja     |                                                                                                                            |
| `when`               | ja     | ja     |                                                                                                                            |
| `width`              | ja     | ja     |                                                                                                                            |
...
| `georss:box`             | ja     | nee    | Lezen als een veelhoek en op basis van een `subType` eigenschap van ' Rectangle '                                |
| `georss:circle`          | ja     | ja   |                                                                                                |
| `georss:elev`            | ja     | ja   |                                                                                                |
...
| `rss:cloud`              | ja     | nee    |                                                                                                |
| `rss:comments`           | ja     | nee    |                                                                                                |
| `rss:copyright`          | ja     | gedeeltelijke | Dit is geschreven als `atom:rights` als er al een `rights` `properties`-eigenschap is.       |
| `rss:description`        | ja     | gedeeltelijke | Dit is geschreven als `atom:content` als er al een `content` `properties`-eigenschap is.      |
| `rss:docs`               | ja     | nee    |                                                                                                |
| `rss:enclosure`          | ja     | nee    |                                                                                                |
| `rss:generator`          | ja     | nee    |                                                                                                |
| `rss:guid`               | ja     | gedeeltelijke | Dit is geschreven als `atom:id` als er al een `id` `properties`-eigenschap is.         |
| `rss:image`              | ja     | gedeeltelijke | Dit is geschreven als `atom:logo` als er al een `logo` `properties`-eigenschap is.      |
| `rss:item`               | ja     | gedeeltelijke | Geschreven als een `atom:entry`.                                                                  |
| `rss:language`           | ja     | nee    |                                                                                                |
| `rss:lastBuildDate`      | ja     | gedeeltelijke | Dit is geschreven als `atom:updated` als er al een `updated` `properties`-eigenschap is.     |
...
| `rss:pubDate`            | ja     | gedeeltelijke | Dit is geschreven als `atom:published` als er al een `published` `properties`-eigenschap is.  |
| `rss:rating`             | ja     | nee    |                                                                                                |
| `rss:skipDays`           | ja     | nee    |                                                                                                |
...
| `gml:MultiCurve`        | ja  | nee    | Alleen `gml:LineString`-leden worden gelezen. Geschreven als `gml.MultiLineString`                  |
...
| `gml:MultiSurface`      | ja  | nee    | Alleen `gml:Polygon`-leden worden gelezen. Geschreven als `gml.MultiPolygon`                        |
| `gml:name`              | ja  | ja   |                                                                                        |
...
| `gpxx:DisplayColor`      | ja     | nee      | Wordt gebruikt om de kleur van een vorm op te geven. In plaats daarvan wordt `gpx_style:line` kleur gebruikt.  |
| `gpxx:RouteExtension`    | gedeeltelijke | nee      | Alle eigenschappen worden in `properties`gelezen. Alleen `DisplayColor` wordt gebruikt.                     |
| `gpxx:TrackExtension`    | gedeeltelijke | nee      | Alle eigenschappen worden in `properties`gelezen. Alleen `DisplayColor` wordt gebruikt.                     |
| `gpxx:WaypointExtension` | gedeeltelijke | nee      | Alle eigenschappen worden in `properties`gelezen. Alleen `DisplayColor` wordt gebruikt.                     |
| `gpx:keywords`           | ja     | ja     |                                                                                             |
| `gpx:fix`                | ja     | ja     |                                                                                             |
...
## <a name="supported-well-known-text-geometry-types"></a>Ondersteunde typen bekende tekst geometrie
...
\[1\] alleen Z para meter wordt vastgelegd en toegevoegd als derde waarde in de positie waarde.

\[2\] M-para meter is niet vastgelegd.
...
De eerste rij met gegevens wordt gescand op teken reeksen die een bekende tekst indeling hebben. 
