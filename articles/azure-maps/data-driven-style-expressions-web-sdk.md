...
| Type of expressions | Beschrijving |
|---------------------|-------------|
...
| Expressie | Return type | Beschrijving |
|------------|-------------|-------------|
...
| `['get', string]` | waarde | Gets the property value from the current feature's properties. Returns null if the requested property is missing. |
| `['get', string, object]` | waarde | Gets the property value from the properties of the provided object. Returns null if the requested property is missing. |
| `['has', string]` | booleaans | Determines if the properties of a feature have the specified property. |
| `['has', string, object]` | booleaans | Determines if the properties of the object have the specified property. |
| `['id']` | waarde | Gets the feature's ID if it has one. |
| `['length', string | array]` | getal | Gets the length of a string or array. |
...
| Expressie | Return type | Beschrijving |
|------------|-------------|-------------|
| `['+', number, number, …]` | getal | Calculates the sum of the specified numbers. |
| `['-', number]` | getal | Subtracts 0 by the specified number. |
| `['-', number, number]` | getal | Subtracts the first numbers by the second number. |
| `['*', number, number, …]` | getal | Multiplies the specified numbers together. |
| `['/', number, number]` | getal | Divides the first number by the second number. |
| `['%', number, number]` | getal | Calculates the remainder when dividing the first number by the second number. |
| `['^', number, number]` | getal | Calculates the value of the first value raised to the power of the second number. |
| `['abs', number]` | getal | Calculates the absolute value of the specified number. |
| `['acos', number]` | getal | Calculates the arccosine of the specified number. |
| `['asin', number]` | getal | Calculates the arcsine of the specified number. |
| `['atan', number]` | getal | Calculates the arctangent of the specified number. |
| `['ceil', number]` | getal | Rounds the number up to the next whole integer. |
| `['cos', number]` | getal | Calculates the cos of the specified number. |
| `['e']` | getal | Returns the mathematical constant `e`. |
| `['floor', number]` | getal | Rounds the number down to the previous whole integer. |
| `['ln', number]` | getal | Calculates the natural logarithm of the specified number. |
| `['ln2']` | getal | Returns the mathematical constant `ln(2)`. |
| `['log10', number]` | getal | Calculates the base-ten logarithm of the specified number. |
| `['log2', number]` | getal | Calculates the base-two logarithm of the specified number. |
| `['max', number, number, …]` | getal | Calculates the maximum number in the specified set of numbers. |
| `['min', number, number, …]` | getal | Calculates the minimum number in the specified set of numbers. |
| `['pi']` | getal | Returns the mathematical constant `PI`. |
| `['round', number]` | getal | Rounds the number to the nearest integer. Halfway values are rounded away from zero. For example, `['round', -1.5]` evaluates to -2. |
| `['sin', number]` | getal | Calculates the sine of the specified number. |
| `['sqrt', number]` | getal | Calculates the square root of the specified number. |
| `['tan', number]` | getal | Calculates the tangent of the specified number. |
...
| Expressie | Return type | Beschrijving |
|------------|-------------|-------------|
| `['! ', boolean]` | booleaans | Logical negation. Returns `true` if the input is `false`, and `false` if the input is `true`. |
| `['!= ', value, value]` | booleaans | Returns `true` if the input values are not equal, `false` otherwise. |
| `['<', value, value]` | booleaans | Returns `true` if the first input is strictly less than the second, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['<=', value, value]` | booleaans | Returns `true` if the first input is less than or equal to the second, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['==', value, value]` | booleaans | Returns `true` if the input values are equal, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['>', value, value]` | booleaans | Returns `true` if the first input is strictly greater than the second, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['>=' value, value]` | booleaans | Returns `true` if the first input is greater than or equal to the second, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['all', boolean, boolean, …]` | booleaans | Returns `true` if all the inputs are `true`, `false` otherwise. |
| `['any', boolean, boolean, …]` | booleaans | Returns `true` if any of the inputs are `true`, `false` otherwise. |
...
| `['to-boolean', value]` | booleaans | Converts the input value to a boolean. The result is `false` when the input is an empty string, `0`, `false`, `null`, or `NaN`; otherwise its `true`. |
...
| Lineair  | Exponentieel | Cubic Bezier |
|---------|-------------|--------------|
