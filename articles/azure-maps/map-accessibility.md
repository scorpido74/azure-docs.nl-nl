...
- Met de kaart focus, gebruikt u het plus teken (`+`) of * gelijkteken (`=`) om op één niveau in te zoomen.
- Gebruik het minteken, het koppel teken (`-`) of het Onderstrepings teken (`_`) om één niveau uit te zoomen.
...
| Plus teken (`+`) of <sup>*</sup>is gelijk aan-teken (`=`) | Inzoomen |
