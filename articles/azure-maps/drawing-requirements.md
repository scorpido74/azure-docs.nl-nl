...
U kunt de DWG-bestanden op een wille keurige manier in de map indelen, maar het manifest bestand moet zich in de hoofdmap van de map bevinden. U moet de map in één archief bestand met de extensie. zip zip. De volgende secties beschrijven de vereisten voor de DWG-bestanden, het manifest bestand en de inhoud van deze bestanden.  
...
* Buitens moeten worden getekend als veelhoek, poly lijn (gesloten) of cirkel.
* Buitens kunnen overlappen, maar worden in één geometrie opgelost.
...
Het DWG-bestand voor elk niveau definieert een laag met eenheden. Eenheden zijn navigeerbaar ruimten in het gebouw, zoals kant oren, hal, traps en liften. De laag eenheden moet voldoen aan de volgende vereisten:

* Eenheden moeten worden getekend als veelhoek, poly lijn (gesloten) of cirkel.
...
* Wanden moeten worden getekend als veelhoek, poly lijn (gesloten) of cirkel.
...
* Zones moeten worden getekend als veelhoek, poly lijn (gesloten) of cirkel.
...
Het DWG-bestand voor elk niveau kan een UnitLabel-laag bevatten. De UnitLabel-laag voegt een naam eigenschap toe aan eenheden die zijn geëxtraheerd uit de laag van de eenheid. Voor eenheden met een naam eigenschap kunnen aanvullende details worden opgegeven in het manifest bestand.
...
Het DWG-bestand voor elk niveau kan een ZoneLabel-laag bevatten. Deze laag voegt een naam eigenschap toe aan zones die worden geëxtraheerd uit de laag van de zone. In zones met een naam eigenschap kunnen aanvullende details worden opgegeven in het manifest bestand.
...
Hier volgt een voor beeld van een manifest bestand voor het voorbeeld teken pakket. Zie voor [beeld tekening pakket](https://github.com/Azure-Samples/am-creator-indoor-data-examples)om het hele pakket te downloaden.
