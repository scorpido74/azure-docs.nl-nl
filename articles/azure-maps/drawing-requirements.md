...
| isRoutable | booleaans | false | Als deze instelling `false` is ingesteld op, kan eenheid niet worden genavigeerd naar of via. De standaardwaarde is `true`. |
