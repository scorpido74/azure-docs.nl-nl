...
Als u de agent op de achtergrond wilt installeren en een installatie logboek bestand `C:\Support\Logs` in de map wilt maken, voert u de volgende opdracht uit.
