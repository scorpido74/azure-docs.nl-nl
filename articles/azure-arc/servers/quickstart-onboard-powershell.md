...
* Als u de agent al hebt geïnstalleerd, voert u de opdracht uit `/opt/azcmagent/bin/hybridrp_proxy add https://{proxy-url}:{proxy-port}`, waarmee de proxy wordt geconfigureerd en de agent opnieuw wordt gestart.
