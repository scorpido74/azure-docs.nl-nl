...
## <a name="understand"></a>Over routes
...
## <a name="view"></a>Efficiënte routes weer geven
...
### <a name="routetable"></a>Route tabel van de hub
...
### <a name="abouthubroute"></a>Over de route tabel van de hub
...
### <a name="aboutdefaultroute"></a>Over de standaard route (0.0.0.0/0)
