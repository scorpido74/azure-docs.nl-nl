...
De volgende lijst bevat de gegevens bronnen in azure die u kunt gebruiken met Azure Databricks. Zie [gegevens bronnen voor Azure Databricks](/azure/databricks/data/data-sources/index.html)voor een volledige lijst met gegevens bronnen die kunnen worden gebruikt met Azure Databricks.
...
Zie [gegevens bronnen voor Azure Databricks](/azure/databricks/data/data-sources/index.html#)voor meer informatie over de bronnen waaruit u gegevens kunt importeren in azure Databricks.
