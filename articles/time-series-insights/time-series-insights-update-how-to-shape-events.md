...
In dit artikel leert u hoe u uw JSON-bestand kunt vorm geven om de efficiëntie van uw Azure Time Series Insights preview-query's te optimaliseren.
...
| deviceId  | Type | L1 | L2 | tijdstempel | reeks. Stroom verhouding FT3/s | reeks. Snelheid van de motor olie druk psi |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
