...
- Clouds: alles (wereld wijd, onderdaan, overheid en soeverein)
...
Zie de [API-documentatie](https://docs.microsoft.com/api/securitycenter/)voor gedetailleerde informatie en voor beelden van gebruik. 
