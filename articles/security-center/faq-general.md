...
Security Center gebruikt de Microsoft Monitoring Agent om gegevens te verzamelen en op te slaan. Zie [Gegevensverzameling in Azure Security Center](security-center-enable-data-collection.md)voor uitgebreide details.
