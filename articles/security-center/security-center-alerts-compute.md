...
* Voor **AKS-cluster niveau**is er sprake van detectie van bedreigingen op basis van de analyse van Kubernetes-controle Logboeken. Als u deze bewaking zonder **agents** wilt inschakelen, voegt u de optie Kubernetes toe aan uw abonnement op de pagina met **prijs & instellingen** (Zie [prijzen](security-center-pricing.md)). Als u waarschuwingen op dit niveau wilt genereren, controleert Security Center uw door AKS beheerde services met de logboeken die zijn opgehaald door AKS. Voor beelden van gebeurtenissen op dit niveau zijn onder andere weer gegeven Kubernetes-Dash boards, het maken van rollen met hoge bevoegdheden en gevoelige koppelingen. 
