...
Nadat u uw Azure-abonnement hebt voor bereid, kunt u Security Center voor het beveiligen van uw virtuele machines die worden uitgevoerd op Azure Stack door de extensie van de virtuele machine voor de **Azure monitor, update en configuratie beheer** van de Azure stack Marketplace toe te voegen.
