...
3. Schakel onder **prijs categorie**in de rij **app service** het abonnement in op **ingeschakeld**.
    ...
    [![App-Services inschakelen in uw Standard-laag abonnement](media/security-center-app-services/app-services-toggle.png)](media/security-center-app-services/app-services-toggle.png#lightbox)
