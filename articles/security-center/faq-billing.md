---
title: 'Azure Security Center Veelgestelde vragen: vragen over facturering'
description: Deze veelgestelde vragen antwoorden op facturerings vragen over Azure Security Center, een product waarmee u bedreigingen kunt voor komen, detecteren en reageren.
...
- **Azure Defender** voegt mogelijkheden voor beveiliging tegen bedreigingen toe met beveiligings waarschuwingen, bedreigings informatie, gedrags analyse, afwijkings detectie en rapporten met betrekking tot risico toewijzing. U kunt een gratis proef versie van 30 dagen voor Azure Defender starten. [Meer informatie over upgraden](security-center-pricing.md).
