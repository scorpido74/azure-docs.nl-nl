...
5. Selecteer **Opslaan**. De agent wordt binnen 15 minuten geïmplementeerd op alle virtuele machines. 

>[!TIP]
> Als een werk ruimte moet worden ingericht, kan de installatie van de agent tot wel 25 minuten duren.
