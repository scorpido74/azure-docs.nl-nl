...
Zie [Azure Active Directory B2C: gebruikers migratie](active-directory-b2c-user-migration.md) voor meer informatie over het gebruik van de voor beeld-app.
