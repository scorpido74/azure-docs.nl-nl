...
Azure AD B2C breidt de set kenmerken uit die zijn opgeslagen op elk gebruikers account. U kunt deze kenmerken ook lezen en schrijven met behulp van de [Azure AD-Graph API](active-directory-b2c-devquickstarts-graph-dotnet.md).
