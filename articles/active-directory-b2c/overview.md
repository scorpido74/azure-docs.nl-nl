...
![Infographic van Azure AD B2C-id-providers en downstream-toepassingen](./media/overview/azureadb2c-overview.png)
...
![Aangepaste registratie-en aanmeldings pagina's en achtergrond afbeelding](./media/overview/sign-in-small.png)
...
![Diagram van identiteiten van derden federeren naar Azure AD B2C](./media/overview/scenario-singlesignon.png)
...
![Een logisch diagram van Azure AD B2C het communiceren met een extern gebruikers archief](./media/overview/scenario-remoteprofile.png)
...
Een andere reis optie voor een gebruiker bevat progressieve profilering. Met de progressieve profilering kunnen uw klanten snel hun eerste transactie voltooien door een minimale hoeveelheid informatie te verzamelen. Verzamelt vervolgens geleidelijk meer profiel gegevens van de klant voor toekomstige aanmeldingen.

![Een visuele voors telling van progressieve profilering](./media/overview/scenario-progressive.png)
...
![Een diagram van de gebruikers stroom voor identiteits controle van derden](./media/overview/scenario-idproofing.png)
...
## <a name="example-woodgrove-groceries"></a>Voor beeld: WoodGrove-boodschappen
...
![Afzonderlijke aanmeldings pagina's (B2C), Business (B2C) en partners (B2B)](./media/overview/woodgrove-overview.png)
...
![Aangepaste WoodGrove-aanmeldings pagina gehost door Azure AD B2C](./media/overview/sign-in.png)
...
![Aangepaste WoodGrove-aanmeldings pagina die wordt gehost door Azure AD B2C](./media/overview/sign-up.png)
...
![Website van WoodGrove-boodschappen waarop de gebruiker is aangemeld](./media/overview/signed-in-individual.png)
