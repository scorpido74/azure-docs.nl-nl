...
U kunt de interactie ook als een Orchestration-stap ontwerpen. Zie voor meer informatie [Walkthrough: integreer rest API claim uitwisselingen in uw Azure AD B2C gebruikers traject als een](custom-policy-rest-api-claims-exchange.md)indelings stap.
...
- Een Azure AD B2C-Tenant die is geconfigureerd voor het volt ooien van een lokaal account, aanmelden/aanmelden, zoals beschreven in [aan de slag](custom-policy-get-started.md).
...
[De profiel wijziging en gebruikers registratie wijzigen om aanvullende informatie van uw gebruikers te verzamelen](custom-policy-custom-attributes.md)
