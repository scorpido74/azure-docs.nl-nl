...
De gebruikers interface-elementen van de telefoon Factor Authentication-pagina kunnen worden [gelokaliseerd](localization-string-ids.md#phone-factor-authentication-page-user-interface-elements).
