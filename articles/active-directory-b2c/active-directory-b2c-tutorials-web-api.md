...
Voer de stappen en vereisten in de [zelf studie uit: Schakel verifiëren in een webtoepassing in met behulp van Azure Active Directory B2C](active-directory-b2c-tutorials-web-app.md).
