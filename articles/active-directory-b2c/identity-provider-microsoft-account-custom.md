...
1. Zoek in het bestand *TrustFrameworkExtensions. XML* het element **OrchestrationStep** op dat is opgenomen `Order="1"` in de gebruikers traject die u hebt gemaakt.
