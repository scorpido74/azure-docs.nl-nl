...
Volg de stappen in het artikel [aan de slag met aangepast beleid](custom-policy-get-started.md). Test de inschrijvings-of aanmeldings traject van de gebruiker om een nieuw lokaal account aan te melden voordat u verdergaat.
...
![Besturings element voor vervolg keuzelijst met één selectie meerdere opties weer geven](./media/custom-policy-configure-user-input/dropdown-menu-example.png)
...
![Besturings element selectie vakje met meerdere opties](./media/custom-policy-configure-user-input/multiselect-menu-example.png)
