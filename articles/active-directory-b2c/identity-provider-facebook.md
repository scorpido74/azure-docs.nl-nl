...
1. Voer in **site-URL**het adres van uw website in, bijvoorbeeld `https://contoso.com` . Voer een URL in voor **Privacy Policy URL**, bijvoorbeeld `http://www.contoso.com/privacy`. De beleids-URL is een pagina die u kunt onderhouden voor het verstrekken van privacy-informatie voor uw toepassing.
