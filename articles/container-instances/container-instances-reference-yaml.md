...
|  gebruikersnaam | string | Ja | De gebruikers naam voor het persoonlijke REGI ster. |
|  wachtwoord | string | Nee | Het wacht woord voor het persoonlijke REGI ster. |
...
|  waarde | string | Nee | De waarde van de omgevings variabele. |
