...
Gebruik de API voor het gebruik van de [lijst](/rest/api/container-instances/location/listusage) om het huidige quotum gebruik in een regio voor een abonnement te controleren.
