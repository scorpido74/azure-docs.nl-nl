...
Als u een ticket wilt openen wanneer u geen actieve cache hebt, gebruikt u de pagina hoofd hulp en ondersteuning van de Azure Portal. Open het menu Portal vanuit het besturings element linksboven in het scherm, schuif naar beneden en klik op **Help en ondersteuning**.

Kies een **nieuwe ondersteunings aanvraag** en selecteer **technische** voor hulp specifiek voor Azure HPC-cache.

Selecteer uw abonnement in de lijst.

Als u de service Azure HPC cache wilt zoeken, klikt u op de knop **alle services** en zoekt u naar HPC.
