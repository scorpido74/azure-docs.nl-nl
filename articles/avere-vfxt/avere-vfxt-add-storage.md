...
U kunt bijvoorbeeld `/vfxt/files` maken om toe te wijzen aan uw NetApp-kern bestand `/vol0/data` exporteren en de `/project/resources` submap.
...
* [Mount the Avere vFXT cluster](avere-vfxt-mount-clients.md) (Avere vFXT-cluster koppelen)
