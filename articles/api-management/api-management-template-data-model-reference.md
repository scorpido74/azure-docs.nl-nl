...
|--------------|----------|-----------------|  
|`id`|tekenreeks|Resource-id. Identificeert de API binnen het huidige API Management service-exemplaar. De waarde is een geldige relatieve URL in de indeling van `apis/{id}` waarbij `{id}` een API-id is. Deze eigenschap is alleen-lezen.|  
...
|Eigenschap|Type|Beschrijving|  
|--------------|----------|-----------------|  
|`Id`|tekenreeks|Resource-id. Hiermee wordt het product uniek geïdentificeerd binnen het huidige API Management service-exemplaar. De waarde is een geldige relatieve URL in de indeling van `products/{pid}` waarbij `{pid}` een product-id is. Deze eigenschap is alleen-lezen.|  
...
|`ProductId`|tekenreeks|De product resource-id van het geabonneerde product. De waarde is een geldige relatieve URL in de indeling van `products/{pid}` waarbij `{pid}` een product-id is.|  
...
|`CreatedDate`|Datum/tijd|De datum waarop het abonnement is gemaakt, in ISO 8601-indeling: `2014-06-24T16:25:00Z`.|  
...
|`NotificationDate`|Datum/tijd|De meldings datum voor het abonnement, in ISO 8601-indeling: `2014-06-24T16:25:00Z`.|  
