...
5. Selecteer eventueel **+** onder **api's** om een of meer api's aan deze gateway bron te koppelen.
> [!TIP]
> U kunt een API koppelen aan en verwijderen uit een gateway op het tabblad **instellingen** van de API.

> [!IMPORTANT]
> Standaard wordt geen van de bestaande Api's gekoppeld aan de nieuwe gateway resource. Daarom worden pogingen om deze via de nieuwe gateway aan te roepen tot `404 Resource Not Found` reacties.
6. Klik op **Toevoegen**.
