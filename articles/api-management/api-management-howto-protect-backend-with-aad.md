...
```
> [!NOTE]
> Deze `openid-config` URL komt overeen met het v1-eind punt. Gebruik `https://login.microsoftonline.com/common/v2.0/.well-known/openid-configuration`voor het v2 `openid-config`-eind punt.
