...
| ------------- | ---- | ---- | ---- | ---- | ---- 
| Inzender voor API Management-service | ✓ | ✓ | ✓ | ✓ | Super gebruiker. Heeft volledige ruwe toegang tot API Management Services en entiteiten (bijvoorbeeld Api's en beleids regels). Heeft toegang tot de verouderde Publisher-Portal. |
...
| <sup>*</sup> van API Management inhouds beheerder | ✓ | | | ✓ | Kan de ontwikkelaars portal beheren. Alleen-lezen toegang tot services en entiteiten.|
