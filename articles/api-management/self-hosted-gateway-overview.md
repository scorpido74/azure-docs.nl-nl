...
Als u zelf-hostende gateways in dezelfde omgevingen implementeert als back-end-API-implementaties en deze aan de API Management-service toevoegt, kan API-verkeer rechtstreeks naar de back-end-Api's stromen, waardoor de latentie wordt verbeterd, worden de kosten voor gegevens overdracht geoptimaliseerd en kunnen naleving, met behoud van de voor delen van het beheer en de detectie van alle Api's binnen de organisatie, ongeacht waar de implementaties worden gehost.
