...
description: Meer informatie over het concept van abonnementen in azure API Management. Gebruikers krijgen toegang tot Api's met behulp van abonnementen in azure API Management.
