...
1. Kies **apparaten** in het navigatie menu aan de linkerkant. Hier ziet u een lijst met alle apparaten en de sjablonen van uw apparaten.
...
1. In het rechterdeel venster van de pagina **apparaten** ziet u een lijst met apparaten die zijn gemaakt op basis van die apparaataccount. Kies een afzonderlijk apparaat om de pagina met details van het apparaat voor dat apparaat weer te geven:
    ...
    ![Pagina Details van apparaat](./media/howto-manage-devices-pnp/devicelist.png)
...
1. Kies **apparaten** in het navigatie menu aan de linkerkant.
...
1. Selecteer **importeren**.
    ...
    ![Import actie](./media/howto-manage-devices-pnp/bulkimport1a.png)
...
1. Zodra het importeren is voltooid, wordt een bericht weer gegeven in het deel venster apparaten.
    ...
    ![Import geslaagd](./media/howto-manage-devices-pnp/bulkimport3a.png)
...
1. Kies in het linkerdeel venster **alle apparaten**:
    ...
    ![Niet-gekoppelde apparaten](./media/howto-manage-devices-pnp/unassociateddevices1a.png)
...
1. Selecteer **migreren**:
    ...
    ![Apparaten koppelen](./media/howto-manage-devices-pnp/unassociateddevices2a.png)
...
1. Selecteer de apparaten die u wilt exporteren en selecteer vervolgens de **export** actie.
    ...
    ![Exporteren](./media/howto-manage-devices-pnp/export1a.png)
...
1. Selecteer de koppeling **bestand downloaden** om het bestand te downloaden naar een lokale map op de schijf.
    ...
    ![Het exporteren is voltooid](./media/howto-manage-devices-pnp/export2a.png)
...
1. Kies **apparaten** in het navigatie menu.
