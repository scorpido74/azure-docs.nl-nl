...
1. Kies **device Explorer** in het linkerdeel venster. Hier ziet u een lijst met de [sjablonen](howto-set-up-template.md)van uw apparaten.
...
1. Kies **device Explorer** in het linkerdeel venster.
