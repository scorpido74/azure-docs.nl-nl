...
![Een toepassings pagina maken in azure IoT Central](media/quick-deploy-iot-central-pnp/iotcentralcreate-templates-pnp.png)
...
1. Azure IoT Central genereert ook een uniek voor voegsel voor de **toepassings-URL** , op basis van de naam van de toepassing. U gebruikt deze URL om toegang te krijgen tot uw toepassing. Als u wilt, kunt u dit URL-voor voegsel wijzigen in iets eenvoudiger te onthouden.
    ...
    ![Een toepassings pagina maken in azure IoT Central](media/quick-deploy-iot-central-pnp/iotcentralcreate-industry-pnp.png)
...
> [Een gesimuleerd apparaat toevoegen aan uw IoT Central-toepassing](./quick-create-pnp-device-pnp.md)
