...
ms.locfileid: "72950494"
---
# <a name="customize-the-azure-iot-central-ui-preview-features"></a>De gebruikers interface van Azure IoT Central aanpassen (preview-functies)
...
![Standaard IoT Central-thema](./media/howto-customize-ui-pnp/standard-ui.png)
...
![Aangepast IoT Central thema](./media/howto-customize-ui-pnp/themed-ui.png)
...
![IoT Central-Thema's](./media/howto-customize-ui-pnp/themes.png)
...
Als uw logo afbeelding de naam van uw toepassing bevat, kunt u de tekst van de toepassings naam verbergen. Zie [uw toepassing beheren](./howto-administer-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json#change-application-name-and-url)voor meer informatie.
...
![Help-koppelingen voor IoT Central aanpassen](./media/howto-customize-ui-pnp/help-links.png)

U kunt ook nieuwe vermeldingen toevoegen aan het menu Help en standaard vermeldingen verwijderen:

![Help voor aangepaste IoT Central](./media/howto-customize-ui-pnp/custom-help.png)
...
- [Uw toepassing beheren](./howto-administer-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
- [Tegels toevoegen aan uw dash board](./howto-add-tiles-to-your-dashboard.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)