...
Voordat u begint, moet u de drie vorige Quick starts volt ooien [een Azure IOT Central-toepassing maken](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json), [een gesimuleerd apparaat toevoegen aan uw IOT Central toepassing](./quick-create-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) en [regels en acties voor uw apparaat configureren](quick-configure-rules-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
Open het e-mail bericht dat u hebt ontvangen aan het einde van de [regels en acties voor de Snelstartgids van uw apparaat](quick-configure-rules-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) . Selecteer in het e-mail bericht de koppeling naar het apparaat:

![E-mailwaarschuwing](media/quick-monitor-devices-pnp/email.png)
...
![Apparaat dat het e-mailbericht met de melding heeft geactiveerd](media/quick-monitor-devices-pnp/dashboard.png)
...
![Instellingen bijwerken](media/quick-monitor-devices-pnp/change-settings.png)
...
> [Een sjabloon voor een apparaat maken en beheren](howto-set-up-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
