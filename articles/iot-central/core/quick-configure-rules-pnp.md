...
Voordat u begint, moet u de twee vorige Quick starts volt ooien om [een Azure IOT Central-toepassing te maken](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) en [een gesimuleerd apparaat toe te voegen aan uw IOT Central-toepassing](./quick-create-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) om het apparaat sjabloon **omgevings sensor** te maken waarmee u kunt werken.
...
1. In de sectie **voor waarden** definieert u wat uw regel activeert. Gebruik de volgende informatie om een voor waarde op te geven op basis van de Tempe ratuur van de telemetrie:
    ...
    ![Regel voorwaarde maken](./media/quick-configure-rules-pnp/condition.png)
...
1. Gebruik de informatie in de volgende tabel om uw actie te definiëren:
    ...
    ![Regel actie maken](./media/quick-configure-rules-pnp/action.png)
...
> [Gebruik Azure IOT Central om uw apparaten te bewaken](quick-monitor-devices-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
