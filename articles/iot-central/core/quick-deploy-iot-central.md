...
U maakt een nieuwe toepassing in de lijst met branchespecifieke IoT Central sjablonen waarmee u snel aan de slag kunt gaan, of helemaal met de sjabloon voor **aangepaste apps** . In deze Quick Start gebruikt u de sjabloon **aangepaste app** .

Een nieuwe Azure IoT Central-toepassing maken vanuit de sjabloon voor **aangepaste apps** :
...
1. Kies **aangepaste app** en zorg ervoor dat de sjabloon voor de **aangepaste toepassing** is geselecteerd.
...
1. Azure IoT Central genereert ook een uniek voor voegsel voor de **toepassings-URL** , op basis van de naam van de toepassing. U gebruikt deze URL om toegang te krijgen tot uw toepassing. Wijzig dit URL-voor voegsel in iets wat u graag wilt onthouden.
    ...
    ![Facturerings gegevens voor Azure IoT Central](media/quick-deploy-iot-central/iotcentralcreate-billinginfo-pnp.png)
