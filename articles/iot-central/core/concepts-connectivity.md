...
1. Configureer uw Verbindings instellingen:
    ...
    SAS-](media/concepts-connectivity/connection-settings-sas.png) ![Verbindings instellingen
...
## <a name="provisioning-status"></a>Inrichtings status
