...
U kunt altijd beginnen met het bouwen van een werk stroom met behulp van de IoT Central-connector in Logic Apps in de Azure Portal. Vervolgens kunt u kiezen welke IoT Central-app en met welke regel u verbinding wilt maken. het werkt op dezelfde manier. U hoeft niet telkens op de pagina IoT Central regels te beginnen.
