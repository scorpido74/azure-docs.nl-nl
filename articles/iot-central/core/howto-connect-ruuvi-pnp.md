...
Volg de [onderstaande instructies](./howto-connect-rigado-cascade-500-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) als u een Rigado trapsgewijs 500-gateway apparaat wilt instellen.
...
* Een Azure IoT Central-toepassing die is gemaakt op basis van een van de preview-toepassings sjablonen. Zie voor meer informatie de [nieuwe toepassing maken](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
