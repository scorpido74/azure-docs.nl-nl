...
Selecteer **kopiëren**. Voer in het dialoog venster de details in voor de nieuwe toepassing voor betalen naar gebruik. Selecteer vervolgens **kopiëren** om te bevestigen dat u wilt door gaan. Zie de Snelstartgids [een toepassing maken](quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) voor meer informatie over de velden in het formulier.

![Pagina Toepassings instellingen](media/howto-use-app-templates-pnp/appcopy2.png)

Nadat de Kopieer bewerking van de app is voltooid, kunt u naar de nieuwe toepassing navigeren met behulp van de koppeling.

![Pagina Toepassings instellingen](media/howto-use-app-templates-pnp/appcopy3a.png)
...
![Een toepassings sjabloon maken](media/howto-use-app-templates-pnp/create-template.png)
...
![Een toepassing maken op basis van een sjabloon](media/howto-use-app-templates-pnp/create-app.png)
...
Nu u hebt geleerd hoe u toepassings sjablonen kunt gebruiken, is de voorgestelde volgende stap informatie over het [beheren van IOT Central van de Azure Portal](howto-manage-iot-central-from-portal.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
