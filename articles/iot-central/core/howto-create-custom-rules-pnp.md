...
Nu u weet hoe u aangepaste regels en meldingen kunt maken, is de voorgestelde volgende stap informatie over het [uitbreiden van Azure IOT Central met aangepaste analyses](howto-create-custom-analytics-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
