...
![Actie kiezen](media/howto-use-action-groups-pnp/chooseaction.png)

Kies een actie groep uit uw Azure-abonnement:

![Actie groep kiezen](media/howto-use-action-groups-pnp/chooseactiongroup.png)
...
![Opgeslagen actie groep](media/howto-use-action-groups-pnp/savedactiongroup.png)
...
| Webhook     | {"schemaId": "AzureIoTCentralRuleWebhook", "gegevens": {[normale webhook Payload](howto-create-webhooks-pnp.md#payload)}} |
...
Nu u hebt geleerd hoe u actie groepen met regels kunt gebruiken, is de voorgestelde volgende stap om te leren hoe u [uw apparaten beheert](howto-manage-devices-pnp.md).
