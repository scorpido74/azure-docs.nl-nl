...
U hebt nu een overzicht van de stappen voor het implementeren en gebruiken van de toepassing video Analytics. Zie [een video Analytics n-toepassing maken in Azure IOT Central](tutorial-video-analytics-create-app.md) om aan de slag te gaan.
