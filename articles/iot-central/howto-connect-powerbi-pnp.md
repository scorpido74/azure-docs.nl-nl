...
ms.locfileid: "69880070"
---
# <a name="visualize-and-analyze-your-azure-iot-central-data-in-a-power-bi-dashboard-preview-features"></a>Uw Azure IoT Central-gegevens visualiseren en analyseren in een Power BI dash board (preview-functies)

[!INCLUDE [iot-central-pnp-original](../../includes/iot-central-pnp-original-note.md)]

*Dit onderwerp is van toepassing op beheerders.*

![Power BI solution-pijp lijn](media/howto-connect-powerbi-pnp/iot-continuous-data-export.png)
...
Met deze oplossing wordt de pijp lijn zo ingesteld dat de gegevens in uw Azure Blob-opslag account worden gebruikt voor [continue gegevens export](howto-export-data-blob-storage-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json). Deze gegevens worden door gegeven aan Azure Functions, Azure Data Factory en Azure SQL Database om de gegevens te verwerken en te transformeren. De uitvoer kan worden gevisualiseerd en geanalyseerd in een Power BI rapport dat u als een PBIX-bestand kunt downloaden. Al deze resources worden gemaakt in uw Azure-abonnement, zodat u elk onderdeel kunt aanpassen aan uw behoeften.
...
- Geëxporteerde gegevens met [continue gegevens export](howto-export-data-blob-storage-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) vanuit uw IOT Central-app. U wordt aangeraden metingen, apparaten en Device-sjabloon stromen in te scha kelen om optimaal gebruik te maken van het Power BI dash board.
...
![Power BI rapport pagina 1](media/howto-connect-powerbi-pnp/template-page1-hasdata.PNG)
...
![Power BI rapport pagina 2](media/howto-connect-powerbi-pnp/template-page2-hasdata.PNG)
...
![Azure portal-weer gave van resource groep](media/howto-connect-powerbi-pnp/azure-deployment.PNG)
...
> [Apparaten beheren](howto-manage-devices-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)