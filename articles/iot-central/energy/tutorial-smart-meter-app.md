...
* Lees meer over de architectuur van de app voor slimme meters door dit [conceptartikel](https://docs.microsoft.com/azure/iot-central/energy/concept-iot-central-smart-meter-app) te raadplegen
