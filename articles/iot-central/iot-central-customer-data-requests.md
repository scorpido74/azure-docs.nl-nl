...
description: Functies voor het aanvragen van klant gegevens in azure IoT Central
author: dominicbetts
ms.author: dobett
ms.date: 08/23/2019
ms.topic: conceptual
...
Zie [regels en acties voor uw apparaat configureren](tutorial-configure-rules.md)voor meer informatie.
