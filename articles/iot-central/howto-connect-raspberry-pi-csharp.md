...
1. Open **Program.cs** en vervang de inhoud door de volgende code. Werk de `{your Scope ID}`, `{your Device ID}`en `{your Device Primary Key}` door met de waarden die u eerder hebt genoteerd:
