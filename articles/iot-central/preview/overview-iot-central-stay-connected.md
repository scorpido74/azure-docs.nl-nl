...
Identificeer snel apparaten die aandacht moeten best Eden door [aangepaste regels](tutorial-create-telemetry-rules.md) te bouwen op basis van de apparaatstatus en telemetrie. Configureer acties om de juiste mensen te informeren dat er tijdig corrigerende maat regelen optreden.

## <a name="jobs"></a>Taken 
Met [taken](../core/howto-run-a-job.md?toc=/azure/iot-central/preview/toc.json&bc=/azure/iot-central/preview/breadcrumb/toc.json) kunt u enkele of bulk updates uitvoeren op apparaateigenschappen, instellingen en opdrachten. 

## <a name="user-roles-and-permissions"></a>Gebruikers rollen en machtigingen
[Rollen en machtigingen](howto-manage-users-roles.md) bieden u de mogelijkheid om de gebruikers ervaring aan te passen. Maak rollen rechtstreeks via de gebruikers interface en wijs eenvoudig de juiste machtigingen toe. 
