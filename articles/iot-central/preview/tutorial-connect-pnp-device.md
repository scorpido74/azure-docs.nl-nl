...
---
# <a name="tutorial-use-a-device-capability-model-to-create-an-iot-plug-and-play-device-and-connect-it-to-your-iot-central-application"></a>Tutorial: Use a device capability model to create an IoT Plug and Play device and connect it to your IoT Central application
...
## <a name="generate-device-key"></a>Generate device key
...
## <a name="download-your-model"></a>Download your model
...
## <a name="view-the-device"></a>View the device
