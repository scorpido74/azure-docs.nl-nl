...
U kunt een kopie maken van elke toepassing, min eventuele exemplaren van apparaten, geschiedenis van apparaatgegevens en gebruikers gegevens. De kopie is een standaard toepassing waarvoor u wordt gefactureerd. U kunt geen proef toepassing maken door een toepassing te kopiëren.

Selecteer **kopiëren**. Voer in het dialoog venster de Details voor de nieuwe standaard toepassing in. Selecteer vervolgens **kopiëren** om te bevestigen dat u wilt door gaan. Zie de Snelstartgids [een toepassing maken](quick-deploy-iot-central.md) voor meer informatie over de velden in het formulier.
