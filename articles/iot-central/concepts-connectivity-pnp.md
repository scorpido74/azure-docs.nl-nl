...
1. Configureer uw Verbindings instellingen:
    ...
    ![Verbindings instellingen SAS](media/concepts-connectivity-pnp/connection-settings-sas.png)
...
Zie How to [Connect a iot Plug en Play Device](howto-connect-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)(Engelstalig) voor meer informatie over het verbinden van een iot-Plug en Play apparaat.
...
- [Een IoT Plug en Play-apparaat verbinden](howto-connect-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
