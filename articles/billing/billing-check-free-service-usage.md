...
2.  Zoek naar **Abonnementen**.
    ...
    ![Schermopname van zoekopdracht in portal naar abonnementen](./media/billing-check-usage-of-free-services/billing-search-subscriptions.png)
...
- [Uw gratis Azure-account upgraden](billing-upgrade-azure-subscription.md)
