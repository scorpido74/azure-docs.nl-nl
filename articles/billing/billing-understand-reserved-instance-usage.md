...
Als u een klant bent met een Enterprise Overeenkomst, raadpleegt u [Het gebruik van reserveringen voor uw Enterprise-inschrijving begrijpen.](billing-understand-reserved-instance-usage-ea.md).
...
Het hardware-gedeelte van de virtuele machine wordt gedekt omdat de geïmplementeerde virtuele machine overeenkomt met de reserveringskenmerken. Zie [Azure Reserve VM Instances Windows-softwarekosten](billing-reserved-instance-windows-software-costs.md) voor meer informatie over de Windows-software die niet wordt gedekt door de gereserveerde VM-instantie
...
![Schermopname van gefilterde details en kosten van reserveringsgebruik](./media/billing-understand-reserved-instance-usage/billing-payg-reserved-instance-csv-statements.png)
...
![Schermopname van de details en kosten van dagelijks gebruik](./media/billing-understand-reserved-instance-usage/billing-payg-reserved-instance-csv-details.png)
...
5. Standard_DS1_v2 is een vCPU-VM en de virtuele machine wordt zonder Azure Hybrid Benefit geïmplementeerd. Deze meter dekt dus de extra kosten van de Windows-software. Zie [Windows-softwarekosten voor gereserveerde Azure VM-instanties](billing-reserved-instance-windows-software-costs.md) als u de meter wilt vinden die overeenkomt met de D-serie 1-core-VM. Als u de Azure Hybrid Benefit hebt, worden deze extra kosten niet toegepast.
...
![CSV-bestand voor gereserveerde SQL Database-capaciteit](./media/billing-understand-reserved-instance-usage/billing-payg-sql-db-reserved-capacity-csv-statements.png)
...
![CSV-bestand voor gereserveerde SQL Database-capaciteit](./media/billing-understand-reserved-instance-usage/billing-payg-sql-db-reserved-capacity-csv-details.png)
