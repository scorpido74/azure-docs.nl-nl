---
title: Overzicht van API voor Azure-gebruiksgegevens | Microsoft Docs
...
- Zie het [overzicht van Azure Billing API's](billing-usage-rate-card-overview.md) voor informatie over het gebruik van Azure Billing-API's om programmatisch inzicht te krijgen in uw Azure-gebruik.
