...
Voor meer informatie raadpleegt u [Creditcard toevoegen, bijwerken of verwijderen voor Azure](billing-how-to-change-credit-card.md).
...
- Raadpleeg [Achterstallig saldo voor uw Azure-abonnement vereffenen](billing-azure-subscription-past-due-balance.md) als u een Azure-rekening moet betalen.
