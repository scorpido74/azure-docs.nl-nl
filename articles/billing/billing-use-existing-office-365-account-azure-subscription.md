...
Als u al een Office 365-account en een Azure-abonnement hebt, raadpleegt u [Een Office 365-tenant koppelen aan een Azure-abonnement](billing-add-office-365-tenant-to-azure-subscription.md).
...
2. Meld u aan met uw Office 365-gebruikersnaam en -wachtwoord. Het account dat u gebruikt, heeft geen beheerdersmachtigingen nodig. Als u meer dan één Office 365-account hebt, moet u ervoor zorgen dat u de referenties gebruikt voor het Office 365-account dat u wilt koppelen aan uw Azure-abonnement. 
   ...
   ![Schermopname waarin de aanmeldingspagina wordt weergegeven.](./media/billing-use-existing-office-365-account-azure-subscription/billing-sign-in-with-office-365-account.png)
...
3. Voer de vereiste gegevens in en voltooi het aanmeldingsproces. Sommige gegevens zijn mogelijk niet vereist als u al een Office 365-account hebt.
    ...
    ![Schermopname waarin het aanmeldingsformulier wordt weergegeven.](./media/billing-use-existing-office-365-account-azure-subscription/billing-azure-sign-up-fill-information.png)
...
![Schermopname van de relatie tussen de map, gebruikers en abonnementen.](./media/billing-use-existing-office-365-account-azure-subscription/19-background-information.png)
