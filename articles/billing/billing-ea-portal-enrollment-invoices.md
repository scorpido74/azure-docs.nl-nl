...
## <a name="incorrect-overage-invoice"></a>Onjuiste overschrijdingsfactuuur

Als u denkt dat u een onjuiste overschrijdingsfactuur hebt, raadpleegt u [Meer informatie over uw Azure Enterprise Agreement-factuur](billing-understand-your-bill-ea.md) voor hulp bij het afstemmen van uw Azure-gebruikskosten. Neem contact op met de ondersteuning als u denkt dat er een fout is in de overschrijding die Microsoft in rekening heeft gebracht.

## <a name="change-a-po-number-for-an-overage-invoice"></a>Een inkoopordernummer wijzigen voor een overschrijdingfactuur

In Azure EA Portal wordt automatisch een standaardnummer voor een inkooporder (PO) gegenereerd, tenzij de EA-beheerder er een instelt vóór de factuurdatum. Een EA-beheerder kan het PO-nummer bijwerken in Azure EA Portal door zich aan te melden en te navigeren naar **Rapporten**. Een EA-beheerder kan het PO-nummer bijwerken. Klik rechtsboven in de sectie met het PO-nummer op het potloodsymbool en werk de gegevens bij.

Een EA-beheerder kan het PO-nummer bijwerken in het huidige factureringskwartaal voordat er een factuur is gemaakt. Deze kan PO-nummer ook bijwerken tot zeven dagen na ontvangst van een geautomatiseerde factuurmeldingsmail.

Als de EA-beheerder het PO-nummer niet heeft bijgewerkt en er een nieuw PO-nummer nodig is, is de enige optie een tegoed te voltooien en opnieuw te factureren. Als een klant het PO-nummer moet bijwerken, neemt u contact op met uw partner voor ondersteuning.
...
Alle tegoeden of aanpassingen die op uw enrollment zijn toegepast, worden weergegeven op [https://ea.azure.com](https://ea.azure.com) in de sectie **Rapporten**. Als u een specifieke vraag hebt over een huidige tegoed, neemt u contact op met de [Azure EA Portal-ondersteuning](https://support.microsoft.com/supportrequestform/cf791efa-485b-95a3-6fad-3daf9cd4027c).
...
## <a name="understand-your-bill"></a>Meer informatie over uw factuur
...
_Afzonderlijk gefactureerde kosten_ en _Azure Marketplace-services_ zijn externe services die worden geïmplementeerd vanuit het Azure Marketplace-platform. Het belangrijkste verschil tussen de twee services is de manier waarop deze worden gefactureerd, op basis van de overeenkomststructuur die is vastgelegd met externe uitgevers.

Extern gebruik wordt op uw factuur weergegeven onder **Afzonderlijk gefactureerde kosten**. Bij dit gebruik wordt uw saldo van de financiële toezegging van Azure verbruikt. Zie [Azure Marketplace-services van externe resellers maken nu gebruik van financiële toezegging van Azure](https://azure.microsoft.com/updates/azure-marketplace-third-party-reseller-services-now-use-azure-monetary-commitment/) om de lijst met externe services weer te geven.

Het gebruik op uw factuur dat wordt weergegeven onder **Azure Marketplace**, wordt afzonderlijk in rekening gebracht. Het wordt niet gedekt door financiële toezeggingen. Alle kosten, met inbegrip van Marketplace, overschrijding en afzonderlijk gefactureerde kosten, worden echter afzonderlijk geconsolideerd op één factuur.

U ontvangt één factuur voor eigen Azure-overschrijding en externe Azure Marketplace-aankopen.

Wanneer uw financiële toezegging volledig is verbruikt, wordt het gebruik gefactureerd per maand of per kwartaal. Als uw enrollment vóór mei 2018 is gestart, geldt er een drempelwaarderegel van 150% van de financiële toezegging en wordt u per kwartaal gefactureerd voor overschrijdingen. Als uw enrollment na mei 2018 is gestart, worden alle overschrijdingen maandelijks gefactureerd.
