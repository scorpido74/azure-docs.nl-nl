...
![Schermopname met 'Niet-geautoriseerd' in het veld Huidige kosten voor abonnement.](media/billing-enterprise-mgmt-groups/unauthorized.png)
...
2. Als u een EA Direct-klant bent, zijn er een aantal mogelijkheden:
    ...
    * Neem contact op met uw inschrijvingsbeheerder voor toegang. De inschrijvingsbeheerder kan de instellingen bijwerken in de [Enterprise-portal](https://ea.azure.com/manage/enrollment).
      ...
      ![Schermopname met de instellingen voor kostenweergave in de Enterprise-portal.](media/billing-enterprise-mgmt-groups/ea-portal-settings.png)
...
![Schermopname met het bericht dat een asset niet beschikbaar is.](media/billing-enterprise-mgmt-groups/asset-not-found.png)
