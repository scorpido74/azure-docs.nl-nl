...
|-------------|----------|-----------|
|`id`|Tekenreeks|The ID of the webhook event.|
|`timestamp`|Datum/tijd|The time at which the webhook event was triggered.|
|`action`|Tekenreeks|The action that triggered the webhook event.|
...
|Element|Type|Beschrijving|
|------------------|----------|-----------|
|`mediaType`|Tekenreeks|The MIME type of the referenced object.|
|`size`|Int32|The number of bytes of the content. Same as Length field.|
|`digest`|Tekenreeks|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`length`|Int32|The number of bytes of the content. Same as Size field.|
|`repository`|Tekenreeks|The repository name.|
|`tag`|Tekenreeks|The image tag name.|

### <a name="request"></a>request

|Element|Type|Beschrijving|
|------------------|----------|-----------|
|`id`|Tekenreeks|The ID of the request that initiated the event.|
|`host`|Tekenreeks|The externally accessible hostname of the registry instance, as specified by the HTTP host header on incoming requests.|
|`method`|Tekenreeks|The request method that generated the event.|
|`useragent`|Tekenreeks|The user agent header of the request.|
...
|`digest`|Tekenreeks|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`repository`|Tekenreeks|The repository name.|
|`tag`|Tekenreeks|The chart tag name.|
|`name`|Tekenreeks|The chart name.|
|`version`|Tekenreeks|The chart version.|
