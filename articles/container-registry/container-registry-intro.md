...
* **Beveiliging en toegang** : u meldt zich aan bij een REGI ster met behulp van `docker login` de Azure CLI of de opdracht standaard. Azure Container Registry container installatie kopieën overdraagt via HTTPS en TLS ondersteunt om client verbindingen te beveiligen. 
...
* [Een container register maken met de Azure CLI](container-registry-get-started-azure-cli.md)
