...
* Als u nog geen container register hebt, maakt u er een (vereist een Premium-laag) en pusht u `hello-world` een voor beeld van een installatie kopie, zoals van docker hub. Gebruik bijvoorbeeld de [Azure Portal][quickstart-portal] of de [Azure cli][quickstart-cli] om een REGI ster te maken.
