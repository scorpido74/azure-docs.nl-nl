...
Voer [AZ ACR taak referentie add][az-acr-task-credential-add] uit om referenties toe te voegen aan de taak. Geef de para meter `--use-identity [system]` door om aan te geven dat de door het systeem toegewezen beheerde identiteit van de taak toegang kan krijgen tot de referenties.
