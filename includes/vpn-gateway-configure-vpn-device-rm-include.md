...
- Zie [Overzicht van VPN-apparaatconfiguratie](../articles/vpn-gateway/vpn-gateway-3rdparty-device-config-overview.md) voor een overzicht van VPN-apparaatconfiguratie.
