...
| --- | --- | --- |
| [Grootte van back-upgroep](https://docs.microsoft.com/azure/azure-resource-manager/management/azure-subscription-service-limits#load-balancer) | Ondersteunt maximaal 1000 instanties. | Ondersteunt Maxi maal 300 exemplaren. |
...
| TCP opnieuw instellen bij niet-actief | [Beschikbaar op elke regel](../articles/load-balancer/load-balancer-tcp-reset.md) | Niet beschikbaar |
