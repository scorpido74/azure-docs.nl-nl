...
ms.locfileid: "74980621"
---
## <a name="create-an-azure-resource"></a>Een Azure-resource maken

Begin met het gebruik van de Bing Afbeeldingen zoeken-API door een van de onderstaande Azure-resources te maken.
...
* [Bing Search V7-resource maken](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7):
