...
1. Gebruik in **een nieuwe Azure functions-toepassing maken**de volgende opties:
    ...
    > [!NOTE]
    > Zorg ervoor dat u het **autorisatie niveau** instelt op `Anonymous`. Als u het standaard niveau van `Function`kiest, moet u de [functie toets](../articles/azure-functions/functions-bindings-http-webhook-trigger.md#authorization-keys) in aanvragen voor toegang tot uw functie-eind punt presen teren.
