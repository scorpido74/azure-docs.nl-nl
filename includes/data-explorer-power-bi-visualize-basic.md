...
1. Selecteer de rapportweergave aan de linkerkant van het hoofdvenster van Power BI.
    ...
    ![Rapportweergave](media/data-explorer-power-bi-visualize-basic/report-view.png)

1. Selecteer in het deelvenster **VISUALISATIES** het gegroepeerde kolomdiagram.

    ![Kolomdiagram toevoegen](media/data-explorer-power-bi-visualize-basic/add-column-chart.png)
...
1. Selecteer in de lijst **VELDEN****DamageCrops** en **State**.
    ...
    ![Gewasschade per staat](media/data-explorer-power-bi-visualize-basic/damage-column-chart.png)
