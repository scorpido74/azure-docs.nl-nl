...
[**Azure Digital apparaatdubbels Explorer**](https://docs.microsoft.com/samples/azure-samples/digital-twins-explorer/digital-twins-explorer/) is een voorbeeld toepassing voor het visualiseren en samen werken met Azure Digital apparaatdubbels. Volg de instructies van het voor beeld om de toepassings code te downloaden en uit te voeren. 
