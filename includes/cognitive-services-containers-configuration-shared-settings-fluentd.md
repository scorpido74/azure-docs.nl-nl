...
| `UseTLS` | Boolean-waarde | Hiermee geeft u op of de container SSL/TLS moet gebruiken voor communicatie met de vloeiende server. De standaardwaarde is false. |