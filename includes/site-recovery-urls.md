...
--- | --- | --- | ---
Azure Active Directory | ``login.microsoftonline.com`` | ``login.microsoftonline.us`` | Gebruikt door Azure Active Directory voor toegangsbeheer en identiteitsbeheer. 
...
Tijdsynchronisatie | ``time.windows.com`` | ``time.nist.gov`` | Gebruikt om de tijdsynchronisatie tussen de systeemtijd en de algemene tijd te controleren in alle implementaties.
