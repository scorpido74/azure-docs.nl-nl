...
Voor toegang tot de service moet u beschikken over een accountsleutel, een toegangstoken of een Azure Active Directory-beveiligingstoken. U kunt hierover meer lezen op de [conceptpagina Verificatie](/azure/spatial-anchors/concepts/authentication).
