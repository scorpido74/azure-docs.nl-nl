...
|[Java](../articles/azure-functions/functions-reference-java.md)|N.v.t.|GA (Java 8)| GA (Java 11<sup>1</sup> & 8)|
...
<sup>1</sup> Ondersteuning van taalversie is momenteel in preview.  
