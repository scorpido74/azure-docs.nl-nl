...
ms.openlocfilehash: f8bb07dce36ec52ee15c093f1f948781993ff2d8
ms.sourcegitcommit: 4bee52a3601b226cfc4e6eac71c1cb3b4b0eafe2
ms.translationtype: HT
ms.contentlocale: nl-NL
ms.lasthandoff: 11/11/2020
ms.locfileid: "94523954"
---
|Taal                                 |1.x         |2.x| 3.x |
|-----------------------------------------|------------|---| --- |
...
|[Python](../articles/azure-functions/functions-reference-python.md#python-version)|N.v.t.|GA (Python 3.7 & 3.6)| GA (Python 3.8, 3.7, & 3.6)|
|[TypeScript](../articles/azure-functions/functions-reference-node.md#typescript) |N.v.t.|GA<sup>*</sup>| GA<sup>*</sup> |

<sup>*</sup> Ondersteund via transpilatie naar JavaScript.
