...
Instanties van de ESv3-serie beschikken over de Intel® Xeon® 8171M 2,1 GHz (Skylake) of de Intel® Xeon® E5-2673 v4 2,3 GHz-processors (Broadwell) en kunnen 3,5 GHz bereiken met Intel Turbo Boost Technology 2,0 en Premium Storage gebruiken. Exemplaren uit de Ev3-reeks zijn ideaal voor geheugenintensieve bedrijfstoepassingen.
...
Ev3-Series-exemplaren beschikken over de Intel® Xeon® 8171M 2,1 GHz (Skylake) of de Intel® Xeon® E5-2673 v4 2,3 GHz (Broadwell)-processors en kunnen 3,5 GHz bereiken met de Intel Turbo Boost-technologie 2,0. Exemplaren uit de Ev3-reeks zijn ideaal voor geheugenintensieve bedrijfstoepassingen.
...
1. SUSE-installatie kopieën die compatibel zijn met de Mv2-serie, worden voorafgegaan door de naam `GEN2:`. De volgende SUSE-installatie kopieën zijn beschikbaar voor Vm's uit de Mv2-serie:
...
Gebruik de volgende [`az vm image list`](https://docs.microsoft.com/cli/azure/vm/image?view=azure-cli-latest#az-vm-image-list) opdracht voor een overzicht van de momenteel beschik bare SLES voor SAP-installatie kopie voor virtuele machines uit de Mv2-serie:
...
<sup>2</sup> meer dan 64 vCPU vereisen een van deze ondersteunde gast systemen: Windows Server 2016, Ubuntu 16,04 LTS, SLES 12 SP2 en Red Hat Enterprise Linux, CentOS 7,3 of Oracle Linux 7,3 met Lis 4.2.1.
...
| Standard_D15_v2 @ no__t-0<sup>1</sup> | 20        | 140         | 1000          | 60.000 / 937 / 468                                        | 64/64x500                       | 8/25000 @ no__t-0<sup>2</sup> |
