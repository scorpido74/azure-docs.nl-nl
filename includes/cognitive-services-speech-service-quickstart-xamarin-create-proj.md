...
1. Selecteer in de menu balk van Visual Studio de optie **bestand** > **Nieuw** > **project** om het venster **een nieuw project maken** weer te geven.
...
1. Voer *micro soft. CognitiveServices. speech*in het **zoekvak** in. Selecteer vervolgens dat pakket nadat het is weer gegeven in de zoek resultaten.
   ...
   > [!NOTE] 
   > Voor de iOS- `Microsoft.CognitiveServices.Speech` bibliotheek in NuGet is bitcode niet ingeschakeld. Als u de bitcode-bibliotheek voor uw toepassing nodig hebt, `Microsoft.CognitiveServices.Speech.Xamarin.iOS` gebruikt u NuGet voor het IOS-project.
