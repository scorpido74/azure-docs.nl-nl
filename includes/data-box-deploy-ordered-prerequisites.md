---
title: Vereisten zijn onder andere een bestand gedeeld door twee tabbladen in hetzelfde bestand | Microsoft Docs
description: Azure Data Box bestelde vereisten implementeren
services: databox
author: priestlg
ms.service: databox
ms.subservice: pod
...
* Er is een hostcomputer verbonden met het datacenternetwerk. Data Box kopieert de gegevens vanaf deze computer. Uw hostcomputer moet een ondersteund besturingssysteem hebben, zoals beschreven in [Systeemvereisten voor Azure Data Box](../articles/databox/data-box-system-requirements.md).
