...
* **Opslagaccount:** Alle toegang tot Azure Storage vindt plaats via een opslagaccount. Zie voor meer informatie over opslag accounts [opslag account overview] [.. /articles/storage/common/storage-account-overview.md].
