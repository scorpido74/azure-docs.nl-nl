...
1. Selecteer **virtueel WAN** in de resultaten. Klik op de pagina virtueel WAN op **maken**.
1. Vul op de pagina **WAN maken** de volgende velden in:
...
4. Nadat u klaar bent met het invullen van de velden, klikt u op **Maken**.