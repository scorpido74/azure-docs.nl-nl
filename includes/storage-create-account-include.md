...
Als u op dit moment liever geen opslag account maakt in azure, kunt u ook de Azure-opslag emulator gebruiken om uw code uit te voeren en te testen in een lokale omgeving. Zie [de Azure Storage-emulator gebruiken voor ontwikkeling en testen](../articles/storage/common/storage-use-emulator.md)voor meer informatie.
