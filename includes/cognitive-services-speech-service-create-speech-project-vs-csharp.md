...
1. Selecteer in de menu balk van Visual Studio **extra** > **hulp middelen en functies ophalen**, waarmee Visual Studio Installer wordt geopend en het dialoog venster **wijzigen** wordt weer gegeven.
