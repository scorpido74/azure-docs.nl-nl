...
* Stel de **verloop tijd** op de juiste wijze in. Zorg ervoor dat de toegang tot Azure Storage objecten niet verloopt binnen de actieve periode van de pijp lijn.
