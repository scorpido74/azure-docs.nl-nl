...
ms.locfileid: "67176566"
---
<!-- Guidance on technologies used to move data to and/or from Azure Blob storage are linked here:
-->
In dit menu vindt u koppelingen naar technologieën die u kunt gebruiken om gegevens van en naar Azure Blob-opslag te verplaatsen:

> [!div class="op_single_selector" title1="Hulpprogram ma's voor Blob-opslag"]
> * [Overzicht](../articles/machine-learning/team-data-science-process/move-azure-blob.md)
> * [Azure Storage-Verkenner](../articles/machine-learning/team-data-science-process/move-data-to-azure-blob-using-azure-storage-explorer.md)
