...
<sup>2</sup> Triggers worden niet ondersteund in het Consumption-abonnement. Vereist [runtime-gestuurde triggers](../articles/azure-functions/functions-networking-options.md#premium-plan-with-virtual-network-triggers).

<sup>3</sup> Alleen ondersteund in Kubernetes, IoT Edge en andere zelf-gehoste modi.
