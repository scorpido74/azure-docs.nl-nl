...
Voor verbeterde [windows VM-](../articles/virtual-machines/windows/encrypt-disks.md) en [Linux VM-beveiliging](../articles/virtual-machines/linux/disk-encryption-overview.md) en -naleving kunnen virtuele schijven in Azure worden versleuteld. Virtuele schijven op Windows VM's worden in rust versleuteld met BitLocker. Virtuele schijven op Linux VM's worden in rust versleuteld met behulp van dm-crypt. 
