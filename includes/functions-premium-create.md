...
---
1. Open de Azure Portal van[https://portal.azure.com](https://portal.azure.com)
...
1. Voer de volgende hosting-instellingen in.
    ...
    | **[Plannen](../articles/azure-functions/functions-scale.md)** | Premium | Selecteer **Premium (preview)** bij plan type en selecteer standaard instellingen voor het *Windows-plan* en de opties voor de *SKU en de grootte* . |
