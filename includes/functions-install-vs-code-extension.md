...
1. Na de installatie selecteert u het pictogram van Azure op de activiteiten balk. Het gebied Azure Functions moet nu in de zijbalk worden weergegeven.

    ![Gebied Azure Functions in de zijbalk](./media/functions-install-vs-code-extension/azure-functions-window-vscode.png)