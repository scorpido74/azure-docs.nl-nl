...
5. Typ de naam van het apparaat om de verwijdering te bevestigen. Nadat het apparaat is verwijderd, wordt de lijst met apparaten bijgewerkt.

    ![Verwijdering bevestigen](./media/storsimple-8000-delete-cloud-appliance/delete-cloud-appliance2.png)

6. U ontvangt een melding nadat het apparaat is verwijderd.

    ![Melding dat het apparaat is verwijderd](./media/storsimple-8000-delete-cloud-appliance/delete-cloud-appliance4.png)

7. De lijst met apparaten wordt bijgewerkt en geeft aan dat het apparaat is verwijderd.
