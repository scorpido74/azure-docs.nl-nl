...
|---            |---         | ---        | ---       | ---            | ---       | ---       | ---|
|**Generation1**|**Basic**   | Met maximaal 10    | Met maximaal 128  | Niet ondersteund  | 100 Mbps  | Niet ondersteund| Nee |
...
|**Generatie**|**SKU**   | **Gebruikte algoritmen<br>** | **Door Voer<br>waargenomen** | **<br>waargenomen pakketten per seconde** |
|---           |---       | ---                 | ---            | ---                    |
