...
* **Ondernemingscertificaat:** Als u een bedrijfsoplossing gebruikt, u uw bestaande certificaatketen gebruiken. Haal het CER-bestand op dat u wilt gebruiken voor het basiscertificaat.
* **Zelfondertekend rootcertificaat:** Als u geen oplossing voor bedrijfscertificaten gebruikt, maakt u een zelfondertekend rootcertificaat. Anders zijn de certificaten die u maakt niet compatibel met uw P2S-verbindingen en treedt er voor clients een verbindingsfout op tijdens het verbinden. U kunt Azure PowerShell, MakeCert of OpenSSL gebruiken. In de stappen in de volgende artikelen wordt beschreven hoe u een compatibel, zelfondertekend basiscertificaat genereert:
