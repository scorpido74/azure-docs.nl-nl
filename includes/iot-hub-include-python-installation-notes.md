...
* Installeer, indien nodig, het [Azure-IOT-Device-](https://pypi.org/project/azure-iot-device/) pakket met behulp van de opdracht`pip install azure-iot-device`
