...
2. Als u de batchreferenties wilt bekijken, selecteert u **Toetsen**. Kopieer de waarden van **Batch-account**, **URL** en **Primaire toegangssleutel** in een teksteditor.

3. Als u de naam en sleutels van het opslagaccount wilt bekijken, selecteert u **Opslagaccount**. Kopieer de waarden van **Naam van opslagaccount** en **Key1** in een teksteditor.