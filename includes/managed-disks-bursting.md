...
- Een veelvoorkomend scenario dat kan profiteren van het barsten van de schijf is sneller VM opstarten en applicatie te starten op OS-schijven. Neem een Linux VM met een 8 GiB OS afbeelding als voorbeeld. Als we een P2-schijf als de OS-schijf gebruiken, is het beoogde doel 120 IOPS en 25 MBps. Wanneer VM wordt gestart, wordt er een leespiek naar de OS-schijf weergegeven die de opstartbestanden laadt. Met de introductie van barsten, u lezen op de maximale burst snelheid van 3500 IOPS en 170 MBps, het versnellen van de laadtijd met ten minste 6x. Na het opstarten van de VM is het verkeersniveau op de OS-schijf meestal laag, omdat de meeste gegevensbewerkingen door de toepassing tegen de aangesloten gegevensschijven zijn. Als het verkeer onder het ingerichte doel ligt, verzamelt u credits.
