...
## <a name="users"></a>2. Tenant gebruikers maken
...
## <a name="register-client"></a>3. de VPN-client registreren
...
## <a name="register-apps"></a>4. aanvullende toepassingen registreren
...
## <a name="assign-users"></a>5. gebruikers toewijzen aan toepassingen
