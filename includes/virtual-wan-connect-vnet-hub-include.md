...
1. Klik op de pagina voor uw virtueel WAN op **Virtuele netwerkverbindingen**.
1. Selecteer op de pagina van de virtuele netwerkverbinding **+ Verbinding toevoegen**.
...
1. Selecteer **OK** om de verbinding te maken.