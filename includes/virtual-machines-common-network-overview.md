...
U een VNet maken voordat u een VM maakt of u als u een VM maakt. U maakt deze resources ter ondersteuning van de communicatie met een virtuele machine:
...
| [Azure PowerShell](../articles/virtual-machines/windows/multiple-nics.md) | Gebruik [New-AzNetworkInterface](https://docs.microsoft.com/powershell/module/az.network/new-aznetworkinterface) met de parameter **-PublicIpAddressId** om de id van het openbare IP-adres op te geven dat u eerder hebt gemaakt. |
| [Azure-CLI](../articles/virtual-machines/linux/multiple-nics.md) | Als u de id wilt opgeven van het openbare IP-adres dat u eerder hebt gemaakt, gebruikt u [az-netwerknic-maken](https://docs.microsoft.com/cli/azure/network/nic) met de parameter **--public-ip-address.** |
...
Aan virtuele machines wordt een IP-adres toegewezen wanneer deze worden geïmplementeerd. Als u meerdere virtuele machines in een VNet of subnet implementeert, worden er IP-adressen aan toegewezen als ze opstarten. U ook een statisch IP toewijzen aan een virtuele machine. Als u een statisch IP-adres toewijst, u overwegen een specifiek subnet te gebruiken om te voorkomen dat u per ongeluk een statisch IP-adres voor een andere vm opnieuw gebruikt.  
...
Zie [de](../articles/virtual-machines/windows/tutorial-virtual-network.md) windows- of Linux-zelfstudies voor VM-specifieke [Linux](../articles/virtual-machines/linux/tutorial-virtual-network.md) stappen voor het beheren van virtuele Azure-netwerken voor VM's.

Er zijn ook tutorials over hoe je balans VM's laden en maak zeer beschikbare toepassingen voor [Windows](../articles/virtual-machines/windows/tutorial-load-balancer.md) of [Linux](../articles/virtual-machines/linux/tutorial-load-balancer.md).
...
- Meer informatie over [bandbreedte van het virtuele machinenetwerk](../articles/virtual-network/virtual-machine-network-throughput.md).
