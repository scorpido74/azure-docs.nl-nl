...
| Methode | Beschrijving |
| ------ | ----------- |
| Azure Portal | U kunt [de belasting van het interne verkeer verdelen met een basis Load Balancer in het Azure Portal](../articles/load-balancer/tutorial-load-balancer-basic-internal-portal.md). |
...
## <a name="vms"></a>Virtuele machines
